 ...
 * A(n) {@link gw.webservice.cc.cc901.dto.BulkInvoiceDTO} is a DTO that represents an instance of {@link BulkInvoice} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link BulkInvoice}.
 ...
 * <p>The specific mappings for {@link gw.webservice.cc.cc901.dto.BulkInvoiceDTO} are as follows:
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc901/dto/BulkInvoiceDTO")
final class BulkInvoiceDTO {
  ...
  var _mailingAddress                : gw.webservice.cc.cc901.dto.AddressDTO as MailingAddress
  var _mailTo                        : String                           as MailTo
  var _memo                          : String                           as Memo
  var _newInvoiceItems               : gw.webservice.cc.cc901.dto.BulkInvoiceItemDTO[]             as NewInvoiceItems = {}
  ...
  var _validationAlerts              : gw.webservice.cc.cc901.dto.BIValidationAlertDTO[]           as ValidationAlerts = {}
   ...
   * @param that The BulkInvoice to copy from.
   */
  final function readFrom(that : BulkInvoice) : gw.webservice.cc.cc901.dto.BulkInvoiceDTO {
  ...
  /** Convenience property that returns the {@link entity.Contact} whose PublicID is {@code PayeePublicID}, or {@code null} if PublicID is {@code null}. This property is only available on the server--it is not exposed through the WS-I layer. */
   ...
   */
  static function valueOf(that : BulkInvoice) : gw.webservice.cc.cc901.dto.BulkInvoiceDTO {
    return new gw.webservice.cc.cc901.dto.BulkInvoiceDTO().readFrom(that)
  }
