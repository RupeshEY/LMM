 ...
 * A(n) {@link gw.webservice.cc.cc901.dto.TransactionSetDTO} is a DTO that represents an instance of {@link entity.TransactionSet} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link entity.TransactionSet}.
 ...
 * <p>The specific mappings for {@link gw.webservice.cc.cc901.dto.TransactionSetDTO} are as follows:
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc901/dto/TransactionSetDTO")
final class TransactionSetDTO {
  ...
  var _newChecks                            : gw.webservice.cc.cc901.dto.CheckDTO[]             as NewChecks = {}
  ...
  var _newRecoveries                        : gw.webservice.cc.cc901.dto.TransactionDTO[]       as NewRecoveries = {}
  var _newRecoveryReserves                  : gw.webservice.cc.cc901.dto.TransactionDTO[]       as NewRecoveryReserves = {}
  var _newReserves                          : gw.webservice.cc.cc901.dto.TransactionDTO[]       as NewReserves = {}
   ...
   * @param that The TransactionSet to copy from.
   */
  final function readFrom(that : TransactionSet) : gw.webservice.cc.cc901.dto.TransactionSetDTO {
  ...
  /** Convenience property that returns a {@link entity.Activity[]} of the objects whose PublicIDs are in {@code ActivityPublicIDs}. This property is only available on the server--it is not exposed through the WS-I layer. */
   ...
   */
  static function valueOf(that : TransactionSet) : gw.webservice.cc.cc901.dto.TransactionSetDTO {
    return new gw.webservice.cc.cc901.dto.TransactionSetDTO().readFrom(that)
  }
