 ...
 * A(n) {@link gw.webservice.cc.cc901.dto.ActivityDTO} is a DTO that represents an instance of {@link entity.Activity} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link entity.Activity}.
 ...
 * <p>The specific mappings for {@link gw.webservice.cc.cc901.dto.ActivityDTO} are as follows:
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc901/dto/ActivityDTO")
final class ActivityDTO {
   ...
   * @param that The Activity to copy from.
   */
  final function readFrom(that : Activity) : gw.webservice.cc.cc901.dto.ActivityDTO {
   ...
   */
  static function valueOf(that : Activity) : gw.webservice.cc.cc901.dto.ActivityDTO {
    return new gw.webservice.cc.cc901.dto.ActivityDTO().readFrom(that)
  }
