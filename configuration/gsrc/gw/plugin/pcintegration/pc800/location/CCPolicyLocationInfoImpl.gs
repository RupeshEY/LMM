...
uses wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.PolicyLocationInfo_PNIAddressFields
uses wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.PolicyLocationInfo_PolicyLocationAddress
uses wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.PolicyLocationInfo_TotalInsuredValues
uses wsi.remote.gw.webservice.pc.pc800.entities.types.complex.PolicyLocationInfo
...
class CCPolicyLocationInfoImpl implements CCPolicyLocationInfo {
  ...
  override property get PolicyLocationAddress(): gw.plugin.pcintegration.pc800.location.CCPolicyLocationInfoImpl.Address {
    return new gw.plugin.pcintegration.pc800.location.CCPolicyLocationInfoImpl.Address(_info.PolicyLocationAddress)
  }
  ...
  override property get TotalInsuredValues(): gw.plugin.pcintegration.pc800.location.CCPolicyLocationInfoImpl.InsuredValue[] {
    return (_info.TotalInsuredValues.map(\insuredVal -> new gw.plugin.pcintegration.pc800.location.CCPolicyLocationInfoImpl.InsuredValue(insuredVal)))?.toTypedArray()
  }
