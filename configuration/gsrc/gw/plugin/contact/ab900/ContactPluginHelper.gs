...
uses wsi.remote.gw.webservice.ab.ab900.abcontactapi.anonymous.elements.ABContactAPISearchSpec_SortColumns
uses wsi.remote.gw.webservice.ab.ab900.abcontactapi.anonymous.elements.ABContactAPISearchSpec_SortColumns_Entry
uses wsi.remote.gw.webservice.ab.ab900.abcontactapi.anonymous.elements.ABContactAPISearchSpec_SubtypeFilter
uses wsi.remote.gw.webservice.ab.ab900.abcontactapi.types.complex.ABContactAPIFindDuplicatesResultContainer
uses wsi.remote.gw.webservice.ab.ab900.abcontactapi.types.complex.ABContactAPIPendingContactChange
uses wsi.remote.gw.webservice.ab.ab900.abcontactapi.types.complex.ABContactAPISearchResultContainer
...
internal class ContactPluginHelper extends ContactPluginHelperBase {
  ...
  protected function toRemoteXmlBackedInstance(xmlContact : XmlBackedInstance) : wsi.remote.gw.webservice.ab.ab900.beanmodel.XmlBackedInstance {
    return wsi.remote.gw.webservice.ab.ab900.beanmodel.XmlBackedInstance.parse(xmlContact.bytes())
  }
  
  protected function fromRemoteXmlBackedInstance(remoteXmlInstance:wsi.remote.gw.webservice.ab.ab900.beanmodel.XmlBackedInstance) : XmlBackedInstance {
  ...
  protected function toSearchSpec(searchFilter:ContactSearchFilter, includePendingCreates : boolean) : ABContactAPISearchSpec {
    ...
    var sortColumns = new ArrayList<ABContactAPISearchSpec_SortColumns_Entry>()
