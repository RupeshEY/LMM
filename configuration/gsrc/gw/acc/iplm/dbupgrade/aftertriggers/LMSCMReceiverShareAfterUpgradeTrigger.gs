...
class LMSCMReceiverShareAfterUpgradeTrigger extends AfterUpgradeVersionTrigger {
  ...
  override function execute() {
    ...
    gw.transaction.Transaction.runWithNewBundle(\bundle -> {
      scmMessagesList.each(\msg -> {
        ...
        msg = bundle.add(msg)
        msg = mapReceiverShare(msg, parsedMessage)
      })
  ...
  private function mapReceiverShare(msg: LMMessageLloydsSCM_Ext, parsedMessage: Jv_Ins_Reinsurance): LMMessageLloydsSCM_Ext {
    msg = SyndicateClaimMessageEntityMapper.mapReceiverShare(msg, parsedMessage)
    return msg
  }

  override property get Description(): String {
    return "Populates the ReceiverShare column of the LMMessageLloydsSCM_Ext entity."
  }
