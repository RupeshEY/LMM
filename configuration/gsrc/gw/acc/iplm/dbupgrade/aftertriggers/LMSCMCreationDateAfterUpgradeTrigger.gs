...
class LMSCMCreationDateAfterUpgradeTrigger extends AfterUpgradeVersionTrigger {
  ...
  override function execute() {
    ...
    gw.transaction.Transaction.runWithNewBundle(\bundle -> {
      scmMessagesList.each(\msg -> {
        ...
        msg = bundle.add(msg)
        msg = mapCreationDate(msg, parsedMessage)
      })
  ...
  private function mapCreationDate(msg: LMMessageLloydsSCM_Ext, parsedMessage: Jv_Ins_Reinsurance): LMMessageLloydsSCM_Ext {
    msg = SyndicateClaimMessageEntityMapper.mapCreationDate(msg, parsedMessage)
    return msg
  }
