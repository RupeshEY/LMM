...
class TransactionCompleteRule extends RespondRuleState<ECFMessageClaimNotifyRq_Ext> {
  ...
  private function shouldUpdateTransactionState(ecfMessage: ECFMessageClaimNotifyRq_Ext): boolean {
    return ecfMessage.TransactionStatus == ECFTransactionStatus_Ext.TC_40_COMPLETE
  }
