...
enhancement GWQueriesEnhancement: gw.api.database.Queries {
  ...
  static function findByIdOrPublicId<T>(type: Type<T>, id: long): T {
    return findByIdOrPublicId<T>(id as String)
  }

  @Deprecated("Please use Queries#findByPublicId() or Bundle#loadBean().")
  static function findByIdOrPublicId<T>(type: Type<T>, strLocalOrPublicId: String): T {
    return findByIdOrPublicId<T>(strLocalOrPublicId)
  }

  @Deprecated("Please use Queries#findByPublicId() or Bundle#loadBean().")
  static function findByIdOrPublicId<T>(id: long): T {
    return findByIdOrPublicId<T>(id as String)
  }

  @Deprecated("Please use Queries#findByPublicId() or Bundle#loadBean().")
  static function findByIdOrPublicId<T>(strLocalOrPublicId: String): T {
    var lId: long
    try {
  ...
  @Deprecated("Please use Queries#findByPublicId() or Bundle#loadBean().")
  static function findByIdOrPublicId<T extends Object>(type: Type<T>, key: gw.pl.persistence.core.Key): T {
