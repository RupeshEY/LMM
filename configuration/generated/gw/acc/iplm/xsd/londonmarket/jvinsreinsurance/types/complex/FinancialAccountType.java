...
public class FinancialAccountType extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public FinancialAccountType() {
    super( -1134619872, TYPE.get() );
  }

  private FinancialAccountType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1134619872, state );
  }

  protected FinancialAccountType( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected FinancialAccountType( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.types.complex.FinancialAccountType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.types.complex.FinancialAccountType get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.FinancialAccountItem> getFinancialAccountItem() {
    return (java.util.List<gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.FinancialAccountItem>) TYPE.get().getPropertyValue( this, "_FinancialAccountItem" );
  }
  ...
  public final void setFinancialAccountItem( java.util.List<gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.FinancialAccountItem> value ) {
    TYPE.get().setPropertyValue( this, "_FinancialAccountItem", value );
  }
  ...
  public final gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.anonymous.elements.FinancialAccountType_Extension getExtension() {
    return (gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.anonymous.elements.FinancialAccountType_Extension) TYPE.get().getPropertyValue( this, "_Extension" );
  }
