...
public class ClaimantType extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.types.complex.ClaimantType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.types.complex.ClaimantType get$TypeInstance() {
    return this;
  }
  ...
  public final gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.FullNameAndAddress getFullNameAndAddress_elem() {
    return (gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.FullNameAndAddress) TYPE.get().getPropertyValue( this, "_FullNameAndAddress_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.BirthDate getBirthDate_elem() {
    return (gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.BirthDate) TYPE.get().getPropertyValue( this, "_BirthDate_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.LastDateWorked getLastDateWorked_elem() {
    return (gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.LastDateWorked) TYPE.get().getPropertyValue( this, "_LastDateWorked_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.DateOfDisablement getDateOfDisablement_elem() {
    return (gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.DateOfDisablement) TYPE.get().getPropertyValue( this, "_DateOfDisablement_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.DateOfReturnToWork getDateOfReturnToWork_elem() {
    return (gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.DateOfReturnToWork) TYPE.get().getPropertyValue( this, "_DateOfReturnToWork_elem" );
  }
  ...
  public final java.util.List<gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.ConsequenceOfLoss> getConsequenceOfLoss_elem() {
    return (java.util.List<gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.ConsequenceOfLoss>) TYPE.get().getPropertyValue( this, "_ConsequenceOfLoss_elem" );
  }
  ...
  public final java.util.List<gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.ConsequenceOfLossOld> getConsequenceOfLossOld_elem() {
    return (java.util.List<gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.ConsequenceOfLossOld>) TYPE.get().getPropertyValue( this, "_ConsequenceOfLossOld_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.anonymous.elements.ClaimantType_Extension getExtension() {
    return (gw.acc.iplm.xsd.londonmarket.jvinsreinsurance.anonymous.elements.ClaimantType_Extension) TYPE.get().getPropertyValue( this, "_Extension" );
  }
