...
public class ClaimNotifyEventRqType_SupportingDocument extends gw.acc.iplm.xsd.acord_repository_v_1_3_0_rlc_slice.types.complex.SupportingDocument_Type {
  ...
  public ClaimNotifyEventRqType_SupportingDocument() {
    super( 1470583450, TYPE.get() );
  }

  private ClaimNotifyEventRqType_SupportingDocument( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1470583450, state );
  }

  protected ClaimNotifyEventRqType_SupportingDocument( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ClaimNotifyEventRqType_SupportingDocument( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.anonymous.types.complex.ClaimNotifyEventRqType_SupportingDocument> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.anonymous.types.complex.ClaimNotifyEventRqType_SupportingDocument get$TypeInstance() {
    return this;
  }
  ...
  public final gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.anonymous.elements.ClaimNotifyEventRqType_SupportingDocument_ReferredObjects getReferredObjects() {
    return (gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.anonymous.elements.ClaimNotifyEventRqType_SupportingDocument_ReferredObjects) TYPE.get().getPropertyValue( this, "_ReferredObjects" );
  }
