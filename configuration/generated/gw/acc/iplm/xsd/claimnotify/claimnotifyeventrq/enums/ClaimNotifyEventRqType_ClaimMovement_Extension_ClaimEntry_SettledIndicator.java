...
public enum ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_SettledIndicator implements gw.xml.IXmlSchemaEnumValue {
  Y( "Y" ),
  N( "N" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.util.SchemaAccess ).getSchemaIndex().getTypeData( "gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.enums.ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_SettledIndicator" );
    }
  };

  private final java.lang.String _stringValue;

  private ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_SettledIndicator( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.enums.ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_SettledIndicator forValue( java.lang.String value ) {
    return (gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.enums.ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_SettledIndicator) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.enums.ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_SettledIndicator forGosuValue( java.lang.String value ) {
    return (gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.enums.ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_SettledIndicator) TYPE.get().cg_forValue( value );
  }
