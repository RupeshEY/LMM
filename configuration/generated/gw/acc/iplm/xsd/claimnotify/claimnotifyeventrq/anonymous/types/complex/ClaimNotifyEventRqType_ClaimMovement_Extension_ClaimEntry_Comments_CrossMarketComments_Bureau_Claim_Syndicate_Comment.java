...
public class ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment() {
    super( -1279788283, TYPE.get() );
  }

  private ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1279788283, state );
  }

  protected ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.anonymous.types.complex.ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.claimnotify.claimnotifyeventrq.anonymous.types.complex.ClaimNotifyEventRqType_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment get$TypeInstance() {
    return this;
  }
