...
public class ClaimNotifyEventRs extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public ClaimNotifyEventRs() {
    super( 1297813735, TYPE.get() );
  }

  private ClaimNotifyEventRs( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1297813735, state );
  }

  protected ClaimNotifyEventRs( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ClaimNotifyEventRs( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.claimnotify.claimeventnotifyrs.anonymous.types.complex.ClaimNotifyEventRs> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.claimnotify.claimeventnotifyrs.anonymous.types.complex.ClaimNotifyEventRs get$TypeInstance() {
    return this;
  }
  ...
  public final gw.acc.iplm.xsd.claimnotify.claimeventnotifyrs.anonymous.elements.ClaimNotifyEventRs_ReferredMessage getReferredMessage() {
    return (gw.acc.iplm.xsd.claimnotify.claimeventnotifyrs.anonymous.elements.ClaimNotifyEventRs_ReferredMessage) TYPE.get().getPropertyValue( this, "_ReferredMessage" );
  }
  ...
  public final gw.acc.iplm.xsd.claimnotify.claimeventnotifyrs.anonymous.elements.ClaimNotifyEventRs_ErrorsandWarnings getErrorsandWarnings() {
    return (gw.acc.iplm.xsd.claimnotify.claimeventnotifyrs.anonymous.elements.ClaimNotifyEventRs_ErrorsandWarnings) TYPE.get().getPropertyValue( this, "_ErrorsandWarnings" );
  }
