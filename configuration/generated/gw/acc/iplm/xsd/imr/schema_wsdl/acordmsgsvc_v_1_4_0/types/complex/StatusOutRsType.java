...
public class StatusOutRsType extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://www.ACORD.org/Standards/AcordMsgSvc/1.4.0", "StatusOutRsType", "" );
  ...
  public StatusOutRsType() {
    super( 1163251799, TYPE.get() );
  }

  private StatusOutRsType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1163251799, state );
  }

  protected StatusOutRsType( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected StatusOutRsType( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.imr.schema_wsdl.acordmsgsvc_v_1_4_0.types.complex.StatusOutRsType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.imr.schema_wsdl.acordmsgsvc_v_1_4_0.types.complex.StatusOutRsType get$TypeInstance() {
    return this;
  }
