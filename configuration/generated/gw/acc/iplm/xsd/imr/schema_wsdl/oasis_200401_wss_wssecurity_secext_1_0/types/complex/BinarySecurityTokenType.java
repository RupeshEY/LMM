...
@gw.xml.annotation.SuperTypeData(gw.acc.iplm.xsd.imr.schema_wsdl.oasis_200401_wss_wssecurity_secext_1_0.types.complex.EncodedString.class)
public class BinarySecurityTokenType extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd", "BinarySecurityTokenType", "" );
  ...
  public BinarySecurityTokenType() {
    super( 385997827, TYPE.get() );
  }

  public BinarySecurityTokenType( java.lang.String value ) {
    this();
    setValue( value );
  }

  private BinarySecurityTokenType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 385997827, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.imr.schema_wsdl.oasis_200401_wss_wssecurity_secext_1_0.types.complex.BinarySecurityTokenType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.imr.schema_wsdl.oasis_200401_wss_wssecurity_secext_1_0.types.complex.BinarySecurityTokenType get$TypeInstance() {
    return this;
  }
