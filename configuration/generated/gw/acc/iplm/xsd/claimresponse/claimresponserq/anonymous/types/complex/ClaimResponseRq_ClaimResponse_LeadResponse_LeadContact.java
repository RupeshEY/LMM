...
public class ClaimResponseRq_ClaimResponse_LeadResponse_LeadContact extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public ClaimResponseRq_ClaimResponse_LeadResponse_LeadContact() {
    super( 1543771006, TYPE.get() );
  }

  private ClaimResponseRq_ClaimResponse_LeadResponse_LeadContact( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1543771006, state );
  }

  protected ClaimResponseRq_ClaimResponse_LeadResponse_LeadContact( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ClaimResponseRq_ClaimResponse_LeadResponse_LeadContact( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.types.complex.ClaimResponseRq_ClaimResponse_LeadResponse_LeadContact> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.types.complex.ClaimResponseRq_ClaimResponse_LeadResponse_LeadContact get$TypeInstance() {
    return this;
  }
