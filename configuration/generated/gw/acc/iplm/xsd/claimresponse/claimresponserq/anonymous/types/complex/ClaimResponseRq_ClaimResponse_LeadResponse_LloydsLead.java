...
public class ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead() {
    super( -1869391141, TYPE.get() );
  }

  private ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1869391141, state );
  }

  protected ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.types.complex.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.types.complex.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead get$TypeInstance() {
    return this;
  }
  ...
  public final gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_XcsToAgreeIndicator getXcsToAgreeIndicator_elem() {
    return (gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_XcsToAgreeIndicator) TYPE.get().getPropertyValue( this, "_XcsToAgreeIndicator_elem" );
  }
  ...
  public final java.lang.String getLloydsResponse() {
    return (java.lang.String) TYPE.get().getPropertyValue( this, "_LloydsResponse" );
  }


  public final void setLloydsResponse( java.lang.String value ) {
    TYPE.get().setPropertyValue( this, "_LloydsResponse", value );
  }
  ...
  public final gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_LloydsResponse getLloydsResponse_elem() {
    return (gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_LloydsResponse) TYPE.get().getPropertyValue( this, "_LloydsResponse_elem" );
  }
  ...
  public final void setLloydsResponse_elem( gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_LloydsResponse value ) {
    TYPE.get().setPropertyValue( this, "_LloydsResponse_elem", value );
  }
  ...
  public final java.util.List<gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_QueryReason> getQueryReason_elem() {
    return (java.util.List<gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_QueryReason>) TYPE.get().getPropertyValue( this, "_QueryReason_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_OutstandingAmountQualifier getOutstandingAmountQualifier_elem() {
    return (gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_OutstandingAmountQualifier) TYPE.get().getPropertyValue( this, "_OutstandingAmountQualifier_elem" );
  }
  ...
  public final java.util.List<gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_PrivateComments> getPrivateComments() {
    return (java.util.List<gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_PrivateComments>) TYPE.get().getPropertyValue( this, "_PrivateComments" );
  }
  ...
  public final java.util.List<gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_PublicComments> getPublicComments() {
    return (java.util.List<gw.acc.iplm.xsd.claimresponse.claimresponserq.anonymous.elements.ClaimResponseRq_ClaimResponse_LeadResponse_LloydsLead_PublicComments>) TYPE.get().getPropertyValue( this, "_PublicComments" );
  }
