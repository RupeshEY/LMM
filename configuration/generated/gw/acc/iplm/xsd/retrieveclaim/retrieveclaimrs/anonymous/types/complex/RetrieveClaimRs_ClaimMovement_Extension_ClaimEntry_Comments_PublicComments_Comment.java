...
public class RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PublicComments_Comment extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PublicComments_Comment() {
    super( 1924167552, TYPE.get() );
  }

  private RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PublicComments_Comment( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1924167552, state );
  }

  protected RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PublicComments_Comment( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PublicComments_Comment( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PublicComments_Comment> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PublicComments_Comment get$TypeInstance() {
    return this;
  }
