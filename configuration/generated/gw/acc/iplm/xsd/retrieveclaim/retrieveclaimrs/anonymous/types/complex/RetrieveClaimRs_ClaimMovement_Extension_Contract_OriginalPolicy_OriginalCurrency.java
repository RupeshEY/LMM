...
public class RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency() {
    super( 495088754, TYPE.get() );
  }

  private RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 495088754, state );
  }

  protected RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency get$TypeInstance() {
    return this;
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency_Ccy getCcy_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency_Ccy) TYPE.get().getPropertyValue( this, "_Ccy_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency_OriginalSumInsuredAmount getOriginalSumInsuredAmount_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency_OriginalSumInsuredAmount) TYPE.get().getPropertyValue( this, "_OriginalSumInsuredAmount_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency_OriginalExcessAmount getOriginalExcessAmount_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Contract_OriginalPolicy_OriginalCurrency_OriginalExcessAmount) TYPE.get().getPropertyValue( this, "_OriginalExcessAmount_elem" );
  }
