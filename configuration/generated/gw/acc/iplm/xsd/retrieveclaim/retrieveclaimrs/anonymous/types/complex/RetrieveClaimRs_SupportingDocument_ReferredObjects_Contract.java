...
public class RetrieveClaimRs_SupportingDocument_ReferredObjects_Contract extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public RetrieveClaimRs_SupportingDocument_ReferredObjects_Contract() {
    super( -1001062638, TYPE.get() );
  }

  private RetrieveClaimRs_SupportingDocument_ReferredObjects_Contract( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1001062638, state );
  }

  protected RetrieveClaimRs_SupportingDocument_ReferredObjects_Contract( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected RetrieveClaimRs_SupportingDocument_ReferredObjects_Contract( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_SupportingDocument_ReferredObjects_Contract> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_SupportingDocument_ReferredObjects_Contract get$TypeInstance() {
    return this;
  }
