...
public class RetrieveClaimRs_SupportingDocument_ReferredObjects_Claim extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public RetrieveClaimRs_SupportingDocument_ReferredObjects_Claim() {
    super( 255621692, TYPE.get() );
  }

  private RetrieveClaimRs_SupportingDocument_ReferredObjects_Claim( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 255621692, state );
  }

  protected RetrieveClaimRs_SupportingDocument_ReferredObjects_Claim( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected RetrieveClaimRs_SupportingDocument_ReferredObjects_Claim( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_SupportingDocument_ReferredObjects_Claim> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_SupportingDocument_ReferredObjects_Claim get$TypeInstance() {
    return this;
  }
