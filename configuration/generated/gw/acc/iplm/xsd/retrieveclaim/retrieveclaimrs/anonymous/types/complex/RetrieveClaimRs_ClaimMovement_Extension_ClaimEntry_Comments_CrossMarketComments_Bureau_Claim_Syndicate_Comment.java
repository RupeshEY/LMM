...
public class RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment() {
    super( 1365272038, TYPE.get() );
  }

  private RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1365272038, state );
  }

  protected RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_CrossMarketComments_Bureau_Claim_Syndicate_Comment get$TypeInstance() {
    return this;
  }
