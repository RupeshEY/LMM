...
public class RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PrivateComments_Comment extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PrivateComments_Comment() {
    super( 2105196276, TYPE.get() );
  }

  private RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PrivateComments_Comment( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 2105196276, state );
  }

  protected RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PrivateComments_Comment( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PrivateComments_Comment( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PrivateComments_Comment> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments_PrivateComments_Comment get$TypeInstance() {
    return this;
  }
