...
public final class RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators extends gw.xml.XmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://www.xchanging.com/retrieveClaim/rs/1", "Indicators", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.util.SchemaAccess ).getSchemaIndex().getTypeData( "gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators" );
    }
  };
  ...
  public RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators() {
    super( -1684355884, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators() );
  }

  public RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators( gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators typeInstance ) {
    super( -1684355884, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators( gw.internal.xml.XmlElementState state ) {
    super( -1684355884, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators get$TypeInstance() {
    return super.get$TypeInstance().cast( gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators.class );
  }

  public final void set$TypeInstance( gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators typeInstance ) {
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_ConflictOfInterestIndicator getConflictOfInterestIndicator_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_ConflictOfInterestIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_ConflictOfInterestIndicator_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_ChaseUpIndicator getChaseUpIndicator() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_ChaseUpIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_ChaseUpIndicator" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_CedantInLiquidationIndicator getCedantInLiquidationIndicator_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_CedantInLiquidationIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_CedantInLiquidationIndicator_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_SimultaneousReinstatementRequired getSimultaneousReinstatementRequired_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_SimultaneousReinstatementRequired) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_SimultaneousReinstatementRequired_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_SimultaneousReinstatementProcessed getSimultaneousReinstatementProcessed_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_SimultaneousReinstatementProcessed) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_SimultaneousReinstatementProcessed_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_WarIndicator getWarIndicator_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_WarIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_WarIndicator_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_NotifySalvageAssociationIndicator getNotifySalvageAssociationIndicator_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_NotifySalvageAssociationIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_NotifySalvageAssociationIndicator_elem" );
  }
  ...
  public final java.util.List<gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_SoftWarnings> getSoftWarnings() {
    return (java.util.List<gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_SoftWarnings>) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_SoftWarnings" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_XcsToAgreeIndicator getXcsToAgreeIndicator_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_XcsToAgreeIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_XcsToAgreeIndicator_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_CollectionUnlikelyIndicator getCollectionUnlikelyIndicator_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_CollectionUnlikelyIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_CollectionUnlikelyIndicator_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_ContractualConditionsMayApplyIndicator getContractualConditionsMayApplyIndicator_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_ContractualConditionsMayApplyIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_ContractualConditionsMayApplyIndicator_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_ImmediatePartCollectionIndicator getImmediatePartCollectionIndicator_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_ImmediatePartCollectionIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_ImmediatePartCollectionIndicator_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_NoFurtherResponseIndicator getNoFurtherResponseIndicator_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_NoFurtherResponseIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_NoFurtherResponseIndicator_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_MultipleResponseIndicator getMultipleResponseIndicator_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_Claim_Indicators_MultipleResponseIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_MultipleResponseIndicator_elem" );
  }
