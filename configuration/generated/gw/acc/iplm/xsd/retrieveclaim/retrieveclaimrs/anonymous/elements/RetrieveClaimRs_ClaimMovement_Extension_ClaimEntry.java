...
public final class RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry extends gw.xml.XmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://www.xchanging.com/retrieveClaim/rs/1", "ClaimEntry", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.util.SchemaAccess ).getSchemaIndex().getTypeData( "gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry" );
    }
  };
  ...
  public RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry() {
    super( -922331165, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry() );
  }

  public RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry( gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry typeInstance ) {
    super( -922331165, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry( gw.internal.xml.XmlElementState state ) {
    super( -922331165, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry get$TypeInstance() {
    return super.get$TypeInstance().cast( gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry.class );
  }

  public final void set$TypeInstance( gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry typeInstance ) {
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_TransactionSequence getTransactionSequence_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_TransactionSequence) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_TransactionSequence_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_AmendmentDetails getAmendmentDetails_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_AmendmentDetails) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_AmendmentDetails_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_LloydsStatus getLloydsStatus_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_LloydsStatus) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_LloydsStatus_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_LirmaStatus getLirmaStatus_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_LirmaStatus) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_LirmaStatus_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_IluStatus getIluStatus_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_IluStatus) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_IluStatus_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_SubClassification getSubClassification_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_SubClassification) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_SubClassification_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_BrokerAdvisedDate getBrokerAdvisedDate_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_BrokerAdvisedDate) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_BrokerAdvisedDate_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_AddedCirculatedOrAuthorisedDate getAddedCirculatedOrAuthorisedDate_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_AddedCirculatedOrAuthorisedDate) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_AddedCirculatedOrAuthorisedDate_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_TransactionSubCode getTransactionSubCode_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_TransactionSubCode) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_TransactionSubCode_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.enums.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_SettledIndicator getSettledIndicator() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.enums.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_SettledIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_SettledIndicator" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_SettledIndicator getSettledIndicator_elem() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_SettledIndicator) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_SettledIndicator_elem" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_LinkedClaims getLinkedClaims() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_LinkedClaims) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_LinkedClaims" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments getComments() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_Comments) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_Comments" );
  }
  ...
  public final java.util.List<gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_ClaimEntryFinancialAmounts> getClaimEntryFinancialAmounts() {
    return (java.util.List<gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_ClaimEntryFinancialAmounts>) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_ClaimEntryFinancialAmounts" );
  }
  ...
  public final java.util.List<gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_AggregateDetails> getAggregateDetails() {
    return (java.util.List<gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_AggregateDetails>) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_AggregateDetails" );
  }
  ...
  public final gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_BulkClaimInformation getBulkClaimInformation() {
    return (gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.elements.RetrieveClaimRs_ClaimMovement_Extension_ClaimEntry_BulkClaimInformation) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_BulkClaimInformation" );
  }
