...
public class RetrieveClaimRs_SupportingDocument_ReferredObjects_ClaimEntry extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public RetrieveClaimRs_SupportingDocument_ReferredObjects_ClaimEntry() {
    super( -1344101482, TYPE.get() );
  }

  private RetrieveClaimRs_SupportingDocument_ReferredObjects_ClaimEntry( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1344101482, state );
  }

  protected RetrieveClaimRs_SupportingDocument_ReferredObjects_ClaimEntry( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected RetrieveClaimRs_SupportingDocument_ReferredObjects_ClaimEntry( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_SupportingDocument_ReferredObjects_ClaimEntry> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public gw.acc.iplm.xsd.retrieveclaim.retrieveclaimrs.anonymous.types.complex.RetrieveClaimRs_SupportingDocument_ReferredObjects_ClaimEntry get$TypeInstance() {
    return this;
  }
