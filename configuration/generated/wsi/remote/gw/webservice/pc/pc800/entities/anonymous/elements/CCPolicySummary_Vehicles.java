...
public final class CCPolicySummary_Vehicles extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.remote.gw.webservice.pc.pc800.entities.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCPolicySummary_Vehicles" );
    }
  };
  ...
  public CCPolicySummary_Vehicles() {
    super( 302040041, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCPolicySummaryVehicle() );
  }

  public CCPolicySummary_Vehicles( wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCPolicySummaryVehicle typeInstance ) {
    super( 302040041, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CCPolicySummary_Vehicles( gw.internal.xml.XmlElementState state ) {
    super( 302040041, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCPolicySummary_Vehicles> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCPolicySummaryVehicle get$TypeInstance() {
    return super.get$TypeInstance().cast( wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCPolicySummaryVehicle.class );
  }

  public final void set$TypeInstance( wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCPolicySummaryVehicle typeInstance ) {
