...
@gw.xml.annotation.SuperTypeData(wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCContact.class)
public class CCCompany extends wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCContact {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/pc/ccintegration", "CCCompany", "tns" );
  public static final gw.xml.XmlNamespace $NAMESPACE = new gw.xml.XmlNamespace( "http://guidewire.com/pc/ccintegration", "tns" );
  public static final javax.xml.namespace.QName $ELEMENT_QNAME_Case = new javax.xml.namespace.QName( "http://guidewire.com/pc/ccintegration", "Case", "tns" );
  public static final javax.xml.namespace.QName $ELEMENT_QNAME_Employees = new javax.xml.namespace.QName( "http://guidewire.com/pc/ccintegration", "Employees", "tns" );
  public static final javax.xml.namespace.QName $ELEMENT_QNAME_Thirdpartyinsured = new javax.xml.namespace.QName( "http://guidewire.com/pc/ccintegration", "Thirdpartyinsured", "tns" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.remote.gw.webservice.pc.pc800.entities.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCCompany" );
    }
  };

  public CCCompany() {
    super( -533129365, TYPE.get() );
  }

  private CCCompany( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -533129365, state );
  }

  protected CCCompany( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CCCompany( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCCompany> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCCompany get$TypeInstance() {
    return this;
  }
  ...
  @gw.lang.Autocreate
  @gw.lang.Autoinsert
  public final java.util.List<gw.xml.XmlElement> getCase() {
    return (java.util.List<gw.xml.XmlElement>) TYPE.get().getPropertyValue( this, "_Case" );
  }


  public final void setCase( java.util.List<gw.xml.XmlElement> value ) {
    TYPE.get().setPropertyValue( this, "_Case", value );
  }
  ...
  @gw.lang.Autocreate
  @gw.lang.Autoinsert
  public final java.util.List<wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCCompany_Case> getCase_elem() {
    return (java.util.List<wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCCompany_Case>) TYPE.get().getPropertyValue( this, "_Case_elem" );
  }


  public final void setCase_elem( java.util.List<wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCCompany_Case> value ) {
    TYPE.get().setPropertyValue( this, "_Case_elem", value );
  }
  ...
  @gw.lang.Autocreate
  @gw.lang.Autoinsert
  public final java.util.List<gw.xml.XmlElement> getEmployees() {
    return (java.util.List<gw.xml.XmlElement>) TYPE.get().getPropertyValue( this, "_Employees" );
  }


  public final void setEmployees( java.util.List<gw.xml.XmlElement> value ) {
    TYPE.get().setPropertyValue( this, "_Employees", value );
  }
  ...
  @gw.lang.Autocreate
  @gw.lang.Autoinsert
  public final java.util.List<wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCCompany_Employees> getEmployees_elem() {
    return (java.util.List<wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCCompany_Employees>) TYPE.get().getPropertyValue( this, "_Employees_elem" );
  }


  public final void setEmployees_elem( java.util.List<wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCCompany_Employees> value ) {
    TYPE.get().setPropertyValue( this, "_Employees_elem", value );
  }
  ...
  @gw.lang.Autocreate
  @gw.lang.Autoinsert
  public final java.util.List<gw.xml.XmlElement> getThirdpartyinsured() {
    return (java.util.List<gw.xml.XmlElement>) TYPE.get().getPropertyValue( this, "_Thirdpartyinsured" );
  }


  public final void setThirdpartyinsured( java.util.List<gw.xml.XmlElement> value ) {
    TYPE.get().setPropertyValue( this, "_Thirdpartyinsured", value );
  }
  ...
  @gw.lang.Autocreate
  @gw.lang.Autoinsert
  public final java.util.List<wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCCompany_Thirdpartyinsured> getThirdpartyinsured_elem() {
    return (java.util.List<wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCCompany_Thirdpartyinsured>) TYPE.get().getPropertyValue( this, "_Thirdpartyinsured_elem" );
  }


  public final void setThirdpartyinsured_elem( java.util.List<wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCCompany_Thirdpartyinsured> value ) {
    TYPE.get().setPropertyValue( this, "_Thirdpartyinsured_elem", value );
  }
