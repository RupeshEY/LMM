...
public final class CCPolicy_RiskUnits extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.remote.gw.webservice.pc.pc800.entities.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCPolicy_RiskUnits" );
    }
  };
  ...
  public CCPolicy_RiskUnits() {
    super( -1032502422, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCRiskUnit() );
  }

  public CCPolicy_RiskUnits( wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCRiskUnit typeInstance ) {
    super( -1032502422, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CCPolicy_RiskUnits( gw.internal.xml.XmlElementState state ) {
    super( -1032502422, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCPolicy_RiskUnits> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCRiskUnit get$TypeInstance() {
    return super.get$TypeInstance().cast( wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCRiskUnit.class );
  }

  public final void set$TypeInstance( wsi.remote.gw.webservice.pc.pc800.entities.types.complex.CCRiskUnit typeInstance ) {
  ...
  public final wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCRiskUnit_ClassCode getClassCode_elem() {
    return (wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCRiskUnit_ClassCode) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_ClassCode_elem" );
  }
  ...
  public final java.util.List<wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCRiskUnit_Coverages> getCoverages() {
    return (java.util.List<wsi.remote.gw.webservice.pc.pc800.entities.anonymous.elements.CCRiskUnit_Coverages>) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_Coverages" );
  }
