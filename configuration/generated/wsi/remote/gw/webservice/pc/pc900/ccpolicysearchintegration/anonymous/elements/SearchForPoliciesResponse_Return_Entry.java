...
public final class SearchForPoliciesResponse_Return_Entry extends gw.xml.XmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/pc/ws/gw/webservice/pc/pc900/ccintegration/CCPolicySearchIntegration", "Entry", "tns" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.remote.gw.webservice.pc.pc900.ccpolicysearchintegration.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.remote.gw.webservice.pc.pc900.ccpolicysearchintegration.anonymous.elements.SearchForPoliciesResponse_Return_Entry" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.remote.gw.webservice.pc.pc900.ccpolicysearchintegration.util.SchemaAccess ).getSchemaIndex().findTypeData( "wsi.remote.gw.webservice.pc.pc900.entities.types.complex.CCPolicySummary", "wsi.remote.gw.webservice.pc.pc900.entities" );
    }
  };

  public SearchForPoliciesResponse_Return_Entry() {
    super( -1960626107, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.remote.gw.webservice.pc.pc900.entities.types.complex.CCPolicySummary() );
  }

  public SearchForPoliciesResponse_Return_Entry( wsi.remote.gw.webservice.pc.pc900.entities.types.complex.CCPolicySummary typeInstance ) {
    super( -1960626107, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private SearchForPoliciesResponse_Return_Entry( gw.internal.xml.XmlElementState state ) {
    super( -1960626107, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.remote.gw.webservice.pc.pc900.ccpolicysearchintegration.anonymous.elements.SearchForPoliciesResponse_Return_Entry> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final wsi.remote.gw.webservice.pc.pc900.entities.types.complex.CCPolicySummary get$TypeInstance() {
    return super.get$TypeInstance().cast( wsi.remote.gw.webservice.pc.pc900.entities.types.complex.CCPolicySummary.class );
  }

  public final void set$TypeInstance( wsi.remote.gw.webservice.pc.pc900.entities.types.complex.CCPolicySummary typeInstance ) {
  ...
  public final java.util.List<wsi.remote.gw.webservice.pc.pc900.entities.anonymous.elements.CCPolicySummary_Properties> getProperties() {
    return (java.util.List<wsi.remote.gw.webservice.pc.pc900.entities.anonymous.elements.CCPolicySummary_Properties>) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_Properties" );
  }
  ...
  public final java.util.List<wsi.remote.gw.webservice.pc.pc900.entities.anonymous.elements.CCPolicySummary_Vehicles> getVehicles() {
    return (java.util.List<wsi.remote.gw.webservice.pc.pc900.entities.anonymous.elements.CCPolicySummary_Vehicles>) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_Vehicles" );
  }
