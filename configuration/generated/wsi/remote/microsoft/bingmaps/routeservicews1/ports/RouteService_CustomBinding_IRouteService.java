...
public final class RouteService_CustomBinding_IRouteService extends gw.internal.xml.ws.WsdlPortImpl {

  public static final javax.xml.namespace.QName PORT_QNAME = new javax.xml.namespace.QName( "http://dev.virtualearth.net/webservices/v1/route", "CustomBinding_IRouteService", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.ws.WsdlPortTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.ws.WsdlPortTypeDataImpl>() {
    ...
    public gw.internal.xml.ws.WsdlPortTypeDataImpl init() {
      return (gw.internal.xml.ws.WsdlPortTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.remote.microsoft.bingmaps.routeservicews1.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.remote.microsoft.bingmaps.routeservicews1.ports.RouteService_CustomBinding_IRouteService" );
    }
  };
  ...
  static {
    try {
      ADDRESS = new java.net.URI( "http://dev.virtualearth.net/webservices/v1/routeservice/routeservice.svc/binaryHttp" );
    }
  ...
  public RouteService_CustomBinding_IRouteService() {
    super( TYPE.get(), new gw.xml.ws.WsdlConfig() );
  }

  public RouteService_CustomBinding_IRouteService( gw.xml.ws.WsdlConfig config ) {
  ...
  public final gw.xml.ws.AsyncResponse<wsi.remote.microsoft.bingmaps.routeservice2.CalculateRouteResponse,gw.xsd.w3c.soap12_envelope.Envelope> async_CalculateRoute( wsi.remote.microsoft.bingmaps.routeservice2.CalculateRoute CalculateRoute ) {
    return (gw.xml.ws.AsyncResponse<wsi.remote.microsoft.bingmaps.routeservice2.CalculateRouteResponse,gw.xsd.w3c.soap12_envelope.Envelope>) invokeAsync( "CalculateRoute", new java.lang.Object[] { CalculateRoute } );
  }
  ...
  public final gw.xml.ws.AsyncResponse<wsi.remote.microsoft.bingmaps.routeservice2.CalculateRoutesFromMajorRoadsResponse,gw.xsd.w3c.soap12_envelope.Envelope> async_CalculateRoutesFromMajorRoads( wsi.remote.microsoft.bingmaps.routeservice2.CalculateRoutesFromMajorRoads CalculateRoutesFromMajorRoads ) {
    return (gw.xml.ws.AsyncResponse<wsi.remote.microsoft.bingmaps.routeservice2.CalculateRoutesFromMajorRoadsResponse,gw.xsd.w3c.soap12_envelope.Envelope>) invokeAsync( "CalculateRoutesFromMajorRoads", new java.lang.Object[] { CalculateRoutesFromMajorRoads } );
  }
