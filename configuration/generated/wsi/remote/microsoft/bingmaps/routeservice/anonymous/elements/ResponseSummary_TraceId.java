...
public final class ResponseSummary_TraceId extends gw.internal.xml.simplevalues.StringXmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.remote.microsoft.bingmaps.routeservice.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.remote.microsoft.bingmaps.routeservice.anonymous.elements.ResponseSummary_TraceId" );
    }
  };

  public ResponseSummary_TraceId() {
    super( 1051378210, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.String() );
  }

  public ResponseSummary_TraceId( gw.xsd.w3c.xmlschema.types.simple.String typeInstance ) {
    super( 1051378210, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ResponseSummary_TraceId( gw.internal.xml.XmlElementState state ) {
    super( 1051378210, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.remote.microsoft.bingmaps.routeservice.anonymous.elements.ResponseSummary_TraceId> get$Class() {
    return getClass();
  }
}
