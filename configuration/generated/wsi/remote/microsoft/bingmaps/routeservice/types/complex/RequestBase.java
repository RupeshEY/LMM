...
public class RequestBase extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.remote.microsoft.bingmaps.routeservice.types.complex.RequestBase> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.remote.microsoft.bingmaps.routeservice.types.complex.RequestBase get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.remote.microsoft.bingmaps.routeservice.Credentials getCredentials() {
    return (wsi.remote.microsoft.bingmaps.routeservice.Credentials) TYPE.get().getPropertyValue( this, "_Credentials" );
  }
  ...
  public final wsi.remote.microsoft.bingmaps.routeservice.anonymous.elements.RequestBase_Culture getCulture_elem() {
    return (wsi.remote.microsoft.bingmaps.routeservice.anonymous.elements.RequestBase_Culture) TYPE.get().getPropertyValue( this, "_Culture_elem" );
  }
  ...
  public final wsi.remote.microsoft.bingmaps.routeservice.ExecutionOptions getExecutionOptions() {
    return (wsi.remote.microsoft.bingmaps.routeservice.ExecutionOptions) TYPE.get().getPropertyValue( this, "_ExecutionOptions" );
  }
  ...
  public final wsi.remote.microsoft.bingmaps.routeservice.UserProfile getUserProfile() {
    return (wsi.remote.microsoft.bingmaps.routeservice.UserProfile) TYPE.get().getPropertyValue( this, "_UserProfile" );
  }
