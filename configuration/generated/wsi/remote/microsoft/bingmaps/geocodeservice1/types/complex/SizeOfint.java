...
public class SizeOfint extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.remote.microsoft.bingmaps.geocodeservice1.types.complex.SizeOfint> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.remote.microsoft.bingmaps.geocodeservice1.types.complex.SizeOfint get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.remote.microsoft.bingmaps.geocodeservice1.anonymous.elements.SizeOfint_Height getHeight_elem() {
    return (wsi.remote.microsoft.bingmaps.geocodeservice1.anonymous.elements.SizeOfint_Height) TYPE.get().getPropertyValue( this, "_Height_elem" );
  }
  ...
  public final wsi.remote.microsoft.bingmaps.geocodeservice1.anonymous.elements.SizeOfint_Width getWidth_elem() {
    return (wsi.remote.microsoft.bingmaps.geocodeservice1.anonymous.elements.SizeOfint_Width) TYPE.get().getPropertyValue( this, "_Width_elem" );
  }
