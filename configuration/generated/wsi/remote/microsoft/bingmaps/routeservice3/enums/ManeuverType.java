...
public enum ManeuverType implements gw.xml.IXmlSchemaEnumValue {
  None( "None" ),
  Unknown( "Unknown" ),
  ...
  ArriveIntermediateStop( "ArriveIntermediateStop" ),
  TurnLeft( "TurnLeft" ),
  TurnRight( "TurnRight" ),
  TurnBack( "TurnBack" ),
  UTurn( "UTurn" ),
  ...
  RampToHighwayStraight( "RampToHighwayStraight" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.remote.microsoft.bingmaps.routeservice3.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.remote.microsoft.bingmaps.routeservice3.enums.ManeuverType" );
    }
  };

  private final java.lang.String _stringValue;

  private ManeuverType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final wsi.remote.microsoft.bingmaps.routeservice3.enums.ManeuverType forValue( java.lang.String value ) {
    return (wsi.remote.microsoft.bingmaps.routeservice3.enums.ManeuverType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final wsi.remote.microsoft.bingmaps.routeservice3.enums.ManeuverType forGosuValue( java.lang.String value ) {
    return (wsi.remote.microsoft.bingmaps.routeservice3.enums.ManeuverType) TYPE.get().cg_forValue( value );
  }
