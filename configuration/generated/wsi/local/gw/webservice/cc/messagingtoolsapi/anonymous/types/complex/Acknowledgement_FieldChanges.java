...
public class Acknowledgement_FieldChanges extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public Acknowledgement_FieldChanges() {
    super( 559708040, TYPE.get() );
  }

  private Acknowledgement_FieldChanges( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 559708040, state );
  }

  protected Acknowledgement_FieldChanges( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected Acknowledgement_FieldChanges( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.messagingtoolsapi.anonymous.types.complex.Acknowledgement_FieldChanges> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.messagingtoolsapi.anonymous.types.complex.Acknowledgement_FieldChanges get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<wsi.local.gw.webservice.cc.messagingtoolsapi.anonymous.elements.Acknowledgement_FieldChanges_Entry> getEntry() {
    return (java.util.List<wsi.local.gw.webservice.cc.messagingtoolsapi.anonymous.elements.Acknowledgement_FieldChanges_Entry>) TYPE.get().getPropertyValue( this, "_Entry" );
  }
