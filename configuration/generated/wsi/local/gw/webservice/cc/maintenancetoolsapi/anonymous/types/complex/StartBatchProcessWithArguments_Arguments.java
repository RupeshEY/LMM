...
public class StartBatchProcessWithArguments_Arguments extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public StartBatchProcessWithArguments_Arguments() {
    super( -1401667205, TYPE.get() );
  }

  private StartBatchProcessWithArguments_Arguments( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1401667205, state );
  }

  protected StartBatchProcessWithArguments_Arguments( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected StartBatchProcessWithArguments_Arguments( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.maintenancetoolsapi.anonymous.types.complex.StartBatchProcessWithArguments_Arguments> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.maintenancetoolsapi.anonymous.types.complex.StartBatchProcessWithArguments_Arguments get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<wsi.local.gw.webservice.cc.maintenancetoolsapi.anonymous.elements.StartBatchProcessWithArguments_Arguments_Entry> getEntry_elem() {
    return (java.util.List<wsi.local.gw.webservice.cc.maintenancetoolsapi.anonymous.elements.StartBatchProcessWithArguments_Arguments_Entry>) TYPE.get().getPropertyValue( this, "_Entry_elem" );
  }
