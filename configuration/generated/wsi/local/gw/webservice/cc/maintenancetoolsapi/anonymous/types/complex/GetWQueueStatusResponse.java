...
public class GetWQueueStatusResponse extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public GetWQueueStatusResponse() {
    super( 496318712, TYPE.get() );
  }

  private GetWQueueStatusResponse( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 496318712, state );
  }

  protected GetWQueueStatusResponse( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected GetWQueueStatusResponse( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.maintenancetoolsapi.anonymous.types.complex.GetWQueueStatusResponse> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.maintenancetoolsapi.anonymous.types.complex.GetWQueueStatusResponse get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.maintenancetoolsapi.anonymous.elements.GetWQueueStatusResponse_Return getReturn() {
    return (wsi.local.gw.webservice.cc.maintenancetoolsapi.anonymous.elements.GetWQueueStatusResponse_Return) TYPE.get().getPropertyValue( this, "_Return" );
  }
