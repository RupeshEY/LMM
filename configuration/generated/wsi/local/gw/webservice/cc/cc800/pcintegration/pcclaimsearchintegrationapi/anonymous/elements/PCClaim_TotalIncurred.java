...
public final class PCClaim_TotalIncurred extends gw.internal.xml.simplevalues.DecimalXmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc800/pcintegration/pcentities/PCClaim", "TotalIncurred", "pogo2" );
  ...
  public PCClaim_TotalIncurred() {
    super( 114808099, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.Decimal() );
  }

  public PCClaim_TotalIncurred( gw.xsd.w3c.xmlschema.types.simple.Decimal typeInstance ) {
    super( 114808099, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCClaim_TotalIncurred( gw.internal.xml.XmlElementState state ) {
    super( 114808099, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc800.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaim_TotalIncurred> get$Class() {
    return getClass();
  }
}
