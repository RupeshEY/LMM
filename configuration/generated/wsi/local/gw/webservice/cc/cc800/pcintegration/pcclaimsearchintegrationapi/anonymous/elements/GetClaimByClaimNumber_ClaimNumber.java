...
public final class GetClaimByClaimNumber_ClaimNumber extends gw.internal.xml.simplevalues.StringXmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc800/pcintegration/PCClaimSearchIntegrationAPI", "claimNumber", "tns" );
  ...
  public GetClaimByClaimNumber_ClaimNumber() {
    super( 2135274733, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.String() );
  }

  public GetClaimByClaimNumber_ClaimNumber( gw.xsd.w3c.xmlschema.types.simple.String typeInstance ) {
    super( 2135274733, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private GetClaimByClaimNumber_ClaimNumber( gw.internal.xml.XmlElementState state ) {
    super( 2135274733, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc800.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.GetClaimByClaimNumber_ClaimNumber> get$Class() {
    return getClass();
  }
}
