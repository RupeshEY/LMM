...
public final class PCClaim_PolicyTypeName extends gw.internal.xml.simplevalues.StringXmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc800/pcintegration/pcentities/PCClaim", "PolicyTypeName", "pogo2" );
  ...
  public PCClaim_PolicyTypeName() {
    super( -501310642, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.String() );
  }

  public PCClaim_PolicyTypeName( gw.xsd.w3c.xmlschema.types.simple.String typeInstance ) {
    super( -501310642, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCClaim_PolicyTypeName( gw.internal.xml.XmlElementState state ) {
    super( -501310642, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc800.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaim_PolicyTypeName> get$Class() {
    return getClass();
  }
}
