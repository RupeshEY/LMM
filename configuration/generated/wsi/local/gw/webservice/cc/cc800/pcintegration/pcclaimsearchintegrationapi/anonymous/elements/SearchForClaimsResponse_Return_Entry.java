...
public final class SearchForClaimsResponse_Return_Entry extends gw.xml.XmlElement {
  ...
  public SearchForClaimsResponse_Return_Entry() {
    super( -51871222, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc800.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaim() );
  }

  public SearchForClaimsResponse_Return_Entry( wsi.local.gw.webservice.cc.cc800.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaim typeInstance ) {
    super( -51871222, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private SearchForClaimsResponse_Return_Entry( gw.internal.xml.XmlElementState state ) {
    super( -51871222, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc800.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.SearchForClaimsResponse_Return_Entry> get$Class() {
    return getClass();
  }
