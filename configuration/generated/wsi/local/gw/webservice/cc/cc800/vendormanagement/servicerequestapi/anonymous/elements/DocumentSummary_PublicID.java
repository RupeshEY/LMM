...
public final class DocumentSummary_PublicID extends gw.internal.xml.simplevalues.StringXmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc800/vendormanagement/DocumentSummary", "PublicID", "pogo10" );
  ...
  public DocumentSummary_PublicID() {
    super( 364219470, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.String() );
  }

  public DocumentSummary_PublicID( gw.xsd.w3c.xmlschema.types.simple.String typeInstance ) {
    super( 364219470, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private DocumentSummary_PublicID( gw.internal.xml.XmlElementState state ) {
    super( 364219470, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.DocumentSummary_PublicID> get$Class() {
    return getClass();
  }
}
