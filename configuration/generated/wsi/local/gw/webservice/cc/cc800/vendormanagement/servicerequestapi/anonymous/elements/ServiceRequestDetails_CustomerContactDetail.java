...
public final class ServiceRequestDetails_CustomerContactDetail extends gw.xml.XmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc800/vendormanagement/ServiceRequestDetails", "CustomerContactDetail", "pogo8" );
  ...
  public ServiceRequestDetails_CustomerContactDetail() {
    super( -1041655802, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.types.complex.ContactDetail() );
  }

  public ServiceRequestDetails_CustomerContactDetail( wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.types.complex.ContactDetail typeInstance ) {
    super( -1041655802, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ServiceRequestDetails_CustomerContactDetail( gw.internal.xml.XmlElementState state ) {
    super( -1041655802, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.ServiceRequestDetails_CustomerContactDetail> get$Class() {
    return getClass();
  }
