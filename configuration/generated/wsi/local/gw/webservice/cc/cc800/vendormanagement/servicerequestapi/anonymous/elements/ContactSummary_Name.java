...
public final class ContactSummary_Name extends gw.internal.xml.simplevalues.StringXmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc800/vendormanagement/ContactSummary", "Name", "pogo4" );
  ...
  public ContactSummary_Name() {
    super( -1952917778, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.String() );
  }

  public ContactSummary_Name( gw.xsd.w3c.xmlschema.types.simple.String typeInstance ) {
    super( -1952917778, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ContactSummary_Name( gw.internal.xml.XmlElementState state ) {
    super( -1952917778, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.ContactSummary_Name> get$Class() {
    return getClass();
  }
}
