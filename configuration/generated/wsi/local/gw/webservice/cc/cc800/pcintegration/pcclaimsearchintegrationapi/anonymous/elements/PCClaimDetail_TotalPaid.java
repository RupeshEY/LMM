...
public final class PCClaimDetail_TotalPaid extends gw.internal.xml.simplevalues.DecimalXmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc800/pcintegration/pcentities/PCClaimDetail", "TotalPaid", "pogo4" );
  ...
  public PCClaimDetail_TotalPaid() {
    super( 1278425066, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.Decimal() );
  }

  public PCClaimDetail_TotalPaid( gw.xsd.w3c.xmlschema.types.simple.Decimal typeInstance ) {
    super( 1278425066, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCClaimDetail_TotalPaid( gw.internal.xml.XmlElementState state ) {
    super( 1278425066, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc800.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimDetail_TotalPaid> get$Class() {
    return getClass();
  }
}
