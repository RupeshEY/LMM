...
public final class PCClaimDetail_PcClaim extends gw.xml.XmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc800/pcintegration/pcentities/PCClaimDetail", "pcClaim", "pogo4" );
  ...
  public PCClaimDetail_PcClaim() {
    super( 2123159619, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc800.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaim() );
  }

  public PCClaimDetail_PcClaim( wsi.local.gw.webservice.cc.cc800.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaim typeInstance ) {
    super( 2123159619, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCClaimDetail_PcClaim( gw.internal.xml.XmlElementState state ) {
    super( 2123159619, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc800.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimDetail_PcClaim> get$Class() {
    return getClass();
  }
