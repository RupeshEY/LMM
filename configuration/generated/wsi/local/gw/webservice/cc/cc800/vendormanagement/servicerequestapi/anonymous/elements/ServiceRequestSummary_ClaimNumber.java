...
public final class ServiceRequestSummary_ClaimNumber extends gw.internal.xml.simplevalues.StringXmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc800/vendormanagement/ServiceRequestSummary", "ClaimNumber", "pogo3" );
  ...
  public ServiceRequestSummary_ClaimNumber() {
    super( 2134926460, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.String() );
  }

  public ServiceRequestSummary_ClaimNumber( gw.xsd.w3c.xmlschema.types.simple.String typeInstance ) {
    super( 2134926460, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ServiceRequestSummary_ClaimNumber( gw.internal.xml.XmlElementState state ) {
    super( 2134926460, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.ServiceRequestSummary_ClaimNumber> get$Class() {
    return getClass();
  }
}
