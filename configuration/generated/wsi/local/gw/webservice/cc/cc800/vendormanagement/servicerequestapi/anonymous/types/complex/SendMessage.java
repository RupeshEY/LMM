...
public class SendMessage extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.types.complex.SendMessage> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.types.complex.SendMessage get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.SendMessage_SpecialistId getSpecialistId_elem() {
    return (wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.SendMessage_SpecialistId) TYPE.get().getPropertyValue( this, "_SpecialistId_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.SendMessage_ServiceRequestNumber getServiceRequestNumber_elem() {
    return (wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.SendMessage_ServiceRequestNumber) TYPE.get().getPropertyValue( this, "_ServiceRequestNumber_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.SendMessage_Title getTitle_elem() {
    return (wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.SendMessage_Title) TYPE.get().getPropertyValue( this, "_Title_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.SendMessage_Body getBody_elem() {
    return (wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.SendMessage_Body) TYPE.get().getPropertyValue( this, "_Body_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.SendMessage_Type getType_elem() {
    return (wsi.local.gw.webservice.cc.cc800.vendormanagement.servicerequestapi.anonymous.elements.SendMessage_Type) TYPE.get().getPropertyValue( this, "_Type_elem" );
  }
