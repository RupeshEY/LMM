...
public final class CreateActivity_Dto extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.local.gw.webservice.cc.cc901.claim.claimapi.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.local.gw.webservice.cc.cc901.claim.claimapi.anonymous.elements.CreateActivity_Dto" );
    }
  };
  ...
  public CreateActivity_Dto() {
    super( -481639182, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc901.claim.claimapi.types.complex.ActivityDTO() );
  }

  public CreateActivity_Dto( wsi.local.gw.webservice.cc.cc901.claim.claimapi.types.complex.ActivityDTO typeInstance ) {
    super( -481639182, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CreateActivity_Dto( gw.internal.xml.XmlElementState state ) {
    super( -481639182, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc901.claim.claimapi.anonymous.elements.CreateActivity_Dto> get$Class() {
    return getClass();
  }
