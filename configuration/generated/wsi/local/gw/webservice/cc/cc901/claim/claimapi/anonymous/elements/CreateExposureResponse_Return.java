...
public final class CreateExposureResponse_Return extends gw.internal.xml.simplevalues.StringXmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.local.gw.webservice.cc.cc901.claim.claimapi.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.local.gw.webservice.cc.cc901.claim.claimapi.anonymous.elements.CreateExposureResponse_Return" );
    }
  };

  public CreateExposureResponse_Return() {
    super( 1146512068, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.String() );
  }

  public CreateExposureResponse_Return( gw.xsd.w3c.xmlschema.types.simple.String typeInstance ) {
    super( 1146512068, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CreateExposureResponse_Return( gw.internal.xml.XmlElementState state ) {
    super( 1146512068, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc901.claim.claimapi.anonymous.elements.CreateExposureResponse_Return> get$Class() {
    return getClass();
  }
}
