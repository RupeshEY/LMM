...
public class ClaimSegment extends gw.xml.XmlTypeInstance {
  ...
  public ClaimSegment() {
    super( 1831726991, TYPE.get() );
  }

  public ClaimSegment( wsi.local.gw.webservice.cc.cc901.claim.claimapi.enums.ClaimSegment value ) {
    this();
    setValue( value );
  }

  private ClaimSegment( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1831726991, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc901.claim.claimapi.types.simple.ClaimSegment> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc901.claim.claimapi.types.simple.ClaimSegment get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc901.claim.claimapi.enums.ClaimSegment getValue() {
    return (wsi.local.gw.webservice.cc.cc901.claim.claimapi.enums.ClaimSegment) TYPE.get().getPropertyValue( this, "Value" );
  }
