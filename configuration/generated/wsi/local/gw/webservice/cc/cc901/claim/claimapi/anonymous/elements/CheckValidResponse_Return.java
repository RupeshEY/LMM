...
public final class CheckValidResponse_Return extends gw.internal.xml.simplevalues.BooleanXmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.local.gw.webservice.cc.cc901.claim.claimapi.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.local.gw.webservice.cc.cc901.claim.claimapi.anonymous.elements.CheckValidResponse_Return" );
    }
  };

  public CheckValidResponse_Return() {
    super( -747969165, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.Boolean() );
  }

  public CheckValidResponse_Return( gw.xsd.w3c.xmlschema.types.simple.Boolean typeInstance ) {
    super( -747969165, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CheckValidResponse_Return( gw.internal.xml.XmlElementState state ) {
    super( -747969165, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc901.claim.claimapi.anonymous.elements.CheckValidResponse_Return> get$Class() {
    return getClass();
  }
}
