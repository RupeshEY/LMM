...
public class VehicleManufacturer extends gw.xml.XmlTypeInstance {
  ...
  public VehicleManufacturer() {
    super( -1469507099, TYPE.get() );
  }

  public VehicleManufacturer( wsi.local.gw.webservice.cc.cc901.claim.claimapi.enums.VehicleManufacturer value ) {
    this();
    setValue( value );
  }

  private VehicleManufacturer( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1469507099, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc901.claim.claimapi.types.simple.VehicleManufacturer> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc901.claim.claimapi.types.simple.VehicleManufacturer get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc901.claim.claimapi.enums.VehicleManufacturer getValue() {
    return (wsi.local.gw.webservice.cc.cc901.claim.claimapi.enums.VehicleManufacturer) TYPE.get().getPropertyValue( this, "Value" );
  }
