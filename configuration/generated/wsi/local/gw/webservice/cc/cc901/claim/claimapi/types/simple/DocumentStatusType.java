...
public class DocumentStatusType extends gw.xml.XmlTypeInstance {
  ...
  public DocumentStatusType() {
    super( 1202299903, TYPE.get() );
  }

  public DocumentStatusType( wsi.local.gw.webservice.cc.cc901.claim.claimapi.enums.DocumentStatusType value ) {
    this();
    setValue( value );
  }

  private DocumentStatusType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1202299903, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc901.claim.claimapi.types.simple.DocumentStatusType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc901.claim.claimapi.types.simple.DocumentStatusType get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc901.claim.claimapi.enums.DocumentStatusType getValue() {
    return (wsi.local.gw.webservice.cc.cc901.claim.claimapi.enums.DocumentStatusType) TYPE.get().getPropertyValue( this, "Value" );
  }
