...
public final class PCClaimDetail_RemainingReserves extends gw.internal.xml.simplevalues.DecimalXmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc900/pcintegration/pcentities/PCClaimDetail", "RemainingReserves", "pogo4" );
  ...
  public PCClaimDetail_RemainingReserves() {
    super( -776504090, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.Decimal() );
  }

  public PCClaimDetail_RemainingReserves( gw.xsd.w3c.xmlschema.types.simple.Decimal typeInstance ) {
    super( -776504090, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCClaimDetail_RemainingReserves( gw.internal.xml.XmlElementState state ) {
    super( -776504090, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimDetail_RemainingReserves> get$Class() {
    return getClass();
  }
}
