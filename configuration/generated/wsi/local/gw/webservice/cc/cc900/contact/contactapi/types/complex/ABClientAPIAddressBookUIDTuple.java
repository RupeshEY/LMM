...
public class ABClientAPIAddressBookUIDTuple extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/pl/ws/gw/webservice/contactapi/ab900/ABClientAPIAddressBookUIDTuple", "ABClientAPIAddressBookUIDTuple", "pogo4" );
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.contact.contactapi.types.complex.ABClientAPIAddressBookUIDTuple> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.contact.contactapi.types.complex.ABClientAPIAddressBookUIDTuple get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.contact.contactapi.anonymous.elements.ABClientAPIAddressBookUIDTuple_EntityType getEntityType_elem() {
    return (wsi.local.gw.webservice.cc.cc900.contact.contactapi.anonymous.elements.ABClientAPIAddressBookUIDTuple_EntityType) TYPE.get().getPropertyValue( this, "_EntityType_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.contact.contactapi.anonymous.elements.ABClientAPIAddressBookUIDTuple_External_PublicID getExternal_PublicID_elem() {
    return (wsi.local.gw.webservice.cc.cc900.contact.contactapi.anonymous.elements.ABClientAPIAddressBookUIDTuple_External_PublicID) TYPE.get().getPropertyValue( this, "_External_PublicID_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.contact.contactapi.anonymous.elements.ABClientAPIAddressBookUIDTuple_LinkID getLinkID_elem() {
    return (wsi.local.gw.webservice.cc.cc900.contact.contactapi.anonymous.elements.ABClientAPIAddressBookUIDTuple_LinkID) TYPE.get().getPropertyValue( this, "_LinkID_elem" );
  }
