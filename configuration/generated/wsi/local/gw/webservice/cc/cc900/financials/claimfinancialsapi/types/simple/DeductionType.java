...
public class DeductionType extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/typekey", "DeductionType", "pogo2" );
  ...
  public DeductionType() {
    super( -500178370, TYPE.get() );
  }

  public DeductionType( wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.DeductionType value ) {
    this();
    setValue( value );
  }

  private DeductionType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -500178370, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.DeductionType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.DeductionType get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.DeductionType getValue() {
    return (wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.DeductionType) TYPE.get().getPropertyValue( this, "Value" );
  }
