...
public class GeocodeStatus extends gw.xml.XmlTypeInstance {
  ...
  public GeocodeStatus() {
    super( 1686255756, TYPE.get() );
  }

  public GeocodeStatus( wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.enums.GeocodeStatus value ) {
    this();
    setValue( value );
  }

  private GeocodeStatus( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1686255756, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.types.simple.GeocodeStatus> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.types.simple.GeocodeStatus get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.enums.GeocodeStatus getValue() {
    return (wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.enums.GeocodeStatus) TYPE.get().getPropertyValue( this, "Value" );
  }
