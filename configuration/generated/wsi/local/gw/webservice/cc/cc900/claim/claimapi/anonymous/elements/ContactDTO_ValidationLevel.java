...
public final class ContactDTO_ValidationLevel extends gw.xml.XmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc900/dto/ContactDTO", "ValidationLevel", "pogo11" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.local.gw.webservice.cc.cc900.claim.claimapi.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.ContactDTO_ValidationLevel" );
    }
  };
  ...
  public ContactDTO_ValidationLevel() {
    super( 1376803443, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.ValidationLevel() );
  }

  public ContactDTO_ValidationLevel( wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.ValidationLevel typeInstance ) {
    super( 1376803443, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ContactDTO_ValidationLevel( gw.internal.xml.XmlElementState state ) {
    super( 1376803443, state );
  }

  public ContactDTO_ValidationLevel( wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.ValidationLevel value ) {
    this();
    set$Value( value );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.ContactDTO_ValidationLevel> get$Class() {
    return getClass();
  }
