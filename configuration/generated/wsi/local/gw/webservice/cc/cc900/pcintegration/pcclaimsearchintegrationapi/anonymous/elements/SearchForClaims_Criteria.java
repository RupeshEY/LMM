...
public final class SearchForClaims_Criteria extends gw.xml.XmlElement {
  ...
  public SearchForClaims_Criteria() {
    super( 452092328, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaimSearchCriteria() );
  }

  public SearchForClaims_Criteria( wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaimSearchCriteria typeInstance ) {
    super( 452092328, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private SearchForClaims_Criteria( gw.internal.xml.XmlElementState state ) {
    super( 452092328, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.SearchForClaims_Criteria> get$Class() {
    return getClass();
  }
