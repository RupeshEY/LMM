...
public class CheckDTO_DeductionPublicIDs extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public CheckDTO_DeductionPublicIDs() {
    super( -1980924008, TYPE.get() );
  }

  private CheckDTO_DeductionPublicIDs( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1980924008, state );
  }

  protected CheckDTO_DeductionPublicIDs( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CheckDTO_DeductionPublicIDs( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.types.complex.CheckDTO_DeductionPublicIDs> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.types.complex.CheckDTO_DeductionPublicIDs get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.elements.CheckDTO_DeductionPublicIDs_Entry> getEntry_elem() {
    return (java.util.List<wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.elements.CheckDTO_DeductionPublicIDs_Entry>) TYPE.get().getPropertyValue( this, "_Entry_elem" );
  }
