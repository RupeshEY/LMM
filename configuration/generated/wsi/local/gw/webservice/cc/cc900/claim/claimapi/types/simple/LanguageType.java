...
public class LanguageType extends gw.xml.XmlTypeInstance {
  ...
  public LanguageType() {
    super( -1421291061, TYPE.get() );
  }

  public LanguageType( wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.LanguageType value ) {
    this();
    setValue( value );
  }

  private LanguageType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1421291061, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.LanguageType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.LanguageType get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.LanguageType getValue() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.LanguageType) TYPE.get().getPropertyValue( this, "Value" );
  }
