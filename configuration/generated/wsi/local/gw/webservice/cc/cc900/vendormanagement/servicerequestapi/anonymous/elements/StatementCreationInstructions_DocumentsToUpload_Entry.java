...
public final class StatementCreationInstructions_DocumentsToUpload_Entry extends gw.xml.XmlElement {
  ...
  public StatementCreationInstructions_DocumentsToUpload_Entry() {
    super( 2011720742, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.types.complex.DocumentContent() );
  }

  public StatementCreationInstructions_DocumentsToUpload_Entry( wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.types.complex.DocumentContent typeInstance ) {
    super( 2011720742, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private StatementCreationInstructions_DocumentsToUpload_Entry( gw.internal.xml.XmlElementState state ) {
    super( 2011720742, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.elements.StatementCreationInstructions_DocumentsToUpload_Entry> get$Class() {
    return getClass();
  }
