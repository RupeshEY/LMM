...
public final class AddFNOLResponse_Return extends gw.internal.xml.simplevalues.StringXmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.local.gw.webservice.cc.cc900.claim.claimapi.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AddFNOLResponse_Return" );
    }
  };

  public AddFNOLResponse_Return() {
    super( -1169207280, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.String() );
  }

  public AddFNOLResponse_Return( gw.xsd.w3c.xmlschema.types.simple.String typeInstance ) {
    super( -1169207280, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AddFNOLResponse_Return( gw.internal.xml.XmlElementState state ) {
    super( -1169207280, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AddFNOLResponse_Return> get$Class() {
    return getClass();
  }
}
