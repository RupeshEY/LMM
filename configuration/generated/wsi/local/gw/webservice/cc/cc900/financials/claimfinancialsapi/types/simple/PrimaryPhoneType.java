...
public class PrimaryPhoneType extends gw.xml.XmlTypeInstance {
  ...
  public PrimaryPhoneType() {
    super( -482574201, TYPE.get() );
  }

  public PrimaryPhoneType( wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.PrimaryPhoneType value ) {
    this();
    setValue( value );
  }

  private PrimaryPhoneType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -482574201, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.PrimaryPhoneType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.PrimaryPhoneType get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.PrimaryPhoneType getValue() {
    return (wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.PrimaryPhoneType) TYPE.get().getPropertyValue( this, "Value" );
  }
