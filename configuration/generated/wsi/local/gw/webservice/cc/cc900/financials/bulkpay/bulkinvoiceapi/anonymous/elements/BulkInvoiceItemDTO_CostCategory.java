...
public final class BulkInvoiceItemDTO_CostCategory extends gw.xml.XmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc900/dto/BulkInvoiceItemDTO", "CostCategory", "pogo4" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.anonymous.elements.BulkInvoiceItemDTO_CostCategory" );
    }
  };
  ...
  public BulkInvoiceItemDTO_CostCategory() {
    super( 1632946054, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.types.simple.CostCategory() );
  }

  public BulkInvoiceItemDTO_CostCategory( wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.types.simple.CostCategory typeInstance ) {
    super( 1632946054, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private BulkInvoiceItemDTO_CostCategory( gw.internal.xml.XmlElementState state ) {
    super( 1632946054, state );
  }

  public BulkInvoiceItemDTO_CostCategory( wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.enums.CostCategory value ) {
    this();
    set$Value( value );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.anonymous.elements.BulkInvoiceItemDTO_CostCategory> get$Class() {
    return getClass();
  }
