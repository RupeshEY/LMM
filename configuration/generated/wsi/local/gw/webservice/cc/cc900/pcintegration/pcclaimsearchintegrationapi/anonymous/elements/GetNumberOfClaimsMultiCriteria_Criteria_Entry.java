...
public final class GetNumberOfClaimsMultiCriteria_Criteria_Entry extends gw.xml.XmlElement {
  ...
  public GetNumberOfClaimsMultiCriteria_Criteria_Entry() {
    super( -300379196, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaimSearchCriteria() );
  }

  public GetNumberOfClaimsMultiCriteria_Criteria_Entry( wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaimSearchCriteria typeInstance ) {
    super( -300379196, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private GetNumberOfClaimsMultiCriteria_Criteria_Entry( gw.internal.xml.XmlElementState state ) {
    super( -300379196, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.GetNumberOfClaimsMultiCriteria_Criteria_Entry> get$Class() {
    return getClass();
  }
