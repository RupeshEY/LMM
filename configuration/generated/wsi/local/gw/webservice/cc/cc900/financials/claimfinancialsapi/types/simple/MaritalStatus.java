...
public class MaritalStatus extends gw.xml.XmlTypeInstance {
  ...
  public MaritalStatus() {
    super( 1764716293, TYPE.get() );
  }

  public MaritalStatus( wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.MaritalStatus value ) {
    this();
    setValue( value );
  }

  private MaritalStatus( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1764716293, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.MaritalStatus> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.MaritalStatus get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.MaritalStatus getValue() {
    return (wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.MaritalStatus) TYPE.get().getPropertyValue( this, "Value" );
  }
