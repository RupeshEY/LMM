...
public class CheckDTO_NewPayees extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public CheckDTO_NewPayees() {
    super( -1366320803, TYPE.get() );
  }

  private CheckDTO_NewPayees( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1366320803, state );
  }

  protected CheckDTO_NewPayees( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CheckDTO_NewPayees( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.types.complex.CheckDTO_NewPayees> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.types.complex.CheckDTO_NewPayees get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.elements.CheckDTO_NewPayees_Entry> getEntry() {
    return (java.util.List<wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.elements.CheckDTO_NewPayees_Entry>) TYPE.get().getPropertyValue( this, "_Entry" );
  }
