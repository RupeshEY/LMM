...
public final class PCClaimDetail_ClaimInfoPublicID extends gw.internal.xml.simplevalues.StringXmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc900/pcintegration/pcentities/PCClaimDetail", "ClaimInfoPublicID", "pogo4" );
  ...
  public PCClaimDetail_ClaimInfoPublicID() {
    super( 51492871, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new gw.xsd.w3c.xmlschema.types.simple.String() );
  }

  public PCClaimDetail_ClaimInfoPublicID( gw.xsd.w3c.xmlschema.types.simple.String typeInstance ) {
    super( 51492871, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCClaimDetail_ClaimInfoPublicID( gw.internal.xml.XmlElementState state ) {
    super( 51492871, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimDetail_ClaimInfoPublicID> get$Class() {
    return getClass();
  }
}
