...
public class CheckDTO_NewPayments extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public CheckDTO_NewPayments() {
    super( 1233087967, TYPE.get() );
  }

  private CheckDTO_NewPayments( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1233087967, state );
  }

  protected CheckDTO_NewPayments( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CheckDTO_NewPayments( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.types.complex.CheckDTO_NewPayments> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.types.complex.CheckDTO_NewPayments get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.elements.CheckDTO_NewPayments_Entry> getEntry() {
    return (java.util.List<wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.elements.CheckDTO_NewPayments_Entry>) TYPE.get().getPropertyValue( this, "_Entry" );
  }
