...
public final class DocumentWithContent_DocumentContent extends gw.xml.XmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc900/vendormanagement/DocumentWithContent", "DocumentContent", "pogo16" );
  ...
  public DocumentWithContent_DocumentContent() {
    super( -128553790, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.types.complex.DocumentContent() );
  }

  public DocumentWithContent_DocumentContent( wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.types.complex.DocumentContent typeInstance ) {
    super( -128553790, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private DocumentWithContent_DocumentContent( gw.internal.xml.XmlElementState state ) {
    super( -128553790, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.elements.DocumentWithContent_DocumentContent> get$Class() {
    return getClass();
  }
