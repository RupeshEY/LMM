...
public class SpecialtyType extends gw.xml.XmlTypeInstance {
  ...
  public SpecialtyType() {
    super( -629500577, TYPE.get() );
  }

  public SpecialtyType( wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.SpecialtyType value ) {
    this();
    setValue( value );
  }

  private SpecialtyType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -629500577, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.SpecialtyType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.SpecialtyType get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.SpecialtyType getValue() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.SpecialtyType) TYPE.get().getPropertyValue( this, "Value" );
  }
