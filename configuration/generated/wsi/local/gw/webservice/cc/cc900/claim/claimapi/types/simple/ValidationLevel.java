...
public class ValidationLevel extends gw.xml.XmlTypeInstance {
  ...
  public ValidationLevel() {
    super( 123542738, TYPE.get() );
  }

  public ValidationLevel( wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.ValidationLevel value ) {
    this();
    setValue( value );
  }

  private ValidationLevel( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 123542738, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.ValidationLevel> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.ValidationLevel get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.ValidationLevel getValue() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.ValidationLevel) TYPE.get().getPropertyValue( this, "Value" );
  }
