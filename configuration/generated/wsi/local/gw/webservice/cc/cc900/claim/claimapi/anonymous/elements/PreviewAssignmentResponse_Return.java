...
public final class PreviewAssignmentResponse_Return extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.local.gw.webservice.cc.cc900.claim.claimapi.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.PreviewAssignmentResponse_Return" );
    }
  };
  ...
  public PreviewAssignmentResponse_Return() {
    super( -105843135, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.complex.AssignmentResponse() );
  }

  public PreviewAssignmentResponse_Return( wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.complex.AssignmentResponse typeInstance ) {
    super( -105843135, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PreviewAssignmentResponse_Return( gw.internal.xml.XmlElementState state ) {
    super( -105843135, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.PreviewAssignmentResponse_Return> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.complex.AssignmentResponse get$TypeInstance() {
    return super.get$TypeInstance().cast( wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.complex.AssignmentResponse.class );
  }

  public final void set$TypeInstance( wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.complex.AssignmentResponse typeInstance ) {
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.AssignmentCommand getAssignmentCommand() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.AssignmentCommand) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_AssignmentCommand" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_AssignmentCommand getAssignmentCommand_elem() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_AssignmentCommand) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_AssignmentCommand_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_GroupID getGroupID_elem() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_GroupID) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_GroupID_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_GroupType getGroupType_elem() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_GroupType) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_GroupType_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_QueueID getQueueID_elem() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_QueueID) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_QueueID_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_ReviewAssignment getReviewAssignment_elem() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_ReviewAssignment) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_ReviewAssignment_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_ReviewerId getReviewerId_elem() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_ReviewerId) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_ReviewerId_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_UserID getUserID_elem() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.AssignmentResponse_UserID) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_UserID_elem" );
  }
