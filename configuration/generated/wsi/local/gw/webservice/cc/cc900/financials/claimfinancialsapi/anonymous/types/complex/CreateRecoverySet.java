...
public class CreateRecoverySet extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public CreateRecoverySet() {
    super( -292009321, TYPE.get() );
  }

  private CreateRecoverySet( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -292009321, state );
  }

  protected CreateRecoverySet( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CreateRecoverySet( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.types.complex.CreateRecoverySet> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.types.complex.CreateRecoverySet get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.elements.CreateRecoverySet_TransactionSetDTO getTransactionSetDTO() {
    return (wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.anonymous.elements.CreateRecoverySet_TransactionSetDTO) TYPE.get().getPropertyValue( this, "_TransactionSetDTO" );
  }
