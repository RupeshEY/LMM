...
public class ClaimReopenedReason extends gw.xml.XmlTypeInstance {
  ...
  public ClaimReopenedReason() {
    super( 1444619235, TYPE.get() );
  }

  public ClaimReopenedReason( wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.ClaimReopenedReason value ) {
    this();
    setValue( value );
  }

  private ClaimReopenedReason( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1444619235, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.ClaimReopenedReason> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.ClaimReopenedReason get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.ClaimReopenedReason getValue() {
    return (wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.ClaimReopenedReason) TYPE.get().getPropertyValue( this, "Value" );
  }
