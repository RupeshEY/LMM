...
package wsi.local.gw.webservice.cc.cc900.contact.contactapi.types.simple;
...
public class ContactChangeResolution extends gw.xml.XmlTypeInstance {
  ...
  public ContactChangeResolution() {
    super( -2075562933, TYPE.get() );
  }

  public ContactChangeResolution( wsi.local.gw.webservice.cc.cc900.contact.contactapi.enums.ContactChangeResolution value ) {
    this();
    setValue( value );
  }

  private ContactChangeResolution( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -2075562933, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.contact.contactapi.types.simple.ContactChangeResolution> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.contact.contactapi.types.simple.ContactChangeResolution get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.contact.contactapi.enums.ContactChangeResolution getValue() {
    return (wsi.local.gw.webservice.cc.cc900.contact.contactapi.enums.ContactChangeResolution) TYPE.get().getPropertyValue( this, "Value" );
  }
