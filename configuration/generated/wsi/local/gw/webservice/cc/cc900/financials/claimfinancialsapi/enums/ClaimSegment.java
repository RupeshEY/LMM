...
public enum ClaimSegment implements gw.xml.IXmlSchemaEnumValue {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.ClaimSegment" );
    }
  };
  ...
  public static final wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.ClaimSegment forValue( java.lang.String value ) {
    return (wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.ClaimSegment) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.ClaimSegment forGosuValue( java.lang.String value ) {
    return (wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.ClaimSegment) TYPE.get().cg_forValue( value );
  }
