...
public class UpdateExpectedQuoteCompletionDate extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.types.complex.UpdateExpectedQuoteCompletionDate> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.types.complex.UpdateExpectedQuoteCompletionDate get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.elements.UpdateExpectedQuoteCompletionDate_SpecialistId getSpecialistId_elem() {
    return (wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.elements.UpdateExpectedQuoteCompletionDate_SpecialistId) TYPE.get().getPropertyValue( this, "_SpecialistId_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.elements.UpdateExpectedQuoteCompletionDate_ServiceRequestNumber getServiceRequestNumber_elem() {
    return (wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.elements.UpdateExpectedQuoteCompletionDate_ServiceRequestNumber) TYPE.get().getPropertyValue( this, "_ServiceRequestNumber_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.elements.UpdateExpectedQuoteCompletionDate_ExpectedCompletionDate getExpectedCompletionDate_elem() {
    return (wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.elements.UpdateExpectedQuoteCompletionDate_ExpectedCompletionDate) TYPE.get().getPropertyValue( this, "_ExpectedCompletionDate_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.elements.UpdateExpectedQuoteCompletionDate_ChangeReason getChangeReason_elem() {
    return (wsi.local.gw.webservice.cc.cc900.vendormanagement.servicerequestapi.anonymous.elements.UpdateExpectedQuoteCompletionDate_ChangeReason) TYPE.get().getPropertyValue( this, "_ChangeReason_elem" );
  }
