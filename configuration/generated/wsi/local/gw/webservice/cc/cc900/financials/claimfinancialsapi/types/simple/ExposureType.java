...
public class ExposureType extends gw.xml.XmlTypeInstance {
  ...
  public ExposureType() {
    super( -401731582, TYPE.get() );
  }

  public ExposureType( wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.ExposureType value ) {
    this();
    setValue( value );
  }

  private ExposureType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -401731582, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.ExposureType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.ExposureType get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.ExposureType getValue() {
    return (wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.ExposureType) TYPE.get().getPropertyValue( this, "Value" );
  }
