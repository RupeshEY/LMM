...
public class ContactCreationApprovalStatus extends gw.xml.XmlTypeInstance {
  ...
  public ContactCreationApprovalStatus() {
    super( -654213101, TYPE.get() );
  }

  public ContactCreationApprovalStatus( wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.ContactCreationApprovalStatus value ) {
    this();
    setValue( value );
  }

  private ContactCreationApprovalStatus( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -654213101, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.ContactCreationApprovalStatus> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.ContactCreationApprovalStatus get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.ContactCreationApprovalStatus getValue() {
    return (wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.ContactCreationApprovalStatus) TYPE.get().getPropertyValue( this, "Value" );
  }
