...
public class PCClaimSearchCriteria extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc900/pcintegration/pcentities/PCClaimSearchCriteria", "PCClaimSearchCriteria", "pogo" );
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaimSearchCriteria> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaimSearchCriteria get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimSearchCriteria_BeginDate getBeginDate_elem() {
    return (wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimSearchCriteria_BeginDate) TYPE.get().getPropertyValue( this, "_BeginDate_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimSearchCriteria_EndDate getEndDate_elem() {
    return (wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimSearchCriteria_EndDate) TYPE.get().getPropertyValue( this, "_EndDate_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimSearchCriteria_Lob getLob_elem() {
    return (wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimSearchCriteria_Lob) TYPE.get().getPropertyValue( this, "_Lob_elem" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimSearchCriteria_PolicyNumbers getPolicyNumbers() {
    return (wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimSearchCriteria_PolicyNumbers) TYPE.get().getPropertyValue( this, "_PolicyNumbers" );
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimSearchCriteria_Status getStatus_elem() {
    return (wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.PCClaimSearchCriteria_Status) TYPE.get().getPropertyValue( this, "_Status_elem" );
  }
