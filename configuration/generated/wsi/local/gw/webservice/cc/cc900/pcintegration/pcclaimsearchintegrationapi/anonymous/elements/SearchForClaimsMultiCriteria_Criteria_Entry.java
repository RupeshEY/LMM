...
public final class SearchForClaimsMultiCriteria_Criteria_Entry extends gw.xml.XmlElement {
  ...
  public SearchForClaimsMultiCriteria_Criteria_Entry() {
    super( 1129114127, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaimSearchCriteria() );
  }

  public SearchForClaimsMultiCriteria_Criteria_Entry( wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.types.complex.PCClaimSearchCriteria typeInstance ) {
    super( 1129114127, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private SearchForClaimsMultiCriteria_Criteria_Entry( gw.internal.xml.XmlElementState state ) {
    super( 1129114127, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.pcintegration.pcclaimsearchintegrationapi.anonymous.elements.SearchForClaimsMultiCriteria_Criteria_Entry> get$Class() {
    return getClass();
  }
