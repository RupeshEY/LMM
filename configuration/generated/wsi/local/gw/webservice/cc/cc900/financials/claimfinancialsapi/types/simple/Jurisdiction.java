...
public class Jurisdiction extends gw.xml.XmlTypeInstance {
  ...
  public Jurisdiction() {
    super( 740101794, TYPE.get() );
  }

  public Jurisdiction( wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.Jurisdiction value ) {
    this();
    setValue( value );
  }

  private Jurisdiction( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 740101794, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.Jurisdiction> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.types.simple.Jurisdiction get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.Jurisdiction getValue() {
    return (wsi.local.gw.webservice.cc.cc900.financials.claimfinancialsapi.enums.Jurisdiction) TYPE.get().getPropertyValue( this, "Value" );
  }
