...
public final class ContactDTO_DoctorSpecialty extends gw.xml.XmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "http://guidewire.com/cc/ws/gw/webservice/cc/cc900/dto/ContactDTO", "DoctorSpecialty", "pogo11" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.local.gw.webservice.cc.cc900.claim.claimapi.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.ContactDTO_DoctorSpecialty" );
    }
  };
  ...
  public ContactDTO_DoctorSpecialty() {
    super( -2086143353, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.SpecialtyType() );
  }

  public ContactDTO_DoctorSpecialty( wsi.local.gw.webservice.cc.cc900.claim.claimapi.types.simple.SpecialtyType typeInstance ) {
    super( -2086143353, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ContactDTO_DoctorSpecialty( gw.internal.xml.XmlElementState state ) {
    super( -2086143353, state );
  }

  public ContactDTO_DoctorSpecialty( wsi.local.gw.webservice.cc.cc900.claim.claimapi.enums.SpecialtyType value ) {
    this();
    set$Value( value );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.claim.claimapi.anonymous.elements.ContactDTO_DoctorSpecialty> get$Class() {
    return getClass();
  }
