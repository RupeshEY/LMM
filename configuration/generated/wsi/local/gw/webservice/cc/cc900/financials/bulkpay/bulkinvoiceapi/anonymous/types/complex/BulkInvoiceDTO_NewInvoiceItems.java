...
public class BulkInvoiceDTO_NewInvoiceItems extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public BulkInvoiceDTO_NewInvoiceItems() {
    super( -900789521, TYPE.get() );
  }

  private BulkInvoiceDTO_NewInvoiceItems( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -900789521, state );
  }

  protected BulkInvoiceDTO_NewInvoiceItems( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected BulkInvoiceDTO_NewInvoiceItems( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.anonymous.types.complex.BulkInvoiceDTO_NewInvoiceItems> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.anonymous.types.complex.BulkInvoiceDTO_NewInvoiceItems get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.anonymous.elements.BulkInvoiceDTO_NewInvoiceItems_Entry> getEntry() {
    return (java.util.List<wsi.local.gw.webservice.cc.cc900.financials.bulkpay.bulkinvoiceapi.anonymous.elements.BulkInvoiceDTO_NewInvoiceItems_Entry>) TYPE.get().getPropertyValue( this, "_Entry" );
  }
