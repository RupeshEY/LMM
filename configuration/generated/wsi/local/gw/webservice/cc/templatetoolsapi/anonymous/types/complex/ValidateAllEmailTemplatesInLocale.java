...
public class ValidateAllEmailTemplatesInLocale extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public ValidateAllEmailTemplatesInLocale() {
    super( -250895943, TYPE.get() );
  }

  private ValidateAllEmailTemplatesInLocale( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -250895943, state );
  }

  protected ValidateAllEmailTemplatesInLocale( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ValidateAllEmailTemplatesInLocale( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.templatetoolsapi.anonymous.types.complex.ValidateAllEmailTemplatesInLocale> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.templatetoolsapi.anonymous.types.complex.ValidateAllEmailTemplatesInLocale get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.templatetoolsapi.anonymous.elements.ValidateAllEmailTemplatesInLocale_BeanNamesAndTypes getBeanNamesAndTypes() {
    return (wsi.local.gw.webservice.cc.templatetoolsapi.anonymous.elements.ValidateAllEmailTemplatesInLocale_BeanNamesAndTypes) TYPE.get().getPropertyValue( this, "_BeanNamesAndTypes" );
  }
  ...
  public final wsi.local.gw.webservice.cc.templatetoolsapi.anonymous.elements.ValidateAllEmailTemplatesInLocale_Locale getLocale_elem() {
    return (wsi.local.gw.webservice.cc.templatetoolsapi.anonymous.elements.ValidateAllEmailTemplatesInLocale_Locale) TYPE.get().getPropertyValue( this, "_Locale_elem" );
  }
