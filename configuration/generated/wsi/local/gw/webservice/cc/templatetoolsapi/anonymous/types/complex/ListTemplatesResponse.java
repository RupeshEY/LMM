...
public class ListTemplatesResponse extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public ListTemplatesResponse() {
    super( 272385486, TYPE.get() );
  }

  private ListTemplatesResponse( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 272385486, state );
  }

  protected ListTemplatesResponse( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ListTemplatesResponse( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.webservice.cc.templatetoolsapi.anonymous.types.complex.ListTemplatesResponse> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.webservice.cc.templatetoolsapi.anonymous.types.complex.ListTemplatesResponse get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.webservice.cc.templatetoolsapi.anonymous.elements.ListTemplatesResponse_Return getReturn_elem() {
    return (wsi.local.gw.webservice.cc.templatetoolsapi.anonymous.elements.ListTemplatesResponse_Return) TYPE.get().getPropertyValue( this, "_Return_elem" );
  }
