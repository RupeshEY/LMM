...
public enum ComponentType implements gw.xml.IXmlSchemaEnumValue {
  ...
  STARTABLE_PLUGIN( "STARTABLE_PLUGIN" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.local.gw.wsi.pl.systemtoolsapi.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.local.gw.wsi.pl.systemtoolsapi.enums.ComponentType" );
    }
  };
  ...
  public static final wsi.local.gw.wsi.pl.systemtoolsapi.enums.ComponentType forValue( java.lang.String value ) {
    return (wsi.local.gw.wsi.pl.systemtoolsapi.enums.ComponentType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final wsi.local.gw.wsi.pl.systemtoolsapi.enums.ComponentType forGosuValue( java.lang.String value ) {
    return (wsi.local.gw.wsi.pl.systemtoolsapi.enums.ComponentType) TYPE.get().cg_forValue( value );
  }
