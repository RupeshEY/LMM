...
public final class ClusterState_UnassignedComponents_Entry extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) wsi.local.gw.wsi.pl.systemtoolsapi.util.SchemaAccess ).getSchemaIndex().getTypeData( "wsi.local.gw.wsi.pl.systemtoolsapi.anonymous.elements.ClusterState_UnassignedComponents_Entry" );
    }
  };
  ...
  public ClusterState_UnassignedComponents_Entry() {
    super( -1016456661, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new wsi.local.gw.wsi.pl.systemtoolsapi.types.complex.ComponentInfo() );
  }

  public ClusterState_UnassignedComponents_Entry( wsi.local.gw.wsi.pl.systemtoolsapi.types.complex.ComponentInfo typeInstance ) {
    super( -1016456661, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClusterState_UnassignedComponents_Entry( gw.internal.xml.XmlElementState state ) {
    super( -1016456661, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends wsi.local.gw.wsi.pl.systemtoolsapi.anonymous.elements.ClusterState_UnassignedComponents_Entry> get$Class() {
    return getClass();
  }
