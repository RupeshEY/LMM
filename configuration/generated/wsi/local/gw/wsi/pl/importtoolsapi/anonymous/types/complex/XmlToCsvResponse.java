...
public class XmlToCsvResponse extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public XmlToCsvResponse() {
    super( 1880087420, TYPE.get() );
  }

  private XmlToCsvResponse( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1880087420, state );
  }

  protected XmlToCsvResponse( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected XmlToCsvResponse( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.wsi.pl.importtoolsapi.anonymous.types.complex.XmlToCsvResponse> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.wsi.pl.importtoolsapi.anonymous.types.complex.XmlToCsvResponse get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.wsi.pl.importtoolsapi.anonymous.elements.XmlToCsvResponse_Return getReturn_elem() {
    return (wsi.local.gw.wsi.pl.importtoolsapi.anonymous.elements.XmlToCsvResponse_Return) TYPE.get().getPropertyValue( this, "_Return_elem" );
  }
