...
public class SetEnableProfilerForBatchProcessAndWorkQueue extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public SetEnableProfilerForBatchProcessAndWorkQueue() {
    super( -574901983, TYPE.get() );
  }

  private SetEnableProfilerForBatchProcessAndWorkQueue( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -574901983, state );
  }

  protected SetEnableProfilerForBatchProcessAndWorkQueue( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SetEnableProfilerForBatchProcessAndWorkQueue( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends wsi.local.gw.wsi.pl.profilerapi.anonymous.types.complex.SetEnableProfilerForBatchProcessAndWorkQueue> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public wsi.local.gw.wsi.pl.profilerapi.anonymous.types.complex.SetEnableProfilerForBatchProcessAndWorkQueue get$TypeInstance() {
    return this;
  }
  ...
  public final wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_Enable getEnable_elem() {
    return (wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_Enable) TYPE.get().getPropertyValue( this, "_Enable_elem" );
  }
  ...
  public final wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_Type getType_elem() {
    return (wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_Type) TYPE.get().getPropertyValue( this, "_Type_elem" );
  }
  ...
  public final wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_HiResTime getHiResTime_elem() {
    return (wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_HiResTime) TYPE.get().getPropertyValue( this, "_HiResTime_elem" );
  }
  ...
  public final wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_EnableStackTracing getEnableStackTracing_elem() {
    return (wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_EnableStackTracing) TYPE.get().getPropertyValue( this, "_EnableStackTracing_elem" );
  }
  ...
  public final wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_EnableQueryOptimizerTracing getEnableQueryOptimizerTracing_elem() {
    return (wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_EnableQueryOptimizerTracing) TYPE.get().getPropertyValue( this, "_EnableQueryOptimizerTracing_elem" );
  }
  ...
  public final wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_EnableExtendedQueryTracing getEnableExtendedQueryTracing_elem() {
    return (wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_EnableExtendedQueryTracing) TYPE.get().getPropertyValue( this, "_EnableExtendedQueryTracing_elem" );
  }
  ...
  public final wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_DbmsCounterThresholdMs getDbmsCounterThresholdMs_elem() {
    return (wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_DbmsCounterThresholdMs) TYPE.get().getPropertyValue( this, "_DbmsCounterThresholdMs_elem" );
  }
  ...
  public final wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_DiffDbmsCounters getDiffDbmsCounters_elem() {
    return (wsi.local.gw.wsi.pl.profilerapi.anonymous.elements.SetEnableProfilerForBatchProcessAndWorkQueue_DiffDbmsCounters) TYPE.get().getPropertyValue( this, "_DiffDbmsCounters_elem" );
  }
