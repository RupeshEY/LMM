...
class ECFSuspenseQueuePolicySearchDVExpressions {
  @javax.annotation.Generated("config/web/pcf/acc/iplm/suspensequeue/policysearch/ECFSuspenseQueuePolicySearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ECFSuspenseQueuePolicySearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at ECFSuspenseQueuePolicySearchDV.pcf: line 12, column 81
    function def_onEnter_0 (def :  pcf.ECFSuspenseQueuePolicySearchPolicyInputSet) : void {
      def.onEnter(PolicySearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at ECFSuspenseQueuePolicySearchDV.pcf: line 17, column 164
    function def_onEnter_2 (def :  pcf.PolicySearchInsuredInputSet_default) : void {
      def.onEnter(PolicySearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at ECFSuspenseQueuePolicySearchDV.pcf: line 21, column 41
    function def_onEnter_5 (def :  pcf.SearchAndResetInputSet) : void {
      def.onEnter()
    }
    
    // 'def' attribute on InputSetRef at ECFSuspenseQueuePolicySearchDV.pcf: line 12, column 81
    function def_refreshVariables_1 (def :  pcf.ECFSuspenseQueuePolicySearchPolicyInputSet) : void {
    ...
    // 'mode' attribute on InputSetRef at ECFSuspenseQueuePolicySearchDV.pcf: line 17, column 164
