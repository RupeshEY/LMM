...
class ClaimSnapshotInjuryIncidentDVExpressions {
  ...
  public static class ClaimSnapshotInjuryIncidentDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RowIterator at ClaimSnapshotInjuryIncidentDV.pcf: line 64, column 36
    function sortValue_13 (BodyPartDetails :  dynamic.Dynamic) : java.lang.Object {
      return BodyPartDetails.Ordering
    }
    
    // 'value' attribute on RowIterator at ClaimSnapshotInjuryIncidentDV.pcf: line 70, column 48
    function sortValue_14 (BodyPartDetails :  dynamic.Dynamic) : java.lang.Object {
      return BodyPartDetails.PrimaryBodyPart
    }
    
    // 'value' attribute on RowIterator at ClaimSnapshotInjuryIncidentDV.pcf: line 76, column 48
    function sortValue_15 (BodyPartDetails :  dynamic.Dynamic) : java.lang.Object {
      return BodyPartDetails.DetailedBodyPart
    }
    
    // 'value' attribute on TextInput (id=Severity) at ClaimSnapshotInjuryIncidentDV.pcf: line 21, column 40
    function valueRoot_3 () : java.lang.Object {
      return InjuryIncidentInstance
    }
    
    // 'value' attribute on TextInput (id=PrimaryDoctor) at ClaimSnapshotInjuryIncidentDV.pcf: line 125, column 40
    ...
    // 'value' attribute on TextInput (id=DetailedInjuryType) at ClaimSnapshotInjuryIncidentDV.pcf: line 37, column 40
    function value_10 () : dynamic.Dynamic {
      return InjuryIncidentInstance.DetailedInjuryType
    }
    
    // 'value' attribute on RowIterator at ClaimSnapshotInjuryIncidentDV.pcf: line 53, column 43
    function value_35 () : dynamic.Dynamic {
      return InjuryIncidentInstance.BodyParts
    }
    
    // 'value' attribute on BooleanRadioInput (id=ReceivedTreatment) at ClaimSnapshotInjuryIncidentDV.pcf: line 112, column 29
    function value_36 () : java.lang.Boolean {
      return treatment
    }
    
    // 'value' attribute on TextInput (id=TreatmentType) at ClaimSnapshotInjuryIncidentDV.pcf: line 120, column 32
    function value_39 () : dynamic.Dynamic {
      return InjuryIncidentInstance.MedicalTreatmentType
    }
    
    // 'value' attribute on TextAreaInput (id=InjuryDescription) at ClaimSnapshotInjuryIncidentDV.pcf: line 27, column 40
    ...
    // 'value' attribute on TextInput (id=LostWages) at ClaimSnapshotInjuryIncidentDV.pcf: line 130, column 39
    function value_46 () : dynamic.Dynamic {
      return InjuryIncidentInstance.LostWages
    }
    
    // 'value' attribute on TextInput (id=PrimaryInjuryType) at ClaimSnapshotInjuryIncidentDV.pcf: line 32, column 40
  ...
  public static class IteratorEntryExpressionsImpl extends ClaimSnapshotInjuryIncidentDVExpressionsImpl {
    ...
    // 'condition' attribute on ToolbarFlag at ClaimSnapshotInjuryIncidentDV.pcf: line 56, column 36
    ...
    // 'value' attribute on TextCell (id=Ordering) at ClaimSnapshotInjuryIncidentDV.pcf: line 64, column 36
    ...
    // 'value' attribute on TextCell (id=PrimaryBodyPart) at ClaimSnapshotInjuryIncidentDV.pcf: line 70, column 48
    function value_20 () : dynamic.Dynamic {
      return BodyPartDetails.PrimaryBodyPart
    }
    
    // 'value' attribute on TextCell (id=DetailedBodyPart) at ClaimSnapshotInjuryIncidentDV.pcf: line 76, column 48
    function value_23 () : dynamic.Dynamic {
      return BodyPartDetails.DetailedBodyPart
    }
    
    // 'value' attribute on TextCell (id=CompensabilityDecision) at ClaimSnapshotInjuryIncidentDV.pcf: line 85, column 37
    function value_26 () : dynamic.Dynamic {
      return BodyPartDetails.CompensabilityDecision
    }
    
    // 'value' attribute on TextCell (id=CompensabilityDecisionDate) at ClaimSnapshotInjuryIncidentDV.pcf: line 94, column 37
    function value_29 () : dynamic.Dynamic {
      return BodyPartDetails.CompensabilityDecisionDate
    }
    
    // 'value' attribute on TextCell (id=CompensabilityComments) at ClaimSnapshotInjuryIncidentDV.pcf: line 103, column 37
