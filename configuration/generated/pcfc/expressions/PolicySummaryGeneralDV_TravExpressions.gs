...
class PolicySummaryGeneralDV_TravExpressions {
  ...
  public static class PolicySummaryGeneralDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Insured) at PolicySummaryGeneralDV.Trav.pcf: line 17, column 44
    ...
    // 'value' attribute on DateInput (id=ExpirationDate) at PolicySummaryGeneralDV.Trav.pcf: line 34, column 47
    function value_12 () : java.util.Date {
      return PolicySummary.ExpirationDate
    }
    
    // 'value' attribute on TypeKeyInput (id=Status) at PolicySummaryGeneralDV.Trav.pcf: line 39, column 43
    function value_15 () : typekey.PolicyStatus {
      return PolicySummary.Status
    }
    
    // 'value' attribute on TextInput (id=PolicyNumber) at PolicySummaryGeneralDV.Trav.pcf: line 21, column 45
    function value_3 () : java.lang.String {
      return PolicySummary.PolicyNumber
    }
    
    // 'value' attribute on TypeKeyInput (id=Type) at PolicySummaryGeneralDV.Trav.pcf: line 26, column 41
    function value_6 () : typekey.PolicyType {
      return PolicySummary.PolicyType
    }
    
    // 'value' attribute on DateInput (id=EffectiveDate) at PolicySummaryGeneralDV.Trav.pcf: line 30, column 46
