...
@javax.annotation.Generated("config/web/pcf/team/group/TeamGroupOtherActivities.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TeamGroupOtherActivitiesExpressions {
  ...
  public static class TeamGroupOtherActivitiesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupOtherActivities_Print) at TeamGroupOtherActivities.pcf: line 46, column 25
    function action_4 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupOtherActivities_Assign) at TeamGroupOtherActivities.pcf: line 39, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupOtherActivities_Print) at TeamGroupOtherActivities.pcf: line 46, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupOtherActivities.pcf: line 49, column 131
