...
class ApprovalDetailDV_ReserveSetExpressions {
  ...
  public static class ApprovalDetailDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at ApprovalDetailDV.ReserveSet.pcf: line 39, column 40
    ...
    function def_onEnter_2 (def :  pcf.ReserveSetLV) : void {
      def.onEnter((Activity.TransactionSet as ReserveSet).Reserves)
    }
    ...
    function def_refreshVariables_3 (def :  pcf.ReserveSetLV) : void {
      def.refreshVariables((Activity.TransactionSet as ReserveSet).Reserves)
    }
    
    // 'value' attribute on TextInput (id=ApprovalRationale) at ApprovalDetailDV.ReserveSet.pcf: line 33, column 42
    ...
    // 'value' attribute on DateInput (id=Details_CreateTime) at ApprovalDetailDV.ReserveSet.pcf: line 55, column 53
    ...
    // 'value' attribute on ClaimContactInput (id=Details_CreateUser) at ApprovalDetailDV.ReserveSet.pcf: line 51, column 41
    ...
    // 'valueType' attribute on ClaimContactInput (id=Details_CreateUser) at ApprovalDetailDV.ReserveSet.pcf: line 51, column 41
    ...
    // 'visible' attribute on ListViewInput at ApprovalDetailDV.ReserveSet.pcf: line 39, column 40
    ...
    // 'visible' attribute on TextInput (id=ApprovalRationale) at ApprovalDetailDV.ReserveSet.pcf: line 33, column 42
