...
@javax.annotation.Generated("config/web/pcf/claim/quickjump/contextualforward/ClaimNotesForward.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimNotesForward extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ClaimNotesForward, LOCATION_CONFIG_CLASS)
  }
