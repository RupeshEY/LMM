...
@javax.annotation.Generated("config/web/pcf/claim/quickjump/contextualforward/ClaimChecksForward.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimChecksForward extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ClaimChecksForward, LOCATION_CONFIG_CLASS)
  }
