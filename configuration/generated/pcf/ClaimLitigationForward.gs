...
@javax.annotation.Generated("config/web/pcf/claim/quickjump/contextualforward/ClaimLitigationForward.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimLitigationForward extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ClaimLitigationForward, LOCATION_CONFIG_CLASS)
  }
