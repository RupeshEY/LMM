...
@javax.annotation.Generated("config/web/pcf/claim/quickjump/contextualforward/ClaimPolicyForward.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimPolicyForward extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ClaimPolicyForward, LOCATION_CONFIG_CLASS)
  }
