...
@javax.annotation.Generated("config/web/pcf/claim/quickjump/contextualforward/ClaimNewReserveForward.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimNewReserveForward extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ClaimNewReserveForward, LOCATION_CONFIG_CLASS)
  }
