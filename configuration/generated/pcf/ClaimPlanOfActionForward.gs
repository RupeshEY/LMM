...
@javax.annotation.Generated("config/web/pcf/claim/quickjump/contextualforward/ClaimPlanOfActionForward.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimPlanOfActionForward extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ClaimPlanOfActionForward, LOCATION_CONFIG_CLASS)
  }
