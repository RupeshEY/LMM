...
public class Reserve extends entity.Transaction implements entity.EventAware {
  ...
  /**
   * The total claim amount of pending approval reserves that match this reserve on this reserve's
   * Claim, Exposure, CostType and CostCategory.
   * @deprecated Use FinancialsCalculationUtil.getFinancialsCalculation(FinancialsLibrary.getPendingApprovalReservesExpression()).getAmount(...)
   */
  @java.lang.Deprecated
  public gw.api.financials.CurrencyAmount getMatchingPendingReserves() {
    return ((gw.cc.financials.reserve.entity.Reserve)__getDelegateManager().getImplementation("gw.cc.financials.reserve.entity.Reserve")).getMatchingPendingReserves();
  }
  ...
  /**
   * The Total Incurred Gross calculation for the ReserveLine of this reserve.
   * @deprecated Use {@link gw.api.financials.FinancialsCalculations#getTotalIncurredGross()}.getAmount(...)
   */
  @java.lang.Deprecated
  public gw.api.financials.CurrencyAmount getTotalIncurredGross() {
    return ((gw.cc.financials.reserve.entity.Reserve)__getDelegateManager().getImplementation("gw.cc.financials.reserve.entity.Reserve")).getTotalIncurredGross();
  }
