 ...
 * Cross market public comment
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ECFMessageCrossMarketPublicComment_Ext.eti;ECFMessageCrossMarketPublicComment_Ext.eix;ECFMessageCrossMarketPublicComment_Ext.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ECFMessageCrossMarketPublicComment_Ext")
public class ECFMessageCrossMarketPublicComment_Ext extends entity.ECFMessageCrossMarketComment_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageCrossMarketPublicComment_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageCrossMarketPublicComment_Ext>("entity.ECFMessageCrossMarketPublicComment_Ext");
   ...
   */
  public ECFMessageCrossMarketPublicComment_Ext()  {
   ...
   */
  public ECFMessageCrossMarketPublicComment_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageCrossMarketPublicComment_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageCrossMarketPublicComment_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageCrossMarketPublicComment_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageCrossMarketPublicComment_ExtInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageCrossMarketPublicComment_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageCrossMarketPublicComment_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageCrossMarketPublicComment_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageCrossMarketPublicComment_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageCrossMarketPublicComment_Ext, com.guidewire._generated.entity.ECFMessageCrossMarketPublicComment_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageCrossMarketPublicComment_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageCrossMarketPublicComment_ExtInternal getInternalInterface(entity.ECFMessageCrossMarketPublicComment_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageCrossMarketPublicComment_Ext newEmptyInstance() {
        return new entity.ECFMessageCrossMarketPublicComment_Ext((java.lang.Void)null);
      }
