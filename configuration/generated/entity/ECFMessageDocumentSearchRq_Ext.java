 ...
 * Document Search Request subtype for ECF messages
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ECFMessageDocumentSearchRq_Ext.eti;ECFMessageDocumentSearchRq_Ext.eix;ECFMessageDocumentSearchRq_Ext.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ECFMessageDocumentSearchRq_Ext")
public class ECFMessageDocumentSearchRq_Ext extends entity.ECFDocumentMessage_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageDocumentSearchRq_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageDocumentSearchRq_Ext>("entity.ECFMessageDocumentSearchRq_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SEARCHRESPONSEUUID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "SearchResponseUUId");
   ...
   */
  public ECFMessageDocumentSearchRq_Ext()  {
   ...
   */
  public ECFMessageDocumentSearchRq_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageDocumentSearchRq_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageDocumentSearchRq_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageDocumentSearchRq_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageDocumentSearchRq_ExtInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the SearchResponseUUId field.
   * SearchResponseUUId - Unique Universal Identifier of the message
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getSearchResponseUUId() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SEARCHRESPONSEUUID_PROP.get());
  }
  
  /**
   * Sets the value of the SearchResponseUUId field.
   */
  public void setSearchResponseUUId(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(SEARCHRESPONSEUUID_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageDocumentSearchRq_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageDocumentSearchRq_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageDocumentSearchRq_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageDocumentSearchRq_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageDocumentSearchRq_Ext, com.guidewire._generated.entity.ECFMessageDocumentSearchRq_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageDocumentSearchRq_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageDocumentSearchRq_ExtInternal getInternalInterface(entity.ECFMessageDocumentSearchRq_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageDocumentSearchRq_Ext newEmptyInstance() {
        return new entity.ECFMessageDocumentSearchRq_Ext((java.lang.Void)null);
      }
