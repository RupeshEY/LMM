 ...
 * A comment on a Claim for the ECF system
 */
...
public abstract class ECFMessageComment_Ext extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageComment_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageComment_Ext>("entity.ECFMessageComment_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DETAIL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Detail");
  ...
  private com.guidewire._generated.entity.ECFMessageComment_ExtInternal _internal;
  
  public static final gw.pl.persistence.type.DynamicEntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RETIRED_DYNPROP = com.guidewire.pl.domain.persistence.core.RetireablePublicMethods.RETIRED_DYNPROP;
  
  protected ECFMessageComment_Ext(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.ECFMessageComment_ExtInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.ECFMessageComment_ExtInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.ECFMessageComment_Ext value) {
  ...
  static {
    com.guidewire._generated.entity.ECFMessageComment_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.ECFMessageComment_Ext, com.guidewire._generated.entity.ECFMessageComment_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageComment_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageComment_ExtInternal getInternalInterface(entity.ECFMessageComment_Ext bean) {
        if(bean == null) {
          return null;
        };
