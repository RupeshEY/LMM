 ...
 * Document Upload Response subtype for ECF messages
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ECFMessageDocumentUploadRs_Ext.eti;ECFMessageDocumentUploadRs_Ext.eix;ECFMessageDocumentUploadRs_Ext.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ECFMessageDocumentUploadRs_Ext")
public class ECFMessageDocumentUploadRs_Ext extends entity.ECFDocumentMessage_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageDocumentUploadRs_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageDocumentUploadRs_Ext>("entity.ECFMessageDocumentUploadRs_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> UPLOADREQUESTUUID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UploadRequestUUId");
   ...
   */
  public ECFMessageDocumentUploadRs_Ext()  {
   ...
   */
  public ECFMessageDocumentUploadRs_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageDocumentUploadRs_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageDocumentUploadRs_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageDocumentUploadRs_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageDocumentUploadRs_ExtInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the UploadRequestUUId field.
   * UploadRequestUUId - Unique Universal Identifier of the message
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getUploadRequestUUId() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(UPLOADREQUESTUUID_PROP.get());
  }
  
  /**
   * Sets the value of the UploadRequestUUId field.
   */
  public void setUploadRequestUUId(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(UPLOADREQUESTUUID_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageDocumentUploadRs_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageDocumentUploadRs_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageDocumentUploadRs_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageDocumentUploadRs_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageDocumentUploadRs_Ext, com.guidewire._generated.entity.ECFMessageDocumentUploadRs_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageDocumentUploadRs_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageDocumentUploadRs_ExtInternal getInternalInterface(entity.ECFMessageDocumentUploadRs_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageDocumentUploadRs_Ext newEmptyInstance() {
        return new entity.ECFMessageDocumentUploadRs_Ext((java.lang.Void)null);
      }
