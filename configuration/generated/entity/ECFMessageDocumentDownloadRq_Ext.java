 ...
 * Document Download Request subtype for ECF messages
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ECFMessageDocumentDownloadRq_Ext.eti;ECFMessageDocumentDownloadRq_Ext.eix;ECFMessageDocumentDownloadRq_Ext.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ECFMessageDocumentDownloadRq_Ext")
public class ECFMessageDocumentDownloadRq_Ext extends entity.ECFDocumentMessage_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageDocumentDownloadRq_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageDocumentDownloadRq_Ext>("entity.ECFMessageDocumentDownloadRq_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DOWNLOADRESPONSEUUID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DownloadResponseUUId");
   ...
   */
  public ECFMessageDocumentDownloadRq_Ext()  {
   ...
   */
  public ECFMessageDocumentDownloadRq_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageDocumentDownloadRq_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageDocumentDownloadRq_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageDocumentDownloadRq_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageDocumentDownloadRq_ExtInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the DownloadResponseUUId field.
   * DownloadResponseUUId - Unique Universal Identifier of the message
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getDownloadResponseUUId() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(DOWNLOADRESPONSEUUID_PROP.get());
  }
  
  /**
   * Sets the value of the DownloadResponseUUId field.
   */
  public void setDownloadResponseUUId(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(DOWNLOADRESPONSEUUID_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageDocumentDownloadRq_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageDocumentDownloadRq_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageDocumentDownloadRq_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageDocumentDownloadRq_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageDocumentDownloadRq_Ext, com.guidewire._generated.entity.ECFMessageDocumentDownloadRq_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageDocumentDownloadRq_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageDocumentDownloadRq_ExtInternal getInternalInterface(entity.ECFMessageDocumentDownloadRq_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageDocumentDownloadRq_Ext newEmptyInstance() {
        return new entity.ECFMessageDocumentDownloadRq_Ext((java.lang.Void)null);
      }
