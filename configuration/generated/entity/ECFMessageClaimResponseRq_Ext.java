 ...
 * Claim Response Request - Holds the values the user edited on the transaction during this Writeback request
 */
...
@gw.entity.EntityName(value = "ECFMessageClaimResponseRq_Ext")
public class ECFMessageClaimResponseRq_Ext extends entity.ECFMessage_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageClaimResponseRq_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageClaimResponseRq_Ext>("entity.ECFMessageClaimResponseRq_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> AGREEMENTPARTYMODIFICATIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "AgreementPartyModifications");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ALLUNDERWRITERSTOSEEFILEIND_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AllUnderwritersToSeeFileInd");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CAUSEOFLOSSCODE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "CauseOfLossCode");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CLAIMPARTICIPANTROLES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ClaimParticipantRoles");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONTACTCLASSACCOUNTID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ContactClassAccountId");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONTACTCLASSUSERID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ContactClassUserId");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONTACTEMAIL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ContactEmail");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONTACTFAX_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ContactFax");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONTACTTELEPHONE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ContactTelephone");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CONTRACTCONDITIONSAPPLYIND_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ContractConditionsApplyInd");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CURRENCY1_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Currency1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CURRENCY2_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Currency2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CURRENCY3_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Currency3");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> IMPORTEDSERVICESAMOUNT1_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "ImportedServicesAmount1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> IMPORTEDSERVICESAMOUNT1_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ImportedServicesAmount1_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> IMPORTEDSERVICESAMOUNT1_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ImportedServicesAmount1_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> IMPORTEDSERVICESAMOUNT2_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "ImportedServicesAmount2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> IMPORTEDSERVICESAMOUNT2_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ImportedServicesAmount2_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> IMPORTEDSERVICESAMOUNT2_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ImportedServicesAmount2_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> IMPORTEDSERVICESAMOUNT3_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "ImportedServicesAmount3");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> IMPORTEDSERVICESAMOUNT3_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ImportedServicesAmount3_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> IMPORTEDSERVICESAMOUNT3_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ImportedServicesAmount3_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> IMPORTEDSERVICESNARRATIVE1_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ImportedServicesNarrative1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> IMPORTEDSERVICESNARRATIVE2_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ImportedServicesNarrative2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> IMPORTEDSERVICESNARRATIVE3_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ImportedServicesNarrative3");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INSURERTRANSACTIONREFERENCE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "InsurerTransactionReference");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ISSIMULTANEOUSRIPINDICATOR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IsSimultaneousRIPIndicator");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LIRMALEADACTIONS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LIRMALeadActions");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEADCONTACTEMAIL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LeadContactEmail");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEADCONTACTNAME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LeadContactName");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEADCONTACTTELEPHONE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LeadContactTelephone");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> LEADRESERVEAMOUNT1_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "LeadReserveAmount1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEADRESERVEAMOUNT1_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LeadReserveAmount1_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LEADRESERVEAMOUNT1_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LeadReserveAmount1_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> LEADRESERVEAMOUNT2_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "LeadReserveAmount2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEADRESERVEAMOUNT2_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LeadReserveAmount2_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LEADRESERVEAMOUNT2_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LeadReserveAmount2_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> LEADRESERVEAMOUNT3_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "LeadReserveAmount3");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEADRESERVEAMOUNT3_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LeadReserveAmount3_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LEADRESERVEAMOUNT3_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LeadReserveAmount3_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> LEADRESERVEFEES1_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "LeadReserveFees1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEADRESERVEFEES1_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LeadReserveFees1_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LEADRESERVEFEES1_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LeadReserveFees1_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> LEADRESERVEFEES2_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "LeadReserveFees2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEADRESERVEFEES2_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LeadReserveFees2_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LEADRESERVEFEES2_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LeadReserveFees2_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> LEADRESERVEFEES3_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "LeadReserveFees3");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEADRESERVEFEES3_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LeadReserveFees3_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LEADRESERVEFEES3_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LeadReserveFees3_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MINORPRECAUTIONARYINDICATOR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MinorPrecautionaryIndicator");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> OUTSTANDINGQUALIFIERCODE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "OutstandingQualifierCode");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> PARTICIPANTFUNCTION_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ParticipantFunction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PRIVATEFOOTNOTE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PrivateFootnote");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> QUERYREASONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "QueryReasons");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REFERREDUUID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ReferredUUID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REQUESTTOBROKER1_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RequestToBroker1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REQUESTTOBROKER2_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RequestToBroker2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> RESPONSECODE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ResponseCode");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SIMULTANEOUSRIPINDICATOR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "SimultaneousRIPIndicator");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> TARGETCURRENCY1_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "TargetCurrency1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> TARGETCURRENCY2_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "TargetCurrency2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> TARGETCURRENCY3_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "TargetCurrency3");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> VATAMOUNT1_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "VATAmount1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> VATAMOUNT1_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "VATAmount1_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> VATAMOUNT1_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "VATAmount1_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> VATAMOUNT2_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "VATAmount2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> VATAMOUNT2_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "VATAmount2_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> VATAMOUNT2_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "VATAmount2_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> VATAMOUNT3_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "VATAmount3");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> VATAMOUNT3_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "VATAmount3_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> VATAMOUNT3_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "VATAmount3_cur");
   ...
   */
  public ECFMessageClaimResponseRq_Ext()  {
   ...
   */
  public ECFMessageClaimResponseRq_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageClaimResponseRq_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageClaimResponseRq_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageClaimResponseRq_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageClaimResponseRq_ExtInternal)super.__getInternalInterface();
  }
  ...
  public void addToAgreementPartyModifications(entity.ECFResponseAPModification_Ext element) {
    __getInternalInterface().addArrayElement(AGREEMENTPARTYMODIFICATIONS_PROP.get(), element);
  }
  ...
  public void addToClaimParticipantRoles(entity.ECFClaimParticipantRole_Ext element) {
    __getInternalInterface().addArrayElement(CLAIMPARTICIPANTROLES_PROP.get(), element);
  }
  ...
  public void addToQueryReasons(entity.ECFResponseQueryReason_Ext element) {
    __getInternalInterface().addArrayElement(QUERYREASONS_PROP.get(), element);
  }
  ...
  public entity.ECFResponseAPModification_Ext[] getAgreementPartyModifications() {
    return (entity.ECFResponseAPModification_Ext[])__getInternalInterface().getFieldValue(AGREEMENTPARTYMODIFICATIONS_PROP.get());
  }
  ...
  public java.lang.String getAllUnderwritersToSeeFileInd() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ALLUNDERWRITERSTOSEEFILEIND_PROP.get());
  }
  ...
  public typekey.ECFCauseOfLossCode_Ext getCauseOfLossCode() {
    return (typekey.ECFCauseOfLossCode_Ext)__getInternalInterface().getFieldValue(CAUSEOFLOSSCODE_PROP.get());
  }
  ...
  public entity.ECFClaimParticipantRole_Ext[] getClaimParticipantRoles() {
    return (entity.ECFClaimParticipantRole_Ext[])__getInternalInterface().getFieldValue(CLAIMPARTICIPANTROLES_PROP.get());
  }
  ...
  public java.lang.String getContactClassAccountId() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CONTACTCLASSACCOUNTID_PROP.get());
  }
  ...
  public java.lang.String getContactClassUserId() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CONTACTCLASSUSERID_PROP.get());
  }
  ...
  public java.lang.String getContactEmail() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CONTACTEMAIL_PROP.get());
  }
  ...
  public java.lang.String getContactFax() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CONTACTFAX_PROP.get());
  }
  ...
  public java.lang.String getContactTelephone() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CONTACTTELEPHONE_PROP.get());
  }
  ...
  public typekey.ECFContractConditions_Ext getContractConditionsApplyInd() {
    return (typekey.ECFContractConditions_Ext)__getInternalInterface().getFieldValue(CONTRACTCONDITIONSAPPLYIND_PROP.get());
  }
  ...
  public typekey.Currency getCurrency1() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(CURRENCY1_PROP.get());
  }
  ...
  public typekey.Currency getCurrency2() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(CURRENCY2_PROP.get());
  }
  ...
  public typekey.Currency getCurrency3() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(CURRENCY3_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getImportedServicesAmount1() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(IMPORTEDSERVICESAMOUNT1_PROP.get());
  }
  ...
  public java.math.BigDecimal getImportedServicesAmount1_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(IMPORTEDSERVICESAMOUNT1_AMT_PROP.get());
  }
  ...
  public typekey.Currency getImportedServicesAmount1_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(IMPORTEDSERVICESAMOUNT1_CUR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getImportedServicesAmount2() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(IMPORTEDSERVICESAMOUNT2_PROP.get());
  }
  ...
  public java.math.BigDecimal getImportedServicesAmount2_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(IMPORTEDSERVICESAMOUNT2_AMT_PROP.get());
  }
  ...
  public typekey.Currency getImportedServicesAmount2_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(IMPORTEDSERVICESAMOUNT2_CUR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getImportedServicesAmount3() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(IMPORTEDSERVICESAMOUNT3_PROP.get());
  }
  ...
  public java.math.BigDecimal getImportedServicesAmount3_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(IMPORTEDSERVICESAMOUNT3_AMT_PROP.get());
  }
  ...
  public typekey.Currency getImportedServicesAmount3_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(IMPORTEDSERVICESAMOUNT3_CUR_PROP.get());
  }
  ...
  public java.lang.String getImportedServicesNarrative1() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(IMPORTEDSERVICESNARRATIVE1_PROP.get());
  }
  ...
  public java.lang.String getImportedServicesNarrative2() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(IMPORTEDSERVICESNARRATIVE2_PROP.get());
  }
  ...
  public java.lang.String getImportedServicesNarrative3() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(IMPORTEDSERVICESNARRATIVE3_PROP.get());
  }
  ...
  public java.lang.String getInsurerTransactionReference() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(INSURERTRANSACTIONREFERENCE_PROP.get());
  }
  ...
  public java.lang.String getLeadContactEmail() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LEADCONTACTEMAIL_PROP.get());
  }
  ...
  public java.lang.String getLeadContactName() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LEADCONTACTNAME_PROP.get());
  }
  ...
  public java.lang.String getLeadContactTelephone() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LEADCONTACTTELEPHONE_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getLeadReserveAmount1() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(LEADRESERVEAMOUNT1_PROP.get());
  }
  ...
  public java.math.BigDecimal getLeadReserveAmount1_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(LEADRESERVEAMOUNT1_AMT_PROP.get());
  }
  ...
  public typekey.Currency getLeadReserveAmount1_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(LEADRESERVEAMOUNT1_CUR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getLeadReserveAmount2() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(LEADRESERVEAMOUNT2_PROP.get());
  }
  ...
  public java.math.BigDecimal getLeadReserveAmount2_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(LEADRESERVEAMOUNT2_AMT_PROP.get());
  }
  ...
  public typekey.Currency getLeadReserveAmount2_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(LEADRESERVEAMOUNT2_CUR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getLeadReserveAmount3() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(LEADRESERVEAMOUNT3_PROP.get());
  }
  ...
  public java.math.BigDecimal getLeadReserveAmount3_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(LEADRESERVEAMOUNT3_AMT_PROP.get());
  }
  ...
  public typekey.Currency getLeadReserveAmount3_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(LEADRESERVEAMOUNT3_CUR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getLeadReserveFees1() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(LEADRESERVEFEES1_PROP.get());
  }
  ...
  public java.math.BigDecimal getLeadReserveFees1_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(LEADRESERVEFEES1_AMT_PROP.get());
  }
  ...
  public typekey.Currency getLeadReserveFees1_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(LEADRESERVEFEES1_CUR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getLeadReserveFees2() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(LEADRESERVEFEES2_PROP.get());
  }
  ...
  public java.math.BigDecimal getLeadReserveFees2_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(LEADRESERVEFEES2_AMT_PROP.get());
  }
  ...
  public typekey.Currency getLeadReserveFees2_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(LEADRESERVEFEES2_CUR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getLeadReserveFees3() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(LEADRESERVEFEES3_PROP.get());
  }
  ...
  public java.math.BigDecimal getLeadReserveFees3_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(LEADRESERVEFEES3_AMT_PROP.get());
  }
  ...
  public typekey.Currency getLeadReserveFees3_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(LEADRESERVEFEES3_CUR_PROP.get());
  }
  ...
  public java.lang.String getMinorPrecautionaryIndicator() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(MINORPRECAUTIONARYINDICATOR_PROP.get());
  }
  ...
  public typekey.ECFOutstandingQualifierCode_Ext getOutstandingQualifierCode() {
    return (typekey.ECFOutstandingQualifierCode_Ext)__getInternalInterface().getFieldValue(OUTSTANDINGQUALIFIERCODE_PROP.get());
  }
  ...
  public typekey.ECFParticipantFunction_Ext getParticipantFunction() {
    return (typekey.ECFParticipantFunction_Ext)__getInternalInterface().getFieldValue(PARTICIPANTFUNCTION_PROP.get());
  }
  ...
  public java.lang.String getPrivateFootnote() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PRIVATEFOOTNOTE_PROP.get());
  }
  ...
  public entity.ECFResponseQueryReason_Ext[] getQueryReasons() {
    return (entity.ECFResponseQueryReason_Ext[])__getInternalInterface().getFieldValue(QUERYREASONS_PROP.get());
  }
  ...
  public java.lang.String getReferredUUID() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(REFERREDUUID_PROP.get());
  }
  ...
  public java.lang.String getRequestToBroker1() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(REQUESTTOBROKER1_PROP.get());
  }
  ...
  public java.lang.String getRequestToBroker2() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(REQUESTTOBROKER2_PROP.get());
  }
  ...
  public typekey.ECFResponseCode_Ext getResponseCode() {
    return (typekey.ECFResponseCode_Ext)__getInternalInterface().getFieldValue(RESPONSECODE_PROP.get());
  }
  ...
  public java.lang.String getSimultaneousRIPIndicator() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SIMULTANEOUSRIPINDICATOR_PROP.get());
  }
  ...
  public typekey.Currency getTargetCurrency1() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(TARGETCURRENCY1_PROP.get());
  }
  ...
  public typekey.Currency getTargetCurrency2() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(TARGETCURRENCY2_PROP.get());
  }
  ...
  public typekey.Currency getTargetCurrency3() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(TARGETCURRENCY3_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getVATAmount1() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(VATAMOUNT1_PROP.get());
  }
  ...
  public java.math.BigDecimal getVATAmount1_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(VATAMOUNT1_AMT_PROP.get());
  }
  ...
  public typekey.Currency getVATAmount1_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(VATAMOUNT1_CUR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getVATAmount2() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(VATAMOUNT2_PROP.get());
  }
  ...
  public java.math.BigDecimal getVATAmount2_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(VATAMOUNT2_AMT_PROP.get());
  }
  ...
  public typekey.Currency getVATAmount2_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(VATAMOUNT2_CUR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getVATAmount3() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(VATAMOUNT3_PROP.get());
  }
  ...
  public java.math.BigDecimal getVATAmount3_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(VATAMOUNT3_AMT_PROP.get());
  }
  ...
  public typekey.Currency getVATAmount3_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(VATAMOUNT3_CUR_PROP.get());
  }
  ...
  public java.lang.Boolean isIsSimultaneousRIPIndicator() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(ISSIMULTANEOUSRIPINDICATOR_PROP.get());
  }
  ...
  public java.lang.Boolean isLIRMALeadActions() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(LIRMALEADACTIONS_PROP.get());
  }
  ...
  public void removeFromAgreementPartyModifications(entity.ECFResponseAPModification_Ext element) {
    __getInternalInterface().removeArrayElement(AGREEMENTPARTYMODIFICATIONS_PROP.get(), element);
  }
  ...
  public void removeFromAgreementPartyModifications(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(AGREEMENTPARTYMODIFICATIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromClaimParticipantRoles(entity.ECFClaimParticipantRole_Ext element) {
    __getInternalInterface().removeArrayElement(CLAIMPARTICIPANTROLES_PROP.get(), element);
  }
  ...
  public void removeFromClaimParticipantRoles(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CLAIMPARTICIPANTROLES_PROP.get(), elementID);
  }
  ...
  public void removeFromQueryReasons(entity.ECFResponseQueryReason_Ext element) {
    __getInternalInterface().removeArrayElement(QUERYREASONS_PROP.get(), element);
  }
  ...
  public void removeFromQueryReasons(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(QUERYREASONS_PROP.get(), elementID);
  }
  ...
  public void setAgreementPartyModifications(entity.ECFResponseAPModification_Ext[] value) {
    __getInternalInterface().setFieldValue(AGREEMENTPARTYMODIFICATIONS_PROP.get(), value);
  }
  ...
  public void setAllUnderwritersToSeeFileInd(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ALLUNDERWRITERSTOSEEFILEIND_PROP.get(), value);
  }
  ...
  public void setCauseOfLossCode(typekey.ECFCauseOfLossCode_Ext value) {
    __getInternalInterface().setFieldValue(CAUSEOFLOSSCODE_PROP.get(), value);
  }
  ...
  public void setClaimParticipantRoles(entity.ECFClaimParticipantRole_Ext[] value) {
    __getInternalInterface().setFieldValue(CLAIMPARTICIPANTROLES_PROP.get(), value);
  }
  ...
  public void setContactClassAccountId(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CONTACTCLASSACCOUNTID_PROP.get(), value);
  }
  ...
  public void setContactClassUserId(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CONTACTCLASSUSERID_PROP.get(), value);
  }
  ...
  public void setContactEmail(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CONTACTEMAIL_PROP.get(), value);
  }
  ...
  public void setContactFax(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CONTACTFAX_PROP.get(), value);
  }
  ...
  public void setContactTelephone(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CONTACTTELEPHONE_PROP.get(), value);
  }
  ...
  public void setContractConditionsApplyInd(typekey.ECFContractConditions_Ext value) {
    __getInternalInterface().setFieldValue(CONTRACTCONDITIONSAPPLYIND_PROP.get(), value);
  }
  ...
  public void setCurrency1(typekey.Currency value) {
    __getInternalInterface().setFieldValue(CURRENCY1_PROP.get(), value);
  }
  ...
  public void setCurrency2(typekey.Currency value) {
    __getInternalInterface().setFieldValue(CURRENCY2_PROP.get(), value);
  }
  ...
  public void setCurrency3(typekey.Currency value) {
    __getInternalInterface().setFieldValue(CURRENCY3_PROP.get(), value);
  }
  ...
  public void setImportedServicesAmount1(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(IMPORTEDSERVICESAMOUNT1_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ImportedServicesAmount1_amt field.
   */
  private void setImportedServicesAmount1_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(IMPORTEDSERVICESAMOUNT1_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ImportedServicesAmount1_cur field.
   */
  private void setImportedServicesAmount1_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(IMPORTEDSERVICESAMOUNT1_CUR_PROP.get(), value);
  }
  ...
  public void setImportedServicesAmount2(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(IMPORTEDSERVICESAMOUNT2_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ImportedServicesAmount2_amt field.
   */
  private void setImportedServicesAmount2_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(IMPORTEDSERVICESAMOUNT2_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ImportedServicesAmount2_cur field.
   */
  private void setImportedServicesAmount2_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(IMPORTEDSERVICESAMOUNT2_CUR_PROP.get(), value);
  }
  ...
  public void setImportedServicesAmount3(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(IMPORTEDSERVICESAMOUNT3_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ImportedServicesAmount3_amt field.
   */
  private void setImportedServicesAmount3_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(IMPORTEDSERVICESAMOUNT3_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ImportedServicesAmount3_cur field.
   */
  private void setImportedServicesAmount3_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(IMPORTEDSERVICESAMOUNT3_CUR_PROP.get(), value);
  }
  ...
  public void setImportedServicesNarrative1(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(IMPORTEDSERVICESNARRATIVE1_PROP.get(), value);
  }
  ...
  public void setImportedServicesNarrative2(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(IMPORTEDSERVICESNARRATIVE2_PROP.get(), value);
  }
  ...
  public void setImportedServicesNarrative3(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(IMPORTEDSERVICESNARRATIVE3_PROP.get(), value);
  }
  ...
  public void setInsurerTransactionReference(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(INSURERTRANSACTIONREFERENCE_PROP.get(), value);
  }
  ...
  public void setIsSimultaneousRIPIndicator(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(ISSIMULTANEOUSRIPINDICATOR_PROP.get(), value);
  }
  ...
  public void setLIRMALeadActions(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(LIRMALEADACTIONS_PROP.get(), value);
  }
  ...
  public void setLeadContactEmail(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LEADCONTACTEMAIL_PROP.get(), value);
  }
  ...
  public void setLeadContactName(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LEADCONTACTNAME_PROP.get(), value);
  }
  ...
  public void setLeadContactTelephone(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LEADCONTACTTELEPHONE_PROP.get(), value);
  }
  ...
  public void setLeadReserveAmount1(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(LEADRESERVEAMOUNT1_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveAmount1_amt field.
   */
  private void setLeadReserveAmount1_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(LEADRESERVEAMOUNT1_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveAmount1_cur field.
   */
  private void setLeadReserveAmount1_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(LEADRESERVEAMOUNT1_CUR_PROP.get(), value);
  }
  ...
  public void setLeadReserveAmount2(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(LEADRESERVEAMOUNT2_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveAmount2_amt field.
   */
  private void setLeadReserveAmount2_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(LEADRESERVEAMOUNT2_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveAmount2_cur field.
   */
  private void setLeadReserveAmount2_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(LEADRESERVEAMOUNT2_CUR_PROP.get(), value);
  }
  ...
  public void setLeadReserveAmount3(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(LEADRESERVEAMOUNT3_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveAmount3_amt field.
   */
  private void setLeadReserveAmount3_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(LEADRESERVEAMOUNT3_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveAmount3_cur field.
   */
  private void setLeadReserveAmount3_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(LEADRESERVEAMOUNT3_CUR_PROP.get(), value);
  }
  ...
  public void setLeadReserveFees1(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(LEADRESERVEFEES1_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveFees1_amt field.
   */
  private void setLeadReserveFees1_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(LEADRESERVEFEES1_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveFees1_cur field.
   */
  private void setLeadReserveFees1_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(LEADRESERVEFEES1_CUR_PROP.get(), value);
  }
  ...
  public void setLeadReserveFees2(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(LEADRESERVEFEES2_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveFees2_amt field.
   */
  private void setLeadReserveFees2_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(LEADRESERVEFEES2_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveFees2_cur field.
   */
  private void setLeadReserveFees2_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(LEADRESERVEFEES2_CUR_PROP.get(), value);
  }
  ...
  public void setLeadReserveFees3(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(LEADRESERVEFEES3_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveFees3_amt field.
   */
  private void setLeadReserveFees3_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(LEADRESERVEFEES3_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LeadReserveFees3_cur field.
   */
  private void setLeadReserveFees3_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(LEADRESERVEFEES3_CUR_PROP.get(), value);
  }
  ...
  public void setMinorPrecautionaryIndicator(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(MINORPRECAUTIONARYINDICATOR_PROP.get(), value);
  }
  ...
  public void setOutstandingQualifierCode(typekey.ECFOutstandingQualifierCode_Ext value) {
    __getInternalInterface().setFieldValue(OUTSTANDINGQUALIFIERCODE_PROP.get(), value);
  }
  ...
  public void setParticipantFunction(typekey.ECFParticipantFunction_Ext value) {
    __getInternalInterface().setFieldValue(PARTICIPANTFUNCTION_PROP.get(), value);
  }
  ...
  public void setPrivateFootnote(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PRIVATEFOOTNOTE_PROP.get(), value);
  }
  ...
  public void setQueryReasons(entity.ECFResponseQueryReason_Ext[] value) {
    __getInternalInterface().setFieldValue(QUERYREASONS_PROP.get(), value);
  }
  ...
  public void setReferredUUID(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(REFERREDUUID_PROP.get(), value);
  }
  ...
  public void setRequestToBroker1(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(REQUESTTOBROKER1_PROP.get(), value);
  }
  ...
  public void setRequestToBroker2(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(REQUESTTOBROKER2_PROP.get(), value);
  }
  ...
  public void setResponseCode(typekey.ECFResponseCode_Ext value) {
    __getInternalInterface().setFieldValue(RESPONSECODE_PROP.get(), value);
  }
  ...
  public void setSimultaneousRIPIndicator(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(SIMULTANEOUSRIPINDICATOR_PROP.get(), value);
  }
  ...
  public void setTargetCurrency1(typekey.Currency value) {
    __getInternalInterface().setFieldValue(TARGETCURRENCY1_PROP.get(), value);
  }
  ...
  public void setTargetCurrency2(typekey.Currency value) {
    __getInternalInterface().setFieldValue(TARGETCURRENCY2_PROP.get(), value);
  }
  ...
  public void setTargetCurrency3(typekey.Currency value) {
    __getInternalInterface().setFieldValue(TARGETCURRENCY3_PROP.get(), value);
  }
  ...
  public void setVATAmount1(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(VATAMOUNT1_PROP.get(), value);
  }
  
  /**
   * Sets the value of the VATAmount1_amt field.
   */
  private void setVATAmount1_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(VATAMOUNT1_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the VATAmount1_cur field.
   */
  private void setVATAmount1_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(VATAMOUNT1_CUR_PROP.get(), value);
  }
  ...
  public void setVATAmount2(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(VATAMOUNT2_PROP.get(), value);
  }
  
  /**
   * Sets the value of the VATAmount2_amt field.
   */
  private void setVATAmount2_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(VATAMOUNT2_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the VATAmount2_cur field.
   */
  private void setVATAmount2_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(VATAMOUNT2_CUR_PROP.get(), value);
  }
  ...
  public void setVATAmount3(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(VATAMOUNT3_PROP.get(), value);
  }
  
  /**
   * Sets the value of the VATAmount3_amt field.
   */
  private void setVATAmount3_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(VATAMOUNT3_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the VATAmount3_cur field.
   */
  private void setVATAmount3_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(VATAMOUNT3_CUR_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageClaimResponseRq_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageClaimResponseRq_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageClaimResponseRq_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageClaimResponseRq_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageClaimResponseRq_Ext, com.guidewire._generated.entity.ECFMessageClaimResponseRq_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageClaimResponseRq_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageClaimResponseRq_ExtInternal getInternalInterface(entity.ECFMessageClaimResponseRq_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageClaimResponseRq_Ext newEmptyInstance() {
        return new entity.ECFMessageClaimResponseRq_Ext((java.lang.Void)null);
      }
