...
/**
 * ECFMessageClaimDataCarrier_Ext
 * ECF Message Claim Data Carrier
 */
...
@gw.entity.EntityName(value = "ECFMessageClaimDataCarrier_Ext")
public class ECFMessageClaimDataCarrier_Ext extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageClaimDataCarrier_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageClaimDataCarrier_Ext>("entity.ECFMessageClaimDataCarrier_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONSORTIUM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Consortium");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MARKET_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Market");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> MARKETFINANCIALAMOUNTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "MarketFinancialAmounts");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REFERENCE1_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Reference1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REFERENCE2_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Reference2");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SHARE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Share");
  ...
  private com.guidewire._generated.entity.ECFMessageClaimDataCarrier_ExtInternal _internal;
   ...
   */
  public ECFMessageClaimDataCarrier_Ext()  {
   ...
   */
  public ECFMessageClaimDataCarrier_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageClaimDataCarrier_Ext(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ECFMessageClaimDataCarrier_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageClaimDataCarrier_ExtInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToMarketFinancialAmounts(entity.ECFMarketFinancialAmount_Ext element) {
    __getInternalInterface().addArrayElement(MARKETFINANCIALAMOUNTS_PROP.get(), element);
  }
  ...
  public entity.ECFMarketFinancialAmount_Ext[] getMarketFinancialAmounts() {
    return (entity.ECFMarketFinancialAmount_Ext[])__getInternalInterface().getFieldValue(MARKETFINANCIALAMOUNTS_PROP.get());
  }
  ...
  public void removeFromMarketFinancialAmounts(entity.ECFMarketFinancialAmount_Ext element) {
    __getInternalInterface().removeArrayElement(MARKETFINANCIALAMOUNTS_PROP.get(), element);
  }
  ...
  public void removeFromMarketFinancialAmounts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(MARKETFINANCIALAMOUNTS_PROP.get(), elementID);
  }
  ...
  public void setMarketFinancialAmounts(entity.ECFMarketFinancialAmount_Ext[] value) {
    __getInternalInterface().setFieldValue(MARKETFINANCIALAMOUNTS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageClaimDataCarrier_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageClaimDataCarrier_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageClaimDataCarrier_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageClaimDataCarrier_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageClaimDataCarrier_Ext, com.guidewire._generated.entity.ECFMessageClaimDataCarrier_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageClaimDataCarrier_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageClaimDataCarrier_ExtInternal getInternalInterface(entity.ECFMessageClaimDataCarrier_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageClaimDataCarrier_Ext newEmptyInstance() {
        return new entity.ECFMessageClaimDataCarrier_Ext((java.lang.Void)null);
      }
