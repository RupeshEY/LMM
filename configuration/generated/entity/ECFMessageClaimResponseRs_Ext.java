 ...
 * Claim Response Response subtype for ECF messages
 */
...
@gw.entity.EntityName(value = "ECFMessageClaimResponseRs_Ext")
public class ECFMessageClaimResponseRs_Ext extends entity.ECFMessage_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageClaimResponseRs_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageClaimResponseRs_Ext>("entity.ECFMessageClaimResponseRs_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REFERREDMESSAGEUUID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ReferredMessageUUId");
   ...
   */
  public ECFMessageClaimResponseRs_Ext()  {
   ...
   */
  public ECFMessageClaimResponseRs_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageClaimResponseRs_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageClaimResponseRs_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageClaimResponseRs_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageClaimResponseRs_ExtInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getReferredMessageUUId() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(REFERREDMESSAGEUUID_PROP.get());
  }
  ...
  public void setReferredMessageUUId(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(REFERREDMESSAGEUUID_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageClaimResponseRs_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageClaimResponseRs_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageClaimResponseRs_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageClaimResponseRs_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageClaimResponseRs_Ext, com.guidewire._generated.entity.ECFMessageClaimResponseRs_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageClaimResponseRs_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageClaimResponseRs_ExtInternal getInternalInterface(entity.ECFMessageClaimResponseRs_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageClaimResponseRs_Ext newEmptyInstance() {
        return new entity.ECFMessageClaimResponseRs_Ext((java.lang.Void)null);
      }
