 ...
 * Claim Retrieve Request subtype for ECF messages
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ECFMessageClaimRetrieveRq_Ext.eti;ECFMessageClaimRetrieveRq_Ext.eix;ECFMessageClaimRetrieveRq_Ext.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ECFMessageClaimRetrieveRq_Ext")
public class ECFMessageClaimRetrieveRq_Ext extends entity.ECFMessage_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageClaimRetrieveRq_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageClaimRetrieveRq_Ext>("entity.ECFMessageClaimRetrieveRq_Ext");
   ...
   */
  public ECFMessageClaimRetrieveRq_Ext()  {
   ...
   */
  public ECFMessageClaimRetrieveRq_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageClaimRetrieveRq_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageClaimRetrieveRq_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageClaimRetrieveRq_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageClaimRetrieveRq_ExtInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageClaimRetrieveRq_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageClaimRetrieveRq_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageClaimRetrieveRq_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageClaimRetrieveRq_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageClaimRetrieveRq_Ext, com.guidewire._generated.entity.ECFMessageClaimRetrieveRq_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageClaimRetrieveRq_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageClaimRetrieveRq_ExtInternal getInternalInterface(entity.ECFMessageClaimRetrieveRq_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageClaimRetrieveRq_Ext newEmptyInstance() {
        return new entity.ECFMessageClaimRetrieveRq_Ext((java.lang.Void)null);
      }
