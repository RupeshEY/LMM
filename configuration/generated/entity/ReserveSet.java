...
public class ReserveSet extends entity.TransactionSet {
  ...
  /**
   * Adds a new Reserve to this ReserveSet with a status of draft and returns it.  The
   * ReserveLine of this new Reserve is specified by the provided Exposure, CostType and
   * CostCategory.  A NULL Exposure indicates that this is a claim-level Reserve.
   ...
   * @deprecated Use <code>newReserve</code> instead to create a new Reserve
   */
  @java.lang.Deprecated
  public entity.Reserve addNewReserve(entity.Exposure exposure, typekey.CostType costType, typekey.CostCategory costCategory) {
    return ((gw.cc.financials.reserve.entity.ReserveSet)__getDelegateManager().getImplementation("gw.cc.financials.reserve.entity.ReserveSet")).addNewReserve(exposure, costType, costCategory);
  }
