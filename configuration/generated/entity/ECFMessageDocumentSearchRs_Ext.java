 ...
 * Document Search Response subtype for ECF messages
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ECFMessageDocumentSearchRs_Ext.eti;ECFMessageDocumentSearchRs_Ext.eix;ECFMessageDocumentSearchRs_Ext.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ECFMessageDocumentSearchRs_Ext")
public class ECFMessageDocumentSearchRs_Ext extends entity.ECFMessage_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageDocumentSearchRs_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageDocumentSearchRs_Ext>("entity.ECFMessageDocumentSearchRs_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SEARCHREQUESTUUID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "SearchRequestUUId");
   ...
   */
  public ECFMessageDocumentSearchRs_Ext()  {
   ...
   */
  public ECFMessageDocumentSearchRs_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageDocumentSearchRs_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageDocumentSearchRs_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageDocumentSearchRs_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageDocumentSearchRs_ExtInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the SearchRequestUUId field.
   * SearchRequestUUId - Unique Universal Identifier of the message
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getSearchRequestUUId() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SEARCHREQUESTUUID_PROP.get());
  }
  
  /**
   * Sets the value of the SearchRequestUUId field.
   */
  public void setSearchRequestUUId(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(SEARCHREQUESTUUID_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageDocumentSearchRs_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageDocumentSearchRs_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageDocumentSearchRs_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageDocumentSearchRs_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageDocumentSearchRs_Ext, com.guidewire._generated.entity.ECFMessageDocumentSearchRs_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageDocumentSearchRs_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageDocumentSearchRs_ExtInternal getInternalInterface(entity.ECFMessageDocumentSearchRs_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageDocumentSearchRs_Ext newEmptyInstance() {
        return new entity.ECFMessageDocumentSearchRs_Ext((java.lang.Void)null);
      }
