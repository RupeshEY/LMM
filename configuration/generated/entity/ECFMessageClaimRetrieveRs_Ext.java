 ...
 * Claim Retrieve Response subtype for ECF messages
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ECFMessageClaimRetrieveRs_Ext.eti;ECFMessageClaimRetrieveRs_Ext.eix;ECFMessageClaimRetrieveRs_Ext.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ECFMessageClaimRetrieveRs_Ext")
public class ECFMessageClaimRetrieveRs_Ext extends entity.ECFMessageClaimData_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageClaimRetrieveRs_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageClaimRetrieveRs_Ext>("entity.ECFMessageClaimRetrieveRs_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLAIMRETRIEVEREQREFERREDUUID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClaimRetrieveReqReferredUUId");
   ...
   */
  public ECFMessageClaimRetrieveRs_Ext()  {
   ...
   */
  public ECFMessageClaimRetrieveRs_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageClaimRetrieveRs_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageClaimRetrieveRs_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageClaimRetrieveRs_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageClaimRetrieveRs_ExtInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the ClaimRetrieveReqReferredUUId field.
   * ReferredUUId - Unique Universal Identifier of the message identifies RetrieveClaimRq
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getClaimRetrieveReqReferredUUId() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CLAIMRETRIEVEREQREFERREDUUID_PROP.get());
  }
  
  /**
   * Sets the value of the ClaimRetrieveReqReferredUUId field.
   */
  public void setClaimRetrieveReqReferredUUId(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CLAIMRETRIEVEREQREFERREDUUID_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageClaimRetrieveRs_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageClaimRetrieveRs_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageClaimRetrieveRs_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageClaimRetrieveRs_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageClaimRetrieveRs_Ext, com.guidewire._generated.entity.ECFMessageClaimRetrieveRs_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageClaimRetrieveRs_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageClaimRetrieveRs_ExtInternal getInternalInterface(entity.ECFMessageClaimRetrieveRs_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageClaimRetrieveRs_Ext newEmptyInstance() {
        return new entity.ECFMessageClaimRetrieveRs_Ext((java.lang.Void)null);
      }
