 ...
 * Cross market private comment
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ECFMessageCrossMarketPrivateComment_Ext.eti;ECFMessageCrossMarketPrivateComment_Ext.eix;ECFMessageCrossMarketPrivateComment_Ext.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ECFMessageCrossMarketPrivateComment_Ext")
public class ECFMessageCrossMarketPrivateComment_Ext extends entity.ECFMessageCrossMarketComment_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageCrossMarketPrivateComment_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageCrossMarketPrivateComment_Ext>("entity.ECFMessageCrossMarketPrivateComment_Ext");
   ...
   */
  public ECFMessageCrossMarketPrivateComment_Ext()  {
   ...
   */
  public ECFMessageCrossMarketPrivateComment_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageCrossMarketPrivateComment_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageCrossMarketPrivateComment_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageCrossMarketPrivateComment_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageCrossMarketPrivateComment_ExtInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageCrossMarketPrivateComment_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageCrossMarketPrivateComment_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageCrossMarketPrivateComment_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageCrossMarketPrivateComment_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageCrossMarketPrivateComment_Ext, com.guidewire._generated.entity.ECFMessageCrossMarketPrivateComment_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageCrossMarketPrivateComment_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageCrossMarketPrivateComment_ExtInternal getInternalInterface(entity.ECFMessageCrossMarketPrivateComment_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageCrossMarketPrivateComment_Ext newEmptyInstance() {
        return new entity.ECFMessageCrossMarketPrivateComment_Ext((java.lang.Void)null);
      }
