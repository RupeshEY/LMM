 ...
 * Document Upload Request subtype for ECF messages
 */
...
@gw.entity.EntityName(value = "ECFMessageDocumentUploadRq_Ext")
public class ECFMessageDocumentUploadRq_Ext extends entity.ECFDocumentMessage_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageDocumentUploadRq_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageDocumentUploadRq_Ext>("entity.ECFMessageDocumentUploadRq_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> ACCESSPARTIES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "AccessParties");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> UPLOADRESPONSEUUID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UploadResponseUUId");
   ...
   */
  public ECFMessageDocumentUploadRq_Ext()  {
   ...
   */
  public ECFMessageDocumentUploadRq_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageDocumentUploadRq_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageDocumentUploadRq_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageDocumentUploadRq_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageDocumentUploadRq_ExtInternal)super.__getInternalInterface();
  }
  ...
  public void addToAccessParties(entity.ECFMessageDocumentUploadAccessParty_Ext element) {
    __getInternalInterface().addArrayElement(ACCESSPARTIES_PROP.get(), element);
  }
  ...
  public entity.ECFMessageDocumentUploadAccessParty_Ext[] getAccessParties() {
    return (entity.ECFMessageDocumentUploadAccessParty_Ext[])__getInternalInterface().getFieldValue(ACCESSPARTIES_PROP.get());
  }
  ...
  public java.lang.String getUploadResponseUUId() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(UPLOADRESPONSEUUID_PROP.get());
  }
  ...
  public void removeFromAccessParties(entity.ECFMessageDocumentUploadAccessParty_Ext element) {
    __getInternalInterface().removeArrayElement(ACCESSPARTIES_PROP.get(), element);
  }
  ...
  public void removeFromAccessParties(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(ACCESSPARTIES_PROP.get(), elementID);
  }
  ...
  public void setAccessParties(entity.ECFMessageDocumentUploadAccessParty_Ext[] value) {
    __getInternalInterface().setFieldValue(ACCESSPARTIES_PROP.get(), value);
  }
  ...
  public void setUploadResponseUUId(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(UPLOADRESPONSEUUID_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageDocumentUploadRq_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageDocumentUploadRq_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageDocumentUploadRq_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageDocumentUploadRq_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageDocumentUploadRq_Ext, com.guidewire._generated.entity.ECFMessageDocumentUploadRq_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageDocumentUploadRq_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageDocumentUploadRq_ExtInternal getInternalInterface(entity.ECFMessageDocumentUploadRq_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageDocumentUploadRq_Ext newEmptyInstance() {
        return new entity.ECFMessageDocumentUploadRq_Ext((java.lang.Void)null);
      }
