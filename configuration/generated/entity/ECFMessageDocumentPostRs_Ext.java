 ...
 * Receipt message received after sending an IMR request message
 */
...
@gw.entity.EntityName(value = "ECFMessageDocumentPostRs_Ext")
public class ECFMessageDocumentPostRs_Ext extends entity.ECFDocumentMessage_Ext {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ECFMessageDocumentPostRs_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ECFMessageDocumentPostRs_Ext>("entity.ECFMessageDocumentPostRs_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> OPERATIONSTATUS_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "OperationStatus");
   ...
   */
  public ECFMessageDocumentPostRs_Ext()  {
   ...
   */
  public ECFMessageDocumentPostRs_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ECFMessageDocumentPostRs_Ext(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ECFMessageDocumentPostRs_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ECFMessageDocumentPostRs_ExtInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ECFMessageDocumentPostRs_ExtInternal)super.__getInternalInterface();
  }
  ...
  public typekey.ECFDocumentMsgStatus_Ext getOperationStatus() {
    return (typekey.ECFDocumentMsgStatus_Ext)__getInternalInterface().getFieldValue(OPERATIONSTATUS_PROP.get());
  }
  ...
  public void setOperationStatus(typekey.ECFDocumentMsgStatus_Ext value) {
    __getInternalInterface().setFieldValue(OPERATIONSTATUS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ECFMessageDocumentPostRs_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ECFMessageDocumentPostRs_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ECFMessageDocumentPostRs_Ext.class, config);
    com.guidewire._generated.entity.ECFMessageDocumentPostRs_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ECFMessageDocumentPostRs_Ext, com.guidewire._generated.entity.ECFMessageDocumentPostRs_ExtInternal>() {
      public java.lang.Object getImplementation(entity.ECFMessageDocumentPostRs_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ECFMessageDocumentPostRs_ExtInternal getInternalInterface(entity.ECFMessageDocumentPostRs_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ECFMessageDocumentPostRs_Ext newEmptyInstance() {
        return new entity.ECFMessageDocumentPostRs_Ext((java.lang.Void)null);
      }
