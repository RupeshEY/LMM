...
public final class TermOfOffice extends gw.xml.XmlElement {
  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "TermOfOffice", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.TermOfOffice" );
    }
  };
  ...
  public TermOfOffice() {
    super( -1719265421, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.acord.types.complex.DURATION() );
  }

  public TermOfOffice( xsd.acord.types.complex.DURATION typeInstance ) {
    super( -1719265421, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private TermOfOffice( gw.internal.xml.XmlElementState state ) {
    super( -1719265421, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.acord.TermOfOffice> get$Class() {
    return getClass();
  }
  ...
  public static xsd.acord.TermOfOffice parse( byte[] bytes ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), bytes, null ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( byte[] bytes, gw.xml.XmlParseOptions options ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), bytes, options ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.io.File file ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), file, null ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.io.File file, gw.xml.XmlParseOptions options ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), file, options ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.io.InputStream stream ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), stream, null ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.io.InputStream stream, gw.xml.XmlParseOptions options ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), stream, options ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.io.Reader reader ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), reader, null ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.io.Reader reader, gw.xml.XmlParseOptions options ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), reader, options ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.lang.String xmlString ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), xmlString, null ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.lang.String xmlString, gw.xml.XmlParseOptions options ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), xmlString, options ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.net.URL url ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), url, null ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.net.URL url, gw.xml.XmlParseOptions options ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), url, options ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.nio.file.Path path ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), path, null ).cast( xsd.acord.TermOfOffice.class );
  }

  public static xsd.acord.TermOfOffice parse( java.nio.file.Path path, gw.xml.XmlParseOptions options ) {
    return gw.internal.xml.XmlElementInternals.instance().cg_parse( TYPE.get(), path, options ).cast( xsd.acord.TermOfOffice.class );
  }
