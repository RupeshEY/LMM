...
public final class OtherOrPriorPolicy_Type_InsuredNameRef {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "InsuredNameRef", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.anonymous.attributes.OtherOrPriorPolicy_Type_InsuredNameRef" );
    }
  };

  // disable public constructor
  private OtherOrPriorPolicy_Type_InsuredNameRef() {
  }
