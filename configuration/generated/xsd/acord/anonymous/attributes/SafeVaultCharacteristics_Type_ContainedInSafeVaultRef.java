...
public final class SafeVaultCharacteristics_Type_ContainedInSafeVaultRef {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ContainedInSafeVaultRef", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.anonymous.attributes.SafeVaultCharacteristics_Type_ContainedInSafeVaultRef" );
    }
  };

  // disable public constructor
  private SafeVaultCharacteristics_Type_ContainedInSafeVaultRef() {
  }
