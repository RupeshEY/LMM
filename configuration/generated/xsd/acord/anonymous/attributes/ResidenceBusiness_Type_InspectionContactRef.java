...
public final class ResidenceBusiness_Type_InspectionContactRef {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "InspectionContactRef", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.anonymous.attributes.ResidenceBusiness_Type_InspectionContactRef" );
    }
  };

  // disable public constructor
  private ResidenceBusiness_Type_InspectionContactRef() {
  }
