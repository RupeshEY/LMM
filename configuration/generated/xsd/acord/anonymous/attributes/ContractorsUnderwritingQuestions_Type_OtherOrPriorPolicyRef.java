...
public final class ContractorsUnderwritingQuestions_Type_OtherOrPriorPolicyRef {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "OtherOrPriorPolicyRef", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.anonymous.attributes.ContractorsUnderwritingQuestions_Type_OtherOrPriorPolicyRef" );
    }
  };

  // disable public constructor
  private ContractorsUnderwritingQuestions_Type_OtherOrPriorPolicyRef() {
  }
