...
public final class CreditScoreInfo_Type_InsuredOrPrincipalRef {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "InsuredOrPrincipalRef", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.anonymous.attributes.CreditScoreInfo_Type_InsuredOrPrincipalRef" );
    }
  };

  // disable public constructor
  private CreditScoreInfo_Type_InsuredOrPrincipalRef() {
  }
