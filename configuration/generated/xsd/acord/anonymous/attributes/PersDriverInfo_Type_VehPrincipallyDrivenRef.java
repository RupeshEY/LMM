...
public final class PersDriverInfo_Type_VehPrincipallyDrivenRef {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "VehPrincipallyDrivenRef", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.anonymous.attributes.PersDriverInfo_Type_VehPrincipallyDrivenRef" );
    }
  };

  // disable public constructor
  private PersDriverInfo_Type_VehPrincipallyDrivenRef() {
  }
