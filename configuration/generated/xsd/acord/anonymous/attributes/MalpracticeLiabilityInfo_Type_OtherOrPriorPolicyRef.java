...
public final class MalpracticeLiabilityInfo_Type_OtherOrPriorPolicyRef {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.anonymous.attributes.MalpracticeLiabilityInfo_Type_OtherOrPriorPolicyRef" );
    }
  };

  // disable public constructor
  private MalpracticeLiabilityInfo_Type_OtherOrPriorPolicyRef() {
  }
