...
public final class HeatingUnitInfo_Type_CertifyingPartyRef {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CertifyingPartyRef", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.anonymous.attributes.HeatingUnitInfo_Type_CertifyingPartyRef" );
    }
  };

  // disable public constructor
  private HeatingUnitInfo_Type_CertifyingPartyRef() {
  }
