...
public enum Usage implements gw.xml.IXmlSchemaEnumValue {
  Opt( "Opt" ),
  OptRepeat( "OptRepeat" ),
  Req( "Req" ),
  ReqRepeat( "ReqRepeat" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Usage" );
    }
  };

  private final java.lang.String _stringValue;

  private Usage( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Usage forValue( java.lang.String value ) {
    return (xsd.acord.enums.Usage) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Usage forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Usage) TYPE.get().cg_forValue( value );
  }
