...
public enum Response implements gw.xml.IXmlSchemaEnumValue {
  NA( "NA" ),
  NO( "NO" ),
  NOTANS( "NOTANS" ),
  YES( "YES" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Response" );
    }
  };

  private final java.lang.String _stringValue;

  private Response( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Response forValue( java.lang.String value ) {
    return (xsd.acord.enums.Response) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Response forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Response) TYPE.get().cg_forValue( value );
  }
