...
public enum WorkPerformed implements gw.xml.IXmlSchemaEnumValue {
  BOTH( "BOTH" ),
  INSIDE( "INSIDE" ),
  OUTSIDE( "OUTSIDE" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.WorkPerformed" );
    }
  };

  private final java.lang.String _stringValue;

  private WorkPerformed( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.WorkPerformed forValue( java.lang.String value ) {
    return (xsd.acord.enums.WorkPerformed) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.WorkPerformed forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.WorkPerformed) TYPE.get().cg_forValue( value );
  }
