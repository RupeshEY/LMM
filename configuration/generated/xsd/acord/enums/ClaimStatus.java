...
public enum ClaimStatus implements gw.xml.IXmlSchemaEnumValue {
  C( "C" ),
  D( "D" ),
  O( "O" ),
  OT( "OT" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ClaimStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private ClaimStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ClaimStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.ClaimStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ClaimStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ClaimStatus) TYPE.get().cg_forValue( value );
  }
