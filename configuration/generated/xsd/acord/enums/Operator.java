...
public enum Operator implements gw.xml.IXmlSchemaEnumValue {
  Insured( "Insured" ),
  OtherThanInsured( "OtherThanInsured" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Operator" );
    }
  };

  private final java.lang.String _stringValue;

  private Operator( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Operator forValue( java.lang.String value ) {
    return (xsd.acord.enums.Operator) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Operator forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Operator) TYPE.get().cg_forValue( value );
  }
