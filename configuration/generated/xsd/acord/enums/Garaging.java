...
public enum Garaging implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  B( "B" ),
  C( "C" ),
  CP( "CP" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Garaging" );
    }
  };

  private final java.lang.String _stringValue;

  private Garaging( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Garaging forValue( java.lang.String value ) {
    return (xsd.acord.enums.Garaging) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Garaging forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Garaging) TYPE.get().cg_forValue( value );
  }
