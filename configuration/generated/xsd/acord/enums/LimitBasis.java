...
public enum LimitBasis implements gw.xml.IXmlSchemaEnumValue {
  Excess( "Excess" ),
  Incl( "Incl" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.LimitBasis" );
    }
  };

  private final java.lang.String _stringValue;

  private LimitBasis( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.LimitBasis forValue( java.lang.String value ) {
    return (xsd.acord.enums.LimitBasis) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.LimitBasis forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.LimitBasis) TYPE.get().cg_forValue( value );
  }
