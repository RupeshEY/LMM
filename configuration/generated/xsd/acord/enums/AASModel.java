...
public enum AASModel implements gw.xml.IXmlSchemaEnumValue {
  ASP( "ASP" ),
  LAN( "LAN" ),
  LOC( "LOC" ),
  OT( "OT" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AASModel" );
    }
  };

  private final java.lang.String _stringValue;

  private AASModel( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AASModel forValue( java.lang.String value ) {
    return (xsd.acord.enums.AASModel) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AASModel forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AASModel) TYPE.get().cg_forValue( value );
  }
