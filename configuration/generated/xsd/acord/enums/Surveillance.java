...
public enum Surveillance implements gw.xml.IXmlSchemaEnumValue {
  CCTV( "CCTV" ),
  SecPatrol( "SecPatrol" ),
  Video( "Video" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Surveillance" );
    }
  };

  private final java.lang.String _stringValue;

  private Surveillance( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Surveillance forValue( java.lang.String value ) {
    return (xsd.acord.enums.Surveillance) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Surveillance forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Surveillance) TYPE.get().cg_forValue( value );
  }
