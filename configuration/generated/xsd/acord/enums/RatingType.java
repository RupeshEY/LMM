...
public enum RatingType implements gw.xml.IXmlSchemaEnumValue {
  _1( "1" ),
  _1A( "1A" ),
  _2( "2" ),
  _3( "3" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RatingType" );
    }
  };

  private final java.lang.String _stringValue;

  private RatingType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RatingType forValue( java.lang.String value ) {
    return (xsd.acord.enums.RatingType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RatingType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RatingType) TYPE.get().cg_forValue( value );
  }
