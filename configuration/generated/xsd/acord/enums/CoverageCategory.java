...
public enum CoverageCategory implements gw.xml.IXmlSchemaEnumValue {
  L( "L" ),
  P( "P" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CoverageCategory" );
    }
  };

  private final java.lang.String _stringValue;

  private CoverageCategory( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CoverageCategory forValue( java.lang.String value ) {
    return (xsd.acord.enums.CoverageCategory) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CoverageCategory forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CoverageCategory) TYPE.get().cg_forValue( value );
  }
