...
public enum WatchPersonFactorCredit implements gw.xml.IXmlSchemaEnumValue {
  C2( "C2" ),
  C3( "C3" ),
  CH( "CH" ),
  CM( "CM" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.WatchPersonFactorCredit" );
    }
  };

  private final java.lang.String _stringValue;

  private WatchPersonFactorCredit( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.WatchPersonFactorCredit forValue( java.lang.String value ) {
    return (xsd.acord.enums.WatchPersonFactorCredit) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.WatchPersonFactorCredit forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.WatchPersonFactorCredit) TYPE.get().cg_forValue( value );
  }
