...
public enum BusinessOwnerStatus implements gw.xml.IXmlSchemaEnumValue {
  AB( "AB" ),
  AO( "AO" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.BusinessOwnerStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private BusinessOwnerStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.BusinessOwnerStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.BusinessOwnerStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.BusinessOwnerStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.BusinessOwnerStatus) TYPE.get().cg_forValue( value );
  }
