...
public enum TieDown implements gw.xml.IXmlSchemaEnumValue {
  C( "C" ),
  F( "F" ),
  NONE( "NONE" ),
  O( "O" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.TieDown" );
    }
  };

  private final java.lang.String _stringValue;

  private TieDown( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.TieDown forValue( java.lang.String value ) {
    return (xsd.acord.enums.TieDown) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.TieDown forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.TieDown) TYPE.get().cg_forValue( value );
  }
