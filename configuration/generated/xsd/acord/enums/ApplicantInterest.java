...
public enum ApplicantInterest implements gw.xml.IXmlSchemaEnumValue {
  LESSEE( "LESSEE" ),
  OT( "OT" ),
  OWNER( "OWNER" ),
  TENANT( "TENANT" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ApplicantInterest" );
    }
  };

  private final java.lang.String _stringValue;

  private ApplicantInterest( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ApplicantInterest forValue( java.lang.String value ) {
    return (xsd.acord.enums.ApplicantInterest) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ApplicantInterest forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ApplicantInterest) TYPE.get().cg_forValue( value );
  }
