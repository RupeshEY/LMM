...
public enum AuditMethodType implements gw.xml.IXmlSchemaEnumValue {
  Internet( "Internet" ),
  Mail( "Mail" ),
  Physical( "Physical" ),
  Telephone( "Telephone" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AuditMethodType" );
    }
  };

  private final java.lang.String _stringValue;

  private AuditMethodType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AuditMethodType forValue( java.lang.String value ) {
    return (xsd.acord.enums.AuditMethodType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AuditMethodType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AuditMethodType) TYPE.get().cg_forValue( value );
  }
