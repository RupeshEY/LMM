...
public enum AuditSource implements gw.xml.IXmlSchemaEnumValue {
  CPA( "CPA" ),
  Independent( "Independent" ),
  Insured( "Insured" ),
  PublicAccountant( "PublicAccountant" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AuditSource" );
    }
  };

  private final java.lang.String _stringValue;

  private AuditSource( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AuditSource forValue( java.lang.String value ) {
    return (xsd.acord.enums.AuditSource) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AuditSource forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AuditSource) TYPE.get().cg_forValue( value );
  }
