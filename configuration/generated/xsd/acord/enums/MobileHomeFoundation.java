...
public enum MobileHomeFoundation implements gw.xml.IXmlSchemaEnumValue {
  M( "M" ),
  O( "O" ),
  P( "P" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.MobileHomeFoundation" );
    }
  };

  private final java.lang.String _stringValue;

  private MobileHomeFoundation( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.MobileHomeFoundation forValue( java.lang.String value ) {
    return (xsd.acord.enums.MobileHomeFoundation) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.MobileHomeFoundation forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.MobileHomeFoundation) TYPE.get().cg_forValue( value );
  }
