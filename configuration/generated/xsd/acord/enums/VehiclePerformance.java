...
public enum VehiclePerformance implements gw.xml.IXmlSchemaEnumValue {
  BASIC( "BASIC" ),
  H( "H" ),
  INMDT( "INMDT" ),
  P( "P" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.VehiclePerformance" );
    }
  };

  private final java.lang.String _stringValue;

  private VehiclePerformance( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.VehiclePerformance forValue( java.lang.String value ) {
    return (xsd.acord.enums.VehiclePerformance) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.VehiclePerformance forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.VehiclePerformance) TYPE.get().cg_forValue( value );
  }
