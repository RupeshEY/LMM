...
public enum ThresholdType implements gw.xml.IXmlSchemaEnumValue {
  DT( "DT" ),
  NT( "NT" ),
  VT( "VT" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ThresholdType" );
    }
  };

  private final java.lang.String _stringValue;

  private ThresholdType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ThresholdType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ThresholdType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ThresholdType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ThresholdType) TYPE.get().cg_forValue( value );
  }
