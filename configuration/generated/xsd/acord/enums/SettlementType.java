...
public enum SettlementType implements gw.xml.IXmlSchemaEnumValue {
  ACV( "ACV" ),
  AGR( "AGR" ),
  REP( "REP" ),
  RR( "RR" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SettlementType" );
    }
  };

  private final java.lang.String _stringValue;

  private SettlementType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SettlementType forValue( java.lang.String value ) {
    return (xsd.acord.enums.SettlementType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SettlementType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SettlementType) TYPE.get().cg_forValue( value );
  }
