...
public enum BondTerms implements gw.xml.IXmlSchemaEnumValue {
  CON( "CON" ),
  NRN( "NRN" ),
  REN( "REN" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.BondTerms" );
    }
  };

  private final java.lang.String _stringValue;

  private BondTerms( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.BondTerms forValue( java.lang.String value ) {
    return (xsd.acord.enums.BondTerms) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.BondTerms forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.BondTerms) TYPE.get().cg_forValue( value );
  }
