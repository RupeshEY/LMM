...
public enum EmployeeSubjectTo implements gw.xml.IXmlSchemaEnumValue {
  FELA( "FELA" ),
  JONES( "JONES" ),
  OTHER( "OTHER" ),
  STOPG( "STOPG" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EmployeeSubjectTo" );
    }
  };

  private final java.lang.String _stringValue;

  private EmployeeSubjectTo( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EmployeeSubjectTo forValue( java.lang.String value ) {
    return (xsd.acord.enums.EmployeeSubjectTo) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EmployeeSubjectTo forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EmployeeSubjectTo) TYPE.get().cg_forValue( value );
  }
