...
public enum DriverUse implements gw.xml.IXmlSchemaEnumValue {
  Excluded( "Excluded" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DriverUse" );
    }
  };

  private final java.lang.String _stringValue;

  private DriverUse( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DriverUse forValue( java.lang.String value ) {
    return (xsd.acord.enums.DriverUse) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DriverUse forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DriverUse) TYPE.get().cg_forValue( value );
  }
