...
public enum VacantOccupiedIndicator implements gw.xml.IXmlSchemaEnumValue {
  OCC( "OCC" ),
  UNO( "UNO" ),
  VAC( "VAC" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.VacantOccupiedIndicator" );
    }
  };

  private final java.lang.String _stringValue;

  private VacantOccupiedIndicator( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.VacantOccupiedIndicator forValue( java.lang.String value ) {
    return (xsd.acord.enums.VacantOccupiedIndicator) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.VacantOccupiedIndicator forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.VacantOccupiedIndicator) TYPE.get().cg_forValue( value );
  }
