...
public enum BinderPurpose implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  E( "E" ),
  N( "N" ),
  R( "R" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.BinderPurpose" );
    }
  };

  private final java.lang.String _stringValue;

  private BinderPurpose( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.BinderPurpose forValue( java.lang.String value ) {
    return (xsd.acord.enums.BinderPurpose) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.BinderPurpose forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.BinderPurpose) TYPE.get().cg_forValue( value );
  }
