...
public enum FuelTank implements gw.xml.IXmlSchemaEnumValue {
  F( "F" ),
  MT( "MT" ),
  OT( "OT" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.FuelTank" );
    }
  };

  private final java.lang.String _stringValue;

  private FuelTank( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.FuelTank forValue( java.lang.String value ) {
    return (xsd.acord.enums.FuelTank) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.FuelTank forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.FuelTank) TYPE.get().cg_forValue( value );
  }
