...
public enum OccupancyType implements gw.xml.IXmlSchemaEnumValue {
  COC( "COC" ),
  OCC( "OCC" ),
  OT( "OT" ),
  OWNER( "OWNER" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.OccupancyType" );
    }
  };

  private final java.lang.String _stringValue;

  private OccupancyType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.OccupancyType forValue( java.lang.String value ) {
    return (xsd.acord.enums.OccupancyType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.OccupancyType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.OccupancyType) TYPE.get().cg_forValue( value );
  }
