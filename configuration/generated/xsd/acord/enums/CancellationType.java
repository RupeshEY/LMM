...
public enum CancellationType implements gw.xml.IXmlSchemaEnumValue {
  FE( "FE" ),
  FL( "FL" ),
  PR( "PR" ),
  SR( "SR" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CancellationType" );
    }
  };

  private final java.lang.String _stringValue;

  private CancellationType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CancellationType forValue( java.lang.String value ) {
    return (xsd.acord.enums.CancellationType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CancellationType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CancellationType) TYPE.get().cg_forValue( value );
  }
