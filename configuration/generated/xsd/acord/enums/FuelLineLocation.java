...
public enum FuelLineLocation implements gw.xml.IXmlSchemaEnumValue {
  F( "F" ),
  U( "U" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.FuelLineLocation" );
    }
  };

  private final java.lang.String _stringValue;

  private FuelLineLocation( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.FuelLineLocation forValue( java.lang.String value ) {
    return (xsd.acord.enums.FuelLineLocation) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.FuelLineLocation forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.FuelLineLocation) TYPE.get().cg_forValue( value );
  }
