...
public enum AuditRendered implements gw.xml.IXmlSchemaEnumValue {
  BOD( "BOD" ),
  PART( "PART" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AuditRendered" );
    }
  };

  private final java.lang.String _stringValue;

  private AuditRendered( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AuditRendered forValue( java.lang.String value ) {
    return (xsd.acord.enums.AuditRendered) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AuditRendered forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AuditRendered) TYPE.get().cg_forValue( value );
  }
