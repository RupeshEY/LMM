...
public enum WCClaimType implements gw.xml.IXmlSchemaEnumValue {
  BecameMed( "BecameMed" ),
  Indemnity( "Indemnity" ),
  LostTime( "LostTime" ),
  Medical( "Medical" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.WCClaimType" );
    }
  };

  private final java.lang.String _stringValue;

  private WCClaimType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.WCClaimType forValue( java.lang.String value ) {
    return (xsd.acord.enums.WCClaimType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.WCClaimType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.WCClaimType) TYPE.get().cg_forValue( value );
  }
