...
public enum DistanceType implements gw.xml.IXmlSchemaEnumValue {
  Average( "Average" ),
  Maximum( "Maximum" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DistanceType" );
    }
  };

  private final java.lang.String _stringValue;

  private DistanceType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DistanceType forValue( java.lang.String value ) {
    return (xsd.acord.enums.DistanceType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DistanceType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DistanceType) TYPE.get().cg_forValue( value );
  }
