...
public enum SystemType implements gw.xml.IXmlSchemaEnumValue {
  AAS( "AAS" ),
  RATE( "RATE" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SystemType" );
    }
  };

  private final java.lang.String _stringValue;

  private SystemType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SystemType forValue( java.lang.String value ) {
    return (xsd.acord.enums.SystemType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SystemType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SystemType) TYPE.get().cg_forValue( value );
  }
