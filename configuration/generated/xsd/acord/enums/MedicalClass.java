...
public enum MedicalClass implements gw.xml.IXmlSchemaEnumValue {
  I( "I" ),
  II( "II" ),
  III( "III" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.MedicalClass" );
    }
  };

  private final java.lang.String _stringValue;

  private MedicalClass( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.MedicalClass forValue( java.lang.String value ) {
    return (xsd.acord.enums.MedicalClass) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.MedicalClass forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.MedicalClass) TYPE.get().cg_forValue( value );
  }
