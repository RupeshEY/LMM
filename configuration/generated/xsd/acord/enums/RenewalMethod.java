...
public enum RenewalMethod implements gw.xml.IXmlSchemaEnumValue {
  AT( "AT" ),
  CR( "CR" ),
  MS( "MS" ),
  NB( "NB" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RenewalMethod" );
    }
  };

  private final java.lang.String _stringValue;

  private RenewalMethod( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RenewalMethod forValue( java.lang.String value ) {
    return (xsd.acord.enums.RenewalMethod) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RenewalMethod forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RenewalMethod) TYPE.get().cg_forValue( value );
  }
