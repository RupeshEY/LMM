...
public enum PremiumType implements gw.xml.IXmlSchemaEnumValue {
  AUDIT( "AUDIT" ),
  EST( "EST" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PremiumType" );
    }
  };

  private final java.lang.String _stringValue;

  private PremiumType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PremiumType forValue( java.lang.String value ) {
    return (xsd.acord.enums.PremiumType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PremiumType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PremiumType) TYPE.get().cg_forValue( value );
  }
