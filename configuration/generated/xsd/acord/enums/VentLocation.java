...
public enum VentLocation implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  B( "B" ),
  S( "S" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.VentLocation" );
    }
  };

  private final java.lang.String _stringValue;

  private VentLocation( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.VentLocation forValue( java.lang.String value ) {
    return (xsd.acord.enums.VentLocation) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.VentLocation forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.VentLocation) TYPE.get().cg_forValue( value );
  }
