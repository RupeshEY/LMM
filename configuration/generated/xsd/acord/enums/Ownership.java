...
public enum Ownership implements gw.xml.IXmlSchemaEnumValue {
  Leased( "Leased" ),
  OWNED( "OWNED" ),
  RENTD( "RENTD" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Ownership" );
    }
  };

  private final java.lang.String _stringValue;

  private Ownership( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Ownership forValue( java.lang.String value ) {
    return (xsd.acord.enums.Ownership) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Ownership forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Ownership) TYPE.get().cg_forValue( value );
  }
