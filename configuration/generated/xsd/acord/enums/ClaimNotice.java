...
public enum ClaimNotice implements gw.xml.IXmlSchemaEnumValue {
  CGM( "CGM" ),
  OCCUR( "OCCUR" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ClaimNotice" );
    }
  };

  private final java.lang.String _stringValue;

  private ClaimNotice( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ClaimNotice forValue( java.lang.String value ) {
    return (xsd.acord.enums.ClaimNotice) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ClaimNotice forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ClaimNotice) TYPE.get().cg_forValue( value );
  }
