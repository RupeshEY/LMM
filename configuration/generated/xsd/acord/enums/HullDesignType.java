...
public enum HullDesignType implements gw.xml.IXmlSchemaEnumValue {
  C( "C" ),
  F( "F" ),
  OT( "OT" ),
  R( "R" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.HullDesignType" );
    }
  };

  private final java.lang.String _stringValue;

  private HullDesignType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.HullDesignType forValue( java.lang.String value ) {
    return (xsd.acord.enums.HullDesignType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.HullDesignType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.HullDesignType) TYPE.get().cg_forValue( value );
  }
