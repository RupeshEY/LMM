...
public enum VehInspectionExemption implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  B( "B" ),
  C( "C" ),
  D( "D" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.VehInspectionExemption" );
    }
  };

  private final java.lang.String _stringValue;

  private VehInspectionExemption( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.VehInspectionExemption forValue( java.lang.String value ) {
    return (xsd.acord.enums.VehInspectionExemption) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.VehInspectionExemption forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.VehInspectionExemption) TYPE.get().cg_forValue( value );
  }
