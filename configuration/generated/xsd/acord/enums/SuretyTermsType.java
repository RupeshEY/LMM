...
public enum SuretyTermsType implements gw.xml.IXmlSchemaEnumValue {
  ADPAY( "ADPAY" ),
  ANBBD( "ANBBD" ),
  B( "B" ),
  C( "C" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SuretyTermsType" );
    }
  };

  private final java.lang.String _stringValue;

  private SuretyTermsType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SuretyTermsType forValue( java.lang.String value ) {
    return (xsd.acord.enums.SuretyTermsType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SuretyTermsType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SuretyTermsType) TYPE.get().cg_forValue( value );
  }
