...
public enum ApplicantLiability implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  B( "B" ),
  C( "C" ),
  OT( "OT" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ApplicantLiability" );
    }
  };

  private final java.lang.String _stringValue;

  private ApplicantLiability( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ApplicantLiability forValue( java.lang.String value ) {
    return (xsd.acord.enums.ApplicantLiability) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ApplicantLiability forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ApplicantLiability) TYPE.get().cg_forValue( value );
  }
