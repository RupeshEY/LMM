...
public enum OperationsType implements gw.xml.IXmlSchemaEnumValue {
  CHART( "CHART" ),
  ENGOVH( "ENGOVH" ),
  FUEL( "FUEL" ),
  HELR( "HELR" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.OperationsType" );
    }
  };

  private final java.lang.String _stringValue;

  private OperationsType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.OperationsType forValue( java.lang.String value ) {
    return (xsd.acord.enums.OperationsType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.OperationsType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.OperationsType) TYPE.get().cg_forValue( value );
  }
