...
public enum ReasonLiabilityRefused implements gw.xml.IXmlSchemaEnumValue {
  PG( "PG" ),
  RGL( "RGL" ),
  RGP( "RGP" ),
  SRGL( "SRGL" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ReasonLiabilityRefused" );
    }
  };

  private final java.lang.String _stringValue;

  private ReasonLiabilityRefused( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ReasonLiabilityRefused forValue( java.lang.String value ) {
    return (xsd.acord.enums.ReasonLiabilityRefused) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ReasonLiabilityRefused forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ReasonLiabilityRefused) TYPE.get().cg_forValue( value );
  }
