...
public enum FormType implements gw.xml.IXmlSchemaEnumValue {
  CO( "CO" ),
  DWELL( "DWELL" ),
  GENERAL( "GENERAL" ),
  OT( "OT" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.FormType" );
    }
  };

  private final java.lang.String _stringValue;

  private FormType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.FormType forValue( java.lang.String value ) {
    return (xsd.acord.enums.FormType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.FormType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.FormType) TYPE.get().cg_forValue( value );
  }
