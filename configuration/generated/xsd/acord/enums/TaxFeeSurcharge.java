...
public enum TaxFeeSurcharge implements gw.xml.IXmlSchemaEnumValue {
  Fee( "Fee" ),
  Surcharge( "Surcharge" ),
  Tax( "Tax" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.TaxFeeSurcharge" );
    }
  };

  private final java.lang.String _stringValue;

  private TaxFeeSurcharge( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.TaxFeeSurcharge forValue( java.lang.String value ) {
    return (xsd.acord.enums.TaxFeeSurcharge) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.TaxFeeSurcharge forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.TaxFeeSurcharge) TYPE.get().cg_forValue( value );
  }
