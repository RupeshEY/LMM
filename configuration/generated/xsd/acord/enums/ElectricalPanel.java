...
public enum ElectricalPanel implements gw.xml.IXmlSchemaEnumValue {
  CIRC( "CIRC" ),
  FUSE( "FUSE" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ElectricalPanel" );
    }
  };

  private final java.lang.String _stringValue;

  private ElectricalPanel( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ElectricalPanel forValue( java.lang.String value ) {
    return (xsd.acord.enums.ElectricalPanel) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ElectricalPanel forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ElectricalPanel) TYPE.get().cg_forValue( value );
  }
