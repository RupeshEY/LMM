...
public enum ContentType implements gw.xml.IXmlSchemaEnumValue {
  Ammonia( "Ammonia" ),
  AnhyAmmonia( "AnhyAmmonia" ),
  Chemical( "Chemical" ),
  Dairy( "Dairy" ),
  Diesel( "Diesel" ),
  DS( "DS" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ContentType" );
    }
  };

  private final java.lang.String _stringValue;

  private ContentType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ContentType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ContentType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ContentType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ContentType) TYPE.get().cg_forValue( value );
  }
