...
public enum NumberOfStories implements gw.xml.IXmlSchemaEnumValue {
  _1( "1" ),
  _1H( "1H" ),
  _2( "2" ),
  _2H( "2H" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.NumberOfStories" );
    }
  };

  private final java.lang.String _stringValue;

  private NumberOfStories( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.NumberOfStories forValue( java.lang.String value ) {
    return (xsd.acord.enums.NumberOfStories) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.NumberOfStories forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.NumberOfStories) TYPE.get().cg_forValue( value );
  }
