...
public enum HomeownersRatingCredit implements gw.xml.IXmlSchemaEnumValue {
  LIGHT( "LIGHT" ),
  MANSE( "MANSE" ),
  NSMKR( "NSMKR" ),
  OPTE( "OPTE" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.HomeownersRatingCredit" );
    }
  };

  private final java.lang.String _stringValue;

  private HomeownersRatingCredit( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.HomeownersRatingCredit forValue( java.lang.String value ) {
    return (xsd.acord.enums.HomeownersRatingCredit) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.HomeownersRatingCredit forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.HomeownersRatingCredit) TYPE.get().cg_forValue( value );
  }
