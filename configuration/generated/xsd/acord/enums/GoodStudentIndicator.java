...
public enum GoodStudentIndicator implements gw.xml.IXmlSchemaEnumValue {
  G( "G" ),
  N( "N" ),
  Y( "Y" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.GoodStudentIndicator" );
    }
  };

  private final java.lang.String _stringValue;

  private GoodStudentIndicator( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.GoodStudentIndicator forValue( java.lang.String value ) {
    return (xsd.acord.enums.GoodStudentIndicator) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.GoodStudentIndicator forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.GoodStudentIndicator) TYPE.get().cg_forValue( value );
  }
