...
public enum PremiumCategory implements gw.xml.IXmlSchemaEnumValue {
  Assumed( "Assumed" ),
  Ceded( "Ceded" ),
  Direct( "Direct" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PremiumCategory" );
    }
  };

  private final java.lang.String _stringValue;

  private PremiumCategory( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PremiumCategory forValue( java.lang.String value ) {
    return (xsd.acord.enums.PremiumCategory) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PremiumCategory forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PremiumCategory) TYPE.get().cg_forValue( value );
  }
