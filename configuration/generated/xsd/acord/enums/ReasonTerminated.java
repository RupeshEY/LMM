...
public enum ReasonTerminated implements gw.xml.IXmlSchemaEnumValue {
  AC( "AC" ),
  AD( "AD" ),
  BC( "BC" ),
  BR( "BR" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ReasonTerminated" );
    }
  };

  private final java.lang.String _stringValue;

  private ReasonTerminated( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ReasonTerminated forValue( java.lang.String value ) {
    return (xsd.acord.enums.ReasonTerminated) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ReasonTerminated forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ReasonTerminated) TYPE.get().cg_forValue( value );
  }
