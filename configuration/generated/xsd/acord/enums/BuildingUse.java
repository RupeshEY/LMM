...
public enum BuildingUse implements gw.xml.IXmlSchemaEnumValue {
  CONV( "CONV" ),
  HOSP( "HOSP" ),
  MAUS( "MAUS" ),
  MUSE( "MUSE" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.BuildingUse" );
    }
  };

  private final java.lang.String _stringValue;

  private BuildingUse( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.BuildingUse forValue( java.lang.String value ) {
    return (xsd.acord.enums.BuildingUse) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.BuildingUse forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.BuildingUse) TYPE.get().cg_forValue( value );
  }
