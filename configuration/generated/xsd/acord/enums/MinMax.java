...
public enum MinMax implements gw.xml.IXmlSchemaEnumValue {
  M( "M" ),
  X( "X" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.MinMax" );
    }
  };

  private final java.lang.String _stringValue;

  private MinMax( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.MinMax forValue( java.lang.String value ) {
    return (xsd.acord.enums.MinMax) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.MinMax forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.MinMax) TYPE.get().cg_forValue( value );
  }
