...
public enum StoveType implements gw.xml.IXmlSchemaEnumValue {
  C( "C" ),
  OT( "OT" ),
  R( "R" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.StoveType" );
    }
  };

  private final java.lang.String _stringValue;

  private StoveType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.StoveType forValue( java.lang.String value ) {
    return (xsd.acord.enums.StoveType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.StoveType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.StoveType) TYPE.get().cg_forValue( value );
  }
