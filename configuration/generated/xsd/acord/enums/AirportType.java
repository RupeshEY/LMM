...
public enum AirportType implements gw.xml.IXmlSchemaEnumValue {
  OT( "OT" ),
  PRI( "PRI" ),
  PUB( "PUB" ),
  RES( "RES" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AirportType" );
    }
  };

  private final java.lang.String _stringValue;

  private AirportType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AirportType forValue( java.lang.String value ) {
    return (xsd.acord.enums.AirportType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AirportType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AirportType) TYPE.get().cg_forValue( value );
  }
