...
public enum InventoryAccountingMethod implements gw.xml.IXmlSchemaEnumValue {
  AvgCost( "AvgCost" ),
  FIFO( "FIFO" ),
  LIFO( "LIFO" ),
  Other( "Other" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.InventoryAccountingMethod" );
    }
  };

  private final java.lang.String _stringValue;

  private InventoryAccountingMethod( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.InventoryAccountingMethod forValue( java.lang.String value ) {
    return (xsd.acord.enums.InventoryAccountingMethod) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.InventoryAccountingMethod forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.InventoryAccountingMethod) TYPE.get().cg_forValue( value );
  }
