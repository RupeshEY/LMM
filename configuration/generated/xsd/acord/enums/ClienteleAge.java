...
public enum ClienteleAge implements gw.xml.IXmlSchemaEnumValue {
  _2140( "2140" ),
  Over40( "Over40" ),
  Under21( "Under21" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ClienteleAge" );
    }
  };

  private final java.lang.String _stringValue;

  private ClienteleAge( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ClienteleAge forValue( java.lang.String value ) {
    return (xsd.acord.enums.ClienteleAge) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ClienteleAge forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ClienteleAge) TYPE.get().cg_forValue( value );
  }
