...
public enum WaterUnitType implements gw.xml.IXmlSchemaEnumValue {
  _0( "0" ),
  _1( "1" ),
  _2( "2" ),
  _3( "3" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.WaterUnitType" );
    }
  };

  private final java.lang.String _stringValue;

  private WaterUnitType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.WaterUnitType forValue( java.lang.String value ) {
    return (xsd.acord.enums.WaterUnitType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.WaterUnitType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.WaterUnitType) TYPE.get().cg_forValue( value );
  }
