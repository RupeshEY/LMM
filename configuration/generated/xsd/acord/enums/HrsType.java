...
public enum HrsType implements gw.xml.IXmlSchemaEnumValue {
  FLIGHT( "FLIGHT" ),
  LOG( "LOG" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.HrsType" );
    }
  };

  private final java.lang.String _stringValue;

  private HrsType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.HrsType forValue( java.lang.String value ) {
    return (xsd.acord.enums.HrsType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.HrsType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.HrsType) TYPE.get().cg_forValue( value );
  }
