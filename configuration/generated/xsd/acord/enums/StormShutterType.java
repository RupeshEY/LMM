...
public enum StormShutterType implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  B( "B" ),
  E( "E" ),
  NE( "NE" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.StormShutterType" );
    }
  };

  private final java.lang.String _stringValue;

  private StormShutterType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.StormShutterType forValue( java.lang.String value ) {
    return (xsd.acord.enums.StormShutterType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.StormShutterType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.StormShutterType) TYPE.get().cg_forValue( value );
  }
