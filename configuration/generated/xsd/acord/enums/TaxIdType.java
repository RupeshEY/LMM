...
public enum TaxIdType implements gw.xml.IXmlSchemaEnumValue {
  FEIN( "FEIN" ),
  SSN( "SSN" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.TaxIdType" );
    }
  };

  private final java.lang.String _stringValue;

  private TaxIdType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.TaxIdType forValue( java.lang.String value ) {
    return (xsd.acord.enums.TaxIdType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.TaxIdType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.TaxIdType) TYPE.get().cg_forValue( value );
  }
