...
public enum Obstruction implements gw.xml.IXmlSchemaEnumValue {
  F( "F" ),
  O( "O" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Obstruction" );
    }
  };

  private final java.lang.String _stringValue;

  private Obstruction( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Obstruction forValue( java.lang.String value ) {
    return (xsd.acord.enums.Obstruction) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Obstruction forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Obstruction) TYPE.get().cg_forValue( value );
  }
