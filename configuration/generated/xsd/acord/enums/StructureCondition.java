...
public enum StructureCondition implements gw.xml.IXmlSchemaEnumValue {
  Broken( "Broken" ),
  Excellent( "Excellent" ),
  Fair( "Fair" ),
  Gaps( "Gaps" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.StructureCondition" );
    }
  };

  private final java.lang.String _stringValue;

  private StructureCondition( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.StructureCondition forValue( java.lang.String value ) {
    return (xsd.acord.enums.StructureCondition) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.StructureCondition forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.StructureCondition) TYPE.get().cg_forValue( value );
  }
