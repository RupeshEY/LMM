...
public enum BroadLineBusiness implements gw.xml.IXmlSchemaEnumValue {
  B( "B" ),
  C( "C" ),
  F( "F" ),
  P( "P" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.BroadLineBusiness" );
    }
  };

  private final java.lang.String _stringValue;

  private BroadLineBusiness( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.BroadLineBusiness forValue( java.lang.String value ) {
    return (xsd.acord.enums.BroadLineBusiness) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.BroadLineBusiness forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.BroadLineBusiness) TYPE.get().cg_forValue( value );
  }
