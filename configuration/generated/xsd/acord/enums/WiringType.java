...
public enum WiringType implements gw.xml.IXmlSchemaEnumValue {
  Aluminum( "Aluminum" ),
  Copper( "Copper" ),
  KnobTube( "KnobTube" ),
  Other( "Other" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.WiringType" );
    }
  };

  private final java.lang.String _stringValue;

  private WiringType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.WiringType forValue( java.lang.String value ) {
    return (xsd.acord.enums.WiringType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.WiringType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.WiringType) TYPE.get().cg_forValue( value );
  }
