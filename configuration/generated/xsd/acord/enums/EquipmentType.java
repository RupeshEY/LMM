...
public enum EquipmentType implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  B( "B" ),
  C( "C" ),
  D( "D" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EquipmentType" );
    }
  };

  private final java.lang.String _stringValue;

  private EquipmentType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EquipmentType forValue( java.lang.String value ) {
    return (xsd.acord.enums.EquipmentType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EquipmentType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EquipmentType) TYPE.get().cg_forValue( value );
  }
