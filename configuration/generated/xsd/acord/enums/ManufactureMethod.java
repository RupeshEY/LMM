...
public enum ManufactureMethod implements gw.xml.IXmlSchemaEnumValue {
  FactoryBuilt( "FactoryBuilt" ),
  HomeMade( "HomeMade" ),
  NonFactoryBuilt( "NonFactoryBuilt" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ManufactureMethod" );
    }
  };

  private final java.lang.String _stringValue;

  private ManufactureMethod( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ManufactureMethod forValue( java.lang.String value ) {
    return (xsd.acord.enums.ManufactureMethod) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ManufactureMethod forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ManufactureMethod) TYPE.get().cg_forValue( value );
  }
