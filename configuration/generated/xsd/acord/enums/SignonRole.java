...
public enum SignonRole implements gw.xml.IXmlSchemaEnumValue {
  Agent( "Agent" ),
  CSR( "CSR" ),
  Customer( "Customer" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SignonRole" );
    }
  };

  private final java.lang.String _stringValue;

  private SignonRole( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SignonRole forValue( java.lang.String value ) {
    return (xsd.acord.enums.SignonRole) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SignonRole forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SignonRole) TYPE.get().cg_forValue( value );
  }
