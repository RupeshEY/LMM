...
public enum ReferralType implements gw.xml.IXmlSchemaEnumValue {
  FireMarshall( "FireMarshall" ),
  FraudBureau( "FraudBureau" ),
  NICB( "NICB" ),
  Other( "Other" ),
  Unknown( "Unknown" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ReferralType" );
    }
  };

  private final java.lang.String _stringValue;

  private ReferralType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ReferralType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ReferralType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ReferralType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ReferralType) TYPE.get().cg_forValue( value );
  }
