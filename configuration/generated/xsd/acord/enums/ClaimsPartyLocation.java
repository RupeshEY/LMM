...
public enum ClaimsPartyLocation implements gw.xml.IXmlSchemaEnumValue {
  INSAIR( "INSAIR" ),
  INSVEH( "INSVEH" ),
  OT( "OT" ),
  OTHAIR( "OTHAIR" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ClaimsPartyLocation" );
    }
  };

  private final java.lang.String _stringValue;

  private ClaimsPartyLocation( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ClaimsPartyLocation forValue( java.lang.String value ) {
    return (xsd.acord.enums.ClaimsPartyLocation) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ClaimsPartyLocation forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ClaimsPartyLocation) TYPE.get().cg_forValue( value );
  }
