...
public enum ValuationType implements gw.xml.IXmlSchemaEnumValue {
  ACT( "ACT" ),
  ACV( "ACV" ),
  FR( "FR" ),
  FVR( "FVR" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ValuationType" );
    }
  };

  private final java.lang.String _stringValue;

  private ValuationType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ValuationType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ValuationType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ValuationType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ValuationType) TYPE.get().cg_forValue( value );
  }
