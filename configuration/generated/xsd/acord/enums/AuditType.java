...
public enum AuditType implements gw.xml.IXmlSchemaEnumValue {
  Cash( "Cash" ),
  Inventory( "Inventory" ),
  Payroll( "Payroll" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AuditType" );
    }
  };

  private final java.lang.String _stringValue;

  private AuditType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AuditType forValue( java.lang.String value ) {
    return (xsd.acord.enums.AuditType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AuditType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AuditType) TYPE.get().cg_forValue( value );
  }
