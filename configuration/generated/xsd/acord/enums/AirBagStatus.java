...
public enum AirBagStatus implements gw.xml.IXmlSchemaEnumValue {
  Deployed( "Deployed" ),
  Intact( "Intact" ),
  LeftSide( "LeftSide" ),
  Missing( "Missing" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AirBagStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private AirBagStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AirBagStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.AirBagStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AirBagStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AirBagStatus) TYPE.get().cg_forValue( value );
  }
