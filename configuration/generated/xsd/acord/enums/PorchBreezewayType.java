...
public enum PorchBreezewayType implements gw.xml.IXmlSchemaEnumValue {
  CovStoop( "CovStoop" ),
  E( "E" ),
  O( "O" ),
  OW1( "OW1" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PorchBreezewayType" );
    }
  };

  private final java.lang.String _stringValue;

  private PorchBreezewayType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PorchBreezewayType forValue( java.lang.String value ) {
    return (xsd.acord.enums.PorchBreezewayType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PorchBreezewayType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PorchBreezewayType) TYPE.get().cg_forValue( value );
  }
