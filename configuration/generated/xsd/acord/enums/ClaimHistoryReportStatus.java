...
public enum ClaimHistoryReportStatus implements gw.xml.IXmlSchemaEnumValue {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ClaimHistoryReportStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private ClaimHistoryReportStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ClaimHistoryReportStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.ClaimHistoryReportStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ClaimHistoryReportStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ClaimHistoryReportStatus) TYPE.get().cg_forValue( value );
  }
