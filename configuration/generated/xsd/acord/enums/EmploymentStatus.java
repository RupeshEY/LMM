...
public enum EmploymentStatus implements gw.xml.IXmlSchemaEnumValue {
  AFULL( "AFULL" ),
  APART( "APART" ),
  OFF( "OFF" ),
  Other( "Other" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EmploymentStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private EmploymentStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EmploymentStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.EmploymentStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EmploymentStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EmploymentStatus) TYPE.get().cg_forValue( value );
  }
