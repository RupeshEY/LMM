...
public enum UnitLocation implements gw.xml.IXmlSchemaEnumValue {
  INSD( "INSD" ),
  OS( "OS" ),
  OSE( "OSE" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.UnitLocation" );
    }
  };

  private final java.lang.String _stringValue;

  private UnitLocation( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.UnitLocation forValue( java.lang.String value ) {
    return (xsd.acord.enums.UnitLocation) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.UnitLocation forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.UnitLocation) TYPE.get().cg_forValue( value );
  }
