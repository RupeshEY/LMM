...
public enum Breed implements gw.xml.IXmlSchemaEnumValue {
  Chow( "Chow" ),
  Doberman( "Doberman" ),
  Gsheperd( "Gsheperd" ),
  Mix( "Mix" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Breed" );
    }
  };

  private final java.lang.String _stringValue;

  private Breed( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Breed forValue( java.lang.String value ) {
    return (xsd.acord.enums.Breed) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Breed forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Breed) TYPE.get().cg_forValue( value );
  }
