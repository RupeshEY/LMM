...
public enum EncryptionType implements gw.xml.IXmlSchemaEnumValue {
  NONE( "NONE" ),
  PKCS1( "PKCS1" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EncryptionType" );
    }
  };

  private final java.lang.String _stringValue;

  private EncryptionType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EncryptionType forValue( java.lang.String value ) {
    return (xsd.acord.enums.EncryptionType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EncryptionType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EncryptionType) TYPE.get().cg_forValue( value );
  }
