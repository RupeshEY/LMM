...
public enum DogType implements gw.xml.IXmlSchemaEnumValue {
  Chow( "Chow" ),
  Doberman( "Doberman" ),
  Gsheperd( "Gsheperd" ),
  Mix( "Mix" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DogType" );
    }
  };

  private final java.lang.String _stringValue;

  private DogType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DogType forValue( java.lang.String value ) {
    return (xsd.acord.enums.DogType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DogType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DogType) TYPE.get().cg_forValue( value );
  }
