...
public enum HousekeepingCondition implements gw.xml.IXmlSchemaEnumValue {
  AV( "AV" ),
  BAVE( "BAVE" ),
  E( "E" ),
  GD( "GD" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.HousekeepingCondition" );
    }
  };

  private final java.lang.String _stringValue;

  private HousekeepingCondition( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.HousekeepingCondition forValue( java.lang.String value ) {
    return (xsd.acord.enums.HousekeepingCondition) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.HousekeepingCondition forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.HousekeepingCondition) TYPE.get().cg_forValue( value );
  }
