...
public enum PlayingSurface implements gw.xml.IXmlSchemaEnumValue {
  Asph( "Asph" ),
  ClayCourt( "ClayCourt" ),
  Grass( "Grass" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PlayingSurface" );
    }
  };

  private final java.lang.String _stringValue;

  private PlayingSurface( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PlayingSurface forValue( java.lang.String value ) {
    return (xsd.acord.enums.PlayingSurface) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PlayingSurface forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PlayingSurface) TYPE.get().cg_forValue( value );
  }
