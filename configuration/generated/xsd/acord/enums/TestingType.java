...
public enum TestingType implements gw.xml.IXmlSchemaEnumValue {
  ACCEP( "ACCEP" ),
  ALPHA( "ALPHA" ),
  BETA( "BETA" ),
  COMP( "COMP" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.TestingType" );
    }
  };

  private final java.lang.String _stringValue;

  private TestingType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.TestingType forValue( java.lang.String value ) {
    return (xsd.acord.enums.TestingType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.TestingType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.TestingType) TYPE.get().cg_forValue( value );
  }
