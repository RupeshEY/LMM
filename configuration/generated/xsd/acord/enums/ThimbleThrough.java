...
public enum ThimbleThrough implements gw.xml.IXmlSchemaEnumValue {
  Ceiling( "Ceiling" ),
  Wall( "Wall" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ThimbleThrough" );
    }
  };

  private final java.lang.String _stringValue;

  private ThimbleThrough( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ThimbleThrough forValue( java.lang.String value ) {
    return (xsd.acord.enums.ThimbleThrough) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ThimbleThrough forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ThimbleThrough) TYPE.get().cg_forValue( value );
  }
