...
public enum IndemnityType implements gw.xml.IXmlSchemaEnumValue {
  GIA( "GIA" ),
  GIA3( "GIA3" ),
  GIAJV( "GIAJV" ),
  NOIND( "NOIND" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.IndemnityType" );
    }
  };

  private final java.lang.String _stringValue;

  private IndemnityType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.IndemnityType forValue( java.lang.String value ) {
    return (xsd.acord.enums.IndemnityType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.IndemnityType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.IndemnityType) TYPE.get().cg_forValue( value );
  }
