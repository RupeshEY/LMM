...
public enum EmployeeInterest implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  C( "C" ),
  O( "O" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EmployeeInterest" );
    }
  };

  private final java.lang.String _stringValue;

  private EmployeeInterest( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EmployeeInterest forValue( java.lang.String value ) {
    return (xsd.acord.enums.EmployeeInterest) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EmployeeInterest forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EmployeeInterest) TYPE.get().cg_forValue( value );
  }
