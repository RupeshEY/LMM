...
public enum ShipperType implements gw.xml.IXmlSchemaEnumValue {
  CN( "CN" ),
  NO( "NO" ),
  OP( "OP" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ShipperType" );
    }
  };

  private final java.lang.String _stringValue;

  private ShipperType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ShipperType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ShipperType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ShipperType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ShipperType) TYPE.get().cg_forValue( value );
  }
