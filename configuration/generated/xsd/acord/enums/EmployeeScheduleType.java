...
public enum EmployeeScheduleType implements gw.xml.IXmlSchemaEnumValue {
  FULL( "FULL" ),
  INJURED( "INJURED" ),
  PART( "PART" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EmployeeScheduleType" );
    }
  };

  private final java.lang.String _stringValue;

  private EmployeeScheduleType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EmployeeScheduleType forValue( java.lang.String value ) {
    return (xsd.acord.enums.EmployeeScheduleType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EmployeeScheduleType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EmployeeScheduleType) TYPE.get().cg_forValue( value );
  }
