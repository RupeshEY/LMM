...
public enum LocationType implements gw.xml.IXmlSchemaEnumValue {
  CM( "CM" ),
  EN( "EN" ),
  FD( "FD" ),
  IAM( "IAM" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.LocationType" );
    }
  };

  private final java.lang.String _stringValue;

  private LocationType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.LocationType forValue( java.lang.String value ) {
    return (xsd.acord.enums.LocationType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.LocationType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.LocationType) TYPE.get().cg_forValue( value );
  }
