...
public enum DetachedStructureType implements gw.xml.IXmlSchemaEnumValue {
  Awning( "Awning" ),
  BBQ( "BBQ" ),
  BoatDock( "BoatDock" ),
  BoatHouse( "BoatHouse" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DetachedStructureType" );
    }
  };

  private final java.lang.String _stringValue;

  private DetachedStructureType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DetachedStructureType forValue( java.lang.String value ) {
    return (xsd.acord.enums.DetachedStructureType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DetachedStructureType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DetachedStructureType) TYPE.get().cg_forValue( value );
  }
