...
public enum InspectionStatus implements gw.xml.IXmlSchemaEnumValue {
  Completed( "Completed" ),
  Estimate( "Estimate" ),
  NotCmplVerify( "NotCmplVerify" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.InspectionStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private InspectionStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.InspectionStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.InspectionStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.InspectionStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.InspectionStatus) TYPE.get().cg_forValue( value );
  }
