...
public enum SpecificTest implements gw.xml.IXmlSchemaEnumValue {
  Diabetes( "Diabetes" ),
  Diastolic( "Diastolic" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SpecificTest" );
    }
  };

  private final java.lang.String _stringValue;

  private SpecificTest( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SpecificTest forValue( java.lang.String value ) {
    return (xsd.acord.enums.SpecificTest) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SpecificTest forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SpecificTest) TYPE.get().cg_forValue( value );
  }
