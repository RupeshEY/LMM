...
public enum RadiusUseType implements gw.xml.IXmlSchemaEnumValue {
  IN( "IN" ),
  LC( "LC" ),
  LD( "LD" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RadiusUseType" );
    }
  };

  private final java.lang.String _stringValue;

  private RadiusUseType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RadiusUseType forValue( java.lang.String value ) {
    return (xsd.acord.enums.RadiusUseType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RadiusUseType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RadiusUseType) TYPE.get().cg_forValue( value );
  }
