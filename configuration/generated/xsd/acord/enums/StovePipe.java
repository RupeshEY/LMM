...
public enum StovePipe implements gw.xml.IXmlSchemaEnumValue {
  LLD( "LLD" ),
  OT( "OT" ),
  SWM( "SWM" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.StovePipe" );
    }
  };

  private final java.lang.String _stringValue;

  private StovePipe( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.StovePipe forValue( java.lang.String value ) {
    return (xsd.acord.enums.StovePipe) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.StovePipe forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.StovePipe) TYPE.get().cg_forValue( value );
  }
