...
public enum ResidenceType implements gw.xml.IXmlSchemaEnumValue {
  APT( "APT" ),
  CD( "CD" ),
  CO( "CO" ),
  DW( "DW" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ResidenceType" );
    }
  };

  private final java.lang.String _stringValue;

  private ResidenceType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ResidenceType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ResidenceType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ResidenceType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ResidenceType) TYPE.get().cg_forValue( value );
  }
