...
public enum HeatSource implements gw.xml.IXmlSchemaEnumValue {
  CNPI( "CNPI" ),
  CPI( "CPI" ),
  E( "E" ),
  F( "F" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.HeatSource" );
    }
  };

  private final java.lang.String _stringValue;

  private HeatSource( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.HeatSource forValue( java.lang.String value ) {
    return (xsd.acord.enums.HeatSource) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.HeatSource forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.HeatSource) TYPE.get().cg_forValue( value );
  }
