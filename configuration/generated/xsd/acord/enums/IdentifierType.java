...
public enum IdentifierType implements gw.xml.IXmlSchemaEnumValue {
  CAWCInsurer( "CAWCInsurer" ),
  CreditBureau( "CreditBureau" ),
  FAA( "FAA" ),
  Insured( "Insured" ),
  Jurisdiction( "Jurisdiction" ),
  MGA( "MGA" ),
  NCCICovProvider( "NCCICovProvider" ),
  OSHA( "OSHA" ),
  PFC( "PFC" ),
  PriorTPA( "PriorTPA" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.IdentifierType" );
    }
  };

  private final java.lang.String _stringValue;

  private IdentifierType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.IdentifierType forValue( java.lang.String value ) {
    return (xsd.acord.enums.IdentifierType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.IdentifierType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.IdentifierType) TYPE.get().cg_forValue( value );
  }
