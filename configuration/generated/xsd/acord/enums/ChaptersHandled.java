...
public enum ChaptersHandled implements gw.xml.IXmlSchemaEnumValue {
  FR( "FR" ),
  L5( "L5" ),
  LQ( "LQ" ),
  M5( "M5" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ChaptersHandled" );
    }
  };

  private final java.lang.String _stringValue;

  private ChaptersHandled( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ChaptersHandled forValue( java.lang.String value ) {
    return (xsd.acord.enums.ChaptersHandled) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ChaptersHandled forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ChaptersHandled) TYPE.get().cg_forValue( value );
  }
