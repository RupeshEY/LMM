...
public enum GarageType implements gw.xml.IXmlSchemaEnumValue {
  BI( "BI" ),
  BS( "BS" ),
  CP( "CP" ),
  CS( "CS" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.GarageType" );
    }
  };

  private final java.lang.String _stringValue;

  private GarageType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.GarageType forValue( java.lang.String value ) {
    return (xsd.acord.enums.GarageType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.GarageType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.GarageType) TYPE.get().cg_forValue( value );
  }
