...
public enum Inspector implements gw.xml.IXmlSchemaEnumValue {
  FD( "FD" ),
  LB( "LB" ),
  NI( "NI" ),
  OT( "OT" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Inspector" );
    }
  };

  private final java.lang.String _stringValue;

  private Inspector( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Inspector forValue( java.lang.String value ) {
    return (xsd.acord.enums.Inspector) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Inspector forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Inspector) TYPE.get().cg_forValue( value );
  }
