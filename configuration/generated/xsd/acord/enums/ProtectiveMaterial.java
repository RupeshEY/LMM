...
public enum ProtectiveMaterial implements gw.xml.IXmlSchemaEnumValue {
  Brick( "Brick" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ProtectiveMaterial" );
    }
  };

  private final java.lang.String _stringValue;

  private ProtectiveMaterial( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ProtectiveMaterial forValue( java.lang.String value ) {
    return (xsd.acord.enums.ProtectiveMaterial) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ProtectiveMaterial forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ProtectiveMaterial) TYPE.get().cg_forValue( value );
  }
