...
public enum AnimalAccommodations implements gw.xml.IXmlSchemaEnumValue {
  Corral( "Corral" ),
  Other( "Other" ),
  Pasture( "Pasture" ),
  Stall( "Stall" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AnimalAccommodations" );
    }
  };

  private final java.lang.String _stringValue;

  private AnimalAccommodations( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AnimalAccommodations forValue( java.lang.String value ) {
    return (xsd.acord.enums.AnimalAccommodations) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AnimalAccommodations forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AnimalAccommodations) TYPE.get().cg_forValue( value );
  }
