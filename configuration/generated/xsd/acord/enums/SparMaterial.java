...
public enum SparMaterial implements gw.xml.IXmlSchemaEnumValue {
  ALUMINUM( "ALUMINUM" ),
  CARBON( "CARBON" ),
  OT( "OT" ),
  WOOD( "WOOD" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SparMaterial" );
    }
  };

  private final java.lang.String _stringValue;

  private SparMaterial( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SparMaterial forValue( java.lang.String value ) {
    return (xsd.acord.enums.SparMaterial) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SparMaterial forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SparMaterial) TYPE.get().cg_forValue( value );
  }
