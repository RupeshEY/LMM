...
public enum SpecialProgram implements gw.xml.IXmlSchemaEnumValue {
  SBAA( "SBAA" ),
  SBAB( "SBAB" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SpecialProgram" );
    }
  };

  private final java.lang.String _stringValue;

  private SpecialProgram( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SpecialProgram forValue( java.lang.String value ) {
    return (xsd.acord.enums.SpecialProgram) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SpecialProgram forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SpecialProgram) TYPE.get().cg_forValue( value );
  }
