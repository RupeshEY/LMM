...
public enum PremiumCalculationMethod implements gw.xml.IXmlSchemaEnumValue {
  Actual( "Actual" ),
  Advance( "Advance" ),
  Estimated( "Estimated" ),
  Flat( "Flat" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PremiumCalculationMethod" );
    }
  };

  private final java.lang.String _stringValue;

  private PremiumCalculationMethod( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PremiumCalculationMethod forValue( java.lang.String value ) {
    return (xsd.acord.enums.PremiumCalculationMethod) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PremiumCalculationMethod forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PremiumCalculationMethod) TYPE.get().cg_forValue( value );
  }
