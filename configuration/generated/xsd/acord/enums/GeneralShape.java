...
public enum GeneralShape implements gw.xml.IXmlSchemaEnumValue {
  Lshape( "Lshape" ),
  Rect( "Rect" ),
  Slrreg( "Slrreg" ),
  Tshape( "Tshape" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.GeneralShape" );
    }
  };

  private final java.lang.String _stringValue;

  private GeneralShape( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.GeneralShape forValue( java.lang.String value ) {
    return (xsd.acord.enums.GeneralShape) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.GeneralShape forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.GeneralShape) TYPE.get().cg_forValue( value );
  }
