...
public enum RoofDeckAttachment implements gw.xml.IXmlSchemaEnumValue {
  ADHESIVE( "ADHESIVE" ),
  BOLT( "BOLT" ),
  NAIL( "NAIL" ),
  SCREW( "SCREW" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RoofDeckAttachment" );
    }
  };

  private final java.lang.String _stringValue;

  private RoofDeckAttachment( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RoofDeckAttachment forValue( java.lang.String value ) {
    return (xsd.acord.enums.RoofDeckAttachment) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RoofDeckAttachment forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RoofDeckAttachment) TYPE.get().cg_forValue( value );
  }
