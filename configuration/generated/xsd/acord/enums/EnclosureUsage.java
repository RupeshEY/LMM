...
public enum EnclosureUsage implements gw.xml.IXmlSchemaEnumValue {
  ACCES( "ACCES" ),
  OT( "OT" ),
  PARKG( "PARKG" ),
  PSA( "PSA" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EnclosureUsage" );
    }
  };

  private final java.lang.String _stringValue;

  private EnclosureUsage( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EnclosureUsage forValue( java.lang.String value ) {
    return (xsd.acord.enums.EnclosureUsage) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EnclosureUsage forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EnclosureUsage) TYPE.get().cg_forValue( value );
  }
