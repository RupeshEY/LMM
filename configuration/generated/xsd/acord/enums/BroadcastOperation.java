...
public enum BroadcastOperation implements gw.xml.IXmlSchemaEnumValue {
  Beverages( "Beverages" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.BroadcastOperation" );
    }
  };

  private final java.lang.String _stringValue;

  private BroadcastOperation( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.BroadcastOperation forValue( java.lang.String value ) {
    return (xsd.acord.enums.BroadcastOperation) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.BroadcastOperation forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.BroadcastOperation) TYPE.get().cg_forValue( value );
  }
