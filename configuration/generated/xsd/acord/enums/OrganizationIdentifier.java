...
public enum OrganizationIdentifier implements gw.xml.IXmlSchemaEnumValue {
  AgcyEnter( "AgcyEnter" ),
  AgcyResp( "AgcyResp" ),
  AgcySvc( "AgcySvc" ),
  AGY( "AGY" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.OrganizationIdentifier" );
    }
  };

  private final java.lang.String _stringValue;

  private OrganizationIdentifier( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.OrganizationIdentifier forValue( java.lang.String value ) {
    return (xsd.acord.enums.OrganizationIdentifier) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.OrganizationIdentifier forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.OrganizationIdentifier) TYPE.get().cg_forValue( value );
  }
