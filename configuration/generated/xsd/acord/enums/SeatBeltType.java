...
public enum SeatBeltType implements gw.xml.IXmlSchemaEnumValue {
  Active( "Active" ),
  None( "None" ),
  PassBoth( "PassBoth" ),
  PassDrv( "PassDrv" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SeatBeltType" );
    }
  };

  private final java.lang.String _stringValue;

  private SeatBeltType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SeatBeltType forValue( java.lang.String value ) {
    return (xsd.acord.enums.SeatBeltType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SeatBeltType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SeatBeltType) TYPE.get().cg_forValue( value );
  }
