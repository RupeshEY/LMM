...
public enum ClearanceTo implements gw.xml.IXmlSchemaEnumValue {
  Ceiling( "Ceiling" ),
  Combust( "Combust" ),
  Edge( "Edge" ),
  Floor( "Floor" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ClearanceTo" );
    }
  };

  private final java.lang.String _stringValue;

  private ClearanceTo( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ClearanceTo forValue( java.lang.String value ) {
    return (xsd.acord.enums.ClearanceTo) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ClearanceTo forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ClearanceTo) TYPE.get().cg_forValue( value );
  }
