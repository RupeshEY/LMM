...
public enum ReceiptsType implements gw.xml.IXmlSchemaEnumValue {
  Food( "Food" ),
  Liquor( "Liquor" ),
  OT( "OT" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ReceiptsType" );
    }
  };

  private final java.lang.String _stringValue;

  private ReceiptsType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ReceiptsType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ReceiptsType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ReceiptsType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ReceiptsType) TYPE.get().cg_forValue( value );
  }
