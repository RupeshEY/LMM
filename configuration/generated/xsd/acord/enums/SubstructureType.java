...
public enum SubstructureType implements gw.xml.IXmlSchemaEnumValue {
  BS( "BS" ),
  BSBG( "BSBG" ),
  CRSP( "CRSP" ),
  S( "S" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SubstructureType" );
    }
  };

  private final java.lang.String _stringValue;

  private SubstructureType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SubstructureType forValue( java.lang.String value ) {
    return (xsd.acord.enums.SubstructureType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SubstructureType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SubstructureType) TYPE.get().cg_forValue( value );
  }
