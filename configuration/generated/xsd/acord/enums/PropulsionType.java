...
public enum PropulsionType implements gw.xml.IXmlSchemaEnumValue {
  INBRD( "INBRD" ),
  IO( "IO" ),
  NONE( "NONE" ),
  OT( "OT" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PropulsionType" );
    }
  };

  private final java.lang.String _stringValue;

  private PropulsionType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PropulsionType forValue( java.lang.String value ) {
    return (xsd.acord.enums.PropulsionType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PropulsionType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PropulsionType) TYPE.get().cg_forValue( value );
  }
