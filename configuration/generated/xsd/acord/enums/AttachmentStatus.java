...
public enum AttachmentStatus implements gw.xml.IXmlSchemaEnumValue {
  DE( "DE" ),
  DF( "DF" ),
  DK( "DK" ),
  FAX( "FAX" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AttachmentStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private AttachmentStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AttachmentStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.AttachmentStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AttachmentStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AttachmentStatus) TYPE.get().cg_forValue( value );
  }
