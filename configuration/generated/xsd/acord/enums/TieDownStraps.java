...
public enum TieDownStraps implements gw.xml.IXmlSchemaEnumValue {
  C2( "C2" ),
  C4( "C4" ),
  OT( "OT" ),
  S2( "S2" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.TieDownStraps" );
    }
  };

  private final java.lang.String _stringValue;

  private TieDownStraps( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.TieDownStraps forValue( java.lang.String value ) {
    return (xsd.acord.enums.TieDownStraps) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.TieDownStraps forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.TieDownStraps) TYPE.get().cg_forValue( value );
  }
