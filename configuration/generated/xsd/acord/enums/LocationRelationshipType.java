...
public enum LocationRelationshipType implements gw.xml.IXmlSchemaEnumValue {
  DuplicateRec( "DuplicateRec" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.LocationRelationshipType" );
    }
  };

  private final java.lang.String _stringValue;

  private LocationRelationshipType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.LocationRelationshipType forValue( java.lang.String value ) {
    return (xsd.acord.enums.LocationRelationshipType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.LocationRelationshipType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.LocationRelationshipType) TYPE.get().cg_forValue( value );
  }
