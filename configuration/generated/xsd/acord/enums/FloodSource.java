...
public enum FloodSource implements gw.xml.IXmlSchemaEnumValue {
  L( "L" ),
  O( "O" ),
  R( "R" ),
  S( "S" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.FloodSource" );
    }
  };

  private final java.lang.String _stringValue;

  private FloodSource( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.FloodSource forValue( java.lang.String value ) {
    return (xsd.acord.enums.FloodSource) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.FloodSource forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.FloodSource) TYPE.get().cg_forValue( value );
  }
