...
public enum InsideOutside implements gw.xml.IXmlSchemaEnumValue {
  INSD( "INSD" ),
  OS( "OS" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.InsideOutside" );
    }
  };

  private final java.lang.String _stringValue;

  private InsideOutside( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.InsideOutside forValue( java.lang.String value ) {
    return (xsd.acord.enums.InsideOutside) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.InsideOutside forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.InsideOutside) TYPE.get().cg_forValue( value );
  }
