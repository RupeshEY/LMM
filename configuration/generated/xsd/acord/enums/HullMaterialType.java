...
public enum HullMaterialType implements gw.xml.IXmlSchemaEnumValue {
  ALUM( "ALUM" ),
  F( "F" ),
  I( "I" ),
  MT( "MT" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.HullMaterialType" );
    }
  };

  private final java.lang.String _stringValue;

  private HullMaterialType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.HullMaterialType forValue( java.lang.String value ) {
    return (xsd.acord.enums.HullMaterialType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.HullMaterialType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.HullMaterialType) TYPE.get().cg_forValue( value );
  }
