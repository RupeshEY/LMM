...
public enum ShorelineDistance implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  B( "B" ),
  C( "C" ),
  D( "D" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ShorelineDistance" );
    }
  };

  private final java.lang.String _stringValue;

  private ShorelineDistance( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ShorelineDistance forValue( java.lang.String value ) {
    return (xsd.acord.enums.ShorelineDistance) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ShorelineDistance forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ShorelineDistance) TYPE.get().cg_forValue( value );
  }
