...
public enum Improvement implements gw.xml.IXmlSchemaEnumValue {
  C( "C" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Improvement" );
    }
  };

  private final java.lang.String _stringValue;

  private Improvement( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Improvement forValue( java.lang.String value ) {
    return (xsd.acord.enums.Improvement) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Improvement forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Improvement) TYPE.get().cg_forValue( value );
  }
