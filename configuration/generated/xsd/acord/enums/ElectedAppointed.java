...
public enum ElectedAppointed implements gw.xml.IXmlSchemaEnumValue {
  Appointed( "Appointed" ),
  Elected( "Elected" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ElectedAppointed" );
    }
  };

  private final java.lang.String _stringValue;

  private ElectedAppointed( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ElectedAppointed forValue( java.lang.String value ) {
    return (xsd.acord.enums.ElectedAppointed) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ElectedAppointed forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ElectedAppointed) TYPE.get().cg_forValue( value );
  }
