...
public enum IncludedExcludedIndicator implements gw.xml.IXmlSchemaEnumValue {
  E( "E" ),
  I( "I" ),
  N( "N" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.IncludedExcludedIndicator" );
    }
  };

  private final java.lang.String _stringValue;

  private IncludedExcludedIndicator( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.IncludedExcludedIndicator forValue( java.lang.String value ) {
    return (xsd.acord.enums.IncludedExcludedIndicator) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.IncludedExcludedIndicator forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.IncludedExcludedIndicator) TYPE.get().cg_forValue( value );
  }
