...
public enum UnderwritingDecision implements gw.xml.IXmlSchemaEnumValue {
  Accept( "Accept" ),
  Hold( "Hold" ),
  NonRenew( "NonRenew" ),
  Refer( "Refer" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.UnderwritingDecision" );
    }
  };

  private final java.lang.String _stringValue;

  private UnderwritingDecision( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.UnderwritingDecision forValue( java.lang.String value ) {
    return (xsd.acord.enums.UnderwritingDecision) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.UnderwritingDecision forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.UnderwritingDecision) TYPE.get().cg_forValue( value );
  }
