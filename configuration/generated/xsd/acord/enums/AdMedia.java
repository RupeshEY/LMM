...
public enum AdMedia implements gw.xml.IXmlSchemaEnumValue {
  ALL( "ALL" ),
  OT( "OT" ),
  PRINT( "PRINT" ),
  RADIO( "RADIO" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AdMedia" );
    }
  };

  private final java.lang.String _stringValue;

  private AdMedia( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AdMedia forValue( java.lang.String value ) {
    return (xsd.acord.enums.AdMedia) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AdMedia forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AdMedia) TYPE.get().cg_forValue( value );
  }
