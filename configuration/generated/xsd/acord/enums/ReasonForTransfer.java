...
public enum ReasonForTransfer implements gw.xml.IXmlSchemaEnumValue {
  BrokerageAcquisition( "BrokerageAcquisition" ),
  CompanyAcquisition( "CompanyAcquisition" ),
  NewBusinessToTheBroker( "NewBusinessToTheBroker" ),
  Other( "Other" ),
  PortfolioTransfer( "PortfolioTransfer" ),
  Remarketed( "Remarketed" ),
  ReplacementOfPolicy( "ReplacementOfPolicy" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ReasonForTransfer" );
    }
  };

  private final java.lang.String _stringValue;

  private ReasonForTransfer( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ReasonForTransfer forValue( java.lang.String value ) {
    return (xsd.acord.enums.ReasonForTransfer) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ReasonForTransfer forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ReasonForTransfer) TYPE.get().cg_forValue( value );
  }
