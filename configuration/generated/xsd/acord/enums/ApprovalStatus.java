...
public enum ApprovalStatus implements gw.xml.IXmlSchemaEnumValue {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ApprovalStatus" );
    }
  };
  ...
  public static final xsd.acord.enums.ApprovalStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.ApprovalStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ApprovalStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ApprovalStatus) TYPE.get().cg_forValue( value );
  }
