...
public enum CommunityProgramType implements gw.xml.IXmlSchemaEnumValue {
  E( "E" ),
  R( "R" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CommunityProgramType" );
    }
  };

  private final java.lang.String _stringValue;

  private CommunityProgramType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CommunityProgramType forValue( java.lang.String value ) {
    return (xsd.acord.enums.CommunityProgramType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CommunityProgramType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CommunityProgramType) TYPE.get().cg_forValue( value );
  }
