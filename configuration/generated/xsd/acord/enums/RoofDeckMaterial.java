...
public enum RoofDeckMaterial implements gw.xml.IXmlSchemaEnumValue {
  CONSLAB( "CONSLAB" ),
  LMETAL( "LMETAL" ),
  METALCON( "METALCON" ),
  METALINS( "METALINS" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RoofDeckMaterial" );
    }
  };

  private final java.lang.String _stringValue;

  private RoofDeckMaterial( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RoofDeckMaterial forValue( java.lang.String value ) {
    return (xsd.acord.enums.RoofDeckMaterial) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RoofDeckMaterial forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RoofDeckMaterial) TYPE.get().cg_forValue( value );
  }
