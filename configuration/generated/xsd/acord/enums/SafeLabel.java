...
public enum SafeLabel implements gw.xml.IXmlSchemaEnumValue {
  S( "S" ),
  U( "U" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SafeLabel" );
    }
  };

  private final java.lang.String _stringValue;

  private SafeLabel( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SafeLabel forValue( java.lang.String value ) {
    return (xsd.acord.enums.SafeLabel) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SafeLabel forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SafeLabel) TYPE.get().cg_forValue( value );
  }
