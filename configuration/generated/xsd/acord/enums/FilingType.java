...
public enum FilingType implements gw.xml.IXmlSchemaEnumValue {
  I( "I" ),
  OT( "OT" ),
  P( "P" ),
  S( "S" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.FilingType" );
    }
  };

  private final java.lang.String _stringValue;

  private FilingType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.FilingType forValue( java.lang.String value ) {
    return (xsd.acord.enums.FilingType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.FilingType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.FilingType) TYPE.get().cg_forValue( value );
  }
