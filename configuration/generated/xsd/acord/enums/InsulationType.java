...
public enum InsulationType implements gw.xml.IXmlSchemaEnumValue {
  Cellulose( "Cellulose" ),
  Exposed( "Exposed" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.InsulationType" );
    }
  };

  private final java.lang.String _stringValue;

  private InsulationType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.InsulationType forValue( java.lang.String value ) {
    return (xsd.acord.enums.InsulationType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.InsulationType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.InsulationType) TYPE.get().cg_forValue( value );
  }
