...
public enum ScheduleType implements gw.xml.IXmlSchemaEnumValue {
  Glass( "Glass" ),
  Sign( "Sign" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ScheduleType" );
    }
  };

  private final java.lang.String _stringValue;

  private ScheduleType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ScheduleType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ScheduleType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ScheduleType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ScheduleType) TYPE.get().cg_forValue( value );
  }
