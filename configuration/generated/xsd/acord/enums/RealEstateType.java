...
public enum RealEstateType implements gw.xml.IXmlSchemaEnumValue {
  Apt( "Apt" ),
  Build( "Build" ),
  Condo( "Condo" ),
  Farms( "Farms" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RealEstateType" );
    }
  };

  private final java.lang.String _stringValue;

  private RealEstateType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RealEstateType forValue( java.lang.String value ) {
    return (xsd.acord.enums.RealEstateType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RealEstateType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RealEstateType) TYPE.get().cg_forValue( value );
  }
