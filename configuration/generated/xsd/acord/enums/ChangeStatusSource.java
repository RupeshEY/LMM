...
public enum ChangeStatusSource implements gw.xml.IXmlSchemaEnumValue {
  DCO( "DCO" ),
  Insurer( "Insurer" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ChangeStatusSource" );
    }
  };

  private final java.lang.String _stringValue;

  private ChangeStatusSource( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ChangeStatusSource forValue( java.lang.String value ) {
    return (xsd.acord.enums.ChangeStatusSource) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ChangeStatusSource forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ChangeStatusSource) TYPE.get().cg_forValue( value );
  }
