...
public enum ClearanceFrom implements gw.xml.IXmlSchemaEnumValue {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ClearanceFrom" );
    }
  };

  private final java.lang.String _stringValue;

  private ClearanceFrom( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ClearanceFrom forValue( java.lang.String value ) {
    return (xsd.acord.enums.ClearanceFrom) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ClearanceFrom forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ClearanceFrom) TYPE.get().cg_forValue( value );
  }
