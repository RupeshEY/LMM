...
public enum HydrantType implements gw.xml.IXmlSchemaEnumValue {
  _2( "2" ),
  NSTD( "NSTD" ),
  STD( "STD" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.HydrantType" );
    }
  };

  private final java.lang.String _stringValue;

  private HydrantType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.HydrantType forValue( java.lang.String value ) {
    return (xsd.acord.enums.HydrantType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.HydrantType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.HydrantType) TYPE.get().cg_forValue( value );
  }
