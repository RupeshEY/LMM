...
public enum OccurredPremises implements gw.xml.IXmlSchemaEnumValue {
  Employer( "Employer" ),
  Lessee( "Lessee" ),
  Other( "Other" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.OccurredPremises" );
    }
  };

  private final java.lang.String _stringValue;

  private OccurredPremises( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.OccurredPremises forValue( java.lang.String value ) {
    return (xsd.acord.enums.OccurredPremises) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.OccurredPremises forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.OccurredPremises) TYPE.get().cg_forValue( value );
  }
