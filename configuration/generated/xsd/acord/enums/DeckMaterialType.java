...
public enum DeckMaterialType implements gw.xml.IXmlSchemaEnumValue {
  Redwood( "Redwood" ),
  Wood( "Wood" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DeckMaterialType" );
    }
  };

  private final java.lang.String _stringValue;

  private DeckMaterialType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DeckMaterialType forValue( java.lang.String value ) {
    return (xsd.acord.enums.DeckMaterialType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DeckMaterialType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DeckMaterialType) TYPE.get().cg_forValue( value );
  }
