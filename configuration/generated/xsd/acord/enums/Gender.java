...
public enum Gender implements gw.xml.IXmlSchemaEnumValue {
  F( "F" ),
  M( "M" ),
  U( "U" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Gender" );
    }
  };

  private final java.lang.String _stringValue;

  private Gender( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Gender forValue( java.lang.String value ) {
    return (xsd.acord.enums.Gender) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Gender forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Gender) TYPE.get().cg_forValue( value );
  }
