...
public enum AirBagType implements gw.xml.IXmlSchemaEnumValue {
  Driver( "Driver" ),
  FrontBoth( "FrontBoth" ),
  FrontSide( "FrontSide" ),
  None( "None" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AirBagType" );
    }
  };

  private final java.lang.String _stringValue;

  private AirBagType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AirBagType forValue( java.lang.String value ) {
    return (xsd.acord.enums.AirBagType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AirBagType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AirBagType) TYPE.get().cg_forValue( value );
  }
