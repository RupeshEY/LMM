...
public enum PassengerType implements gw.xml.IXmlSchemaEnumValue {
  EMPL( "EMPL" ),
  FAML( "FAML" ),
  GUEST( "GUEST" ),
  OT( "OT" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PassengerType" );
    }
  };

  private final java.lang.String _stringValue;

  private PassengerType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PassengerType forValue( java.lang.String value ) {
    return (xsd.acord.enums.PassengerType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PassengerType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PassengerType) TYPE.get().cg_forValue( value );
  }
