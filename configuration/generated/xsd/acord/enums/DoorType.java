...
public enum DoorType implements gw.xml.IXmlSchemaEnumValue {
  DWIDE( "DWIDE" ),
  RDWIDE( "RDWIDE" ),
  RSLIDE( "RSLIDE" ),
  RSWIDE( "RSWIDE" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DoorType" );
    }
  };

  private final java.lang.String _stringValue;

  private DoorType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DoorType forValue( java.lang.String value ) {
    return (xsd.acord.enums.DoorType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DoorType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DoorType) TYPE.get().cg_forValue( value );
  }
