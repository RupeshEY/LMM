...
public enum TaxFilingStatus implements gw.xml.IXmlSchemaEnumValue {
  MarriedJoint( "MarriedJoint" ),
  MarriedSep( "MarriedSep" ),
  Single( "Single" ),
  SingleHH( "SingleHH" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.TaxFilingStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private TaxFilingStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.TaxFilingStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.TaxFilingStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.TaxFilingStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.TaxFilingStatus) TYPE.get().cg_forValue( value );
  }
