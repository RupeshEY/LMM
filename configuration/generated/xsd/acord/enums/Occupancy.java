...
public enum Occupancy implements gw.xml.IXmlSchemaEnumValue {
  MULFM( "MULFM" ),
  NORES( "NORES" ),
  OTRES( "OTRES" ),
  SGLFM( "SGLFM" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Occupancy" );
    }
  };

  private final java.lang.String _stringValue;

  private Occupancy( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Occupancy forValue( java.lang.String value ) {
    return (xsd.acord.enums.Occupancy) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Occupancy forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Occupancy) TYPE.get().cg_forValue( value );
  }
