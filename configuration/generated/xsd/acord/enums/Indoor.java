...
public enum Indoor implements gw.xml.IXmlSchemaEnumValue {
  CombinationIndoorOutdoor( "CombinationIndoorOutdoor" ),
  Indoor( "Indoor" ),
  Outdoor( "Outdoor" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Indoor" );
    }
  };

  private final java.lang.String _stringValue;

  private Indoor( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Indoor forValue( java.lang.String value ) {
    return (xsd.acord.enums.Indoor) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Indoor forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Indoor) TYPE.get().cg_forValue( value );
  }
