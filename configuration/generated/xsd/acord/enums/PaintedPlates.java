...
public enum PaintedPlates implements gw.xml.IXmlSchemaEnumValue {
  COMP( "COMP" ),
  NONE( "NONE" ),
  PART( "PART" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PaintedPlates" );
    }
  };

  private final java.lang.String _stringValue;

  private PaintedPlates( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PaintedPlates forValue( java.lang.String value ) {
    return (xsd.acord.enums.PaintedPlates) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PaintedPlates forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PaintedPlates) TYPE.get().cg_forValue( value );
  }
