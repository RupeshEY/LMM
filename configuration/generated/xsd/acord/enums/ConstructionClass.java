...
public enum ConstructionClass implements gw.xml.IXmlSchemaEnumValue {
  Basic( "Basic" ),
  CUSLUX( "CUSLUX" ),
  CUSTM( "CUSTM" ),
  Designer( "Designer" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ConstructionClass" );
    }
  };

  private final java.lang.String _stringValue;

  private ConstructionClass( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ConstructionClass forValue( java.lang.String value ) {
    return (xsd.acord.enums.ConstructionClass) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ConstructionClass forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ConstructionClass) TYPE.get().cg_forValue( value );
  }
