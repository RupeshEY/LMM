...
public enum DefensiveDriverIndicator implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  N( "N" ),
  Y( "Y" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DefensiveDriverIndicator" );
    }
  };

  private final java.lang.String _stringValue;

  private DefensiveDriverIndicator( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DefensiveDriverIndicator forValue( java.lang.String value ) {
    return (xsd.acord.enums.DefensiveDriverIndicator) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DefensiveDriverIndicator forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DefensiveDriverIndicator) TYPE.get().cg_forValue( value );
  }
