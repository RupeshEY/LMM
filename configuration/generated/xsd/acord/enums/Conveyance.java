...
public enum Conveyance implements gw.xml.IXmlSchemaEnumValue {
  Air( "Air" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Conveyance" );
    }
  };

  private final java.lang.String _stringValue;

  private Conveyance( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Conveyance forValue( java.lang.String value ) {
    return (xsd.acord.enums.Conveyance) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Conveyance forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Conveyance) TYPE.get().cg_forValue( value );
  }
