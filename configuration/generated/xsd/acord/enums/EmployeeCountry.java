...
public enum EmployeeCountry implements gw.xml.IXmlSchemaEnumValue {
  Both( "Both" ),
  Domestic( "Domestic" ),
  Foreign( "Foreign" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EmployeeCountry" );
    }
  };

  private final java.lang.String _stringValue;

  private EmployeeCountry( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EmployeeCountry forValue( java.lang.String value ) {
    return (xsd.acord.enums.EmployeeCountry) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EmployeeCountry forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EmployeeCountry) TYPE.get().cg_forValue( value );
  }
