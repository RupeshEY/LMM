...
public enum EntityType implements gw.xml.IXmlSchemaEnumValue {
  BINARY( "BINARY" ),
  CURRENCY( "CURRENCY" ),
  DURATION( "DURATION" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EntityType" );
    }
  };

  private final java.lang.String _stringValue;

  private EntityType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EntityType forValue( java.lang.String value ) {
    return (xsd.acord.enums.EntityType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EntityType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EntityType) TYPE.get().cg_forValue( value );
  }
