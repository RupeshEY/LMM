...
public enum DefenseCategory implements gw.xml.IXmlSchemaEnumValue {
  Cumis( "Cumis" ),
  HouseCounsel( "HouseCounsel" ),
  NonPanel( "NonPanel" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DefenseCategory" );
    }
  };

  private final java.lang.String _stringValue;

  private DefenseCategory( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DefenseCategory forValue( java.lang.String value ) {
    return (xsd.acord.enums.DefenseCategory) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DefenseCategory forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DefenseCategory) TYPE.get().cg_forValue( value );
  }
