...
public enum ContentsLocation implements gw.xml.IXmlSchemaEnumValue {
  ABVGL( "ABVGL" ),
  BASEA( "BASEA" ),
  BASEO( "BASEO" ),
  LOWAB( "LOWAB" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ContentsLocation" );
    }
  };

  private final java.lang.String _stringValue;

  private ContentsLocation( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ContentsLocation forValue( java.lang.String value ) {
    return (xsd.acord.enums.ContentsLocation) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ContentsLocation forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ContentsLocation) TYPE.get().cg_forValue( value );
  }
