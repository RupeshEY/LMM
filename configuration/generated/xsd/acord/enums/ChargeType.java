...
public enum ChargeType implements gw.xml.IXmlSchemaEnumValue {
  ATTFF( "ATTFF" ),
  BND( "BND" ),
  CANCE( "CANCE" ),
  CTSGN( "CTSGN" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ChargeType" );
    }
  };

  private final java.lang.String _stringValue;

  private ChargeType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ChargeType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ChargeType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ChargeType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ChargeType) TYPE.get().cg_forValue( value );
  }
