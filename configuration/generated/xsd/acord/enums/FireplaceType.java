...
public enum FireplaceType implements gw.xml.IXmlSchemaEnumValue {
  Embedded( "Embedded" ),
  GasHook( "GasHook" ),
  Kiva( "Kiva" ),
  MarbSurrnd( "MarbSurrnd" ),
  MetalInsert( "MetalInsert" ),
  Multiface( "Multiface" ),
  MY( "MY" ),
  Other( "Other" ),
  PreFabMetal( "PreFabMetal" ),
  WoodSurrnd( "WoodSurrnd" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.FireplaceType" );
    }
  };

  private final java.lang.String _stringValue;

  private FireplaceType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.FireplaceType forValue( java.lang.String value ) {
    return (xsd.acord.enums.FireplaceType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.FireplaceType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.FireplaceType) TYPE.get().cg_forValue( value );
  }
