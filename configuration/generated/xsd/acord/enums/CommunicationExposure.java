...
public enum CommunicationExposure implements gw.xml.IXmlSchemaEnumValue {
  Airport( "Airport" ),
  Brush( "Brush" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CommunicationExposure" );
    }
  };

  private final java.lang.String _stringValue;

  private CommunicationExposure( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CommunicationExposure forValue( java.lang.String value ) {
    return (xsd.acord.enums.CommunicationExposure) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CommunicationExposure forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CommunicationExposure) TYPE.get().cg_forValue( value );
  }
