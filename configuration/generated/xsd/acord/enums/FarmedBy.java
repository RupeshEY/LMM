...
public enum FarmedBy implements gw.xml.IXmlSchemaEnumValue {
  Manager( "Manager" ),
  Neighbor( "Neighbor" ),
  Other( "Other" ),
  Owner( "Owner" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.FarmedBy" );
    }
  };

  private final java.lang.String _stringValue;

  private FarmedBy( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.FarmedBy forValue( java.lang.String value ) {
    return (xsd.acord.enums.FarmedBy) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.FarmedBy forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.FarmedBy) TYPE.get().cg_forValue( value );
  }
