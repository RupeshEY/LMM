...
public enum AirportOccupancy implements gw.xml.IXmlSchemaEnumValue {
  E( "E" ),
  OT( "OT" ),
  P( "P" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AirportOccupancy" );
    }
  };

  private final java.lang.String _stringValue;

  private AirportOccupancy( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AirportOccupancy forValue( java.lang.String value ) {
    return (xsd.acord.enums.AirportOccupancy) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AirportOccupancy forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AirportOccupancy) TYPE.get().cg_forValue( value );
  }
