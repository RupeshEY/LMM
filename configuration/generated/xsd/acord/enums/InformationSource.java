...
public enum InformationSource implements gw.xml.IXmlSchemaEnumValue {
  COMMO( "COMMO" ),
  FLMAP( "FLMAP" ),
  MORTG( "MORTG" ),
  OT( "OT" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.InformationSource" );
    }
  };

  private final java.lang.String _stringValue;

  private InformationSource( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.InformationSource forValue( java.lang.String value ) {
    return (xsd.acord.enums.InformationSource) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.InformationSource forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.InformationSource) TYPE.get().cg_forValue( value );
  }
