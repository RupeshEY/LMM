...
public enum RatingMethod implements gw.xml.IXmlSchemaEnumValue {
  CLR( "CLR" ),
  S( "S" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RatingMethod" );
    }
  };

  private final java.lang.String _stringValue;

  private RatingMethod( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RatingMethod forValue( java.lang.String value ) {
    return (xsd.acord.enums.RatingMethod) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RatingMethod forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RatingMethod) TYPE.get().cg_forValue( value );
  }
