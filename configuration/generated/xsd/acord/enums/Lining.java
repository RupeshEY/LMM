...
public enum Lining implements gw.xml.IXmlSchemaEnumValue {
  Flue( "Flue" ),
  NONE( "NONE" ),
  OT( "OT" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Lining" );
    }
  };

  private final java.lang.String _stringValue;

  private Lining( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Lining forValue( java.lang.String value ) {
    return (xsd.acord.enums.Lining) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Lining forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Lining) TYPE.get().cg_forValue( value );
  }
