...
public enum BondType implements gw.xml.IXmlSchemaEnumValue {
  CONTB( "CONTB" ),
  CONTF( "CONTF" ),
  JUDCL( "JUDCL" ),
  LICPT( "LICPT" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.BondType" );
    }
  };

  private final java.lang.String _stringValue;

  private BondType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.BondType forValue( java.lang.String value ) {
    return (xsd.acord.enums.BondType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.BondType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.BondType) TYPE.get().cg_forValue( value );
  }
