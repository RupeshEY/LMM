...
public enum LicenseStatus implements gw.xml.IXmlSchemaEnumValue {
  Active( "Active" ),
  Expired( "Expired" ),
  LapsedIntentionally( "LapsedIntentionally" ),
  Pending( "Pending" ),
  Prior( "Prior" ),
  Revoked( "Revoked" ),
  Suspended( "Suspended" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.LicenseStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private LicenseStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.LicenseStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.LicenseStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.LicenseStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.LicenseStatus) TYPE.get().cg_forValue( value );
  }
