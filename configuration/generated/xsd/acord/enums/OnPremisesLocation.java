...
public enum OnPremisesLocation implements gw.xml.IXmlSchemaEnumValue {
  CRoom( "CRoom" ),
  OT( "OT" ),
  Safe( "Safe" ),
  Vault( "Vault" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.OnPremisesLocation" );
    }
  };

  private final java.lang.String _stringValue;

  private OnPremisesLocation( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.OnPremisesLocation forValue( java.lang.String value ) {
    return (xsd.acord.enums.OnPremisesLocation) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.OnPremisesLocation forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.OnPremisesLocation) TYPE.get().cg_forValue( value );
  }
