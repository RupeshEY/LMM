...
public enum ReplacementType implements gw.xml.IXmlSchemaEnumValue {
  HARD( "HARD" ),
  SOFT( "SOFT" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ReplacementType" );
    }
  };

  private final java.lang.String _stringValue;

  private ReplacementType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ReplacementType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ReplacementType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ReplacementType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ReplacementType) TYPE.get().cg_forValue( value );
  }
