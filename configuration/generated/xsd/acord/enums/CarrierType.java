...
public enum CarrierType implements gw.xml.IXmlSchemaEnumValue {
  CM( "CM" ),
  CN( "CN" ),
  EX( "EX" ),
  OT( "OT" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CarrierType" );
    }
  };

  private final java.lang.String _stringValue;

  private CarrierType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CarrierType forValue( java.lang.String value ) {
    return (xsd.acord.enums.CarrierType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CarrierType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CarrierType) TYPE.get().cg_forValue( value );
  }
