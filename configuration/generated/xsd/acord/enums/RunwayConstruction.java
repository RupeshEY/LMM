...
public enum RunwayConstruction implements gw.xml.IXmlSchemaEnumValue {
  B( "B" ),
  C( "C" ),
  G( "G" ),
  OT( "OT" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RunwayConstruction" );
    }
  };

  private final java.lang.String _stringValue;

  private RunwayConstruction( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RunwayConstruction forValue( java.lang.String value ) {
    return (xsd.acord.enums.RunwayConstruction) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RunwayConstruction forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RunwayConstruction) TYPE.get().cg_forValue( value );
  }
