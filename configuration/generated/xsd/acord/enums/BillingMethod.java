...
public enum BillingMethod implements gw.xml.IXmlSchemaEnumValue {
  AB( "AB" ),
  CAB( "CAB" ),
  CPB( "CPB" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.BillingMethod" );
    }
  };

  private final java.lang.String _stringValue;

  private BillingMethod( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.BillingMethod forValue( java.lang.String value ) {
    return (xsd.acord.enums.BillingMethod) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.BillingMethod forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.BillingMethod) TYPE.get().cg_forValue( value );
  }
