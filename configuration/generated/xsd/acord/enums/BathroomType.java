...
public enum BathroomType implements gw.xml.IXmlSchemaEnumValue {
  Full( "Full" ),
  Half( "Half" ),
  Master( "Master" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.BathroomType" );
    }
  };

  private final java.lang.String _stringValue;

  private BathroomType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.BathroomType forValue( java.lang.String value ) {
    return (xsd.acord.enums.BathroomType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.BathroomType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.BathroomType) TYPE.get().cg_forValue( value );
  }
