...
public enum CancelEvidenceObtained implements gw.xml.IXmlSchemaEnumValue {
  N( "N" ),
  O( "O" ),
  P( "P" ),
  R( "R" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CancelEvidenceObtained" );
    }
  };

  private final java.lang.String _stringValue;

  private CancelEvidenceObtained( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CancelEvidenceObtained forValue( java.lang.String value ) {
    return (xsd.acord.enums.CancelEvidenceObtained) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CancelEvidenceObtained forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CancelEvidenceObtained) TYPE.get().cg_forValue( value );
  }
