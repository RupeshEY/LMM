...
public enum SupplementaryNameType implements gw.xml.IXmlSchemaEnumValue {
  AKA( "AKA" ),
  Alias( "Alias" ),
  ATTN( "ATTN" ),
  Branch( "Branch" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SupplementaryNameType" );
    }
  };

  private final java.lang.String _stringValue;

  private SupplementaryNameType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SupplementaryNameType forValue( java.lang.String value ) {
    return (xsd.acord.enums.SupplementaryNameType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SupplementaryNameType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SupplementaryNameType) TYPE.get().cg_forValue( value );
  }
