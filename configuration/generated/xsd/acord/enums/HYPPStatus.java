...
public enum HYPPStatus implements gw.xml.IXmlSchemaEnumValue {
  HH( "HH" ),
  NH( "NH" ),
  NN( "NN" ),
  UN( "UN" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.HYPPStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private HYPPStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.HYPPStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.HYPPStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.HYPPStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.HYPPStatus) TYPE.get().cg_forValue( value );
  }
