...
public enum WindClass implements gw.xml.IXmlSchemaEnumValue {
  OT( "OT" ),
  SWR( "SWR" ),
  WR( "WR" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.WindClass" );
    }
  };

  private final java.lang.String _stringValue;

  private WindClass( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.WindClass forValue( java.lang.String value ) {
    return (xsd.acord.enums.WindClass) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.WindClass forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.WindClass) TYPE.get().cg_forValue( value );
  }
