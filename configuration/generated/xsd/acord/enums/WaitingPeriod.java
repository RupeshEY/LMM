...
public enum WaitingPeriod implements gw.xml.IXmlSchemaEnumValue {
  LN0( "LN0" ),
  MR1( "MR1" ),
  S30( "S30" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.WaitingPeriod" );
    }
  };

  private final java.lang.String _stringValue;

  private WaitingPeriod( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.WaitingPeriod forValue( java.lang.String value ) {
    return (xsd.acord.enums.WaitingPeriod) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.WaitingPeriod forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.WaitingPeriod) TYPE.get().cg_forValue( value );
  }
