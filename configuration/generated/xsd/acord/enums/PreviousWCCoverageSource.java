...
public enum PreviousWCCoverageSource implements gw.xml.IXmlSchemaEnumValue {
  E( "E" ),
  NBS( "NBS" ),
  SIGRP( "SIGRP" ),
  SIIND( "SIIND" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PreviousWCCoverageSource" );
    }
  };

  private final java.lang.String _stringValue;

  private PreviousWCCoverageSource( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PreviousWCCoverageSource forValue( java.lang.String value ) {
    return (xsd.acord.enums.PreviousWCCoverageSource) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PreviousWCCoverageSource forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PreviousWCCoverageSource) TYPE.get().cg_forValue( value );
  }
