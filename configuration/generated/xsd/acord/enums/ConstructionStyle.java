...
public enum ConstructionStyle implements gw.xml.IXmlSchemaEnumValue {
  Pre1930( "Pre1930" ),
  Pre1940( "Pre1940" ),
  Standard( "Standard" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ConstructionStyle" );
    }
  };

  private final java.lang.String _stringValue;

  private ConstructionStyle( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ConstructionStyle forValue( java.lang.String value ) {
    return (xsd.acord.enums.ConstructionStyle) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ConstructionStyle forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ConstructionStyle) TYPE.get().cg_forValue( value );
  }
