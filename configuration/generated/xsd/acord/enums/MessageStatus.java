...
public enum MessageStatus implements gw.xml.IXmlSchemaEnumValue {
  Error( "Error" ),
  Rejected( "Rejected" ),
  ResponsePending( "ResponsePending" ),
  ResultPendingOutOfBand( "ResultPendingOutOfBand" ),
  Success( "Success" ),
  SuccessWithChanges( "SuccessWithChanges" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.MessageStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private MessageStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.MessageStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.MessageStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.MessageStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.MessageStatus) TYPE.get().cg_forValue( value );
  }
