...
public enum DirectionType implements gw.xml.IXmlSchemaEnumValue {
  E( "E" ),
  N( "N" ),
  NE( "NE" ),
  NW( "NW" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DirectionType" );
    }
  };

  private final java.lang.String _stringValue;

  private DirectionType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DirectionType forValue( java.lang.String value ) {
    return (xsd.acord.enums.DirectionType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DirectionType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DirectionType) TYPE.get().cg_forValue( value );
  }
