...
public enum FinancialType implements gw.xml.IXmlSchemaEnumValue {
  Audited( "Audited" ),
  Compiled( "Compiled" ),
  Internal( "Internal" ),
  Reviewed( "Reviewed" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.FinancialType" );
    }
  };

  private final java.lang.String _stringValue;

  private FinancialType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.FinancialType forValue( java.lang.String value ) {
    return (xsd.acord.enums.FinancialType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.FinancialType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.FinancialType) TYPE.get().cg_forValue( value );
  }
