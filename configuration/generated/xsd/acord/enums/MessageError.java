...
public enum MessageError implements gw.xml.IXmlSchemaEnumValue {
  DataError( "DataError" ),
  DuplicateRqUID( "DuplicateRqUID" ),
  GeneralFailure( "GeneralFailure" ),
  InvalidRqUID( "InvalidRqUID" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.MessageError" );
    }
  };

  private final java.lang.String _stringValue;

  private MessageError( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.MessageError forValue( java.lang.String value ) {
    return (xsd.acord.enums.MessageError) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.MessageError forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.MessageError) TYPE.get().cg_forValue( value );
  }
