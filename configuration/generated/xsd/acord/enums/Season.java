...
public enum Season implements gw.xml.IXmlSchemaEnumValue {
  SUMMER( "SUMMER" ),
  WINTER( "WINTER" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Season" );
    }
  };

  private final java.lang.String _stringValue;

  private Season( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Season forValue( java.lang.String value ) {
    return (xsd.acord.enums.Season) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Season forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Season) TYPE.get().cg_forValue( value );
  }
