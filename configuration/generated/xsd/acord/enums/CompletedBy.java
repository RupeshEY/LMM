...
public enum CompletedBy implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  OT( "OT" ),
  P( "P" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CompletedBy" );
    }
  };

  private final java.lang.String _stringValue;

  private CompletedBy( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CompletedBy forValue( java.lang.String value ) {
    return (xsd.acord.enums.CompletedBy) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CompletedBy forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CompletedBy) TYPE.get().cg_forValue( value );
  }
