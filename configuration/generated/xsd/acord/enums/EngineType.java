...
public enum EngineType implements gw.xml.IXmlSchemaEnumValue {
  D( "D" ),
  E( "E" ),
  G( "G" ),
  H( "H" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EngineType" );
    }
  };

  private final java.lang.String _stringValue;

  private EngineType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EngineType forValue( java.lang.String value ) {
    return (xsd.acord.enums.EngineType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EngineType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EngineType) TYPE.get().cg_forValue( value );
  }
