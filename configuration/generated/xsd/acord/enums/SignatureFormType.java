...
public enum SignatureFormType implements gw.xml.IXmlSchemaEnumValue {
  APP( "APP" ),
  LA1( "LA1" ),
  SL1( "SL1" ),
  SL2( "SL2" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SignatureFormType" );
    }
  };

  private final java.lang.String _stringValue;

  private SignatureFormType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SignatureFormType forValue( java.lang.String value ) {
    return (xsd.acord.enums.SignatureFormType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SignatureFormType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SignatureFormType) TYPE.get().cg_forValue( value );
  }
