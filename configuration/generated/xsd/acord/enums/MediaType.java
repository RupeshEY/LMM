...
public enum MediaType implements gw.xml.IXmlSchemaEnumValue {
  E( "E" ),
  H( "H" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.MediaType" );
    }
  };

  private final java.lang.String _stringValue;

  private MediaType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.MediaType forValue( java.lang.String value ) {
    return (xsd.acord.enums.MediaType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.MediaType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.MediaType) TYPE.get().cg_forValue( value );
  }
