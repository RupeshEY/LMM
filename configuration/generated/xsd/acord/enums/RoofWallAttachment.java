...
public enum RoofWallAttachment implements gw.xml.IXmlSchemaEnumValue {
  ABOLT( "ABOLT" ),
  ADHESIVE( "ADHESIVE" ),
  GRAVITY( "GRAVITY" ),
  HTIES( "HTIES" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RoofWallAttachment" );
    }
  };

  private final java.lang.String _stringValue;

  private RoofWallAttachment( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RoofWallAttachment forValue( java.lang.String value ) {
    return (xsd.acord.enums.RoofWallAttachment) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RoofWallAttachment forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RoofWallAttachment) TYPE.get().cg_forValue( value );
  }
