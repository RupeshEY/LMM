...
public enum AmountType implements gw.xml.IXmlSchemaEnumValue {
  AnticDed( "AnticDed" ),
  AnticRecov( "AnticRecov" ),
  DedReimbursement( "DedReimbursement" ),
  OutResv( "OutResv" ),
  PdDed( "PdDed" ),
  PdDt( "PdDt" ),
  PdRecov( "PdRecov" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AmountType" );
    }
  };

  private final java.lang.String _stringValue;

  private AmountType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AmountType forValue( java.lang.String value ) {
    return (xsd.acord.enums.AmountType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AmountType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AmountType) TYPE.get().cg_forValue( value );
  }
