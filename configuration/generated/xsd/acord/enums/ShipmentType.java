...
public enum ShipmentType implements gw.xml.IXmlSchemaEnumValue {
  Domestic( "Domestic" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ShipmentType" );
    }
  };

  private final java.lang.String _stringValue;

  private ShipmentType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ShipmentType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ShipmentType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ShipmentType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ShipmentType) TYPE.get().cg_forValue( value );
  }
