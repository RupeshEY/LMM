...
public enum TestType implements gw.xml.IXmlSchemaEnumValue {
  Blood( "Blood" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.TestType" );
    }
  };

  private final java.lang.String _stringValue;

  private TestType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.TestType forValue( java.lang.String value ) {
    return (xsd.acord.enums.TestType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.TestType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.TestType) TYPE.get().cg_forValue( value );
  }
