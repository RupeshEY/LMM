...
public enum AutoAntiTheftDevice implements gw.xml.IXmlSchemaEnumValue {
  _0( "0" ),
  _1( "1" ),
  _10( "10" ),
  _11( "11" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AutoAntiTheftDevice" );
    }
  };

  private final java.lang.String _stringValue;

  private AutoAntiTheftDevice( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AutoAntiTheftDevice forValue( java.lang.String value ) {
    return (xsd.acord.enums.AutoAntiTheftDevice) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AutoAntiTheftDevice forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AutoAntiTheftDevice) TYPE.get().cg_forValue( value );
  }
