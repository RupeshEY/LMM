...
public enum OtherPolicyType implements gw.xml.IXmlSchemaEnumValue {
  Other( "Other" ),
  Prior( "Prior" ),
  Underly( "Underly" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.OtherPolicyType" );
    }
  };

  private final java.lang.String _stringValue;

  private OtherPolicyType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.OtherPolicyType forValue( java.lang.String value ) {
    return (xsd.acord.enums.OtherPolicyType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.OtherPolicyType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.OtherPolicyType) TYPE.get().cg_forValue( value );
  }
