...
public enum SalesReceiptAppraisals implements gw.xml.IXmlSchemaEnumValue {
  Appraisal( "Appraisal" ),
  SaleRec( "SaleRec" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SalesReceiptAppraisals" );
    }
  };

  private final java.lang.String _stringValue;

  private SalesReceiptAppraisals( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SalesReceiptAppraisals forValue( java.lang.String value ) {
    return (xsd.acord.enums.SalesReceiptAppraisals) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SalesReceiptAppraisals forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SalesReceiptAppraisals) TYPE.get().cg_forValue( value );
  }
