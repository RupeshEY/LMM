...
public enum RoofCoverAttachment implements gw.xml.IXmlSchemaEnumValue {
  ADHESIVE( "ADHESIVE" ),
  MORTAR( "MORTAR" ),
  NAIL( "NAIL" ),
  SCREW( "SCREW" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RoofCoverAttachment" );
    }
  };

  private final java.lang.String _stringValue;

  private RoofCoverAttachment( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RoofCoverAttachment forValue( java.lang.String value ) {
    return (xsd.acord.enums.RoofCoverAttachment) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RoofCoverAttachment forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RoofCoverAttachment) TYPE.get().cg_forValue( value );
  }
