...
public enum ProtectionExtent implements gw.xml.IXmlSchemaEnumValue {
  AF( "AF" ),
  AG( "AG" ),
  AOP( "AOP" ),
  BG( "BG" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ProtectionExtent" );
    }
  };

  private final java.lang.String _stringValue;

  private ProtectionExtent( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ProtectionExtent forValue( java.lang.String value ) {
    return (xsd.acord.enums.ProtectionExtent) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ProtectionExtent forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ProtectionExtent) TYPE.get().cg_forValue( value );
  }
