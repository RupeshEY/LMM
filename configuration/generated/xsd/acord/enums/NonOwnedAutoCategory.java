...
public enum NonOwnedAutoCategory implements gw.xml.IXmlSchemaEnumValue {
  E( "E" ),
  PRT( "PRT" ),
  V( "V" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.NonOwnedAutoCategory" );
    }
  };

  private final java.lang.String _stringValue;

  private NonOwnedAutoCategory( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.NonOwnedAutoCategory forValue( java.lang.String value ) {
    return (xsd.acord.enums.NonOwnedAutoCategory) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.NonOwnedAutoCategory forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.NonOwnedAutoCategory) TYPE.get().cg_forValue( value );
  }
