...
public enum Days implements gw.xml.IXmlSchemaEnumValue {
  Friday( "Friday" ),
  Monday( "Monday" ),
  Saturday( "Saturday" ),
  Sunday( "Sunday" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Days" );
    }
  };

  private final java.lang.String _stringValue;

  private Days( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Days forValue( java.lang.String value ) {
    return (xsd.acord.enums.Days) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Days forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Days) TYPE.get().cg_forValue( value );
  }
