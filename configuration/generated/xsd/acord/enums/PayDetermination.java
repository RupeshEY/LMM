...
public enum PayDetermination implements gw.xml.IXmlSchemaEnumValue {
  ACT( "ACT" ),
  EST( "EST" ),
  MAX( "MAX" ),
  MIN( "MIN" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PayDetermination" );
    }
  };

  private final java.lang.String _stringValue;

  private PayDetermination( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PayDetermination forValue( java.lang.String value ) {
    return (xsd.acord.enums.PayDetermination) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PayDetermination forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PayDetermination) TYPE.get().cg_forValue( value );
  }
