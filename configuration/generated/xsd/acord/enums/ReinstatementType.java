...
public enum ReinstatementType implements gw.xml.IXmlSchemaEnumValue {
  RFL( "RFL" ),
  RMID( "RMID" ),
  RWNR( "RWNR" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ReinstatementType" );
    }
  };

  private final java.lang.String _stringValue;

  private ReinstatementType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ReinstatementType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ReinstatementType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ReinstatementType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ReinstatementType) TYPE.get().cg_forValue( value );
  }
