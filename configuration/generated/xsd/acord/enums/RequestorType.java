...
public enum RequestorType implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  C( "C" ),
  I( "I" ),
  O( "O" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RequestorType" );
    }
  };

  private final java.lang.String _stringValue;

  private RequestorType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RequestorType forValue( java.lang.String value ) {
    return (xsd.acord.enums.RequestorType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RequestorType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RequestorType) TYPE.get().cg_forValue( value );
  }
