...
public enum PremiumAccountingType implements gw.xml.IXmlSchemaEnumValue {
  Earned( "Earned" ),
  Unearned( "Unearned" ),
  Written( "Written" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PremiumAccountingType" );
    }
  };

  private final java.lang.String _stringValue;

  private PremiumAccountingType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PremiumAccountingType forValue( java.lang.String value ) {
    return (xsd.acord.enums.PremiumAccountingType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PremiumAccountingType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PremiumAccountingType) TYPE.get().cg_forValue( value );
  }
