...
public enum TaxType implements gw.xml.IXmlSchemaEnumValue {
  Liab( "Liab" ),
  Prop( "Prop" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.TaxType" );
    }
  };

  private final java.lang.String _stringValue;

  private TaxType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.TaxType forValue( java.lang.String value ) {
    return (xsd.acord.enums.TaxType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.TaxType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.TaxType) TYPE.get().cg_forValue( value );
  }
