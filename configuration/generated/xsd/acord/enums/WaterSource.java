...
public enum WaterSource implements gw.xml.IXmlSchemaEnumValue {
  H( "H" ),
  OT( "OT" ),
  PL( "PL" ),
  W( "W" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.WaterSource" );
    }
  };

  private final java.lang.String _stringValue;

  private WaterSource( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.WaterSource forValue( java.lang.String value ) {
    return (xsd.acord.enums.WaterSource) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.WaterSource forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.WaterSource) TYPE.get().cg_forValue( value );
  }
