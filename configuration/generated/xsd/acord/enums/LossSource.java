...
public enum LossSource implements gw.xml.IXmlSchemaEnumValue {
  Carrier( "Carrier" ),
  FEMA( "FEMA" ),
  FICO( "FICO" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.LossSource" );
    }
  };

  private final java.lang.String _stringValue;

  private LossSource( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.LossSource forValue( java.lang.String value ) {
    return (xsd.acord.enums.LossSource) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.LossSource forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.LossSource) TYPE.get().cg_forValue( value );
  }
