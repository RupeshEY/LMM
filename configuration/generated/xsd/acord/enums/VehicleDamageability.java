...
public enum VehicleDamageability implements gw.xml.IXmlSchemaEnumValue {
  AV( "AV" ),
  H( "H" ),
  L( "L" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.VehicleDamageability" );
    }
  };

  private final java.lang.String _stringValue;

  private VehicleDamageability( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.VehicleDamageability forValue( java.lang.String value ) {
    return (xsd.acord.enums.VehicleDamageability) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.VehicleDamageability forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.VehicleDamageability) TYPE.get().cg_forValue( value );
  }
