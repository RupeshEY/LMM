...
public enum InquiryTerms implements gw.xml.IXmlSchemaEnumValue {
  AllTerms( "AllTerms" ),
  CurrentAndPreviousTerm( "CurrentAndPreviousTerm" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.InquiryTerms" );
    }
  };

  private final java.lang.String _stringValue;

  private InquiryTerms( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.InquiryTerms forValue( java.lang.String value ) {
    return (xsd.acord.enums.InquiryTerms) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.InquiryTerms forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.InquiryTerms) TYPE.get().cg_forValue( value );
  }
