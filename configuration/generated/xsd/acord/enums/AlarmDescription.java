...
public enum AlarmDescription implements gw.xml.IXmlSchemaEnumValue {
  BOT( "BOT" ),
  CE( "CE" ),
  CEK( "CEK" ),
  CEN( "CEN" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AlarmDescription" );
    }
  };

  private final java.lang.String _stringValue;

  private AlarmDescription( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AlarmDescription forValue( java.lang.String value ) {
    return (xsd.acord.enums.AlarmDescription) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AlarmDescription forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AlarmDescription) TYPE.get().cg_forValue( value );
  }
