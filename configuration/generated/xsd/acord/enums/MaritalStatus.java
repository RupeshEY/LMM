...
public enum MaritalStatus implements gw.xml.IXmlSchemaEnumValue {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.MaritalStatus" );
    }
  };
  ...
  public static final xsd.acord.enums.MaritalStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.MaritalStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.MaritalStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.MaritalStatus) TYPE.get().cg_forValue( value );
  }
