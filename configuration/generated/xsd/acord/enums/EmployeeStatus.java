...
public enum EmployeeStatus implements gw.xml.IXmlSchemaEnumValue {
  CONT( "CONT" ),
  FULL( "FULL" ),
  OT( "OT" ),
  PART( "PART" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EmployeeStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private EmployeeStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EmployeeStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.EmployeeStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EmployeeStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EmployeeStatus) TYPE.get().cg_forValue( value );
  }
