...
public enum LandUse implements gw.xml.IXmlSchemaEnumValue {
  CRP( "CRP" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.LandUse" );
    }
  };

  private final java.lang.String _stringValue;

  private LandUse( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.LandUse forValue( java.lang.String value ) {
    return (xsd.acord.enums.LandUse) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.LandUse forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.LandUse) TYPE.get().cg_forValue( value );
  }
