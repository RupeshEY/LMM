...
public enum NatureOperations implements gw.xml.IXmlSchemaEnumValue {
  Boring( "Boring" ),
  Brazing( "Brazing" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.NatureOperations" );
    }
  };

  private final java.lang.String _stringValue;

  private NatureOperations( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.NatureOperations forValue( java.lang.String value ) {
    return (xsd.acord.enums.NatureOperations) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.NatureOperations forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.NatureOperations) TYPE.get().cg_forValue( value );
  }
