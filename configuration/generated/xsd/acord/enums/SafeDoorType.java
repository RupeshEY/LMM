...
public enum SafeDoorType implements gw.xml.IXmlSchemaEnumValue {
  RND( "RND" ),
  SQR( "SQR" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SafeDoorType" );
    }
  };

  private final java.lang.String _stringValue;

  private SafeDoorType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SafeDoorType forValue( java.lang.String value ) {
    return (xsd.acord.enums.SafeDoorType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SafeDoorType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SafeDoorType) TYPE.get().cg_forValue( value );
  }
