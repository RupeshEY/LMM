...
public enum VehElevAirType implements gw.xml.IXmlSchemaEnumValue {
  AOOA( "AOOA" ),
  CAR( "CAR" ),
  ELEV( "ELEV" ),
  ESCA( "ESCA" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.VehElevAirType" );
    }
  };

  private final java.lang.String _stringValue;

  private VehElevAirType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.VehElevAirType forValue( java.lang.String value ) {
    return (xsd.acord.enums.VehElevAirType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.VehElevAirType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.VehElevAirType) TYPE.get().cg_forValue( value );
  }
