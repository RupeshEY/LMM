...
public enum PaintType implements gw.xml.IXmlSchemaEnumValue {
  Latex( "Latex" ),
  Oil( "Oil" ),
  WhiteWash( "WhiteWash" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PaintType" );
    }
  };

  private final java.lang.String _stringValue;

  private PaintType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PaintType forValue( java.lang.String value ) {
    return (xsd.acord.enums.PaintType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PaintType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PaintType) TYPE.get().cg_forValue( value );
  }
