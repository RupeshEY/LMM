...
public enum YearIdentifier implements gw.xml.IXmlSchemaEnumValue {
  Last( "Last" ),
  Last12( "Last12" ),
  Next( "Next" ),
  Next12( "Next12" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.YearIdentifier" );
    }
  };

  private final java.lang.String _stringValue;

  private YearIdentifier( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.YearIdentifier forValue( java.lang.String value ) {
    return (xsd.acord.enums.YearIdentifier) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.YearIdentifier forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.YearIdentifier) TYPE.get().cg_forValue( value );
  }
