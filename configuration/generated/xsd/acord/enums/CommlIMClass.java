...
public enum CommlIMClass implements gw.xml.IXmlSchemaEnumValue {
  AccountsReceivable( "AccountsReceivable" ),
  BuildersRisk( "BuildersRisk" ),
  CommlArticles( "CommlArticles" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CommlIMClass" );
    }
  };

  private final java.lang.String _stringValue;

  private CommlIMClass( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CommlIMClass forValue( java.lang.String value ) {
    return (xsd.acord.enums.CommlIMClass) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CommlIMClass forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CommlIMClass) TYPE.get().cg_forValue( value );
  }
