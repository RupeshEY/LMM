...
public enum PilotType implements gw.xml.IXmlSchemaEnumValue {
  CHART( "CHART" ),
  CHIEF( "CHIEF" ),
  COMML( "COMML" ),
  INSFL( "INSFL" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PilotType" );
    }
  };

  private final java.lang.String _stringValue;

  private PilotType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PilotType forValue( java.lang.String value ) {
    return (xsd.acord.enums.PilotType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PilotType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PilotType) TYPE.get().cg_forValue( value );
  }
