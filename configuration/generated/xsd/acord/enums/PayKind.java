...
public enum PayKind implements gw.xml.IXmlSchemaEnumValue {
  GROSS( "GROSS" ),
  MEALS( "MEALS" ),
  OT( "OT" ),
  OTIME( "OTIME" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PayKind" );
    }
  };

  private final java.lang.String _stringValue;

  private PayKind( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PayKind forValue( java.lang.String value ) {
    return (xsd.acord.enums.PayKind) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PayKind forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PayKind) TYPE.get().cg_forValue( value );
  }
