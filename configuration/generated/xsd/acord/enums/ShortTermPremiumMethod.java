...
public enum ShortTermPremiumMethod implements gw.xml.IXmlSchemaEnumValue {
  B( "B" ),
  P( "P" ),
  S( "S" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ShortTermPremiumMethod" );
    }
  };

  private final java.lang.String _stringValue;

  private ShortTermPremiumMethod( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ShortTermPremiumMethod forValue( java.lang.String value ) {
    return (xsd.acord.enums.ShortTermPremiumMethod) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ShortTermPremiumMethod forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ShortTermPremiumMethod) TYPE.get().cg_forValue( value );
  }
