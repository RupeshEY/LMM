...
public enum DriverType implements gw.xml.IXmlSchemaEnumValue {
  DD( "DD" ),
  E( "E" ),
  N( "N" ),
  U( "U" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DriverType" );
    }
  };

  private final java.lang.String _stringValue;

  private DriverType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DriverType forValue( java.lang.String value ) {
    return (xsd.acord.enums.DriverType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DriverType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DriverType) TYPE.get().cg_forValue( value );
  }
