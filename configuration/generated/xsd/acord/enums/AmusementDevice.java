...
public enum AmusementDevice implements gw.xml.IXmlSchemaEnumValue {
  Gambling( "Gambling" ),
  OT( "OT" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AmusementDevice" );
    }
  };

  private final java.lang.String _stringValue;

  private AmusementDevice( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AmusementDevice forValue( java.lang.String value ) {
    return (xsd.acord.enums.AmusementDevice) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AmusementDevice forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AmusementDevice) TYPE.get().cg_forValue( value );
  }
