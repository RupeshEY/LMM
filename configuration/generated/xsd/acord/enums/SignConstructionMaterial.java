...
public enum SignConstructionMaterial implements gw.xml.IXmlSchemaEnumValue {
  EM( "EM" ),
  NEM( "NEM" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SignConstructionMaterial" );
    }
  };

  private final java.lang.String _stringValue;

  private SignConstructionMaterial( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SignConstructionMaterial forValue( java.lang.String value ) {
    return (xsd.acord.enums.SignConstructionMaterial) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SignConstructionMaterial forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SignConstructionMaterial) TYPE.get().cg_forValue( value );
  }
