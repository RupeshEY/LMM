...
public enum VehicleSpecialUse implements gw.xml.IXmlSchemaEnumValue {
  A( "A" ),
  B( "B" ),
  D( "D" ),
  DB( "DB" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.VehicleSpecialUse" );
    }
  };

  private final java.lang.String _stringValue;

  private VehicleSpecialUse( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.VehicleSpecialUse forValue( java.lang.String value ) {
    return (xsd.acord.enums.VehicleSpecialUse) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.VehicleSpecialUse forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.VehicleSpecialUse) TYPE.get().cg_forValue( value );
  }
