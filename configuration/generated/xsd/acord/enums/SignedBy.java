...
public enum SignedBy implements gw.xml.IXmlSchemaEnumValue {
  Auditor( "Auditor" ),
  AUR( "AUR" ),
  IAA( "IAA" ),
  IOA( "IOA" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SignedBy" );
    }
  };

  private final java.lang.String _stringValue;

  private SignedBy( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SignedBy forValue( java.lang.String value ) {
    return (xsd.acord.enums.SignedBy) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SignedBy forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SignedBy) TYPE.get().cg_forValue( value );
  }
