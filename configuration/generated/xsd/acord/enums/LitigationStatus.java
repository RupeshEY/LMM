...
public enum LitigationStatus implements gw.xml.IXmlSchemaEnumValue {
  Active( "Active" ),
  Closed( "Closed" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.LitigationStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private LitigationStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.LitigationStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.LitigationStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.LitigationStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.LitigationStatus) TYPE.get().cg_forValue( value );
  }
