...
public enum SearchBasis implements gw.xml.IXmlSchemaEnumValue {
  Claim( "Claim" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.SearchBasis" );
    }
  };

  private final java.lang.String _stringValue;

  private SearchBasis( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.SearchBasis forValue( java.lang.String value ) {
    return (xsd.acord.enums.SearchBasis) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.SearchBasis forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.SearchBasis) TYPE.get().cg_forValue( value );
  }
