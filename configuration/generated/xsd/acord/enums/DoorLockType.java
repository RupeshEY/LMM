...
public enum DoorLockType implements gw.xml.IXmlSchemaEnumValue {
  DBLCL( "DBLCL" ),
  DEADB( "DEADB" ),
  NONE( "NONE" ),
  OT( "OT" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DoorLockType" );
    }
  };

  private final java.lang.String _stringValue;

  private DoorLockType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DoorLockType forValue( java.lang.String value ) {
    return (xsd.acord.enums.DoorLockType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DoorLockType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DoorLockType) TYPE.get().cg_forValue( value );
  }
