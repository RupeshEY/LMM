...
public enum WallType implements gw.xml.IXmlSchemaEnumValue {
  BKAWY( "BKAWY" ),
  LATTC( "LATTC" ),
  MSNRY( "MSNRY" ),
  OT( "OT" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.WallType" );
    }
  };

  private final java.lang.String _stringValue;

  private WallType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.WallType forValue( java.lang.String value ) {
    return (xsd.acord.enums.WallType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.WallType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.WallType) TYPE.get().cg_forValue( value );
  }
