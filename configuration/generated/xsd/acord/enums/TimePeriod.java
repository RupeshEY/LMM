...
public enum TimePeriod implements gw.xml.IXmlSchemaEnumValue {
  _1( "1" ),
  _3( "3" ),
  _4( "4" ),
  _5( "5" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.TimePeriod" );
    }
  };

  private final java.lang.String _stringValue;

  private TimePeriod( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.TimePeriod forValue( java.lang.String value ) {
    return (xsd.acord.enums.TimePeriod) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.TimePeriod forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.TimePeriod) TYPE.get().cg_forValue( value );
  }
