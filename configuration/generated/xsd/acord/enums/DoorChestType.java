...
public enum DoorChestType implements gw.xml.IXmlSchemaEnumValue {
  Chest( "Chest" ),
  Inner( "Inner" ),
  Internal( "Internal" ),
  Outer( "Outer" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.DoorChestType" );
    }
  };

  private final java.lang.String _stringValue;

  private DoorChestType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.DoorChestType forValue( java.lang.String value ) {
    return (xsd.acord.enums.DoorChestType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.DoorChestType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.DoorChestType) TYPE.get().cg_forValue( value );
  }
