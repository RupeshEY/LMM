...
public enum Responsibility implements gw.xml.IXmlSchemaEnumValue {
  AG( "AG" ),
  COR( "COR" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.Responsibility" );
    }
  };

  private final java.lang.String _stringValue;

  private Responsibility( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.Responsibility forValue( java.lang.String value ) {
    return (xsd.acord.enums.Responsibility) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.Responsibility forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.Responsibility) TYPE.get().cg_forValue( value );
  }
