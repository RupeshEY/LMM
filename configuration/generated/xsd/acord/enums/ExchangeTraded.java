...
public enum ExchangeTraded implements gw.xml.IXmlSchemaEnumValue {
  AMEX( "AMEX" ),
  Frankfurt( "Frankfurt" ),
  HongKong( "HongKong" ),
  London( "London" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ExchangeTraded" );
    }
  };

  private final java.lang.String _stringValue;

  private ExchangeTraded( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ExchangeTraded forValue( java.lang.String value ) {
    return (xsd.acord.enums.ExchangeTraded) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ExchangeTraded forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ExchangeTraded) TYPE.get().cg_forValue( value );
  }
