...
public enum EarthquakeRetrofit implements gw.xml.IXmlSchemaEnumValue {
  AB( "AB" ),
  AF( "AF" ),
  AL( "AL" ),
  AS( "AS" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EarthquakeRetrofit" );
    }
  };

  private final java.lang.String _stringValue;

  private EarthquakeRetrofit( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EarthquakeRetrofit forValue( java.lang.String value ) {
    return (xsd.acord.enums.EarthquakeRetrofit) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EarthquakeRetrofit forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EarthquakeRetrofit) TYPE.get().cg_forValue( value );
  }
