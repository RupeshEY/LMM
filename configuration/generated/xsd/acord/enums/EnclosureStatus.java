...
public enum EnclosureStatus implements gw.xml.IXmlSchemaEnumValue {
  F( "F" ),
  P( "P" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EnclosureStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private EnclosureStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EnclosureStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.EnclosureStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EnclosureStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EnclosureStatus) TYPE.get().cg_forValue( value );
  }
