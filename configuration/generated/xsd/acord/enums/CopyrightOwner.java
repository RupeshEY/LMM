...
public enum CopyrightOwner implements gw.xml.IXmlSchemaEnumValue {
  ACORD( "ACORD" ),
  CMPNY( "CMPNY" ),
  ISO( "ISO" ),
  NCCI( "NCCI" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CopyrightOwner" );
    }
  };

  private final java.lang.String _stringValue;

  private CopyrightOwner( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CopyrightOwner forValue( java.lang.String value ) {
    return (xsd.acord.enums.CopyrightOwner) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CopyrightOwner forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CopyrightOwner) TYPE.get().cg_forValue( value );
  }
