...
public enum RateScaleType implements gw.xml.IXmlSchemaEnumValue {
  Fixed( "Fixed" ),
  Flat( "Flat" ),
  Sliding( "Sliding" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RateScaleType" );
    }
  };

  private final java.lang.String _stringValue;

  private RateScaleType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RateScaleType forValue( java.lang.String value ) {
    return (xsd.acord.enums.RateScaleType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RateScaleType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RateScaleType) TYPE.get().cg_forValue( value );
  }
