...
public enum AcquisitionMethod implements gw.xml.IXmlSchemaEnumValue {
  Auction( "Auction" ),
  Homebred( "Homebred" ),
  Other( "Other" ),
  Private( "Private" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AcquisitionMethod" );
    }
  };

  private final java.lang.String _stringValue;

  private AcquisitionMethod( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AcquisitionMethod forValue( java.lang.String value ) {
    return (xsd.acord.enums.AcquisitionMethod) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AcquisitionMethod forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AcquisitionMethod) TYPE.get().cg_forValue( value );
  }
