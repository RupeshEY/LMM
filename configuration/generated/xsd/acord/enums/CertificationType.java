...
public enum CertificationType implements gw.xml.IXmlSchemaEnumValue {
  APMECH( "APMECH" ),
  ATP( "ATP" ),
  COMML( "COMML" ),
  IA( "IA" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CertificationType" );
    }
  };

  private final java.lang.String _stringValue;

  private CertificationType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CertificationType forValue( java.lang.String value ) {
    return (xsd.acord.enums.CertificationType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CertificationType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CertificationType) TYPE.get().cg_forValue( value );
  }
