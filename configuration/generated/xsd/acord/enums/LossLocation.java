...
public enum LossLocation implements gw.xml.IXmlSchemaEnumValue {
  IN( "IN" ),
  N( "N" ),
  OT( "OT" ),
  P( "P" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.LossLocation" );
    }
  };

  private final java.lang.String _stringValue;

  private LossLocation( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.LossLocation forValue( java.lang.String value ) {
    return (xsd.acord.enums.LossLocation) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.LossLocation forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.LossLocation) TYPE.get().cg_forValue( value );
  }
