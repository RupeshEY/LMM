...
public enum InteriorComponent implements gw.xml.IXmlSchemaEnumValue {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.InteriorComponent" );
    }
  };

  private final java.lang.String _stringValue;

  private InteriorComponent( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.InteriorComponent forValue( java.lang.String value ) {
    return (xsd.acord.enums.InteriorComponent) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.InteriorComponent forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.InteriorComponent) TYPE.get().cg_forValue( value );
  }
