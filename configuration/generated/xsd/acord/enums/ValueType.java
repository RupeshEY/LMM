...
public enum ValueType implements gw.xml.IXmlSchemaEnumValue {
  Annual( "Annual" ),
  Average( "Average" ),
  Maximum( "Maximum" ),
  Minimum( "Minimum" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ValueType" );
    }
  };

  private final java.lang.String _stringValue;

  private ValueType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ValueType forValue( java.lang.String value ) {
    return (xsd.acord.enums.ValueType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ValueType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ValueType) TYPE.get().cg_forValue( value );
  }
