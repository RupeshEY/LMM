...
public enum ShippingInterest implements gw.xml.IXmlSchemaEnumValue {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ShippingInterest" );
    }
  };

  private final java.lang.String _stringValue;

  private ShippingInterest( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ShippingInterest forValue( java.lang.String value ) {
    return (xsd.acord.enums.ShippingInterest) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ShippingInterest forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ShippingInterest) TYPE.get().cg_forValue( value );
  }
