...
public enum GlassType implements gw.xml.IXmlSchemaEnumValue {
  ANNEALED( "ANNEALED" ),
  LAMINATE( "LAMINATE" ),
  OTHER( "OTHER" ),
  TEMPERED( "TEMPERED" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.GlassType" );
    }
  };

  private final java.lang.String _stringValue;

  private GlassType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.GlassType forValue( java.lang.String value ) {
    return (xsd.acord.enums.GlassType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.GlassType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.GlassType) TYPE.get().cg_forValue( value );
  }
