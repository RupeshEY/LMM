...
public enum CommunicationUse implements gw.xml.IXmlSchemaEnumValue {
  Alternate( "Alternate" ),
  Business( "Business" ),
  Day( "Day" ),
  Evening( "Evening" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CommunicationUse" );
    }
  };

  private final java.lang.String _stringValue;

  private CommunicationUse( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CommunicationUse forValue( java.lang.String value ) {
    return (xsd.acord.enums.CommunicationUse) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CommunicationUse forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CommunicationUse) TYPE.get().cg_forValue( value );
  }
