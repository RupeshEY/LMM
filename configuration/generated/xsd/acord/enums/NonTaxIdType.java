...
public enum NonTaxIdType implements gw.xml.IXmlSchemaEnumValue {
  AMBest( "AMBest" ),
  CISP( "CISP" ),
  Duns( "Duns" ),
  Employer( "Employer" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.NonTaxIdType" );
    }
  };

  private final java.lang.String _stringValue;

  private NonTaxIdType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.NonTaxIdType forValue( java.lang.String value ) {
    return (xsd.acord.enums.NonTaxIdType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.NonTaxIdType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.NonTaxIdType) TYPE.get().cg_forValue( value );
  }
