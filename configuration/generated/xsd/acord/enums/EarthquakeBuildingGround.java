...
public enum EarthquakeBuildingGround implements gw.xml.IXmlSchemaEnumValue {
  FN( "FN" ),
  HZ( "HZ" ),
  HZI( "HZI" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.EarthquakeBuildingGround" );
    }
  };

  private final java.lang.String _stringValue;

  private EarthquakeBuildingGround( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.EarthquakeBuildingGround forValue( java.lang.String value ) {
    return (xsd.acord.enums.EarthquakeBuildingGround) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.EarthquakeBuildingGround forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.EarthquakeBuildingGround) TYPE.get().cg_forValue( value );
  }
