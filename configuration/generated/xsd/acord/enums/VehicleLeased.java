...
public enum VehicleLeased implements gw.xml.IXmlSchemaEnumValue {
  L( "L" ),
  N( "N" ),
  O( "O" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.VehicleLeased" );
    }
  };

  private final java.lang.String _stringValue;

  private VehicleLeased( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.VehicleLeased forValue( java.lang.String value ) {
    return (xsd.acord.enums.VehicleLeased) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.VehicleLeased forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.VehicleLeased) TYPE.get().cg_forValue( value );
  }
