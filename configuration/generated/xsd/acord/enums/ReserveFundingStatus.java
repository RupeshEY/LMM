...
public enum ReserveFundingStatus implements gw.xml.IXmlSchemaEnumValue {
  FULLY( "FULLY" ),
  NFUND( "NFUND" ),
  PART( "PART" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.ReserveFundingStatus" );
    }
  };

  private final java.lang.String _stringValue;

  private ReserveFundingStatus( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.ReserveFundingStatus forValue( java.lang.String value ) {
    return (xsd.acord.enums.ReserveFundingStatus) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.ReserveFundingStatus forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.ReserveFundingStatus) TYPE.get().cg_forValue( value );
  }
