...
public enum CrimeScheduleType implements gw.xml.IXmlSchemaEnumValue {
  Committee( "Committee" ),
  Custodian( "Custodian" ),
  Employee( "Employee" ),
  Lessee( "Lessee" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.CrimeScheduleType" );
    }
  };

  private final java.lang.String _stringValue;

  private CrimeScheduleType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.CrimeScheduleType forValue( java.lang.String value ) {
    return (xsd.acord.enums.CrimeScheduleType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.CrimeScheduleType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.CrimeScheduleType) TYPE.get().cg_forValue( value );
  }
