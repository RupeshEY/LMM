...
public enum AlarmType implements gw.xml.IXmlSchemaEnumValue {
  BOT( "BOT" ),
  BU( "BU" ),
  CEN( "CEN" ),
  CK( "CK" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.AlarmType" );
    }
  };

  private final java.lang.String _stringValue;

  private AlarmType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.AlarmType forValue( java.lang.String value ) {
    return (xsd.acord.enums.AlarmType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.AlarmType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.AlarmType) TYPE.get().cg_forValue( value );
  }
