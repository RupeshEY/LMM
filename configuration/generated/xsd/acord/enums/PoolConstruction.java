...
public enum PoolConstruction implements gw.xml.IXmlSchemaEnumValue {
  Fiberglass( "Fiberglass" ),
  ReinforcedConcrete( "ReinforcedConcrete" ),
  VinylLiner( "VinylLiner" );
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PoolConstruction" );
    }
  };

  private final java.lang.String _stringValue;

  private PoolConstruction( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PoolConstruction forValue( java.lang.String value ) {
    return (xsd.acord.enums.PoolConstruction) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PoolConstruction forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PoolConstruction) TYPE.get().cg_forValue( value );
  }
