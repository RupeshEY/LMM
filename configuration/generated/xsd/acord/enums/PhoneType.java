...
public enum PhoneType implements gw.xml.IXmlSchemaEnumValue {
  Cell( "Cell" ),
  Fax( "Fax" ),
  Marine( "Marine" ),
  None( "None" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.PhoneType" );
    }
  };

  private final java.lang.String _stringValue;

  private PhoneType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.PhoneType forValue( java.lang.String value ) {
    return (xsd.acord.enums.PhoneType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.PhoneType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.PhoneType) TYPE.get().cg_forValue( value );
  }
