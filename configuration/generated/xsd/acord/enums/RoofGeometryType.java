...
public enum RoofGeometryType implements gw.xml.IXmlSchemaEnumValue {
  COMPLEX( "COMPLEX" ),
  FLAT( "FLAT" ),
  GABLE( "GABLE" ),
  GABLEBRACE( "GABLEBRACE" ),
  GAMBREL( "GAMBREL" ),
  HIP( "HIP" ),
  MANSARD( "MANSARD" ),
  PYRAMID( "PYRAMID" ),
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlEnumerationTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlEnumerationTypeDataImpl init() {
      return (gw.internal.xml.XmlEnumerationTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.acord.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.acord.enums.RoofGeometryType" );
    }
  };

  private final java.lang.String _stringValue;

  private RoofGeometryType( java.lang.String stringValue ) {
    _stringValue = stringValue;
  }

  public static final xsd.acord.enums.RoofGeometryType forValue( java.lang.String value ) {
    return (xsd.acord.enums.RoofGeometryType) TYPE.get().cg_forValue( value );
  } // xmlRefactorRemove

  public static final xsd.acord.enums.RoofGeometryType forGosuValue( java.lang.String value ) {
    return (xsd.acord.enums.RoofGeometryType) TYPE.get().cg_forValue( value );
  }
