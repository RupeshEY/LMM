...
public class CommlPropertyPolicyUpdateModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlPropertyPolicyUpdateModRs_Type", "" );
  ...
  public CommlPropertyPolicyUpdateModRs_Type() {
    super( 691450943, TYPE.get() );
  }

  private CommlPropertyPolicyUpdateModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 691450943, state );
  }

  protected CommlPropertyPolicyUpdateModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlPropertyPolicyUpdateModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlPropertyPolicyUpdateModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlPropertyPolicyUpdateModRs_Type get$TypeInstance() {
    return this;
  }
