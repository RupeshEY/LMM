...
public class CommlPropertyPolicyReplaceRenewRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlPropertyPolicyReplaceRenewRs_Type", "" );
  ...
  public CommlPropertyPolicyReplaceRenewRs_Type() {
    super( 979444415, TYPE.get() );
  }

  private CommlPropertyPolicyReplaceRenewRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 979444415, state );
  }

  protected CommlPropertyPolicyReplaceRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlPropertyPolicyReplaceRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlPropertyPolicyReplaceRenewRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlPropertyPolicyReplaceRenewRs_Type get$TypeInstance() {
    return this;
  }
