...
public class CommlDriverScheduleSubmitRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlDriverScheduleSubmitRs_Type", "" );
  ...
  public CommlDriverScheduleSubmitRs_Type() {
    super( 1338245512, TYPE.get() );
  }

  private CommlDriverScheduleSubmitRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1338245512, state );
  }

  protected CommlDriverScheduleSubmitRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlDriverScheduleSubmitRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlDriverScheduleSubmitRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlDriverScheduleSubmitRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.CommlDriverScheduleState> getCommlDriverScheduleState() {
    return (java.util.List<xsd.acord.CommlDriverScheduleState>) TYPE.get().getPropertyValue( this, "_CommlDriverScheduleState" );
  }


  public final void setCommlDriverScheduleState( java.util.List<xsd.acord.CommlDriverScheduleState> value ) {
    TYPE.get().setPropertyValue( this, "_CommlDriverScheduleState", value );
  }
