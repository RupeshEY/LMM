...
public class CommlPropertyPolicyFullImageReplaceReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlPropertyPolicyFullImageReplaceReinstateRs_Type", "" );
  ...
  public CommlPropertyPolicyFullImageReplaceReinstateRs_Type() {
    super( -46542361, TYPE.get() );
  }

  private CommlPropertyPolicyFullImageReplaceReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -46542361, state );
  }

  protected CommlPropertyPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlPropertyPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlPropertyPolicyFullImageReplaceReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlPropertyPolicyFullImageReplaceReinstateRs_Type get$TypeInstance() {
    return this;
  }
