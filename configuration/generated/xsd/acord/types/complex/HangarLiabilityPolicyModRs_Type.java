...
public class HangarLiabilityPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "HangarLiabilityPolicyModRs_Type", "" );
  ...
  public HangarLiabilityPolicyModRs_Type() {
    super( -1582400085, TYPE.get() );
  }

  private HangarLiabilityPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1582400085, state );
  }

  protected HangarLiabilityPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected HangarLiabilityPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.HangarLiabilityPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.HangarLiabilityPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.HangarLiabilityPolicy> getHangarLiabilityPolicy() {
    return (java.util.List<xsd.acord.HangarLiabilityPolicy>) TYPE.get().getPropertyValue( this, "_HangarLiabilityPolicy" );
  }
