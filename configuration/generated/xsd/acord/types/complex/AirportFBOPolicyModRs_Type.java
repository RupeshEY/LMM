...
public class AirportFBOPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "AirportFBOPolicyModRs_Type", "" );
  ...
  public AirportFBOPolicyModRs_Type() {
    super( 1175520663, TYPE.get() );
  }

  private AirportFBOPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1175520663, state );
  }

  protected AirportFBOPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected AirportFBOPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.AirportFBOPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.AirportFBOPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.AirportFBOPolicy> getAirportFBOPolicy() {
    return (java.util.List<xsd.acord.AirportFBOPolicy>) TYPE.get().getPropertyValue( this, "_AirportFBOPolicy" );
  }
