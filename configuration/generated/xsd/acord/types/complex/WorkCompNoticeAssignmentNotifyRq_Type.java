...
public class WorkCompNoticeAssignmentNotifyRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WorkCompNoticeAssignmentNotifyRq_Type", "" );
  ...
  public WorkCompNoticeAssignmentNotifyRq_Type() {
    super( -1696860475, TYPE.get() );
  }

  private WorkCompNoticeAssignmentNotifyRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1696860475, state );
  }

  protected WorkCompNoticeAssignmentNotifyRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WorkCompNoticeAssignmentNotifyRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WorkCompNoticeAssignmentNotifyRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WorkCompNoticeAssignmentNotifyRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.NoticeAssignmentInfo getNoticeAssignmentInfo() {
    return (xsd.acord.NoticeAssignmentInfo) TYPE.get().getPropertyValue( this, "_NoticeAssignmentInfo" );
  }


  public final void setNoticeAssignmentInfo( xsd.acord.NoticeAssignmentInfo value ) {
    TYPE.get().setPropertyValue( this, "_NoticeAssignmentInfo", value );
  }
