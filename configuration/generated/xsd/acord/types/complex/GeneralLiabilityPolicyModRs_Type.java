...
public class GeneralLiabilityPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "GeneralLiabilityPolicyModRs_Type", "" );
  ...
  public GeneralLiabilityPolicyModRs_Type() {
    super( -1457742604, TYPE.get() );
  }

  private GeneralLiabilityPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1457742604, state );
  }

  protected GeneralLiabilityPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected GeneralLiabilityPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.GeneralLiabilityPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.GeneralLiabilityPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.GeneralLiabilityPolicy> getGeneralLiabilityPolicy() {
    return (java.util.List<xsd.acord.GeneralLiabilityPolicy>) TYPE.get().getPropertyValue( this, "_GeneralLiabilityPolicy" );
  }
