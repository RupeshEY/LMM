...
public class DirectorsAndOfficersPolicyUpdateModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "DirectorsAndOfficersPolicyUpdateModRs_Type", "" );
  ...
  public DirectorsAndOfficersPolicyUpdateModRs_Type() {
    super( -210100827, TYPE.get() );
  }

  private DirectorsAndOfficersPolicyUpdateModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -210100827, state );
  }

  protected DirectorsAndOfficersPolicyUpdateModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected DirectorsAndOfficersPolicyUpdateModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.DirectorsAndOfficersPolicyUpdateModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.DirectorsAndOfficersPolicyUpdateModRs_Type get$TypeInstance() {
    return this;
  }
