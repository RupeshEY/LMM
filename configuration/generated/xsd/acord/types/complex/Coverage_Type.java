...
public class Coverage_Type extends xsd.acord.types.complex.PCCOVERAGE {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "Coverage_Type", "" );
  ...
  public Coverage_Type() {
    super( 242042090, TYPE.get() );
  }

  private Coverage_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 242042090, state );
  }

  protected Coverage_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected Coverage_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.Coverage_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.Coverage_Type get$TypeInstance() {
    return this;
  }
