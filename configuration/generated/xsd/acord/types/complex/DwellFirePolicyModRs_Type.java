...
public class DwellFirePolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "DwellFirePolicyModRs_Type", "" );
  ...
  public DwellFirePolicyModRs_Type() {
    super( 548698313, TYPE.get() );
  }

  private DwellFirePolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 548698313, state );
  }

  protected DwellFirePolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected DwellFirePolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.DwellFirePolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.DwellFirePolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.DwellFirePolicy> getDwellFirePolicy() {
    return (java.util.List<xsd.acord.DwellFirePolicy>) TYPE.get().getPropertyValue( this, "_DwellFirePolicy" );
  }
