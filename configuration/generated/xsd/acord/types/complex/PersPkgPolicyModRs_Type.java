...
public class PersPkgPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersPkgPolicyModRs_Type", "" );
  ...
  public PersPkgPolicyModRs_Type() {
    super( -1915676297, TYPE.get() );
  }

  private PersPkgPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1915676297, state );
  }

  protected PersPkgPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersPkgPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersPkgPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersPkgPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.PersPkgPolicy> getPersPkgPolicy() {
    return (java.util.List<xsd.acord.PersPkgPolicy>) TYPE.get().getPropertyValue( this, "_PersPkgPolicy" );
  }
