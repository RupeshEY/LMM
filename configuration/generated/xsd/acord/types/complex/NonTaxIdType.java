...
public class NonTaxIdType extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "NonTaxIdType", "" );
  ...
  public NonTaxIdType() {
    super( -1148702342, TYPE.get() );
  }

  public NonTaxIdType( xsd.acord.enums.NonTaxIdType value ) {
    this();
    setValue( value );
  }

  private NonTaxIdType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1148702342, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.NonTaxIdType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.NonTaxIdType get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.enums.NonTaxIdType getValue() {
    return (xsd.acord.enums.NonTaxIdType) TYPE.get().getPropertyValue( this, "Value" );
  }
