...
public class SuretyBondRateSyncRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "SuretyBondRateSyncRs_Type", "" );
  ...
  public SuretyBondRateSyncRs_Type() {
    super( -1371229799, TYPE.get() );
  }

  private SuretyBondRateSyncRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1371229799, state );
  }

  protected SuretyBondRateSyncRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SuretyBondRateSyncRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.SuretyBondRateSyncRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.SuretyBondRateSyncRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.RateSyncReturnInfo> getRateSyncReturnInfo() {
    return (java.util.List<xsd.acord.RateSyncReturnInfo>) TYPE.get().getPropertyValue( this, "_RateSyncReturnInfo" );
  }


  public final void setRateSyncReturnInfo( java.util.List<xsd.acord.RateSyncReturnInfo> value ) {
    TYPE.get().setPropertyValue( this, "_RateSyncReturnInfo", value );
  }
