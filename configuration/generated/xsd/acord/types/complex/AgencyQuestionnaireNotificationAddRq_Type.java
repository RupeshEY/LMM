...
public class AgencyQuestionnaireNotificationAddRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "AgencyQuestionnaireNotificationAddRq_Type", "" );
  ...
  public AgencyQuestionnaireNotificationAddRq_Type() {
    super( -1593294309, TYPE.get() );
  }

  private AgencyQuestionnaireNotificationAddRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1593294309, state );
  }

  protected AgencyQuestionnaireNotificationAddRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected AgencyQuestionnaireNotificationAddRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.AgencyQuestionnaireNotificationAddRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.AgencyQuestionnaireNotificationAddRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.AgencySummary getAgencySummary() {
    return (xsd.acord.AgencySummary) TYPE.get().getPropertyValue( this, "_AgencySummary" );
  }


  public final void setAgencySummary( xsd.acord.AgencySummary value ) {
    TYPE.get().setPropertyValue( this, "_AgencySummary", value );
  }
  ...
  public final java.util.List<xsd.acord.AgencyBranchInfo> getAgencyBranchInfo() {
    return (java.util.List<xsd.acord.AgencyBranchInfo>) TYPE.get().getPropertyValue( this, "_AgencyBranchInfo" );
  }


  public final void setAgencyBranchInfo( java.util.List<xsd.acord.AgencyBranchInfo> value ) {
    TYPE.get().setPropertyValue( this, "_AgencyBranchInfo", value );
  }
  ...
  public final java.util.List<xsd.acord.AgencyEmployee> getAgencyEmployee() {
    return (java.util.List<xsd.acord.AgencyEmployee>) TYPE.get().getPropertyValue( this, "_AgencyEmployee" );
  }


  public final void setAgencyEmployee( java.util.List<xsd.acord.AgencyEmployee> value ) {
    TYPE.get().setPropertyValue( this, "_AgencyEmployee", value );
  }
  ...
  public final java.util.List<xsd.acord.OtherInsurer> getOtherInsurer() {
    return (java.util.List<xsd.acord.OtherInsurer>) TYPE.get().getPropertyValue( this, "_OtherInsurer" );
  }


  public final void setOtherInsurer( java.util.List<xsd.acord.OtherInsurer> value ) {
    TYPE.get().setPropertyValue( this, "_OtherInsurer", value );
  }
  ...
  public final java.util.List<xsd.acord.AutomationSystem> getAutomationSystem() {
    return (java.util.List<xsd.acord.AutomationSystem>) TYPE.get().getPropertyValue( this, "_AutomationSystem" );
  }


  public final void setAutomationSystem( java.util.List<xsd.acord.AutomationSystem> value ) {
    TYPE.get().setPropertyValue( this, "_AutomationSystem", value );
  }
