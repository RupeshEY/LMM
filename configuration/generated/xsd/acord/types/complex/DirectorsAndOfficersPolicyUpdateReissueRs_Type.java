...
public class DirectorsAndOfficersPolicyUpdateReissueRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "DirectorsAndOfficersPolicyUpdateReissueRs_Type", "" );
  ...
  public DirectorsAndOfficersPolicyUpdateReissueRs_Type() {
    super( 1377252897, TYPE.get() );
  }

  private DirectorsAndOfficersPolicyUpdateReissueRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1377252897, state );
  }

  protected DirectorsAndOfficersPolicyUpdateReissueRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected DirectorsAndOfficersPolicyUpdateReissueRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.DirectorsAndOfficersPolicyUpdateReissueRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.DirectorsAndOfficersPolicyUpdateReissueRs_Type get$TypeInstance() {
    return this;
  }
