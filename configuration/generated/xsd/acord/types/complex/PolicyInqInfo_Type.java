...
public class PolicyInqInfo_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PolicyInqInfo_Type", "" );
  ...
  public PolicyInqInfo_Type() {
    super( -332231144, TYPE.get() );
  }

  private PolicyInqInfo_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -332231144, state );
  }

  protected PolicyInqInfo_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PolicyInqInfo_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PolicyInqInfo_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PolicyInqInfo_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.SearchInfo> getSearchInfo() {
    return (java.util.List<xsd.acord.SearchInfo>) TYPE.get().getPropertyValue( this, "_SearchInfo" );
  }


  public final void setSearchInfo( java.util.List<xsd.acord.SearchInfo> value ) {
    TYPE.get().setPropertyValue( this, "_SearchInfo", value );
  }
