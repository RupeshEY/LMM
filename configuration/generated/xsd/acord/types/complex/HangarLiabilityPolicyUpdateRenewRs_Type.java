...
public class HangarLiabilityPolicyUpdateRenewRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "HangarLiabilityPolicyUpdateRenewRs_Type", "" );
  ...
  public HangarLiabilityPolicyUpdateRenewRs_Type() {
    super( 617773609, TYPE.get() );
  }

  private HangarLiabilityPolicyUpdateRenewRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 617773609, state );
  }

  protected HangarLiabilityPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected HangarLiabilityPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.HangarLiabilityPolicyUpdateRenewRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.HangarLiabilityPolicyUpdateRenewRs_Type get$TypeInstance() {
    return this;
  }
