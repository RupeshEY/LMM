...
public class CommlPkgPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlPkgPolicyModRs_Type", "" );
  ...
  public CommlPkgPolicyModRs_Type() {
    super( -1008602181, TYPE.get() );
  }

  private CommlPkgPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1008602181, state );
  }

  protected CommlPkgPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlPkgPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlPkgPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlPkgPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.CommlPkgPolicy> getCommlPkgPolicy() {
    return (java.util.List<xsd.acord.CommlPkgPolicy>) TYPE.get().getPropertyValue( this, "_CommlPkgPolicy" );
  }
