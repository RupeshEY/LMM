...
public class HomePolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "HomePolicyModRs_Type", "" );
  ...
  public HomePolicyModRs_Type() {
    super( 740901710, TYPE.get() );
  }

  private HomePolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 740901710, state );
  }

  protected HomePolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected HomePolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.HomePolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.HomePolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.HomePolicy> getHomePolicy() {
    return (java.util.List<xsd.acord.HomePolicy>) TYPE.get().getPropertyValue( this, "_HomePolicy" );
  }
