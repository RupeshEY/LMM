...
public class BoilerMachineryPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "BoilerMachineryPolicyModRs_Type", "" );
  ...
  public BoilerMachineryPolicyModRs_Type() {
    super( 1737812466, TYPE.get() );
  }

  private BoilerMachineryPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1737812466, state );
  }

  protected BoilerMachineryPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected BoilerMachineryPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.BoilerMachineryPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.BoilerMachineryPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.BoilerMachineryPolicy> getBoilerMachineryPolicy() {
    return (java.util.List<xsd.acord.BoilerMachineryPolicy>) TYPE.get().getPropertyValue( this, "_BoilerMachineryPolicy" );
  }
