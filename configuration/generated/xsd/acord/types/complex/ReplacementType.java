...
public class ReplacementType extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ReplacementType", "" );
  ...
  public ReplacementType() {
    super( -1115782203, TYPE.get() );
  }

  public ReplacementType( xsd.acord.enums.ReplacementType value ) {
    this();
    setValue( value );
  }

  private ReplacementType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1115782203, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.ReplacementType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.ReplacementType get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.enums.ReplacementType getValue() {
    return (xsd.acord.enums.ReplacementType) TYPE.get().getPropertyValue( this, "Value" );
  }
