...
public class ClaimNotice extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ClaimNotice", "" );
  ...
  public ClaimNotice() {
    super( 257961485, TYPE.get() );
  }

  public ClaimNotice( xsd.acord.enums.ClaimNotice value ) {
    this();
    setValue( value );
  }

  private ClaimNotice( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 257961485, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.ClaimNotice> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.ClaimNotice get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.enums.ClaimNotice getValue() {
    return (xsd.acord.enums.ClaimNotice) TYPE.get().getPropertyValue( this, "Value" );
  }
