...
public class DirectorsAndOfficersPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "DirectorsAndOfficersPolicyModRs_Type", "" );
  ...
  public DirectorsAndOfficersPolicyModRs_Type() {
    super( 20954236, TYPE.get() );
  }

  private DirectorsAndOfficersPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 20954236, state );
  }

  protected DirectorsAndOfficersPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected DirectorsAndOfficersPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.DirectorsAndOfficersPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.DirectorsAndOfficersPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.DirectorsAndOfficersPolicyInfo> getDirectorsAndOfficersPolicyInfo() {
    return (java.util.List<xsd.acord.DirectorsAndOfficersPolicyInfo>) TYPE.get().getPropertyValue( this, "_DirectorsAndOfficersPolicyInfo" );
  }


  public final void setDirectorsAndOfficersPolicyInfo( java.util.List<xsd.acord.DirectorsAndOfficersPolicyInfo> value ) {
    TYPE.get().setPropertyValue( this, "_DirectorsAndOfficersPolicyInfo", value );
  }
