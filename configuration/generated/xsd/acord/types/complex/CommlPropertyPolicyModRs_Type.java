...
public class CommlPropertyPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlPropertyPolicyModRs_Type", "" );
  ...
  public CommlPropertyPolicyModRs_Type() {
    super( 191876758, TYPE.get() );
  }

  private CommlPropertyPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 191876758, state );
  }

  protected CommlPropertyPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlPropertyPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlPropertyPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlPropertyPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.CommlPropertyPolicy> getCommlPropertyPolicy() {
    return (java.util.List<xsd.acord.CommlPropertyPolicy>) TYPE.get().getPropertyValue( this, "_CommlPropertyPolicy" );
  }
