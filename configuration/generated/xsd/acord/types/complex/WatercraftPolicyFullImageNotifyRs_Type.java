...
public class WatercraftPolicyFullImageNotifyRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WatercraftPolicyFullImageNotifyRs_Type", "" );
  ...
  public WatercraftPolicyFullImageNotifyRs_Type() {
    super( -1930762555, TYPE.get() );
  }

  private WatercraftPolicyFullImageNotifyRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1930762555, state );
  }

  protected WatercraftPolicyFullImageNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WatercraftPolicyFullImageNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WatercraftPolicyFullImageNotifyRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WatercraftPolicyFullImageNotifyRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.WatercraftLineBusiness getWatercraftLineBusiness() {
    return (xsd.acord.WatercraftLineBusiness) TYPE.get().getPropertyValue( this, "_WatercraftLineBusiness" );
  }


  public final void setWatercraftLineBusiness( xsd.acord.WatercraftLineBusiness value ) {
    TYPE.get().setPropertyValue( this, "_WatercraftLineBusiness", value );
  }
