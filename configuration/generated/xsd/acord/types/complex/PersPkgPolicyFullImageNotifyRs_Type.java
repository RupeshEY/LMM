...
public class PersPkgPolicyFullImageNotifyRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersPkgPolicyFullImageNotifyRs_Type", "" );
  ...
  public PersPkgPolicyFullImageNotifyRs_Type() {
    super( -687403740, TYPE.get() );
  }

  private PersPkgPolicyFullImageNotifyRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -687403740, state );
  }

  protected PersPkgPolicyFullImageNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersPkgPolicyFullImageNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersPkgPolicyFullImageNotifyRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersPkgPolicyFullImageNotifyRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.MsgStatus> getMsgStatus() {
    return (java.util.List<xsd.acord.MsgStatus>) TYPE.get().getPropertyValue( this, "_MsgStatus" );
  }
