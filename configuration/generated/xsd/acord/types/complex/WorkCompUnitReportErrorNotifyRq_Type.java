...
public class WorkCompUnitReportErrorNotifyRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WorkCompUnitReportErrorNotifyRq_Type", "" );
  ...
  public WorkCompUnitReportErrorNotifyRq_Type() {
    super( -668657976, TYPE.get() );
  }

  private WorkCompUnitReportErrorNotifyRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -668657976, state );
  }

  protected WorkCompUnitReportErrorNotifyRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WorkCompUnitReportErrorNotifyRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WorkCompUnitReportErrorNotifyRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WorkCompUnitReportErrorNotifyRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.WorkCompErrorSummary getWorkCompErrorSummary() {
    return (xsd.acord.WorkCompErrorSummary) TYPE.get().getPropertyValue( this, "_WorkCompErrorSummary" );
  }


  public final void setWorkCompErrorSummary( xsd.acord.WorkCompErrorSummary value ) {
    TYPE.get().setPropertyValue( this, "_WorkCompErrorSummary", value );
  }
