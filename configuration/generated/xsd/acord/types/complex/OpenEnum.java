...
public class OpenEnum extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "OpenEnum", "" );
  ...
  public OpenEnum() {
    super( -1262907086, TYPE.get() );
  }

  public OpenEnum( java.lang.String value ) {
    this();
    setValue( value );
  }

  private OpenEnum( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1262907086, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.OpenEnum> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.OpenEnum get$TypeInstance() {
    return this;
  }
