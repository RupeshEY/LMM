...
public class PendedResponseNotifyRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PendedResponseNotifyRs_Type", "" );
  ...
  public PendedResponseNotifyRs_Type() {
    super( -137025539, TYPE.get() );
  }

  private PendedResponseNotifyRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -137025539, state );
  }

  protected PendedResponseNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PendedResponseNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PendedResponseNotifyRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PendedResponseNotifyRs_Type get$TypeInstance() {
    return this;
  }
