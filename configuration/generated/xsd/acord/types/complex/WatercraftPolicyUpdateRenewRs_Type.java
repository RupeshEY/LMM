...
public class WatercraftPolicyUpdateRenewRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WatercraftPolicyUpdateRenewRs_Type", "" );
  ...
  public WatercraftPolicyUpdateRenewRs_Type() {
    super( -1493279722, TYPE.get() );
  }

  private WatercraftPolicyUpdateRenewRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1493279722, state );
  }

  protected WatercraftPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WatercraftPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WatercraftPolicyUpdateRenewRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WatercraftPolicyUpdateRenewRs_Type get$TypeInstance() {
    return this;
  }
