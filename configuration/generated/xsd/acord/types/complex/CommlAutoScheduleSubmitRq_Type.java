...
public class CommlAutoScheduleSubmitRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlAutoScheduleSubmitRq_Type", "" );
  ...
  public CommlAutoScheduleSubmitRq_Type() {
    super( 1691458275, TYPE.get() );
  }

  private CommlAutoScheduleSubmitRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1691458275, state );
  }

  protected CommlAutoScheduleSubmitRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlAutoScheduleSubmitRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlAutoScheduleSubmitRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlAutoScheduleSubmitRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.CommlVehSchedule> getCommlVehSchedule() {
    return (java.util.List<xsd.acord.CommlVehSchedule>) TYPE.get().getPropertyValue( this, "_CommlVehSchedule" );
  }


  public final void setCommlVehSchedule( java.util.List<xsd.acord.CommlVehSchedule> value ) {
    TYPE.get().setPropertyValue( this, "_CommlVehSchedule", value );
  }
