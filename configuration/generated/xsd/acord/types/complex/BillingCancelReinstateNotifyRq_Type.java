...
public class BillingCancelReinstateNotifyRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "BillingCancelReinstateNotifyRq_Type", "" );
  ...
  public BillingCancelReinstateNotifyRq_Type() {
    super( -1216121498, TYPE.get() );
  }

  private BillingCancelReinstateNotifyRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1216121498, state );
  }

  protected BillingCancelReinstateNotifyRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected BillingCancelReinstateNotifyRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.BillingCancelReinstateNotifyRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.BillingCancelReinstateNotifyRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.PolicyCancelReinstate getPolicyCancelReinstate() {
    return (xsd.acord.PolicyCancelReinstate) TYPE.get().getPropertyValue( this, "_PolicyCancelReinstate" );
  }


  public final void setPolicyCancelReinstate( xsd.acord.PolicyCancelReinstate value ) {
    TYPE.get().setPropertyValue( this, "_PolicyCancelReinstate", value );
  }
