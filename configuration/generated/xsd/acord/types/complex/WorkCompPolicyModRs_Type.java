...
public class WorkCompPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WorkCompPolicyModRs_Type", "" );
  ...
  public WorkCompPolicyModRs_Type() {
    super( 691989167, TYPE.get() );
  }

  private WorkCompPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 691989167, state );
  }

  protected WorkCompPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WorkCompPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WorkCompPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WorkCompPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.WorkCompPolicy> getWorkCompPolicy() {
    return (java.util.List<xsd.acord.WorkCompPolicy>) TYPE.get().getPropertyValue( this, "_WorkCompPolicy" );
  }
