...
public class SuretyBondRenewListNotifyRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "SuretyBondRenewListNotifyRq_Type", "" );
  ...
  public SuretyBondRenewListNotifyRq_Type() {
    super( 410179626, TYPE.get() );
  }

  private SuretyBondRenewListNotifyRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 410179626, state );
  }

  protected SuretyBondRenewListNotifyRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SuretyBondRenewListNotifyRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.SuretyBondRenewListNotifyRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.SuretyBondRenewListNotifyRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.SuretyBondRenewInfo> getSuretyBondRenewInfo() {
    return (java.util.List<xsd.acord.SuretyBondRenewInfo>) TYPE.get().getPropertyValue( this, "_SuretyBondRenewInfo" );
  }


  public final void setSuretyBondRenewInfo( java.util.List<xsd.acord.SuretyBondRenewInfo> value ) {
    TYPE.get().setPropertyValue( this, "_SuretyBondRenewInfo", value );
  }
