...
public class BOPPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "BOPPolicyModRs_Type", "" );
  ...
  public BOPPolicyModRs_Type() {
    super( -1981345084, TYPE.get() );
  }

  private BOPPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1981345084, state );
  }

  protected BOPPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected BOPPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.BOPPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.BOPPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.BOPPolicy> getBOPPolicy() {
    return (java.util.List<xsd.acord.BOPPolicy>) TYPE.get().getPropertyValue( this, "_BOPPolicy" );
  }
