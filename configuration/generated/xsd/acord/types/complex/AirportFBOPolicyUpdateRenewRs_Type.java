...
public class AirportFBOPolicyUpdateRenewRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "AirportFBOPolicyUpdateRenewRs_Type", "" );
  ...
  public AirportFBOPolicyUpdateRenewRs_Type() {
    super( 215242261, TYPE.get() );
  }

  private AirportFBOPolicyUpdateRenewRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 215242261, state );
  }

  protected AirportFBOPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected AirportFBOPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.AirportFBOPolicyUpdateRenewRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.AirportFBOPolicyUpdateRenewRs_Type get$TypeInstance() {
    return this;
  }
