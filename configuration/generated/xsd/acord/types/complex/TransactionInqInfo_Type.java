...
public class TransactionInqInfo_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "TransactionInqInfo_Type", "" );
  ...
  public TransactionInqInfo_Type() {
    super( -1664437738, TYPE.get() );
  }

  private TransactionInqInfo_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1664437738, state );
  }

  protected TransactionInqInfo_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected TransactionInqInfo_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.TransactionInqInfo_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.TransactionInqInfo_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.TransactionInfo> getTransactionInfo() {
    return (java.util.List<xsd.acord.TransactionInfo>) TYPE.get().getPropertyValue( this, "_TransactionInfo" );
  }
