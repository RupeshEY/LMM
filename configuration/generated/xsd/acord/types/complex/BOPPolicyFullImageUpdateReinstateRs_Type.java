...
public class BOPPolicyFullImageUpdateReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "BOPPolicyFullImageUpdateReinstateRs_Type", "" );
  ...
  public BOPPolicyFullImageUpdateReinstateRs_Type() {
    super( 867028134, TYPE.get() );
  }

  private BOPPolicyFullImageUpdateReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 867028134, state );
  }

  protected BOPPolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected BOPPolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.BOPPolicyFullImageUpdateReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.BOPPolicyFullImageUpdateReinstateRs_Type get$TypeInstance() {
    return this;
  }
