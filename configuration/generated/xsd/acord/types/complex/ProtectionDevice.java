...
public class ProtectionDevice extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ProtectionDevice", "" );
  ...
  public ProtectionDevice() {
    super( 761314902, TYPE.get() );
  }

  public ProtectionDevice( xsd.acord.enums.ProtectionDevice value ) {
    this();
    setValue( value );
  }

  private ProtectionDevice( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 761314902, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.ProtectionDevice> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.ProtectionDevice get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.enums.ProtectionDevice getValue() {
    return (xsd.acord.enums.ProtectionDevice) TYPE.get().getPropertyValue( this, "Value" );
  }
