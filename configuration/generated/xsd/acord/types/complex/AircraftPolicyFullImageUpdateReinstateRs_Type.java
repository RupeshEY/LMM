...
public class AircraftPolicyFullImageUpdateReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "AircraftPolicyFullImageUpdateReinstateRs_Type", "" );
  ...
  public AircraftPolicyFullImageUpdateReinstateRs_Type() {
    super( 716715525, TYPE.get() );
  }

  private AircraftPolicyFullImageUpdateReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 716715525, state );
  }

  protected AircraftPolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected AircraftPolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.AircraftPolicyFullImageUpdateReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.AircraftPolicyFullImageUpdateReinstateRs_Type get$TypeInstance() {
    return this;
  }
