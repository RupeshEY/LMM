...
public class PolicyInqRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PolicyInqRs_Type", "" );
  ...
  public PolicyInqRs_Type() {
    super( 708573093, TYPE.get() );
  }

  private PolicyInqRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 708573093, state );
  }

  protected PolicyInqRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PolicyInqRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PolicyInqRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PolicyInqRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.PolicyInqInfo getPolicyInqInfo() {
    return (xsd.acord.PolicyInqInfo) TYPE.get().getPropertyValue( this, "_PolicyInqInfo" );
  }


  public final void setPolicyInqInfo( xsd.acord.PolicyInqInfo value ) {
    TYPE.get().setPropertyValue( this, "_PolicyInqInfo", value );
  }
  ...
  public final xsd.acord.TransactionInqInfo getTransactionInqInfo() {
    return (xsd.acord.TransactionInqInfo) TYPE.get().getPropertyValue( this, "_TransactionInqInfo" );
  }


  public final void setTransactionInqInfo( xsd.acord.TransactionInqInfo value ) {
    TYPE.get().setPropertyValue( this, "_TransactionInqInfo", value );
  }
  ...
  public final xsd.acord.PolicyDetailInqInfo getPolicyDetailInqInfo() {
    return (xsd.acord.PolicyDetailInqInfo) TYPE.get().getPropertyValue( this, "_PolicyDetailInqInfo" );
  }


  public final void setPolicyDetailInqInfo( xsd.acord.PolicyDetailInqInfo value ) {
    TYPE.get().setPropertyValue( this, "_PolicyDetailInqInfo", value );
  }
  ...
  public final java.util.List<xsd.acord.PolInfo> getPolInfo() {
    return (java.util.List<xsd.acord.PolInfo>) TYPE.get().getPropertyValue( this, "_PolInfo" );
  }
