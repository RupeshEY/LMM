...
public class CommlPropertyPolicyReplaceModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlPropertyPolicyReplaceModRs_Type", "" );
  ...
  public CommlPropertyPolicyReplaceModRs_Type() {
    super( 59037098, TYPE.get() );
  }

  private CommlPropertyPolicyReplaceModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 59037098, state );
  }

  protected CommlPropertyPolicyReplaceModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlPropertyPolicyReplaceModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlPropertyPolicyReplaceModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlPropertyPolicyReplaceModRs_Type get$TypeInstance() {
    return this;
  }
