...
public class SuretyBondNumberSyncRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "SuretyBondNumberSyncRs_Type", "" );
  ...
  public SuretyBondNumberSyncRs_Type() {
    super( -2001543024, TYPE.get() );
  }

  private SuretyBondNumberSyncRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -2001543024, state );
  }

  protected SuretyBondNumberSyncRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SuretyBondNumberSyncRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.SuretyBondNumberSyncRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.SuretyBondNumberSyncRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.BondNumberSyncReturnInfo getBondNumberSyncReturnInfo() {
    return (xsd.acord.BondNumberSyncReturnInfo) TYPE.get().getPropertyValue( this, "_BondNumberSyncReturnInfo" );
  }


  public final void setBondNumberSyncReturnInfo( xsd.acord.BondNumberSyncReturnInfo value ) {
    TYPE.get().setPropertyValue( this, "_BondNumberSyncReturnInfo", value );
  }
  ...
  public final java.util.List<java.lang.String> getBondNumber() {
    return (java.util.List<java.lang.String>) TYPE.get().getPropertyValue( this, "_BondNumber" );
  }
  ...
  public final java.util.List<xsd.acord.BondNumber> getBondNumber_elem() {
    return (java.util.List<xsd.acord.BondNumber>) TYPE.get().getPropertyValue( this, "_BondNumber_elem" );
  }
