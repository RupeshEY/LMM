...
public class BOPPolicyUpdateAddRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "BOPPolicyUpdateAddRs_Type", "" );
  ...
  public BOPPolicyUpdateAddRs_Type() {
    super( -1993897106, TYPE.get() );
  }

  private BOPPolicyUpdateAddRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1993897106, state );
  }

  protected BOPPolicyUpdateAddRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected BOPPolicyUpdateAddRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.BOPPolicyUpdateAddRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.BOPPolicyUpdateAddRs_Type get$TypeInstance() {
    return this;
  }
