...
public class HomePolicyFullImageUpdateReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "HomePolicyFullImageUpdateReinstateRs_Type", "" );
  ...
  public HomePolicyFullImageUpdateReinstateRs_Type() {
    super( -2051000740, TYPE.get() );
  }

  private HomePolicyFullImageUpdateReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -2051000740, state );
  }

  protected HomePolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected HomePolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.HomePolicyFullImageUpdateReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.HomePolicyFullImageUpdateReinstateRs_Type get$TypeInstance() {
    return this;
  }
