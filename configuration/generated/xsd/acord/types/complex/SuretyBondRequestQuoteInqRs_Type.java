...
public class SuretyBondRequestQuoteInqRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "SuretyBondRequestQuoteInqRs_Type", "" );
  ...
  public SuretyBondRequestQuoteInqRs_Type() {
    super( -823734403, TYPE.get() );
  }

  private SuretyBondRequestQuoteInqRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -823734403, state );
  }

  protected SuretyBondRequestQuoteInqRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SuretyBondRequestQuoteInqRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.SuretyBondRequestQuoteInqRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.SuretyBondRequestQuoteInqRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.BondSummaryInfo> getBondSummaryInfo() {
    return (java.util.List<xsd.acord.BondSummaryInfo>) TYPE.get().getPropertyValue( this, "_BondSummaryInfo" );
  }
