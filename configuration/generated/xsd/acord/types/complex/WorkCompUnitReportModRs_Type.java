...
public class WorkCompUnitReportModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WorkCompUnitReportModRs_Type", "" );
  ...
  public WorkCompUnitReportModRs_Type() {
    super( -1336350123, TYPE.get() );
  }

  private WorkCompUnitReportModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1336350123, state );
  }

  protected WorkCompUnitReportModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WorkCompUnitReportModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WorkCompUnitReportModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WorkCompUnitReportModRs_Type get$TypeInstance() {
    return this;
  }
