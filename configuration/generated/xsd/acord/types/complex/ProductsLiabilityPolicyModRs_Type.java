...
public class ProductsLiabilityPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ProductsLiabilityPolicyModRs_Type", "" );
  ...
  public ProductsLiabilityPolicyModRs_Type() {
    super( -2022675126, TYPE.get() );
  }

  private ProductsLiabilityPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -2022675126, state );
  }

  protected ProductsLiabilityPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ProductsLiabilityPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.ProductsLiabilityPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.ProductsLiabilityPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.ProductsLiabilityPolicy> getProductsLiabilityPolicy() {
    return (java.util.List<xsd.acord.ProductsLiabilityPolicy>) TYPE.get().getPropertyValue( this, "_ProductsLiabilityPolicy" );
  }
