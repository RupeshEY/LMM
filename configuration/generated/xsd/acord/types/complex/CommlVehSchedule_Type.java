...
public class CommlVehSchedule_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlVehSchedule_Type", "" );
  ...
  public CommlVehSchedule_Type() {
    super( 387585154, TYPE.get() );
  }

  private CommlVehSchedule_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 387585154, state );
  }

  protected CommlVehSchedule_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlVehSchedule_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlVehSchedule_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlVehSchedule_Type get$TypeInstance() {
    return this;
  }
