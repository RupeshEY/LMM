...
public class SuretyBondInqRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "SuretyBondInqRs_Type", "" );
  ...
  public SuretyBondInqRs_Type() {
    super( -1952571280, TYPE.get() );
  }

  private SuretyBondInqRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1952571280, state );
  }

  protected SuretyBondInqRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SuretyBondInqRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.SuretyBondInqRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.SuretyBondInqRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.PartyInqInfo getPartyInqInfo() {
    return (xsd.acord.PartyInqInfo) TYPE.get().getPropertyValue( this, "_PartyInqInfo" );
  }


  public final void setPartyInqInfo( xsd.acord.PartyInqInfo value ) {
    TYPE.get().setPropertyValue( this, "_PartyInqInfo", value );
  }
  ...
  public final xsd.acord.SuretyBondInqInfo getSuretyBondInqInfo() {
    return (xsd.acord.SuretyBondInqInfo) TYPE.get().getPropertyValue( this, "_SuretyBondInqInfo" );
  }


  public final void setSuretyBondInqInfo( xsd.acord.SuretyBondInqInfo value ) {
    TYPE.get().setPropertyValue( this, "_SuretyBondInqInfo", value );
  }
  ...
  public final xsd.acord.SuretyBondTransactionInqInfo getSuretyBondTransactionInqInfo() {
    return (xsd.acord.SuretyBondTransactionInqInfo) TYPE.get().getPropertyValue( this, "_SuretyBondTransactionInqInfo" );
  }


  public final void setSuretyBondTransactionInqInfo( xsd.acord.SuretyBondTransactionInqInfo value ) {
    TYPE.get().setPropertyValue( this, "_SuretyBondTransactionInqInfo", value );
  }
  ...
  public final xsd.acord.SuretyBondDetailInqInfo getSuretyBondDetailInqInfo() {
    return (xsd.acord.SuretyBondDetailInqInfo) TYPE.get().getPropertyValue( this, "_SuretyBondDetailInqInfo" );
  }


  public final void setSuretyBondDetailInqInfo( xsd.acord.SuretyBondDetailInqInfo value ) {
    TYPE.get().setPropertyValue( this, "_SuretyBondDetailInqInfo", value );
  }
  ...
  public final java.util.List<xsd.acord.SuretyBond> getSuretyBond() {
    return (java.util.List<xsd.acord.SuretyBond>) TYPE.get().getPropertyValue( this, "_SuretyBond" );
  }
