...
public class CrimePolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CrimePolicyModRs_Type", "" );
  ...
  public CrimePolicyModRs_Type() {
    super( -799176269, TYPE.get() );
  }

  private CrimePolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -799176269, state );
  }

  protected CrimePolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CrimePolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CrimePolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CrimePolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.CrimePolicy> getCrimePolicy() {
    return (java.util.List<xsd.acord.CrimePolicy>) TYPE.get().getPropertyValue( this, "_CrimePolicy" );
  }
