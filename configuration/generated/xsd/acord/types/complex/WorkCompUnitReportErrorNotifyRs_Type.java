...
public class WorkCompUnitReportErrorNotifyRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WorkCompUnitReportErrorNotifyRs_Type", "" );
  ...
  public WorkCompUnitReportErrorNotifyRs_Type() {
    super( -611399674, TYPE.get() );
  }

  private WorkCompUnitReportErrorNotifyRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -611399674, state );
  }

  protected WorkCompUnitReportErrorNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WorkCompUnitReportErrorNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WorkCompUnitReportErrorNotifyRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WorkCompUnitReportErrorNotifyRs_Type get$TypeInstance() {
    return this;
  }
