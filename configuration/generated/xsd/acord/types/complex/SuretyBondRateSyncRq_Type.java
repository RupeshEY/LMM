...
public class SuretyBondRateSyncRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "SuretyBondRateSyncRq_Type", "" );
  ...
  public SuretyBondRateSyncRq_Type() {
    super( -1428488101, TYPE.get() );
  }

  private SuretyBondRateSyncRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1428488101, state );
  }

  protected SuretyBondRateSyncRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SuretyBondRateSyncRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.SuretyBondRateSyncRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.SuretyBondRateSyncRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.RateSyncInfo> getRateSyncInfo() {
    return (java.util.List<xsd.acord.RateSyncInfo>) TYPE.get().getPropertyValue( this, "_RateSyncInfo" );
  }


  public final void setRateSyncInfo( java.util.List<xsd.acord.RateSyncInfo> value ) {
    TYPE.get().setPropertyValue( this, "_RateSyncInfo", value );
  }
