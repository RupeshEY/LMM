...
public class PersInlandMarinePolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersInlandMarinePolicyModRs_Type", "" );
  ...
  public PersInlandMarinePolicyModRs_Type() {
    super( -915340681, TYPE.get() );
  }

  private PersInlandMarinePolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -915340681, state );
  }

  protected PersInlandMarinePolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersInlandMarinePolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersInlandMarinePolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersInlandMarinePolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.PersInlandMarinePolicy> getPersInlandMarinePolicy() {
    return (java.util.List<xsd.acord.PersInlandMarinePolicy>) TYPE.get().getPropertyValue( this, "_PersInlandMarinePolicy" );
  }
