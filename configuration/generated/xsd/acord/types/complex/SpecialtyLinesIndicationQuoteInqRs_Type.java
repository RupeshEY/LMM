...
public class SpecialtyLinesIndicationQuoteInqRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "SpecialtyLinesIndicationQuoteInqRs_Type", "" );
  ...
  public SpecialtyLinesIndicationQuoteInqRs_Type() {
    super( 1645556324, TYPE.get() );
  }

  private SpecialtyLinesIndicationQuoteInqRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1645556324, state );
  }

  protected SpecialtyLinesIndicationQuoteInqRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SpecialtyLinesIndicationQuoteInqRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.SpecialtyLinesIndicationQuoteInqRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.SpecialtyLinesIndicationQuoteInqRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.lang.Boolean getInsurerInterestedInd() {
    return (java.lang.Boolean) TYPE.get().getPropertyValue( this, "_InsurerInterestedInd" );
  }


  public final void setInsurerInterestedInd( java.lang.Boolean value ) {
    TYPE.get().setPropertyValue( this, "_InsurerInterestedInd", value );
  }
  ...
  public final xsd.acord.InsurerInterestedInd getInsurerInterestedInd_elem() {
    return (xsd.acord.InsurerInterestedInd) TYPE.get().getPropertyValue( this, "_InsurerInterestedInd_elem" );
  }


  public final void setInsurerInterestedInd_elem( xsd.acord.InsurerInterestedInd value ) {
    TYPE.get().setPropertyValue( this, "_InsurerInterestedInd_elem", value );
  }
