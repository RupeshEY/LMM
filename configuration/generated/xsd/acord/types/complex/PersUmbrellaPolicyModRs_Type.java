...
public class PersUmbrellaPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersUmbrellaPolicyModRs_Type", "" );
  ...
  public PersUmbrellaPolicyModRs_Type() {
    super( -1174671415, TYPE.get() );
  }

  private PersUmbrellaPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1174671415, state );
  }

  protected PersUmbrellaPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersUmbrellaPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersUmbrellaPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersUmbrellaPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.PersUmbrellaPolicy> getPersUmbrellaPolicy() {
    return (java.util.List<xsd.acord.PersUmbrellaPolicy>) TYPE.get().getPropertyValue( this, "_PersUmbrellaPolicy" );
  }
