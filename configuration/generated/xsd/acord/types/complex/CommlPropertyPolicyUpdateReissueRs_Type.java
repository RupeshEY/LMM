...
public class CommlPropertyPolicyUpdateReissueRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlPropertyPolicyUpdateReissueRs_Type", "" );
  ...
  public CommlPropertyPolicyUpdateReissueRs_Type() {
    super( -1810698309, TYPE.get() );
  }

  private CommlPropertyPolicyUpdateReissueRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1810698309, state );
  }

  protected CommlPropertyPolicyUpdateReissueRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlPropertyPolicyUpdateReissueRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlPropertyPolicyUpdateReissueRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlPropertyPolicyUpdateReissueRs_Type get$TypeInstance() {
    return this;
  }
