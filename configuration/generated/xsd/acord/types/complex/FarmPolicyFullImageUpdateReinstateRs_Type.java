...
public class FarmPolicyFullImageUpdateReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "FarmPolicyFullImageUpdateReinstateRs_Type", "" );
  ...
  public FarmPolicyFullImageUpdateReinstateRs_Type() {
    super( -1602851483, TYPE.get() );
  }

  private FarmPolicyFullImageUpdateReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1602851483, state );
  }

  protected FarmPolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected FarmPolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.FarmPolicyFullImageUpdateReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.FarmPolicyFullImageUpdateReinstateRs_Type get$TypeInstance() {
    return this;
  }
