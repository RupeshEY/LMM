...
public class CommlPropertyPolicyReplaceAddRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlPropertyPolicyReplaceAddRs_Type", "" );
  ...
  public CommlPropertyPolicyReplaceAddRs_Type() {
    super( 824361771, TYPE.get() );
  }

  private CommlPropertyPolicyReplaceAddRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 824361771, state );
  }

  protected CommlPropertyPolicyReplaceAddRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlPropertyPolicyReplaceAddRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlPropertyPolicyReplaceAddRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlPropertyPolicyReplaceAddRs_Type get$TypeInstance() {
    return this;
  }
