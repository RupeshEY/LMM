...
public class AircraftPolicyFullImageReplaceReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "AircraftPolicyFullImageReplaceReinstateRs_Type", "" );
  ...
  public AircraftPolicyFullImageReplaceReinstateRs_Type() {
    super( -1538104810, TYPE.get() );
  }

  private AircraftPolicyFullImageReplaceReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1538104810, state );
  }

  protected AircraftPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected AircraftPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.AircraftPolicyFullImageReplaceReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.AircraftPolicyFullImageReplaceReinstateRs_Type get$TypeInstance() {
    return this;
  }
