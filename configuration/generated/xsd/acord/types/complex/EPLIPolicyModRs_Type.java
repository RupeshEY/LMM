...
public class EPLIPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "EPLIPolicyModRs_Type", "" );
  ...
  public EPLIPolicyModRs_Type() {
    super( 1681882039, TYPE.get() );
  }

  private EPLIPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1681882039, state );
  }

  protected EPLIPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected EPLIPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.EPLIPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.EPLIPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.EPLIPolicy> getEPLIPolicy() {
    return (java.util.List<xsd.acord.EPLIPolicy>) TYPE.get().getPropertyValue( this, "_EPLIPolicy" );
  }
