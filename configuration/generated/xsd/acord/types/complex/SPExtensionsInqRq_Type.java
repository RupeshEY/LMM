...
public class SPExtensionsInqRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "SPExtensionsInqRq_Type", "" );
  ...
  public SPExtensionsInqRq_Type() {
    super( 1307241318, TYPE.get() );
  }

  private SPExtensionsInqRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1307241318, state );
  }

  protected SPExtensionsInqRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SPExtensionsInqRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.SPExtensionsInqRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.SPExtensionsInqRq_Type get$TypeInstance() {
    return this;
  }
