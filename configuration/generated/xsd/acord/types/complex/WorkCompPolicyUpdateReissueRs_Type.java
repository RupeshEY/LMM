...
public class WorkCompPolicyUpdateReissueRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WorkCompPolicyUpdateReissueRs_Type", "" );
  ...
  public WorkCompPolicyUpdateReissueRs_Type() {
    super( -1996193644, TYPE.get() );
  }

  private WorkCompPolicyUpdateReissueRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1996193644, state );
  }

  protected WorkCompPolicyUpdateReissueRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WorkCompPolicyUpdateReissueRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WorkCompPolicyUpdateReissueRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WorkCompPolicyUpdateReissueRs_Type get$TypeInstance() {
    return this;
  }
