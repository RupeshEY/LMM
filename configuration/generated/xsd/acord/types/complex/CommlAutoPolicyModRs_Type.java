...
public class CommlAutoPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlAutoPolicyModRs_Type", "" );
  ...
  public CommlAutoPolicyModRs_Type() {
    super( 1646530288, TYPE.get() );
  }

  private CommlAutoPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1646530288, state );
  }

  protected CommlAutoPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlAutoPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlAutoPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlAutoPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.CommlAutoPolicy> getCommlAutoPolicy() {
    return (java.util.List<xsd.acord.CommlAutoPolicy>) TYPE.get().getPropertyValue( this, "_CommlAutoPolicy" );
  }
