...
public class EducationLevel extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "EducationLevel", "" );
  ...
  public EducationLevel() {
    super( -739380669, TYPE.get() );
  }

  public EducationLevel( xsd.acord.enums.EducationLevel value ) {
    this();
    setValue( value );
  }

  private EducationLevel( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -739380669, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.EducationLevel> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.EducationLevel get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.enums.EducationLevel getValue() {
    return (xsd.acord.enums.EducationLevel) TYPE.get().getPropertyValue( this, "Value" );
  }
