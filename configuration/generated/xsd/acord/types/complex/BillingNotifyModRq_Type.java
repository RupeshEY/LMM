...
public class BillingNotifyModRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "BillingNotifyModRq_Type", "" );
  ...
  public BillingNotifyModRq_Type() {
    super( -1157757163, TYPE.get() );
  }

  private BillingNotifyModRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1157757163, state );
  }

  protected BillingNotifyModRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected BillingNotifyModRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.BillingNotifyModRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.BillingNotifyModRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.BillingPolicyInfo getBillingPolicyInfo() {
    return (xsd.acord.BillingPolicyInfo) TYPE.get().getPropertyValue( this, "_BillingPolicyInfo" );
  }


  public final void setBillingPolicyInfo( xsd.acord.BillingPolicyInfo value ) {
    TYPE.get().setPropertyValue( this, "_BillingPolicyInfo", value );
  }
