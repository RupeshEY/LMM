...
public class DirectorsAndOfficersPolicyUpdateAddRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "DirectorsAndOfficersPolicyUpdateAddRs_Type", "" );
  ...
  public DirectorsAndOfficersPolicyUpdateAddRs_Type() {
    super( 555223846, TYPE.get() );
  }

  private DirectorsAndOfficersPolicyUpdateAddRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 555223846, state );
  }

  protected DirectorsAndOfficersPolicyUpdateAddRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected DirectorsAndOfficersPolicyUpdateAddRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.DirectorsAndOfficersPolicyUpdateAddRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.DirectorsAndOfficersPolicyUpdateAddRs_Type get$TypeInstance() {
    return this;
  }
