...
public class AircraftPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "AircraftPolicyModRs_Type", "" );
  ...
  public AircraftPolicyModRs_Type() {
    super( -1992643579, TYPE.get() );
  }

  private AircraftPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1992643579, state );
  }

  protected AircraftPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected AircraftPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.AircraftPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.AircraftPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.AircraftPolicy> getAircraftPolicy() {
    return (java.util.List<xsd.acord.AircraftPolicy>) TYPE.get().getPropertyValue( this, "_AircraftPolicy" );
  }
