...
public class SuretyBondBillingSummaryNotifyRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "SuretyBondBillingSummaryNotifyRs_Type", "" );
  ...
  public SuretyBondBillingSummaryNotifyRs_Type() {
    super( -453128896, TYPE.get() );
  }

  private SuretyBondBillingSummaryNotifyRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -453128896, state );
  }

  protected SuretyBondBillingSummaryNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SuretyBondBillingSummaryNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.SuretyBondBillingSummaryNotifyRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.SuretyBondBillingSummaryNotifyRs_Type get$TypeInstance() {
    return this;
  }
