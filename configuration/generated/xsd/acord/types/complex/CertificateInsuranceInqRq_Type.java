...
public class CertificateInsuranceInqRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CertificateInsuranceInqRq_Type", "" );
  ...
  public CertificateInsuranceInqRq_Type() {
    super( 2000488120, TYPE.get() );
  }

  private CertificateInsuranceInqRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 2000488120, state );
  }

  protected CertificateInsuranceInqRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CertificateInsuranceInqRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CertificateInsuranceInqRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CertificateInsuranceInqRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.CertificateInqInfo getCertificateInqInfo() {
    return (xsd.acord.CertificateInqInfo) TYPE.get().getPropertyValue( this, "_CertificateInqInfo" );
  }


  public final void setCertificateInqInfo( xsd.acord.CertificateInqInfo value ) {
    TYPE.get().setPropertyValue( this, "_CertificateInqInfo", value );
  }
