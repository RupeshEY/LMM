...
public class TaxFeeSurcharge extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "TaxFeeSurcharge", "" );
  ...
  public TaxFeeSurcharge() {
    super( -467695934, TYPE.get() );
  }

  public TaxFeeSurcharge( xsd.acord.enums.TaxFeeSurcharge value ) {
    this();
    setValue( value );
  }

  private TaxFeeSurcharge( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -467695934, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.TaxFeeSurcharge> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.TaxFeeSurcharge get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.enums.TaxFeeSurcharge getValue() {
    return (xsd.acord.enums.TaxFeeSurcharge) TYPE.get().getPropertyValue( this, "Value" );
  }
