...
public class AviationPkgPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "AviationPkgPolicyModRs_Type", "" );
  ...
  public AviationPkgPolicyModRs_Type() {
    super( 1191830892, TYPE.get() );
  }

  private AviationPkgPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1191830892, state );
  }

  protected AviationPkgPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected AviationPkgPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.AviationPkgPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.AviationPkgPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.AviationPkgPolicy> getAviationPkgPolicy() {
    return (java.util.List<xsd.acord.AviationPkgPolicy>) TYPE.get().getPropertyValue( this, "_AviationPkgPolicy" );
  }
