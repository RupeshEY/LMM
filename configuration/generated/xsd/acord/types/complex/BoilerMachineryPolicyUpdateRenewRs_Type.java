...
public class BoilerMachineryPolicyUpdateRenewRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "BoilerMachineryPolicyUpdateRenewRs_Type", "" );
  ...
  public BoilerMachineryPolicyUpdateRenewRs_Type() {
    super( -1568166032, TYPE.get() );
  }

  private BoilerMachineryPolicyUpdateRenewRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1568166032, state );
  }

  protected BoilerMachineryPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected BoilerMachineryPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.BoilerMachineryPolicyUpdateRenewRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.BoilerMachineryPolicyUpdateRenewRs_Type get$TypeInstance() {
    return this;
  }
