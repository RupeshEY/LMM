...
public class WorkCompPolicy_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WorkCompPolicy_Type", "" );
  ...
  public WorkCompPolicy_Type() {
    super( 1061409600, TYPE.get() );
  }

  private WorkCompPolicy_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1061409600, state );
  }

  protected WorkCompPolicy_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WorkCompPolicy_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WorkCompPolicy_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WorkCompPolicy_Type get$TypeInstance() {
    return this;
  }
