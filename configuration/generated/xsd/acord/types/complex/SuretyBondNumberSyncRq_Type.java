...
public class SuretyBondNumberSyncRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "SuretyBondNumberSyncRq_Type", "" );
  ...
  public SuretyBondNumberSyncRq_Type() {
    super( -2058801326, TYPE.get() );
  }

  private SuretyBondNumberSyncRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -2058801326, state );
  }

  protected SuretyBondNumberSyncRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SuretyBondNumberSyncRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.SuretyBondNumberSyncRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.SuretyBondNumberSyncRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.BondNumberSyncInfo getBondNumberSyncInfo() {
    return (xsd.acord.BondNumberSyncInfo) TYPE.get().getPropertyValue( this, "_BondNumberSyncInfo" );
  }


  public final void setBondNumberSyncInfo( xsd.acord.BondNumberSyncInfo value ) {
    TYPE.get().setPropertyValue( this, "_BondNumberSyncInfo", value );
  }
