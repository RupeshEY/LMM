...
public class WatercraftPolicyUpdateReissueRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WatercraftPolicyUpdateReissueRs_Type", "" );
  ...
  public WatercraftPolicyUpdateReissueRs_Type() {
    super( 679519037, TYPE.get() );
  }

  private WatercraftPolicyUpdateReissueRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 679519037, state );
  }

  protected WatercraftPolicyUpdateReissueRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WatercraftPolicyUpdateReissueRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WatercraftPolicyUpdateReissueRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WatercraftPolicyUpdateReissueRs_Type get$TypeInstance() {
    return this;
  }
