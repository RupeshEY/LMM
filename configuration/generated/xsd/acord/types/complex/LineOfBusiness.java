...
public class LineOfBusiness extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "LineOfBusiness", "" );
  ...
  public LineOfBusiness() {
    super( -925910190, TYPE.get() );
  }

  public LineOfBusiness( xsd.acord.enums.LineOfBusiness value ) {
    this();
    setValue( value );
  }

  private LineOfBusiness( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -925910190, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.LineOfBusiness> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.LineOfBusiness get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.enums.LineOfBusiness getValue() {
    return (xsd.acord.enums.LineOfBusiness) TYPE.get().getPropertyValue( this, "Value" );
  }
