...
public class AircraftPolicy_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "AircraftPolicy_Type", "" );
  ...
  public AircraftPolicy_Type() {
    super( -1459743702, TYPE.get() );
  }

  private AircraftPolicy_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1459743702, state );
  }

  protected AircraftPolicy_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected AircraftPolicy_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.AircraftPolicy_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.AircraftPolicy_Type get$TypeInstance() {
    return this;
  }
