...
public class BoilerMachineryPolicyFullImageUpdateReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "BoilerMachineryPolicyFullImageUpdateReinstateRs_Type", "" );
  ...
  public BoilerMachineryPolicyFullImageUpdateReinstateRs_Type() {
    super( 266591800, TYPE.get() );
  }

  private BoilerMachineryPolicyFullImageUpdateReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 266591800, state );
  }

  protected BoilerMachineryPolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected BoilerMachineryPolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.BoilerMachineryPolicyFullImageUpdateReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.BoilerMachineryPolicyFullImageUpdateReinstateRs_Type get$TypeInstance() {
    return this;
  }
