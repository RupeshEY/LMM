...
public class CommlInlandMarinePolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlInlandMarinePolicyModRs_Type", "" );
  ...
  public CommlInlandMarinePolicyModRs_Type() {
    super( -751340365, TYPE.get() );
  }

  private CommlInlandMarinePolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -751340365, state );
  }

  protected CommlInlandMarinePolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlInlandMarinePolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlInlandMarinePolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlInlandMarinePolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.CommlIMPolicy> getCommlIMPolicy() {
    return (java.util.List<xsd.acord.CommlIMPolicy>) TYPE.get().getPropertyValue( this, "_CommlIMPolicy" );
  }
