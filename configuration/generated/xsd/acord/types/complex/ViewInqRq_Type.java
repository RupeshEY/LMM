...
public class ViewInqRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ViewInqRq_Type", "" );
  ...
  public ViewInqRq_Type() {
    super( -1986712102, TYPE.get() );
  }

  private ViewInqRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1986712102, state );
  }

  protected ViewInqRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ViewInqRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.ViewInqRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.ViewInqRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.ViewInqInfo getViewInqInfo() {
    return (xsd.acord.ViewInqInfo) TYPE.get().getPropertyValue( this, "_ViewInqInfo" );
  }


  public final void setViewInqInfo( xsd.acord.ViewInqInfo value ) {
    TYPE.get().setPropertyValue( this, "_ViewInqInfo", value );
  }
