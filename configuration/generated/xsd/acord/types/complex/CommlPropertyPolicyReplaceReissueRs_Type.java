...
public class CommlPropertyPolicyReplaceReissueRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlPropertyPolicyReplaceReissueRs_Type", "" );
  ...
  public CommlPropertyPolicyReplaceReissueRs_Type() {
    super( 1850500006, TYPE.get() );
  }

  private CommlPropertyPolicyReplaceReissueRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1850500006, state );
  }

  protected CommlPropertyPolicyReplaceReissueRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlPropertyPolicyReplaceReissueRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlPropertyPolicyReplaceReissueRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlPropertyPolicyReplaceReissueRs_Type get$TypeInstance() {
    return this;
  }
