...
public class PremiumAuditNotificationAddRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PremiumAuditNotificationAddRq_Type", "" );
  ...
  public PremiumAuditNotificationAddRq_Type() {
    super( -1955223121, TYPE.get() );
  }

  private PremiumAuditNotificationAddRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1955223121, state );
  }

  protected PremiumAuditNotificationAddRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PremiumAuditNotificationAddRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PremiumAuditNotificationAddRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PremiumAuditNotificationAddRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.PremiumAuditInfo getPremiumAuditInfo() {
    return (xsd.acord.PremiumAuditInfo) TYPE.get().getPropertyValue( this, "_PremiumAuditInfo" );
  }


  public final void setPremiumAuditInfo( xsd.acord.PremiumAuditInfo value ) {
    TYPE.get().setPropertyValue( this, "_PremiumAuditInfo", value );
  }
