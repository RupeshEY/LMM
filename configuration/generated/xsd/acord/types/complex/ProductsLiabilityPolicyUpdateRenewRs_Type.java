...
public class ProductsLiabilityPolicyUpdateRenewRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ProductsLiabilityPolicyUpdateRenewRs_Type", "" );
  ...
  public ProductsLiabilityPolicyUpdateRenewRs_Type() {
    super( -1279894840, TYPE.get() );
  }

  private ProductsLiabilityPolicyUpdateRenewRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1279894840, state );
  }

  protected ProductsLiabilityPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ProductsLiabilityPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.ProductsLiabilityPolicyUpdateRenewRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.ProductsLiabilityPolicyUpdateRenewRs_Type get$TypeInstance() {
    return this;
  }
