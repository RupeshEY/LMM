...
public class PersAutoPolicyFullImageNotifyRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersAutoPolicyFullImageNotifyRs_Type", "" );
  ...
  public PersAutoPolicyFullImageNotifyRs_Type() {
    super( -520773407, TYPE.get() );
  }

  private PersAutoPolicyFullImageNotifyRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -520773407, state );
  }

  protected PersAutoPolicyFullImageNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersAutoPolicyFullImageNotifyRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersAutoPolicyFullImageNotifyRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersAutoPolicyFullImageNotifyRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.PersAutoLineBusiness getPersAutoLineBusiness() {
    return (xsd.acord.PersAutoLineBusiness) TYPE.get().getPropertyValue( this, "_PersAutoLineBusiness" );
  }


  public final void setPersAutoLineBusiness( xsd.acord.PersAutoLineBusiness value ) {
    TYPE.get().setPropertyValue( this, "_PersAutoLineBusiness", value );
  }
