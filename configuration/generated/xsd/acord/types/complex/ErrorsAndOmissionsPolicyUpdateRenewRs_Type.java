...
public class ErrorsAndOmissionsPolicyUpdateRenewRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ErrorsAndOmissionsPolicyUpdateRenewRs_Type", "" );
  ...
  public ErrorsAndOmissionsPolicyUpdateRenewRs_Type() {
    super( -662310025, TYPE.get() );
  }

  private ErrorsAndOmissionsPolicyUpdateRenewRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -662310025, state );
  }

  protected ErrorsAndOmissionsPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ErrorsAndOmissionsPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.ErrorsAndOmissionsPolicyUpdateRenewRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.ErrorsAndOmissionsPolicyUpdateRenewRs_Type get$TypeInstance() {
    return this;
  }
