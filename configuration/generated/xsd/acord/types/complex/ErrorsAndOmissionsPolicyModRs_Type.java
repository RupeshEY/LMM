...
public class ErrorsAndOmissionsPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ErrorsAndOmissionsPolicyModRs_Type", "" );
  ...
  public ErrorsAndOmissionsPolicyModRs_Type() {
    super( -199285511, TYPE.get() );
  }

  private ErrorsAndOmissionsPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -199285511, state );
  }

  protected ErrorsAndOmissionsPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ErrorsAndOmissionsPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.ErrorsAndOmissionsPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.ErrorsAndOmissionsPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.ErrorsAndOmissionsPolicy> getErrorsAndOmissionsPolicy() {
    return (java.util.List<xsd.acord.ErrorsAndOmissionsPolicy>) TYPE.get().getPropertyValue( this, "_ErrorsAndOmissionsPolicy" );
  }
