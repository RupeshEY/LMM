...
public class BillingInqRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "BillingInqRq_Type", "" );
  ...
  public BillingInqRq_Type() {
    super( -1680755262, TYPE.get() );
  }

  private BillingInqRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1680755262, state );
  }

  protected BillingInqRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected BillingInqRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.BillingInqRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.BillingInqRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.BillingInqInfo getBillingInqInfo() {
    return (xsd.acord.BillingInqInfo) TYPE.get().getPropertyValue( this, "_BillingInqInfo" );
  }


  public final void setBillingInqInfo( xsd.acord.BillingInqInfo value ) {
    TYPE.get().setPropertyValue( this, "_BillingInqInfo", value );
  }
