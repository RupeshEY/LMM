...
public class PersPkgPolicyFullImageReplaceReinstateRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersPkgPolicyFullImageReplaceReinstateRq_Type", "" );
  ...
  public PersPkgPolicyFullImageReplaceReinstateRq_Type() {
    super( -1722442550, TYPE.get() );
  }

  private PersPkgPolicyFullImageReplaceReinstateRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1722442550, state );
  }

  protected PersPkgPolicyFullImageReplaceReinstateRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersPkgPolicyFullImageReplaceReinstateRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersPkgPolicyFullImageReplaceReinstateRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersPkgPolicyFullImageReplaceReinstateRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.ReplacementInfo> getReplacementInfo() {
    return (java.util.List<xsd.acord.ReplacementInfo>) TYPE.get().getPropertyValue( this, "_ReplacementInfo" );
  }


  public final void setReplacementInfo( java.util.List<xsd.acord.ReplacementInfo> value ) {
    TYPE.get().setPropertyValue( this, "_ReplacementInfo", value );
  }
