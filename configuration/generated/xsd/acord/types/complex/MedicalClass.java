...
public class MedicalClass extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "MedicalClass", "" );
  ...
  public MedicalClass() {
    super( -894669650, TYPE.get() );
  }

  public MedicalClass( xsd.acord.enums.MedicalClass value ) {
    this();
    setValue( value );
  }

  private MedicalClass( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -894669650, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.MedicalClass> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.MedicalClass get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.enums.MedicalClass getValue() {
    return (xsd.acord.enums.MedicalClass) TYPE.get().getPropertyValue( this, "Value" );
  }
