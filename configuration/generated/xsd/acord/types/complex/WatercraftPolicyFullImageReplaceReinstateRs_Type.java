...
public class WatercraftPolicyFullImageReplaceReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WatercraftPolicyFullImageReplaceReinstateRs_Type", "" );
  ...
  public WatercraftPolicyFullImageReplaceReinstateRs_Type() {
    super( 305943145, TYPE.get() );
  }

  private WatercraftPolicyFullImageReplaceReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 305943145, state );
  }

  protected WatercraftPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WatercraftPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WatercraftPolicyFullImageReplaceReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WatercraftPolicyFullImageReplaceReinstateRs_Type get$TypeInstance() {
    return this;
  }
