...
public class SuretyBondBillingSummaryNotifyRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "SuretyBondBillingSummaryNotifyRq_Type", "" );
  ...
  public SuretyBondBillingSummaryNotifyRq_Type() {
    super( -510387198, TYPE.get() );
  }

  private SuretyBondBillingSummaryNotifyRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -510387198, state );
  }

  protected SuretyBondBillingSummaryNotifyRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected SuretyBondBillingSummaryNotifyRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.SuretyBondBillingSummaryNotifyRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.SuretyBondBillingSummaryNotifyRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.SuretyBondBillingSummaryInfo> getSuretyBondBillingSummaryInfo() {
    return (java.util.List<xsd.acord.SuretyBondBillingSummaryInfo>) TYPE.get().getPropertyValue( this, "_SuretyBondBillingSummaryInfo" );
  }


  public final void setSuretyBondBillingSummaryInfo( java.util.List<xsd.acord.SuretyBondBillingSummaryInfo> value ) {
    TYPE.get().setPropertyValue( this, "_SuretyBondBillingSummaryInfo", value );
  }
