...
public class WatercraftPolicyUpdateAddRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WatercraftPolicyUpdateAddRs_Type", "" );
  ...
  public WatercraftPolicyUpdateAddRs_Type() {
    super( -711170494, TYPE.get() );
  }

  private WatercraftPolicyUpdateAddRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -711170494, state );
  }

  protected WatercraftPolicyUpdateAddRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WatercraftPolicyUpdateAddRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WatercraftPolicyUpdateAddRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WatercraftPolicyUpdateAddRs_Type get$TypeInstance() {
    return this;
  }
