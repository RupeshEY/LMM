...
public class CommlUmbrellaPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlUmbrellaPolicyModRs_Type", "" );
  ...
  public CommlUmbrellaPolicyModRs_Type() {
    super( 1114431493, TYPE.get() );
  }

  private CommlUmbrellaPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1114431493, state );
  }

  protected CommlUmbrellaPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlUmbrellaPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlUmbrellaPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlUmbrellaPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.CommlUmbrellaPolicy> getCommlUmbrellaPolicy() {
    return (java.util.List<xsd.acord.CommlUmbrellaPolicy>) TYPE.get().getPropertyValue( this, "_CommlUmbrellaPolicy" );
  }
