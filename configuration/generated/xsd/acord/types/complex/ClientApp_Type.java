...
public class ClientApp_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ClientApp_Type", "" );
  ...
  public ClientApp_Type() {
    super( -1214254806, TYPE.get() );
  }

  private ClientApp_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1214254806, state );
  }

  protected ClientApp_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ClientApp_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.ClientApp_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.ClientApp_Type get$TypeInstance() {
    return this;
  }
