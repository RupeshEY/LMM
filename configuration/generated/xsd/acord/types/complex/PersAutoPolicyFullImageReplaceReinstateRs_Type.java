...
public class PersAutoPolicyFullImageReplaceReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersAutoPolicyFullImageReplaceReinstateRs_Type", "" );
  ...
  public PersAutoPolicyFullImageReplaceReinstateRs_Type() {
    super( -727049851, TYPE.get() );
  }

  private PersAutoPolicyFullImageReplaceReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -727049851, state );
  }

  protected PersAutoPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersAutoPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersAutoPolicyFullImageReplaceReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersAutoPolicyFullImageReplaceReinstateRs_Type get$TypeInstance() {
    return this;
  }
