...
public class PersAutoPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersAutoPolicyModRs_Type", "" );
  ...
  public PersAutoPolicyModRs_Type() {
    super( -702963532, TYPE.get() );
  }

  private PersAutoPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -702963532, state );
  }

  protected PersAutoPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersAutoPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersAutoPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersAutoPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.PersAutoPolicy> getPersAutoPolicy() {
    return (java.util.List<xsd.acord.PersAutoPolicy>) TYPE.get().getPropertyValue( this, "_PersAutoPolicy" );
  }
