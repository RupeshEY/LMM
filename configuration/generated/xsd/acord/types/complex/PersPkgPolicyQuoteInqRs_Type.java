...
public class PersPkgPolicyQuoteInqRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersPkgPolicyQuoteInqRs_Type", "" );
  ...
  public PersPkgPolicyQuoteInqRs_Type() {
    super( 1883561223, TYPE.get() );
  }

  private PersPkgPolicyQuoteInqRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1883561223, state );
  }

  protected PersPkgPolicyQuoteInqRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersPkgPolicyQuoteInqRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersPkgPolicyQuoteInqRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersPkgPolicyQuoteInqRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.AdditionalQuotedScenario> getAdditionalQuotedScenario() {
    return (java.util.List<xsd.acord.AdditionalQuotedScenario>) TYPE.get().getPropertyValue( this, "_AdditionalQuotedScenario" );
  }


  public final void setAdditionalQuotedScenario( java.util.List<xsd.acord.AdditionalQuotedScenario> value ) {
    TYPE.get().setPropertyValue( this, "_AdditionalQuotedScenario", value );
  }
