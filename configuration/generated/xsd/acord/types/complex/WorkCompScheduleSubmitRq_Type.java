...
public class WorkCompScheduleSubmitRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WorkCompScheduleSubmitRq_Type", "" );
  ...
  public WorkCompScheduleSubmitRq_Type() {
    super( -113951100, TYPE.get() );
  }

  private WorkCompScheduleSubmitRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -113951100, state );
  }

  protected WorkCompScheduleSubmitRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WorkCompScheduleSubmitRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WorkCompScheduleSubmitRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WorkCompScheduleSubmitRq_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.WorkCompScheduleState> getWorkCompScheduleState() {
    return (java.util.List<xsd.acord.WorkCompScheduleState>) TYPE.get().getPropertyValue( this, "_WorkCompScheduleState" );
  }


  public final void setWorkCompScheduleState( java.util.List<xsd.acord.WorkCompScheduleState> value ) {
    TYPE.get().setPropertyValue( this, "_WorkCompScheduleState", value );
  }
