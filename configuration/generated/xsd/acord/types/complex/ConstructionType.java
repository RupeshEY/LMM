...
public class ConstructionType extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ConstructionType", "" );
  ...
  public ConstructionType() {
    super( -885382286, TYPE.get() );
  }

  public ConstructionType( xsd.acord.enums.ConstructionType value ) {
    this();
    setValue( value );
  }

  private ConstructionType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -885382286, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.ConstructionType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.ConstructionType get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.enums.ConstructionType getValue() {
    return (xsd.acord.enums.ConstructionType) TYPE.get().getPropertyValue( this, "Value" );
  }
