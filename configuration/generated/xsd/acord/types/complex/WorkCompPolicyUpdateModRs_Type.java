...
public class WorkCompPolicyUpdateModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WorkCompPolicyUpdateModRs_Type", "" );
  ...
  public WorkCompPolicyUpdateModRs_Type() {
    super( -927164008, TYPE.get() );
  }

  private WorkCompPolicyUpdateModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -927164008, state );
  }

  protected WorkCompPolicyUpdateModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WorkCompPolicyUpdateModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WorkCompPolicyUpdateModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WorkCompPolicyUpdateModRs_Type get$TypeInstance() {
    return this;
  }
