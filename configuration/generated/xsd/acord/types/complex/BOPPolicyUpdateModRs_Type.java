...
public class BOPPolicyUpdateModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "BOPPolicyUpdateModRs_Type", "" );
  ...
  public BOPPolicyUpdateModRs_Type() {
    super( 1535745517, TYPE.get() );
  }

  private BOPPolicyUpdateModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1535745517, state );
  }

  protected BOPPolicyUpdateModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected BOPPolicyUpdateModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.BOPPolicyUpdateModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.BOPPolicyUpdateModRs_Type get$TypeInstance() {
    return this;
  }
