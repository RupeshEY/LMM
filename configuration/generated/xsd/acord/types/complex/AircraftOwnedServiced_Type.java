...
public class AircraftOwnedServiced_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "AircraftOwnedServiced_Type", "" );
  ...
  public AircraftOwnedServiced_Type() {
    super( -1947692190, TYPE.get() );
  }

  private AircraftOwnedServiced_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1947692190, state );
  }

  protected AircraftOwnedServiced_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected AircraftOwnedServiced_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.AircraftOwnedServiced_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.AircraftOwnedServiced_Type get$TypeInstance() {
    return this;
  }
