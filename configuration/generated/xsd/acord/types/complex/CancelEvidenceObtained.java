...
public class CancelEvidenceObtained extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CancelEvidenceObtained", "" );
  ...
  public CancelEvidenceObtained() {
    super( 1181565084, TYPE.get() );
  }

  public CancelEvidenceObtained( xsd.acord.enums.CancelEvidenceObtained value ) {
    this();
    setValue( value );
  }

  private CancelEvidenceObtained( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1181565084, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CancelEvidenceObtained> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CancelEvidenceObtained get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.enums.CancelEvidenceObtained getValue() {
    return (xsd.acord.enums.CancelEvidenceObtained) TYPE.get().getPropertyValue( this, "Value" );
  }
