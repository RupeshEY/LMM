...
public class WorkCompPolicyFullImageReplaceReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WorkCompPolicyFullImageReplaceReinstateRs_Type", "" );
  ...
  public WorkCompPolicyFullImageReplaceReinstateRs_Type() {
    super( -245111488, TYPE.get() );
  }

  private WorkCompPolicyFullImageReplaceReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -245111488, state );
  }

  protected WorkCompPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WorkCompPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WorkCompPolicyFullImageReplaceReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WorkCompPolicyFullImageReplaceReinstateRs_Type get$TypeInstance() {
    return this;
  }
