...
public class DirectorsAndOfficersLineBusiness_Type extends xsd.acord.types.complex.PCLINEBUSINESS {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "DirectorsAndOfficersLineBusiness_Type", "" );
  ...
  public DirectorsAndOfficersLineBusiness_Type() {
    super( -327010575, TYPE.get() );
  }

  private DirectorsAndOfficersLineBusiness_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -327010575, state );
  }

  protected DirectorsAndOfficersLineBusiness_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected DirectorsAndOfficersLineBusiness_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.DirectorsAndOfficersLineBusiness_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.DirectorsAndOfficersLineBusiness_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.ShareHoldersInfo> getShareHoldersInfo() {
    return (java.util.List<xsd.acord.ShareHoldersInfo>) TYPE.get().getPropertyValue( this, "_ShareHoldersInfo" );
  }


  public final void setShareHoldersInfo( java.util.List<xsd.acord.ShareHoldersInfo> value ) {
    TYPE.get().setPropertyValue( this, "_ShareHoldersInfo", value );
  }
  ...
  public final java.util.List<xsd.acord.StockInfo> getStockInfo() {
    return (java.util.List<xsd.acord.StockInfo>) TYPE.get().getPropertyValue( this, "_StockInfo" );
  }


  public final void setStockInfo( java.util.List<xsd.acord.StockInfo> value ) {
    TYPE.get().setPropertyValue( this, "_StockInfo", value );
  }
