...
public class RequestorType extends gw.xml.XmlTypeInstance {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "RequestorType", "" );
  ...
  public RequestorType() {
    super( -1619885915, TYPE.get() );
  }

  public RequestorType( xsd.acord.enums.RequestorType value ) {
    this();
    setValue( value );
  }

  private RequestorType( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1619885915, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.RequestorType> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.RequestorType get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.acord.enums.RequestorType getValue() {
    return (xsd.acord.enums.RequestorType) TYPE.get().getPropertyValue( this, "Value" );
  }
