...
public class CommlPropertyPolicy_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlPropertyPolicy_Type", "" );
  ...
  public CommlPropertyPolicy_Type() {
    super( -30418183, TYPE.get() );
  }

  private CommlPropertyPolicy_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -30418183, state );
  }

  protected CommlPropertyPolicy_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlPropertyPolicy_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlPropertyPolicy_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlPropertyPolicy_Type get$TypeInstance() {
    return this;
  }
