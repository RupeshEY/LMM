...
public class CrimePolicyUpdateRenewRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CrimePolicyUpdateRenewRs_Type", "" );
  ...
  public CrimePolicyUpdateRenewRs_Type() {
    super( 198770225, TYPE.get() );
  }

  private CrimePolicyUpdateRenewRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 198770225, state );
  }

  protected CrimePolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CrimePolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CrimePolicyUpdateRenewRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CrimePolicyUpdateRenewRs_Type get$TypeInstance() {
    return this;
  }
