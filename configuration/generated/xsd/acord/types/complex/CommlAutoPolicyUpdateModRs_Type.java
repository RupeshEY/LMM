...
public class CommlAutoPolicyUpdateModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlAutoPolicyUpdateModRs_Type", "" );
  ...
  public CommlAutoPolicyUpdateModRs_Type() {
    super( -794048231, TYPE.get() );
  }

  private CommlAutoPolicyUpdateModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -794048231, state );
  }

  protected CommlAutoPolicyUpdateModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlAutoPolicyUpdateModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlAutoPolicyUpdateModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlAutoPolicyUpdateModRs_Type get$TypeInstance() {
    return this;
  }
