...
public class WatercraftPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "WatercraftPolicyModRs_Type", "" );
  ...
  public WatercraftPolicyModRs_Type() {
    super( 444439704, TYPE.get() );
  }

  private WatercraftPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 444439704, state );
  }

  protected WatercraftPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected WatercraftPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.WatercraftPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.WatercraftPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.WatercraftPolicy> getWatercraftPolicy() {
    return (java.util.List<xsd.acord.WatercraftPolicy>) TYPE.get().getPropertyValue( this, "_WatercraftPolicy" );
  }
