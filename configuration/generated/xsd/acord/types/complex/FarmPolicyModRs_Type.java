...
public class FarmPolicyModRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "FarmPolicyModRs_Type", "" );
  ...
  public FarmPolicyModRs_Type() {
    super( 2042402981, TYPE.get() );
  }

  private FarmPolicyModRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 2042402981, state );
  }

  protected FarmPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected FarmPolicyModRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.FarmPolicyModRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.FarmPolicyModRs_Type get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.acord.FarmPolicy> getFarmPolicy() {
    return (java.util.List<xsd.acord.FarmPolicy>) TYPE.get().getPropertyValue( this, "_FarmPolicy" );
  }
