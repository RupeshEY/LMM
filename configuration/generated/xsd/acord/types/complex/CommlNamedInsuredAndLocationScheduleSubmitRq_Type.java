...
public class CommlNamedInsuredAndLocationScheduleSubmitRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlNamedInsuredAndLocationScheduleSubmitRq_Type", "" );
  ...
  public CommlNamedInsuredAndLocationScheduleSubmitRq_Type() {
    super( 458241321, TYPE.get() );
  }

  private CommlNamedInsuredAndLocationScheduleSubmitRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 458241321, state );
  }

  protected CommlNamedInsuredAndLocationScheduleSubmitRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlNamedInsuredAndLocationScheduleSubmitRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlNamedInsuredAndLocationScheduleSubmitRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlNamedInsuredAndLocationScheduleSubmitRq_Type get$TypeInstance() {
    return this;
  }
