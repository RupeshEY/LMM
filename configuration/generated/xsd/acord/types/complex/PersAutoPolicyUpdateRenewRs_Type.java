...
public class PersAutoPolicyUpdateRenewRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersAutoPolicyUpdateRenewRs_Type", "" );
  ...
  public PersAutoPolicyUpdateRenewRs_Type() {
    super( 1339196466, TYPE.get() );
  }

  private PersAutoPolicyUpdateRenewRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1339196466, state );
  }

  protected PersAutoPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersAutoPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersAutoPolicyUpdateRenewRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersAutoPolicyUpdateRenewRs_Type get$TypeInstance() {
    return this;
  }
