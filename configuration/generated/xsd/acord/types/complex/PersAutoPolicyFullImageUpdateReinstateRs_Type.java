...
public class PersAutoPolicyFullImageUpdateReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersAutoPolicyFullImageUpdateReinstateRs_Type", "" );
  ...
  public PersAutoPolicyFullImageUpdateReinstateRs_Type() {
    super( -1612426058, TYPE.get() );
  }

  private PersAutoPolicyFullImageUpdateReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1612426058, state );
  }

  protected PersAutoPolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersAutoPolicyFullImageUpdateReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersAutoPolicyFullImageUpdateReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersAutoPolicyFullImageUpdateReinstateRs_Type get$TypeInstance() {
    return this;
  }
