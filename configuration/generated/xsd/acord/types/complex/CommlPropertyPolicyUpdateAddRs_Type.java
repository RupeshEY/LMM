...
public class CommlPropertyPolicyUpdateAddRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "CommlPropertyPolicyUpdateAddRs_Type", "" );
  ...
  public CommlPropertyPolicyUpdateAddRs_Type() {
    super( 1456775616, TYPE.get() );
  }

  private CommlPropertyPolicyUpdateAddRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 1456775616, state );
  }

  protected CommlPropertyPolicyUpdateAddRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected CommlPropertyPolicyUpdateAddRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.CommlPropertyPolicyUpdateAddRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.CommlPropertyPolicyUpdateAddRs_Type get$TypeInstance() {
    return this;
  }
