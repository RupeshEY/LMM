...
public class PendingResponseInqRq_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PendingResponseInqRq_Type", "" );
  ...
  public PendingResponseInqRq_Type() {
    super( 371666175, TYPE.get() );
  }

  private PendingResponseInqRq_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 371666175, state );
  }

  protected PendingResponseInqRq_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PendingResponseInqRq_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PendingResponseInqRq_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PendingResponseInqRq_Type get$TypeInstance() {
    return this;
  }
