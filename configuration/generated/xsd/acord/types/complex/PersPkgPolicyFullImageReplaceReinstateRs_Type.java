...
public class PersPkgPolicyFullImageReplaceReinstateRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "PersPkgPolicyFullImageReplaceReinstateRs_Type", "" );
  ...
  public PersPkgPolicyFullImageReplaceReinstateRs_Type() {
    super( -1665184248, TYPE.get() );
  }

  private PersPkgPolicyFullImageReplaceReinstateRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1665184248, state );
  }

  protected PersPkgPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PersPkgPolicyFullImageReplaceReinstateRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.PersPkgPolicyFullImageReplaceReinstateRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.PersPkgPolicyFullImageReplaceReinstateRs_Type get$TypeInstance() {
    return this;
  }
