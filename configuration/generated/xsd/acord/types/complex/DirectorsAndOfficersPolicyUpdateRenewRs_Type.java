...
public class DirectorsAndOfficersPolicyUpdateRenewRs_Type extends gw.xsd.w3c.xmlschema.types.complex.AnyType {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "DirectorsAndOfficersPolicyUpdateRenewRs_Type", "" );
  ...
  public DirectorsAndOfficersPolicyUpdateRenewRs_Type() {
    super( 35936250, TYPE.get() );
  }

  private DirectorsAndOfficersPolicyUpdateRenewRs_Type( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 35936250, state );
  }

  protected DirectorsAndOfficersPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected DirectorsAndOfficersPolicyUpdateRenewRs_Type( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.acord.types.complex.DirectorsAndOfficersPolicyUpdateRenewRs_Type> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.acord.types.complex.DirectorsAndOfficersPolicyUpdateRenewRs_Type get$TypeInstance() {
    return this;
  }
