...
public class ACORD_SignonRs_Status_StatusDesc extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public ACORD_SignonRs_Status_StatusDesc() {
    super( -930318792, TYPE.get() );
  }

  private ACORD_SignonRs_Status_StatusDesc( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -930318792, state );
  }

  protected ACORD_SignonRs_Status_StatusDesc( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ACORD_SignonRs_Status_StatusDesc( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.ak.anonymous.types.complex.ACORD_SignonRs_Status_StatusDesc> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.ak.anonymous.types.complex.ACORD_SignonRs_Status_StatusDesc get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.ak.anonymous.elements.ACORD_SignonRs_Status_StatusDesc_StatusDescShort getStatusDescShort_elem() {
    return (xsd.iso.ak.anonymous.elements.ACORD_SignonRs_Status_StatusDesc_StatusDescShort) TYPE.get().getPropertyValue( this, "_StatusDescShort_elem" );
  }
  ...
  public final xsd.iso.ak.anonymous.elements.ACORD_SignonRs_Status_StatusDesc_StatusDescCode getStatusDescCode_elem() {
    return (xsd.iso.ak.anonymous.elements.ACORD_SignonRs_Status_StatusDesc_StatusDescCode) TYPE.get().getPropertyValue( this, "_StatusDescCode_elem" );
  }
  ...
  public final xsd.iso.ak.anonymous.elements.ACORD_SignonRs_Status_StatusDesc_StatusDescDetail getStatusDescDetail_elem() {
    return (xsd.iso.ak.anonymous.elements.ACORD_SignonRs_Status_StatusDesc_StatusDescDetail) TYPE.get().getPropertyValue( this, "_StatusDescDetail_elem" );
  }
