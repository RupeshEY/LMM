...
public class DURATION extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.types.complex.DURATION" );
    }
  };

  public DURATION() {
    super( -35058171, TYPE.get() );
  }

  private DURATION( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -35058171, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.req.types.complex.DURATION> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.req.types.complex.DURATION get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.req.anonymous.elements.DURATION_EffectiveDt getEffectiveDt_elem() {
    return (xsd.iso.req.anonymous.elements.DURATION_EffectiveDt) TYPE.get().getPropertyValue( this, "_EffectiveDt_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.DURATION_ExpirationDt getExpirationDt_elem() {
    return (xsd.iso.req.anonymous.elements.DURATION_ExpirationDt) TYPE.get().getPropertyValue( this, "_ExpirationDt_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.DURATION_StartTime getStartTime_elem() {
    return (xsd.iso.req.anonymous.elements.DURATION_StartTime) TYPE.get().getPropertyValue( this, "_StartTime_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.DURATION_EndTime getEndTime_elem() {
    return (xsd.iso.req.anonymous.elements.DURATION_EndTime) TYPE.get().getPropertyValue( this, "_EndTime_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.DURATION_LocalStandardTimeInd getLocalStandardTimeInd_elem() {
    return (xsd.iso.req.anonymous.elements.DURATION_LocalStandardTimeInd) TYPE.get().getPropertyValue( this, "_LocalStandardTimeInd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.DURATION_ContinuousInd getContinuousInd_elem() {
    return (xsd.iso.req.anonymous.elements.DURATION_ContinuousInd) TYPE.get().getPropertyValue( this, "_ContinuousInd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.DURATION_Description getDescription_elem() {
    return (xsd.iso.req.anonymous.elements.DURATION_Description) TYPE.get().getPropertyValue( this, "_Description_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.DURATION_GB_BothDaysInclusiveInd getGB_BothDaysInclusiveInd_elem() {
    return (xsd.iso.req.anonymous.elements.DURATION_GB_BothDaysInclusiveInd) TYPE.get().getPropertyValue( this, "_GB_BothDaysInclusiveInd_elem" );
  }
