...
public final class AirbagInfo_AirbagStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.AirbagInfo_AirbagStatusCd" );
    }
  };
  ...
  public AirbagInfo_AirbagStatusCd() {
    super( -186214036, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public AirbagInfo_AirbagStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -186214036, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AirbagInfo_AirbagStatusCd( gw.internal.xml.XmlElementState state ) {
    super( -186214036, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.AirbagInfo_AirbagStatusCd> get$Class() {
    return getClass();
  }
