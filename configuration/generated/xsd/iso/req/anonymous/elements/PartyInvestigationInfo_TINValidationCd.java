...
public final class PartyInvestigationInfo_TINValidationCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PartyInvestigationInfo_TINValidationCd" );
    }
  };
  ...
  public PartyInvestigationInfo_TINValidationCd() {
    super( -1361042250, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PartyInvestigationInfo_TINValidationCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1361042250, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PartyInvestigationInfo_TINValidationCd( gw.internal.xml.XmlElementState state ) {
    super( -1361042250, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PartyInvestigationInfo_TINValidationCd> get$Class() {
    return getClass();
  }
