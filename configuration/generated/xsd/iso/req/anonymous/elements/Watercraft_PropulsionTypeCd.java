...
public final class Watercraft_PropulsionTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.Watercraft_PropulsionTypeCd" );
    }
  };
  ...
  public Watercraft_PropulsionTypeCd() {
    super( -956637784, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public Watercraft_PropulsionTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -956637784, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private Watercraft_PropulsionTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -956637784, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.Watercraft_PropulsionTypeCd> get$Class() {
    return getClass();
  }
