...
public final class WorkCompLossInfo_CoverageCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.WorkCompLossInfo_CoverageCd" );
    }
  };
  ...
  public WorkCompLossInfo_CoverageCd() {
    super( -1323861089, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public WorkCompLossInfo_CoverageCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1323861089, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private WorkCompLossInfo_CoverageCd( gw.internal.xml.XmlElementState state ) {
    super( -1323861089, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.WorkCompLossInfo_CoverageCd> get$Class() {
    return getClass();
  }
