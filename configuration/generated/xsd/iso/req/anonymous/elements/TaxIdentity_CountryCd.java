...
public final class TaxIdentity_CountryCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.TaxIdentity_CountryCd" );
    }
  };
  ...
  public TaxIdentity_CountryCd() {
    super( -1750744151, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public TaxIdentity_CountryCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1750744151, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private TaxIdentity_CountryCd( gw.internal.xml.XmlElementState state ) {
    super( -1750744151, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.TaxIdentity_CountryCd> get$Class() {
    return getClass();
  }
