...
public final class EmployeeSchedule_EmployeeScheduleCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.EmployeeSchedule_EmployeeScheduleCd" );
    }
  };
  ...
  public EmployeeSchedule_EmployeeScheduleCd() {
    super( 1742198856, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public EmployeeSchedule_EmployeeScheduleCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1742198856, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private EmployeeSchedule_EmployeeScheduleCd( gw.internal.xml.XmlElementState state ) {
    super( 1742198856, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.EmployeeSchedule_EmployeeScheduleCd> get$Class() {
    return getClass();
  }
