...
public final class CounterSignature_StateProvCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.CounterSignature_StateProvCd" );
    }
  };
  ...
  public CounterSignature_StateProvCd() {
    super( -595601808, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public CounterSignature_StateProvCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -595601808, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CounterSignature_StateProvCd( gw.internal.xml.XmlElementState state ) {
    super( -595601808, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.CounterSignature_StateProvCd> get$Class() {
    return getClass();
  }
