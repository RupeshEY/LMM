...
public final class PersonInfo_MaritalStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PersonInfo_MaritalStatusCd" );
    }
  };
  ...
  public PersonInfo_MaritalStatusCd() {
    super( -412218653, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PersonInfo_MaritalStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -412218653, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PersonInfo_MaritalStatusCd( gw.internal.xml.XmlElementState state ) {
    super( -412218653, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PersonInfo_MaritalStatusCd> get$Class() {
    return getClass();
  }
