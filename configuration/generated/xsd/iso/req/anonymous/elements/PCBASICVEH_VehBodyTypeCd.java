...
public final class PCBASICVEH_VehBodyTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCBASICVEH_VehBodyTypeCd" );
    }
  };
  ...
  public PCBASICVEH_VehBodyTypeCd() {
    super( -1153284755, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCBASICVEH_VehBodyTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1153284755, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCBASICVEH_VehBodyTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -1153284755, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCBASICVEH_VehBodyTypeCd> get$Class() {
    return getClass();
  }
