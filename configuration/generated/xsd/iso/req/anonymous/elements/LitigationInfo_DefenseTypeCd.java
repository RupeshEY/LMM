...
public final class LitigationInfo_DefenseTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.LitigationInfo_DefenseTypeCd" );
    }
  };
  ...
  public LitigationInfo_DefenseTypeCd() {
    super( 1839716994, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public LitigationInfo_DefenseTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1839716994, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private LitigationInfo_DefenseTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 1839716994, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.LitigationInfo_DefenseTypeCd> get$Class() {
    return getClass();
  }
