...
public final class ClaimsInjury_InjurySeverityCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsInjury_InjurySeverityCd" );
    }
  };
  ...
  public ClaimsInjury_InjurySeverityCd() {
    super( 1472769454, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsInjury_InjurySeverityCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1472769454, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsInjury_InjurySeverityCd( gw.internal.xml.XmlElementState state ) {
    super( 1472769454, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsInjury_InjurySeverityCd> get$Class() {
    return getClass();
  }
