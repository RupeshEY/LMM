...
public final class PersVehInfo_EngineTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PersVehInfo_EngineTypeCd" );
    }
  };
  ...
  public PersVehInfo_EngineTypeCd() {
    super( 1011704387, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PersVehInfo_EngineTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1011704387, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PersVehInfo_EngineTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 1011704387, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PersVehInfo_EngineTypeCd> get$Class() {
    return getClass();
  }
