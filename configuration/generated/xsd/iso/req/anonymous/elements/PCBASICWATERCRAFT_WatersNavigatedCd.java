...
public final class PCBASICWATERCRAFT_WatersNavigatedCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCBASICWATERCRAFT_WatersNavigatedCd" );
    }
  };
  ...
  public PCBASICWATERCRAFT_WatersNavigatedCd() {
    super( -641001595, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCBASICWATERCRAFT_WatersNavigatedCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -641001595, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCBASICWATERCRAFT_WatersNavigatedCd( gw.internal.xml.XmlElementState state ) {
    super( -641001595, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCBASICWATERCRAFT_WatersNavigatedCd> get$Class() {
    return getClass();
  }
