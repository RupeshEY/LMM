...
public final class ClaimsInjury_InjuryNatureCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsInjury_InjuryNatureCd" );
    }
  };
  ...
  public ClaimsInjury_InjuryNatureCd() {
    super( -1735200552, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsInjury_InjuryNatureCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1735200552, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsInjury_InjuryNatureCd( gw.internal.xml.XmlElementState state ) {
    super( -1735200552, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsInjury_InjuryNatureCd> get$Class() {
    return getClass();
  }
