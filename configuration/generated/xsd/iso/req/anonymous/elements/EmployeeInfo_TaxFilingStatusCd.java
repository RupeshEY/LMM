...
public final class EmployeeInfo_TaxFilingStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.EmployeeInfo_TaxFilingStatusCd" );
    }
  };
  ...
  public EmployeeInfo_TaxFilingStatusCd() {
    super( -2133482932, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public EmployeeInfo_TaxFilingStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -2133482932, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private EmployeeInfo_TaxFilingStatusCd( gw.internal.xml.XmlElementState state ) {
    super( -2133482932, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.EmployeeInfo_TaxFilingStatusCd> get$Class() {
    return getClass();
  }
