...
public final class CreditScoreInfo_CSReasonCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.CreditScoreInfo_CSReasonCd" );
    }
  };
  ...
  public CreditScoreInfo_CSReasonCd() {
    super( 490251973, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public CreditScoreInfo_CSReasonCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 490251973, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CreditScoreInfo_CSReasonCd( gw.internal.xml.XmlElementState state ) {
    super( 490251973, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.CreditScoreInfo_CSReasonCd> get$Class() {
    return getClass();
  }
