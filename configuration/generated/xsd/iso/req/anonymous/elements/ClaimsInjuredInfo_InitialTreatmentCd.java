...
public final class ClaimsInjuredInfo_InitialTreatmentCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsInjuredInfo_InitialTreatmentCd" );
    }
  };
  ...
  public ClaimsInjuredInfo_InitialTreatmentCd() {
    super( 2045708788, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsInjuredInfo_InitialTreatmentCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 2045708788, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsInjuredInfo_InitialTreatmentCd( gw.internal.xml.XmlElementState state ) {
    super( 2045708788, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsInjuredInfo_InitialTreatmentCd> get$Class() {
    return getClass();
  }
