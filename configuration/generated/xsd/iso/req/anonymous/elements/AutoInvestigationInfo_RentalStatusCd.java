...
public final class AutoInvestigationInfo_RentalStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.AutoInvestigationInfo_RentalStatusCd" );
    }
  };
  ...
  public AutoInvestigationInfo_RentalStatusCd() {
    super( -1214805235, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public AutoInvestigationInfo_RentalStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1214805235, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AutoInvestigationInfo_RentalStatusCd( gw.internal.xml.XmlElementState state ) {
    super( -1214805235, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.AutoInvestigationInfo_RentalStatusCd> get$Class() {
    return getClass();
  }
