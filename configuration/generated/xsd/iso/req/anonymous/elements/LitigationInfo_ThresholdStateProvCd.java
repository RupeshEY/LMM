...
public final class LitigationInfo_ThresholdStateProvCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.LitigationInfo_ThresholdStateProvCd" );
    }
  };
  ...
  public LitigationInfo_ThresholdStateProvCd() {
    super( -1441302679, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public LitigationInfo_ThresholdStateProvCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1441302679, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private LitigationInfo_ThresholdStateProvCd( gw.internal.xml.XmlElementState state ) {
    super( -1441302679, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.LitigationInfo_ThresholdStateProvCd> get$Class() {
    return getClass();
  }
