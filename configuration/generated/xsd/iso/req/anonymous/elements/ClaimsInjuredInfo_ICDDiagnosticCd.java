...
public final class ClaimsInjuredInfo_ICDDiagnosticCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsInjuredInfo_ICDDiagnosticCd" );
    }
  };
  ...
  public ClaimsInjuredInfo_ICDDiagnosticCd() {
    super( 1509611923, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsInjuredInfo_ICDDiagnosticCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1509611923, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsInjuredInfo_ICDDiagnosticCd( gw.internal.xml.XmlElementState state ) {
    super( 1509611923, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsInjuredInfo_ICDDiagnosticCd> get$Class() {
    return getClass();
  }
