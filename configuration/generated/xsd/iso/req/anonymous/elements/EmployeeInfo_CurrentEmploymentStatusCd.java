...
public final class EmployeeInfo_CurrentEmploymentStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.EmployeeInfo_CurrentEmploymentStatusCd" );
    }
  };
  ...
  public EmployeeInfo_CurrentEmploymentStatusCd() {
    super( 1397629901, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public EmployeeInfo_CurrentEmploymentStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1397629901, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private EmployeeInfo_CurrentEmploymentStatusCd( gw.internal.xml.XmlElementState state ) {
    super( 1397629901, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.EmployeeInfo_CurrentEmploymentStatusCd> get$Class() {
    return getClass();
  }
