...
public final class CommlVehSupplement_FinancedAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.CommlVehSupplement_FinancedAmt" );
    }
  };
  ...
  public CommlVehSupplement_FinancedAmt() {
    super( 938643337, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.CURRENCY() );
  }

  public CommlVehSupplement_FinancedAmt( xsd.iso.req.types.complex.CURRENCY typeInstance ) {
    super( 938643337, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CommlVehSupplement_FinancedAmt( gw.internal.xml.XmlElementState state ) {
    super( 938643337, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.CommlVehSupplement_FinancedAmt> get$Class() {
    return getClass();
  }
