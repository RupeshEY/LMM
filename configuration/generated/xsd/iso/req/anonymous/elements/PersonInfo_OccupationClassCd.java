...
public final class PersonInfo_OccupationClassCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PersonInfo_OccupationClassCd" );
    }
  };
  ...
  public PersonInfo_OccupationClassCd() {
    super( -1756997878, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PersonInfo_OccupationClassCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1756997878, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PersonInfo_OccupationClassCd( gw.internal.xml.XmlElementState state ) {
    super( -1756997878, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PersonInfo_OccupationClassCd> get$Class() {
    return getClass();
  }
