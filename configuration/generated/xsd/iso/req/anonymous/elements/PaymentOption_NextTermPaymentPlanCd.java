...
public final class PaymentOption_NextTermPaymentPlanCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PaymentOption_NextTermPaymentPlanCd" );
    }
  };
  ...
  public PaymentOption_NextTermPaymentPlanCd() {
    super( 1111172725, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PaymentOption_NextTermPaymentPlanCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1111172725, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PaymentOption_NextTermPaymentPlanCd( gw.internal.xml.XmlElementState state ) {
    super( 1111172725, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PaymentOption_NextTermPaymentPlanCd> get$Class() {
    return getClass();
  }
