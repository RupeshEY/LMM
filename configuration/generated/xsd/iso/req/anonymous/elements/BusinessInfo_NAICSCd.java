...
public final class BusinessInfo_NAICSCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.BusinessInfo_NAICSCd" );
    }
  };
  ...
  public BusinessInfo_NAICSCd() {
    super( 751929038, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public BusinessInfo_NAICSCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 751929038, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private BusinessInfo_NAICSCd( gw.internal.xml.XmlElementState state ) {
    super( 751929038, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.BusinessInfo_NAICSCd> get$Class() {
    return getClass();
  }
