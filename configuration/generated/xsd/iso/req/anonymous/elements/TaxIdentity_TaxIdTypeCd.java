...
public final class TaxIdentity_TaxIdTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.TaxIdentity_TaxIdTypeCd" );
    }
  };
  ...
  public TaxIdentity_TaxIdTypeCd() {
    super( 70281107, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public TaxIdentity_TaxIdTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 70281107, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private TaxIdentity_TaxIdTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 70281107, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.TaxIdentity_TaxIdTypeCd> get$Class() {
    return getClass();
  }
