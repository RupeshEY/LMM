...
public final class CreditScoreInfo_CSPolicyTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.CreditScoreInfo_CSPolicyTypeCd" );
    }
  };
  ...
  public CreditScoreInfo_CSPolicyTypeCd() {
    super( -351657459, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public CreditScoreInfo_CSPolicyTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -351657459, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CreditScoreInfo_CSPolicyTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -351657459, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.CreditScoreInfo_CSPolicyTypeCd> get$Class() {
    return getClass();
  }
