...
public final class ComIso_ScoredMatch_LossCauseCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ComIso_ScoredMatch_LossCauseCd" );
    }
  };
  ...
  public ComIso_ScoredMatch_LossCauseCd() {
    super( -725499656, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ComIso_ScoredMatch_LossCauseCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -725499656, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ComIso_ScoredMatch_LossCauseCd( gw.internal.xml.XmlElementState state ) {
    super( -725499656, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ComIso_ScoredMatch_LossCauseCd> get$Class() {
    return getClass();
  }
