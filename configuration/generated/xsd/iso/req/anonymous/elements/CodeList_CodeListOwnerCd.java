...
public final class CodeList_CodeListOwnerCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.CodeList_CodeListOwnerCd" );
    }
  };
  ...
  public CodeList_CodeListOwnerCd() {
    super( -1655757267, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public CodeList_CodeListOwnerCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1655757267, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CodeList_CodeListOwnerCd( gw.internal.xml.XmlElementState state ) {
    super( -1655757267, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.CodeList_CodeListOwnerCd> get$Class() {
    return getClass();
  }
