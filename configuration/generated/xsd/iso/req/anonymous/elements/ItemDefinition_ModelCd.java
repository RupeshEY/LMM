...
public final class ItemDefinition_ModelCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ItemDefinition_ModelCd" );
    }
  };
  ...
  public ItemDefinition_ModelCd() {
    super( 948952937, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ItemDefinition_ModelCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 948952937, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ItemDefinition_ModelCd( gw.internal.xml.XmlElementState state ) {
    super( 948952937, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ItemDefinition_ModelCd> get$Class() {
    return getClass();
  }
