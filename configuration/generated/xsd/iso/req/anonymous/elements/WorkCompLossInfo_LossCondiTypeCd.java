...
public final class WorkCompLossInfo_LossCondiTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.WorkCompLossInfo_LossCondiTypeCd" );
    }
  };
  ...
  public WorkCompLossInfo_LossCondiTypeCd() {
    super( -1823037175, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public WorkCompLossInfo_LossCondiTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1823037175, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private WorkCompLossInfo_LossCondiTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -1823037175, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.WorkCompLossInfo_LossCondiTypeCd> get$Class() {
    return getClass();
  }
