...
public final class MsgStatus_MsgStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.MsgStatus_MsgStatusCd" );
    }
  };
  ...
  public MsgStatus_MsgStatusCd() {
    super( 1870115696, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public MsgStatus_MsgStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1870115696, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private MsgStatus_MsgStatusCd( gw.internal.xml.XmlElementState state ) {
    super( 1870115696, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.MsgStatus_MsgStatusCd> get$Class() {
    return getClass();
  }
