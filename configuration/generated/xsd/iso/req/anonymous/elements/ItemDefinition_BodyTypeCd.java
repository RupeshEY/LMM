...
public final class ItemDefinition_BodyTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ItemDefinition_BodyTypeCd" );
    }
  };
  ...
  public ItemDefinition_BodyTypeCd() {
    super( -1417683170, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ItemDefinition_BodyTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1417683170, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ItemDefinition_BodyTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -1417683170, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ItemDefinition_BodyTypeCd> get$Class() {
    return getClass();
  }
