...
public final class Watercraft_FuelTankCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.Watercraft_FuelTankCd" );
    }
  };
  ...
  public Watercraft_FuelTankCd() {
    super( 1744355167, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public Watercraft_FuelTankCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1744355167, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private Watercraft_FuelTankCd( gw.internal.xml.XmlElementState state ) {
    super( 1744355167, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.Watercraft_FuelTankCd> get$Class() {
    return getClass();
  }
