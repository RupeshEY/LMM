...
public final class AirbagInfo_AirbagTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.AirbagInfo_AirbagTypeCd" );
    }
  };
  ...
  public AirbagInfo_AirbagTypeCd() {
    super( -1365397260, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public AirbagInfo_AirbagTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1365397260, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AirbagInfo_AirbagTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -1365397260, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.AirbagInfo_AirbagTypeCd> get$Class() {
    return getClass();
  }
