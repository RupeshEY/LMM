...
public final class OtherOrPriorPolicy_LOBSubCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.OtherOrPriorPolicy_LOBSubCd" );
    }
  };
  ...
  public OtherOrPriorPolicy_LOBSubCd() {
    super( 735743808, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public OtherOrPriorPolicy_LOBSubCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 735743808, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private OtherOrPriorPolicy_LOBSubCd( gw.internal.xml.XmlElementState state ) {
    super( 735743808, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.OtherOrPriorPolicy_LOBSubCd> get$Class() {
    return getClass();
  }
