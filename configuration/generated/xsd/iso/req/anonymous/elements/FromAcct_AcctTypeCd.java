...
public final class FromAcct_AcctTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.FromAcct_AcctTypeCd" );
    }
  };
  ...
  public FromAcct_AcctTypeCd() {
    super( -712949672, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public FromAcct_AcctTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -712949672, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private FromAcct_AcctTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -712949672, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.FromAcct_AcctTypeCd> get$Class() {
    return getClass();
  }
