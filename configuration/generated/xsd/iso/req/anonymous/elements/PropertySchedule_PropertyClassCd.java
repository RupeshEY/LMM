...
public final class PropertySchedule_PropertyClassCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PropertySchedule_PropertyClassCd" );
    }
  };
  ...
  public PropertySchedule_PropertyClassCd() {
    super( -546487255, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PropertySchedule_PropertyClassCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -546487255, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PropertySchedule_PropertyClassCd( gw.internal.xml.XmlElementState state ) {
    super( -546487255, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PropertySchedule_PropertyClassCd> get$Class() {
    return getClass();
  }
