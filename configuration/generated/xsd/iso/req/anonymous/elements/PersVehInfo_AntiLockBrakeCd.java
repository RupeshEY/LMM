...
public final class PersVehInfo_AntiLockBrakeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PersVehInfo_AntiLockBrakeCd" );
    }
  };
  ...
  public PersVehInfo_AntiLockBrakeCd() {
    super( -2094791015, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PersVehInfo_AntiLockBrakeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -2094791015, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PersVehInfo_AntiLockBrakeCd( gw.internal.xml.XmlElementState state ) {
    super( -2094791015, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PersVehInfo_AntiLockBrakeCd> get$Class() {
    return getClass();
  }
