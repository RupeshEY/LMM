...
public final class CommlVehSupplement_PrimaryClassCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.CommlVehSupplement_PrimaryClassCd" );
    }
  };
  ...
  public CommlVehSupplement_PrimaryClassCd() {
    super( -1837316660, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public CommlVehSupplement_PrimaryClassCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1837316660, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CommlVehSupplement_PrimaryClassCd( gw.internal.xml.XmlElementState state ) {
    super( -1837316660, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.CommlVehSupplement_PrimaryClassCd> get$Class() {
    return getClass();
  }
