...
public final class PersVehInfo_DamageabilityCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PersVehInfo_DamageabilityCd" );
    }
  };
  ...
  public PersVehInfo_DamageabilityCd() {
    super( -1268203850, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PersVehInfo_DamageabilityCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1268203850, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PersVehInfo_DamageabilityCd( gw.internal.xml.XmlElementState state ) {
    super( -1268203850, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PersVehInfo_DamageabilityCd> get$Class() {
    return getClass();
  }
