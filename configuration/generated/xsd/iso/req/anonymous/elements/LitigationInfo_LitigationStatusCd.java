...
public final class LitigationInfo_LitigationStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.LitigationInfo_LitigationStatusCd" );
    }
  };
  ...
  public LitigationInfo_LitigationStatusCd() {
    super( -572979284, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public LitigationInfo_LitigationStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -572979284, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private LitigationInfo_LitigationStatusCd( gw.internal.xml.XmlElementState state ) {
    super( -572979284, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.LitigationInfo_LitigationStatusCd> get$Class() {
    return getClass();
  }
