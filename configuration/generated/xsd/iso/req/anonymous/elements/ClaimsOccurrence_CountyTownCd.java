...
public final class ClaimsOccurrence_CountyTownCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsOccurrence_CountyTownCd" );
    }
  };
  ...
  public ClaimsOccurrence_CountyTownCd() {
    super( -619853060, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsOccurrence_CountyTownCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -619853060, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsOccurrence_CountyTownCd( gw.internal.xml.XmlElementState state ) {
    super( -619853060, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsOccurrence_CountyTownCd> get$Class() {
    return getClass();
  }
