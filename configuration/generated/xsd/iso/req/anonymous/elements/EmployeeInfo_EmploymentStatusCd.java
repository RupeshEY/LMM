...
public final class EmployeeInfo_EmploymentStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.EmployeeInfo_EmploymentStatusCd" );
    }
  };
  ...
  public EmployeeInfo_EmploymentStatusCd() {
    super( -1521650902, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public EmployeeInfo_EmploymentStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1521650902, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private EmployeeInfo_EmploymentStatusCd( gw.internal.xml.XmlElementState state ) {
    super( -1521650902, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.EmployeeInfo_EmploymentStatusCd> get$Class() {
    return getClass();
  }
