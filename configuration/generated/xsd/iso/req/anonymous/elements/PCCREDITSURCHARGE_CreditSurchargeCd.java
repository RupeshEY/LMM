...
public final class PCCREDITSURCHARGE_CreditSurchargeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCCREDITSURCHARGE_CreditSurchargeCd" );
    }
  };
  ...
  public PCCREDITSURCHARGE_CreditSurchargeCd() {
    super( 811951469, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCCREDITSURCHARGE_CreditSurchargeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 811951469, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCCREDITSURCHARGE_CreditSurchargeCd( gw.internal.xml.XmlElementState state ) {
    super( 811951469, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCCREDITSURCHARGE_CreditSurchargeCd> get$Class() {
    return getClass();
  }
