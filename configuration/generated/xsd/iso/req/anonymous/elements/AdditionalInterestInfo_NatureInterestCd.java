...
public final class AdditionalInterestInfo_NatureInterestCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.AdditionalInterestInfo_NatureInterestCd" );
    }
  };
  ...
  public AdditionalInterestInfo_NatureInterestCd() {
    super( -225270982, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public AdditionalInterestInfo_NatureInterestCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -225270982, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AdditionalInterestInfo_NatureInterestCd( gw.internal.xml.XmlElementState state ) {
    super( -225270982, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.AdditionalInterestInfo_NatureInterestCd> get$Class() {
    return getClass();
  }
