...
public final class NameInfo_NonTaxIdentity_StateProvCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.NameInfo_NonTaxIdentity_StateProvCd" );
    }
  };
  ...
  public NameInfo_NonTaxIdentity_StateProvCd() {
    super( -1222671642, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public NameInfo_NonTaxIdentity_StateProvCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1222671642, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private NameInfo_NonTaxIdentity_StateProvCd( gw.internal.xml.XmlElementState state ) {
    super( -1222671642, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.NameInfo_NonTaxIdentity_StateProvCd> get$Class() {
    return getClass();
  }
