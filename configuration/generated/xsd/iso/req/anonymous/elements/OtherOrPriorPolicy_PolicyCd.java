...
public final class OtherOrPriorPolicy_PolicyCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.OtherOrPriorPolicy_PolicyCd" );
    }
  };
  ...
  public OtherOrPriorPolicy_PolicyCd() {
    super( -1325375055, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public OtherOrPriorPolicy_PolicyCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1325375055, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private OtherOrPriorPolicy_PolicyCd( gw.internal.xml.XmlElementState state ) {
    super( -1325375055, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.OtherOrPriorPolicy_PolicyCd> get$Class() {
    return getClass();
  }
