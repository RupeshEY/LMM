...
public final class AutoLossInfo_ImpactPointCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.AutoLossInfo_ImpactPointCd" );
    }
  };
  ...
  public AutoLossInfo_ImpactPointCd() {
    super( -1189719644, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public AutoLossInfo_ImpactPointCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1189719644, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AutoLossInfo_ImpactPointCd( gw.internal.xml.XmlElementState state ) {
    super( -1189719644, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.AutoLossInfo_ImpactPointCd> get$Class() {
    return getClass();
  }
