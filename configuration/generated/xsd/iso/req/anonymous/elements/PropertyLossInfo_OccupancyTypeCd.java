...
public final class PropertyLossInfo_OccupancyTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PropertyLossInfo_OccupancyTypeCd" );
    }
  };
  ...
  public PropertyLossInfo_OccupancyTypeCd() {
    super( -1800122489, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PropertyLossInfo_OccupancyTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1800122489, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PropertyLossInfo_OccupancyTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -1800122489, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PropertyLossInfo_OccupancyTypeCd> get$Class() {
    return getClass();
  }
