...
public final class PCLIMIT_ValuationCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCLIMIT_ValuationCd" );
    }
  };
  ...
  public PCLIMIT_ValuationCd() {
    super( -869639053, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCLIMIT_ValuationCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -869639053, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCLIMIT_ValuationCd( gw.internal.xml.XmlElementState state ) {
    super( -869639053, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCLIMIT_ValuationCd> get$Class() {
    return getClass();
  }
