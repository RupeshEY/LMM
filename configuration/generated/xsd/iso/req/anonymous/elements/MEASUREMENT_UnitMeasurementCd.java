...
public final class MEASUREMENT_UnitMeasurementCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.MEASUREMENT_UnitMeasurementCd" );
    }
  };
  ...
  public MEASUREMENT_UnitMeasurementCd() {
    super( 1896323230, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public MEASUREMENT_UnitMeasurementCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1896323230, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private MEASUREMENT_UnitMeasurementCd( gw.internal.xml.XmlElementState state ) {
    super( 1896323230, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.MEASUREMENT_UnitMeasurementCd> get$Class() {
    return getClass();
  }
