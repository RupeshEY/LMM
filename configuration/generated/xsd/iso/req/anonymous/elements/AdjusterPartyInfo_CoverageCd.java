...
public final class AdjusterPartyInfo_CoverageCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.AdjusterPartyInfo_CoverageCd" );
    }
  };
  ...
  public AdjusterPartyInfo_CoverageCd() {
    super( -275067352, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public AdjusterPartyInfo_CoverageCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -275067352, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AdjusterPartyInfo_CoverageCd( gw.internal.xml.XmlElementState state ) {
    super( -275067352, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.AdjusterPartyInfo_CoverageCd> get$Class() {
    return getClass();
  }
