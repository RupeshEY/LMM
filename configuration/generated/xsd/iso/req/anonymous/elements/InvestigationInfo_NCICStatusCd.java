...
public final class InvestigationInfo_NCICStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.InvestigationInfo_NCICStatusCd" );
    }
  };
  ...
  public InvestigationInfo_NCICStatusCd() {
    super( 956929097, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public InvestigationInfo_NCICStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 956929097, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private InvestigationInfo_NCICStatusCd( gw.internal.xml.XmlElementState state ) {
    super( 956929097, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.InvestigationInfo_NCICStatusCd> get$Class() {
    return getClass();
  }
