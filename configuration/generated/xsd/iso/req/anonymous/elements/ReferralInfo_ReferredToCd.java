...
public final class ReferralInfo_ReferredToCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ReferralInfo_ReferredToCd" );
    }
  };
  ...
  public ReferralInfo_ReferredToCd() {
    super( -1192502711, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ReferralInfo_ReferredToCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1192502711, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ReferralInfo_ReferredToCd( gw.internal.xml.XmlElementState state ) {
    super( -1192502711, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ReferralInfo_ReferredToCd> get$Class() {
    return getClass();
  }
