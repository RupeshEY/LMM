...
public final class PCPOLICY_PayorCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCPOLICY_PayorCd" );
    }
  };
  ...
  public PCPOLICY_PayorCd() {
    super( 2047661898, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCPOLICY_PayorCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 2047661898, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCPOLICY_PayorCd( gw.internal.xml.XmlElementState state ) {
    super( 2047661898, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCPOLICY_PayorCd> get$Class() {
    return getClass();
  }
