...
public final class ClaimsPaymentCovInfo_ClaimStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsPaymentCovInfo_ClaimStatusCd" );
    }
  };
  ...
  public ClaimsPaymentCovInfo_ClaimStatusCd() {
    super( -835338479, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsPaymentCovInfo_ClaimStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -835338479, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsPaymentCovInfo_ClaimStatusCd( gw.internal.xml.XmlElementState state ) {
    super( -835338479, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsPaymentCovInfo_ClaimStatusCd> get$Class() {
    return getClass();
  }
