...
public final class ProducerInfo_ProducerRoleCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ProducerInfo_ProducerRoleCd" );
    }
  };
  ...
  public ProducerInfo_ProducerRoleCd() {
    super( 818171632, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ProducerInfo_ProducerRoleCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 818171632, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ProducerInfo_ProducerRoleCd( gw.internal.xml.XmlElementState state ) {
    super( 818171632, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ProducerInfo_ProducerRoleCd> get$Class() {
    return getClass();
  }
