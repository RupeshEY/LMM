...
public final class ToAcct_AcctTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ToAcct_AcctTypeCd" );
    }
  };
  ...
  public ToAcct_AcctTypeCd() {
    super( 12920679, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ToAcct_AcctTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 12920679, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ToAcct_AcctTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 12920679, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ToAcct_AcctTypeCd> get$Class() {
    return getClass();
  }
