...
public final class BusinessInfo_NatureBusinessCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.BusinessInfo_NatureBusinessCd" );
    }
  };
  ...
  public BusinessInfo_NatureBusinessCd() {
    super( -1738804127, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public BusinessInfo_NatureBusinessCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1738804127, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private BusinessInfo_NatureBusinessCd( gw.internal.xml.XmlElementState state ) {
    super( -1738804127, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.BusinessInfo_NatureBusinessCd> get$Class() {
    return getClass();
  }
