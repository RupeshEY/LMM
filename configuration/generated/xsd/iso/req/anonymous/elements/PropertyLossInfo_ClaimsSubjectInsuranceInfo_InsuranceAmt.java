...
public final class PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt" );
    }
  };
  ...
  public PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt() {
    super( -1159558951, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.CURRENCY() );
  }

  public PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt( xsd.iso.req.types.complex.CURRENCY typeInstance ) {
    super( -1159558951, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt( gw.internal.xml.XmlElementState state ) {
    super( -1159558951, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.req.types.complex.CURRENCY get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.req.types.complex.CURRENCY.class );
  }

  public final void set$TypeInstance( xsd.iso.req.types.complex.CURRENCY typeInstance ) {
