...
public final class OtherOrPriorPolicy_PolicyTerminatedCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.OtherOrPriorPolicy_PolicyTerminatedCd" );
    }
  };
  ...
  public OtherOrPriorPolicy_PolicyTerminatedCd() {
    super( 247728948, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public OtherOrPriorPolicy_PolicyTerminatedCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 247728948, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private OtherOrPriorPolicy_PolicyTerminatedCd( gw.internal.xml.XmlElementState state ) {
    super( 247728948, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.OtherOrPriorPolicy_PolicyTerminatedCd> get$Class() {
    return getClass();
  }
