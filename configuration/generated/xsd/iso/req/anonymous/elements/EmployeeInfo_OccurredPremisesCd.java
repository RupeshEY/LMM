...
public final class EmployeeInfo_OccurredPremisesCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.EmployeeInfo_OccurredPremisesCd" );
    }
  };
  ...
  public EmployeeInfo_OccurredPremisesCd() {
    super( 1312110259, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public EmployeeInfo_OccurredPremisesCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1312110259, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private EmployeeInfo_OccurredPremisesCd( gw.internal.xml.XmlElementState state ) {
    super( 1312110259, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.EmployeeInfo_OccurredPremisesCd> get$Class() {
    return getClass();
  }
