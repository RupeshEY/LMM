...
public final class WorkCompLossInfo_FraudulentClaimCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.WorkCompLossInfo_FraudulentClaimCd" );
    }
  };
  ...
  public WorkCompLossInfo_FraudulentClaimCd() {
    super( -1260927849, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public WorkCompLossInfo_FraudulentClaimCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1260927849, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private WorkCompLossInfo_FraudulentClaimCd( gw.internal.xml.XmlElementState state ) {
    super( -1260927849, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.WorkCompLossInfo_FraudulentClaimCd> get$Class() {
    return getClass();
  }
