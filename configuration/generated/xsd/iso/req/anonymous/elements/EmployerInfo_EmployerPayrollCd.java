...
public final class EmployerInfo_EmployerPayrollCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.EmployerInfo_EmployerPayrollCd" );
    }
  };
  ...
  public EmployerInfo_EmployerPayrollCd() {
    super( -799453267, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public EmployerInfo_EmployerPayrollCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -799453267, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private EmployerInfo_EmployerPayrollCd( gw.internal.xml.XmlElementState state ) {
    super( -799453267, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.EmployerInfo_EmployerPayrollCd> get$Class() {
    return getClass();
  }
