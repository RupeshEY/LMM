...
public final class PCDEDUCTIBLE_DeductibleBasisCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCDEDUCTIBLE_DeductibleBasisCd" );
    }
  };
  ...
  public PCDEDUCTIBLE_DeductibleBasisCd() {
    super( -422839925, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCDEDUCTIBLE_DeductibleBasisCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -422839925, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCDEDUCTIBLE_DeductibleBasisCd( gw.internal.xml.XmlElementState state ) {
    super( -422839925, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCDEDUCTIBLE_DeductibleBasisCd> get$Class() {
    return getClass();
  }
