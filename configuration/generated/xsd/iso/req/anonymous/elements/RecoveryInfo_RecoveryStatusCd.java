...
public final class RecoveryInfo_RecoveryStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.RecoveryInfo_RecoveryStatusCd" );
    }
  };
  ...
  public RecoveryInfo_RecoveryStatusCd() {
    super( 1571697164, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public RecoveryInfo_RecoveryStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1571697164, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private RecoveryInfo_RecoveryStatusCd( gw.internal.xml.XmlElementState state ) {
    super( 1571697164, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.RecoveryInfo_RecoveryStatusCd> get$Class() {
    return getClass();
  }
