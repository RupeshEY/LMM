...
public final class ClaimsPaymentCovInfo_PaymentReasonCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsPaymentCovInfo_PaymentReasonCd" );
    }
  };
  ...
  public ClaimsPaymentCovInfo_PaymentReasonCd() {
    super( 961260589, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsPaymentCovInfo_PaymentReasonCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 961260589, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsPaymentCovInfo_PaymentReasonCd( gw.internal.xml.XmlElementState state ) {
    super( 961260589, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsPaymentCovInfo_PaymentReasonCd> get$Class() {
    return getClass();
  }
