...
public final class AutoLossInfo_ManufacturerCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.AutoLossInfo_ManufacturerCd" );
    }
  };
  ...
  public AutoLossInfo_ManufacturerCd() {
    super( 69950329, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public AutoLossInfo_ManufacturerCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 69950329, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AutoLossInfo_ManufacturerCd( gw.internal.xml.XmlElementState state ) {
    super( 69950329, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.AutoLossInfo_ManufacturerCd> get$Class() {
    return getClass();
  }
