...
public final class EmployeeInfo_ControllingStateProvCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.EmployeeInfo_ControllingStateProvCd" );
    }
  };
  ...
  public EmployeeInfo_ControllingStateProvCd() {
    super( 1165013619, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public EmployeeInfo_ControllingStateProvCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1165013619, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private EmployeeInfo_ControllingStateProvCd( gw.internal.xml.XmlElementState state ) {
    super( 1165013619, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.EmployeeInfo_ControllingStateProvCd> get$Class() {
    return getClass();
  }
