...
public final class NameInfo_NonTaxIdentity_NonTaxIdTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.NameInfo_NonTaxIdentity_NonTaxIdTypeCd" );
    }
  };
  ...
  public NameInfo_NonTaxIdentity_NonTaxIdTypeCd() {
    super( 723437769, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public NameInfo_NonTaxIdentity_NonTaxIdTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 723437769, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private NameInfo_NonTaxIdentity_NonTaxIdTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 723437769, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.NameInfo_NonTaxIdentity_NonTaxIdTypeCd> get$Class() {
    return getClass();
  }
