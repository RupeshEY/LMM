...
public final class CommlCoverageSupplement_CoverageSubCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.CommlCoverageSupplement_CoverageSubCd" );
    }
  };
  ...
  public CommlCoverageSupplement_CoverageSubCd() {
    super( 609346051, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public CommlCoverageSupplement_CoverageSubCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 609346051, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CommlCoverageSupplement_CoverageSubCd( gw.internal.xml.XmlElementState state ) {
    super( 609346051, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.CommlCoverageSupplement_CoverageSubCd> get$Class() {
    return getClass();
  }
