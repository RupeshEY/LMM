...
public final class ComIso_ClaimDirectorRules_ComIso_RuleCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ComIso_ClaimDirectorRules_ComIso_RuleCd" );
    }
  };
  ...
  public ComIso_ClaimDirectorRules_ComIso_RuleCd() {
    super( 1994343339, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ComIso_ClaimDirectorRules_ComIso_RuleCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1994343339, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ComIso_ClaimDirectorRules_ComIso_RuleCd( gw.internal.xml.XmlElementState state ) {
    super( 1994343339, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ComIso_ClaimDirectorRules_ComIso_RuleCd> get$Class() {
    return getClass();
  }
