...
public final class AdditionalInterestInfo_BillFrequencyCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.AdditionalInterestInfo_BillFrequencyCd" );
    }
  };
  ...
  public AdditionalInterestInfo_BillFrequencyCd() {
    super( 1498000718, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public AdditionalInterestInfo_BillFrequencyCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1498000718, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AdditionalInterestInfo_BillFrequencyCd( gw.internal.xml.XmlElementState state ) {
    super( 1498000718, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.AdditionalInterestInfo_BillFrequencyCd> get$Class() {
    return getClass();
  }
