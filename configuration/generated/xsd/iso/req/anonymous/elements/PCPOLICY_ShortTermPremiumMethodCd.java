...
public final class PCPOLICY_ShortTermPremiumMethodCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCPOLICY_ShortTermPremiumMethodCd" );
    }
  };
  ...
  public PCPOLICY_ShortTermPremiumMethodCd() {
    super( -1795554509, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCPOLICY_ShortTermPremiumMethodCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1795554509, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCPOLICY_ShortTermPremiumMethodCd( gw.internal.xml.XmlElementState state ) {
    super( -1795554509, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCPOLICY_ShortTermPremiumMethodCd> get$Class() {
    return getClass();
  }
