...
public final class PropertyLossInfo_RealEstateTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PropertyLossInfo_RealEstateTypeCd" );
    }
  };
  ...
  public PropertyLossInfo_RealEstateTypeCd() {
    super( 798876838, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PropertyLossInfo_RealEstateTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 798876838, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PropertyLossInfo_RealEstateTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 798876838, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PropertyLossInfo_RealEstateTypeCd> get$Class() {
    return getClass();
  }
