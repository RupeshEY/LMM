...
public final class EmployeePay_PayFrequencyCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.EmployeePay_PayFrequencyCd" );
    }
  };
  ...
  public EmployeePay_PayFrequencyCd() {
    super( -45831790, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public EmployeePay_PayFrequencyCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -45831790, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private EmployeePay_PayFrequencyCd( gw.internal.xml.XmlElementState state ) {
    super( -45831790, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.EmployeePay_PayFrequencyCd> get$Class() {
    return getClass();
  }
