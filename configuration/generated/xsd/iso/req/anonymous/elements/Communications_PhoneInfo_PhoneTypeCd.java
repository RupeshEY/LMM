...
public final class Communications_PhoneInfo_PhoneTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.Communications_PhoneInfo_PhoneTypeCd" );
    }
  };
  ...
  public Communications_PhoneInfo_PhoneTypeCd() {
    super( -581016900, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public Communications_PhoneInfo_PhoneTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -581016900, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private Communications_PhoneInfo_PhoneTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -581016900, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.Communications_PhoneInfo_PhoneTypeCd> get$Class() {
    return getClass();
  }
