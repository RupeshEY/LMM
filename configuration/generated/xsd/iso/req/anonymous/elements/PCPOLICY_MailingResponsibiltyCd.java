...
public final class PCPOLICY_MailingResponsibiltyCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCPOLICY_MailingResponsibiltyCd" );
    }
  };
  ...
  public PCPOLICY_MailingResponsibiltyCd() {
    super( 1359599965, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCPOLICY_MailingResponsibiltyCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1359599965, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCPOLICY_MailingResponsibiltyCd( gw.internal.xml.XmlElementState state ) {
    super( 1359599965, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCPOLICY_MailingResponsibiltyCd> get$Class() {
    return getClass();
  }
