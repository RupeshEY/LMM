...
public final class SignonRq_SignonTransport extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.SignonRq_SignonTransport" );
    }
  };
  ...
  public SignonRq_SignonTransport() {
    super( 1961651233, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.anonymous.types.complex.SignonRq_SignonTransport() );
  }

  public SignonRq_SignonTransport( xsd.iso.req.anonymous.types.complex.SignonRq_SignonTransport typeInstance ) {
    super( 1961651233, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private SignonRq_SignonTransport( gw.internal.xml.XmlElementState state ) {
    super( 1961651233, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.SignonRq_SignonTransport> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.req.anonymous.types.complex.SignonRq_SignonTransport get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.req.anonymous.types.complex.SignonRq_SignonTransport.class );
  }

  public final void set$TypeInstance( xsd.iso.req.anonymous.types.complex.SignonRq_SignonTransport typeInstance ) {
