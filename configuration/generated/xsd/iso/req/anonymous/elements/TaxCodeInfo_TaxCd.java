...
public final class TaxCodeInfo_TaxCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.TaxCodeInfo_TaxCd" );
    }
  };
  ...
  public TaxCodeInfo_TaxCd() {
    super( 783407419, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public TaxCodeInfo_TaxCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 783407419, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private TaxCodeInfo_TaxCd( gw.internal.xml.XmlElementState state ) {
    super( 783407419, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.TaxCodeInfo_TaxCd> get$Class() {
    return getClass();
  }
