...
public final class AutoLossInfo_ModelCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.AutoLossInfo_ModelCd" );
    }
  };
  ...
  public AutoLossInfo_ModelCd() {
    super( -1777044509, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public AutoLossInfo_ModelCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1777044509, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AutoLossInfo_ModelCd( gw.internal.xml.XmlElementState state ) {
    super( -1777044509, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.AutoLossInfo_ModelCd> get$Class() {
    return getClass();
  }
