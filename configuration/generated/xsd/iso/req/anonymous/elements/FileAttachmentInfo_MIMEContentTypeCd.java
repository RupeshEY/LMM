...
public final class FileAttachmentInfo_MIMEContentTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.FileAttachmentInfo_MIMEContentTypeCd" );
    }
  };
  ...
  public FileAttachmentInfo_MIMEContentTypeCd() {
    super( -1935848666, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public FileAttachmentInfo_MIMEContentTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1935848666, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private FileAttachmentInfo_MIMEContentTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -1935848666, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.FileAttachmentInfo_MIMEContentTypeCd> get$Class() {
    return getClass();
  }
