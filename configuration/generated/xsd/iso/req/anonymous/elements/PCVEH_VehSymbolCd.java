...
public final class PCVEH_VehSymbolCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCVEH_VehSymbolCd" );
    }
  };
  ...
  public PCVEH_VehSymbolCd() {
    super( -837142239, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCVEH_VehSymbolCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -837142239, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCVEH_VehSymbolCd( gw.internal.xml.XmlElementState state ) {
    super( -837142239, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCVEH_VehSymbolCd> get$Class() {
    return getClass();
  }
