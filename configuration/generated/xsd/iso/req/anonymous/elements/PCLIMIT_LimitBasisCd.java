...
public final class PCLIMIT_LimitBasisCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCLIMIT_LimitBasisCd" );
    }
  };
  ...
  public PCLIMIT_LimitBasisCd() {
    super( 1740199155, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCLIMIT_LimitBasisCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1740199155, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCLIMIT_LimitBasisCd( gw.internal.xml.XmlElementState state ) {
    super( 1740199155, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCLIMIT_LimitBasisCd> get$Class() {
    return getClass();
  }
