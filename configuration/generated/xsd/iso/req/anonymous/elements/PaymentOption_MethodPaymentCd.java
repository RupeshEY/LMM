...
public final class PaymentOption_MethodPaymentCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PaymentOption_MethodPaymentCd" );
    }
  };
  ...
  public PaymentOption_MethodPaymentCd() {
    super( -851944630, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PaymentOption_MethodPaymentCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -851944630, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PaymentOption_MethodPaymentCd( gw.internal.xml.XmlElementState state ) {
    super( -851944630, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PaymentOption_MethodPaymentCd> get$Class() {
    return getClass();
  }
