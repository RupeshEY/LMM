...
public final class MsgStatus_MsgErrorCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.MsgStatus_MsgErrorCd" );
    }
  };
  ...
  public MsgStatus_MsgErrorCd() {
    super( -1184103060, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public MsgStatus_MsgErrorCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1184103060, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private MsgStatus_MsgErrorCd( gw.internal.xml.XmlElementState state ) {
    super( -1184103060, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.MsgStatus_MsgErrorCd> get$Class() {
    return getClass();
  }
