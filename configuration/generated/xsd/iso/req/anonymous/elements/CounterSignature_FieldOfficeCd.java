...
public final class CounterSignature_FieldOfficeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.CounterSignature_FieldOfficeCd" );
    }
  };
  ...
  public CounterSignature_FieldOfficeCd() {
    super( 1961702124, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public CounterSignature_FieldOfficeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1961702124, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CounterSignature_FieldOfficeCd( gw.internal.xml.XmlElementState state ) {
    super( 1961702124, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.CounterSignature_FieldOfficeCd> get$Class() {
    return getClass();
  }
