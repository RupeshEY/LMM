...
public final class Form_CopyrightOwnerCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.Form_CopyrightOwnerCd" );
    }
  };
  ...
  public Form_CopyrightOwnerCd() {
    super( -2058965168, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public Form_CopyrightOwnerCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -2058965168, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private Form_CopyrightOwnerCd( gw.internal.xml.XmlElementState state ) {
    super( -2058965168, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.Form_CopyrightOwnerCd> get$Class() {
    return getClass();
  }
