...
public final class QuestionAnswer_QuestionCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.QuestionAnswer_QuestionCd" );
    }
  };
  ...
  public QuestionAnswer_QuestionCd() {
    super( 792395594, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public QuestionAnswer_QuestionCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 792395594, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private QuestionAnswer_QuestionCd( gw.internal.xml.XmlElementState state ) {
    super( 792395594, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.QuestionAnswer_QuestionCd> get$Class() {
    return getClass();
  }
