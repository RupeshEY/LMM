...
public final class ExtendedStatus_ExtendedStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ExtendedStatus_ExtendedStatusCd" );
    }
  };
  ...
  public ExtendedStatus_ExtendedStatusCd() {
    super( -71527928, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ExtendedStatus_ExtendedStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -71527928, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ExtendedStatus_ExtendedStatusCd( gw.internal.xml.XmlElementState state ) {
    super( -71527928, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ExtendedStatus_ExtendedStatusCd> get$Class() {
    return getClass();
  }
