...
public final class ClaimsPayment_PaymentTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsPayment_PaymentTypeCd" );
    }
  };
  ...
  public ClaimsPayment_PaymentTypeCd() {
    super( -2027265223, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsPayment_PaymentTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -2027265223, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsPayment_PaymentTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -2027265223, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsPayment_PaymentTypeCd> get$Class() {
    return getClass();
  }
