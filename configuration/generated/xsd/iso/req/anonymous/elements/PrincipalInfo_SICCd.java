...
public final class PrincipalInfo_SICCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PrincipalInfo_SICCd" );
    }
  };
  ...
  public PrincipalInfo_SICCd() {
    super( 1898444883, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PrincipalInfo_SICCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1898444883, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PrincipalInfo_SICCd( gw.internal.xml.XmlElementState state ) {
    super( 1898444883, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PrincipalInfo_SICCd> get$Class() {
    return getClass();
  }
