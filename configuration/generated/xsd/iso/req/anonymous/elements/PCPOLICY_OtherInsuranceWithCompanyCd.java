...
public final class PCPOLICY_OtherInsuranceWithCompanyCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCPOLICY_OtherInsuranceWithCompanyCd" );
    }
  };
  ...
  public PCPOLICY_OtherInsuranceWithCompanyCd() {
    super( 69117964, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCPOLICY_OtherInsuranceWithCompanyCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 69117964, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCPOLICY_OtherInsuranceWithCompanyCd( gw.internal.xml.XmlElementState state ) {
    super( 69117964, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCPOLICY_OtherInsuranceWithCompanyCd> get$Class() {
    return getClass();
  }
