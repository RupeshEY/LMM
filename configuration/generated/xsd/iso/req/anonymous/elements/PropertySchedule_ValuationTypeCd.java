...
public final class PropertySchedule_ValuationTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PropertySchedule_ValuationTypeCd" );
    }
  };
  ...
  public PropertySchedule_ValuationTypeCd() {
    super( 940727905, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PropertySchedule_ValuationTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 940727905, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PropertySchedule_ValuationTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 940727905, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PropertySchedule_ValuationTypeCd> get$Class() {
    return getClass();
  }
