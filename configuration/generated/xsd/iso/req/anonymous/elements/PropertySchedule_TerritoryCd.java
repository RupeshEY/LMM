...
public final class PropertySchedule_TerritoryCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PropertySchedule_TerritoryCd" );
    }
  };
  ...
  public PropertySchedule_TerritoryCd() {
    super( 790535264, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PropertySchedule_TerritoryCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 790535264, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PropertySchedule_TerritoryCd( gw.internal.xml.XmlElementState state ) {
    super( 790535264, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PropertySchedule_TerritoryCd> get$Class() {
    return getClass();
  }
