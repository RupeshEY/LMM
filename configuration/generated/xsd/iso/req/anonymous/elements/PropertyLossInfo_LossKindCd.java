...
public final class PropertyLossInfo_LossKindCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PropertyLossInfo_LossKindCd" );
    }
  };
  ...
  public PropertyLossInfo_LossKindCd() {
    super( 1901675801, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PropertyLossInfo_LossKindCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1901675801, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PropertyLossInfo_LossKindCd( gw.internal.xml.XmlElementState state ) {
    super( 1901675801, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PropertyLossInfo_LossKindCd> get$Class() {
    return getClass();
  }
