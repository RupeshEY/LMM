...
public final class PropertySchedule_ItemValuationTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PropertySchedule_ItemValuationTypeCd" );
    }
  };
  ...
  public PropertySchedule_ItemValuationTypeCd() {
    super( -1766700978, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PropertySchedule_ItemValuationTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1766700978, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PropertySchedule_ItemValuationTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -1766700978, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PropertySchedule_ItemValuationTypeCd> get$Class() {
    return getClass();
  }
