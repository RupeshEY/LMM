...
public final class PaymentOption_PaymentIntervalCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PaymentOption_PaymentIntervalCd" );
    }
  };
  ...
  public PaymentOption_PaymentIntervalCd() {
    super( 2066768848, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PaymentOption_PaymentIntervalCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 2066768848, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PaymentOption_PaymentIntervalCd( gw.internal.xml.XmlElementState state ) {
    super( 2066768848, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PaymentOption_PaymentIntervalCd> get$Class() {
    return getClass();
  }
