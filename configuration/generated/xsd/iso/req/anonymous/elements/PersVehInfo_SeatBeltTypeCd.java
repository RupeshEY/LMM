...
public final class PersVehInfo_SeatBeltTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PersVehInfo_SeatBeltTypeCd" );
    }
  };
  ...
  public PersVehInfo_SeatBeltTypeCd() {
    super( 387037361, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PersVehInfo_SeatBeltTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 387037361, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PersVehInfo_SeatBeltTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 387037361, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PersVehInfo_SeatBeltTypeCd> get$Class() {
    return getClass();
  }
