...
public final class AdditionalInterestInfo_PolicyFrequencyCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.AdditionalInterestInfo_PolicyFrequencyCd" );
    }
  };
  ...
  public AdditionalInterestInfo_PolicyFrequencyCd() {
    super( 1902835011, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public AdditionalInterestInfo_PolicyFrequencyCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1902835011, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AdditionalInterestInfo_PolicyFrequencyCd( gw.internal.xml.XmlElementState state ) {
    super( 1902835011, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.AdditionalInterestInfo_PolicyFrequencyCd> get$Class() {
    return getClass();
  }
