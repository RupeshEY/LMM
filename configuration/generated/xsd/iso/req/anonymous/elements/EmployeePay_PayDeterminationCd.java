...
public final class EmployeePay_PayDeterminationCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.EmployeePay_PayDeterminationCd" );
    }
  };
  ...
  public EmployeePay_PayDeterminationCd() {
    super( 1437060057, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public EmployeePay_PayDeterminationCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1437060057, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private EmployeePay_PayDeterminationCd( gw.internal.xml.XmlElementState state ) {
    super( 1437060057, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.EmployeePay_PayDeterminationCd> get$Class() {
    return getClass();
  }
