...
public final class PCBASICVEH_VehTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCBASICVEH_VehTypeCd" );
    }
  };
  ...
  public PCBASICVEH_VehTypeCd() {
    super( 92395819, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCBASICVEH_VehTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 92395819, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCBASICVEH_VehTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 92395819, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCBASICVEH_VehTypeCd> get$Class() {
    return getClass();
  }
