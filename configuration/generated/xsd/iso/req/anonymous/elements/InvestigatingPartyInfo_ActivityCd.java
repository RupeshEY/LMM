...
public final class InvestigatingPartyInfo_ActivityCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.InvestigatingPartyInfo_ActivityCd" );
    }
  };
  ...
  public InvestigatingPartyInfo_ActivityCd() {
    super( -986380865, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public InvestigatingPartyInfo_ActivityCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -986380865, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private InvestigatingPartyInfo_ActivityCd( gw.internal.xml.XmlElementState state ) {
    super( -986380865, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.InvestigatingPartyInfo_ActivityCd> get$Class() {
    return getClass();
  }
