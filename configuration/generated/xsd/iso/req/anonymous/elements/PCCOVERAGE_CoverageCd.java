...
public final class PCCOVERAGE_CoverageCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCCOVERAGE_CoverageCd" );
    }
  };
  ...
  public PCCOVERAGE_CoverageCd() {
    super( -188848395, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCCOVERAGE_CoverageCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -188848395, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCCOVERAGE_CoverageCd( gw.internal.xml.XmlElementState state ) {
    super( -188848395, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCCOVERAGE_CoverageCd> get$Class() {
    return getClass();
  }
