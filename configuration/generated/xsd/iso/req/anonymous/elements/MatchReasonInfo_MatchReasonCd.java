...
public final class MatchReasonInfo_MatchReasonCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.MatchReasonInfo_MatchReasonCd" );
    }
  };
  ...
  public MatchReasonInfo_MatchReasonCd() {
    super( -2126827158, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public MatchReasonInfo_MatchReasonCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -2126827158, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private MatchReasonInfo_MatchReasonCd( gw.internal.xml.XmlElementState state ) {
    super( -2126827158, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.MatchReasonInfo_MatchReasonCd> get$Class() {
    return getClass();
  }
