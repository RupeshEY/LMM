...
public final class ClaimsInjuredInfo_LossActCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsInjuredInfo_LossActCd" );
    }
  };
  ...
  public ClaimsInjuredInfo_LossActCd() {
    super( 74955633, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsInjuredInfo_LossActCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 74955633, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsInjuredInfo_LossActCd( gw.internal.xml.XmlElementState state ) {
    super( 74955633, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsInjuredInfo_LossActCd> get$Class() {
    return getClass();
  }
