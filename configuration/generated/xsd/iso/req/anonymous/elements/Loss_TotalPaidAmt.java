...
public final class Loss_TotalPaidAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.Loss_TotalPaidAmt" );
    }
  };
  ...
  public Loss_TotalPaidAmt() {
    super( -1843235940, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.anonymous.types.complex.Loss_TotalPaidAmt() );
  }

  public Loss_TotalPaidAmt( xsd.iso.req.anonymous.types.complex.Loss_TotalPaidAmt typeInstance ) {
    super( -1843235940, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private Loss_TotalPaidAmt( gw.internal.xml.XmlElementState state ) {
    super( -1843235940, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.Loss_TotalPaidAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.req.anonymous.types.complex.Loss_TotalPaidAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.req.anonymous.types.complex.Loss_TotalPaidAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.req.anonymous.types.complex.Loss_TotalPaidAmt typeInstance ) {
