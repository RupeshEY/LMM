...
public final class AdditionalMatchInfo_MatchTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.AdditionalMatchInfo_MatchTypeCd" );
    }
  };
  ...
  public AdditionalMatchInfo_MatchTypeCd() {
    super( 536359317, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public AdditionalMatchInfo_MatchTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 536359317, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AdditionalMatchInfo_MatchTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 536359317, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.AdditionalMatchInfo_MatchTypeCd> get$Class() {
    return getClass();
  }
