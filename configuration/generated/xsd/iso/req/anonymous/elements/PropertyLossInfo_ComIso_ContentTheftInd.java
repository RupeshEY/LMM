...
public final class PropertyLossInfo_ComIso_ContentTheftInd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PropertyLossInfo_ComIso_ContentTheftInd" );
    }
  };
  ...
  public PropertyLossInfo_ComIso_ContentTheftInd() {
    super( -2130485665, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PropertyLossInfo_ComIso_ContentTheftInd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -2130485665, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PropertyLossInfo_ComIso_ContentTheftInd( gw.internal.xml.XmlElementState state ) {
    super( -2130485665, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PropertyLossInfo_ComIso_ContentTheftInd> get$Class() {
    return getClass();
  }
