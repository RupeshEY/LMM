...
public final class DriversLicense_LicenseClassCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.DriversLicense_LicenseClassCd" );
    }
  };
  ...
  public DriversLicense_LicenseClassCd() {
    super( -507264023, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public DriversLicense_LicenseClassCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -507264023, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private DriversLicense_LicenseClassCd( gw.internal.xml.XmlElementState state ) {
    super( -507264023, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.DriversLicense_LicenseClassCd> get$Class() {
    return getClass();
  }
