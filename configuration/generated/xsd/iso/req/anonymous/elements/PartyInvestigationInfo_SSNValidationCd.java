...
public final class PartyInvestigationInfo_SSNValidationCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PartyInvestigationInfo_SSNValidationCd" );
    }
  };
  ...
  public PartyInvestigationInfo_SSNValidationCd() {
    super( 665754283, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PartyInvestigationInfo_SSNValidationCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 665754283, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PartyInvestigationInfo_SSNValidationCd( gw.internal.xml.XmlElementState state ) {
    super( 665754283, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PartyInvestigationInfo_SSNValidationCd> get$Class() {
    return getClass();
  }
