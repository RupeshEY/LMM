...
public final class NameInfo_LegalEntityCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.NameInfo_LegalEntityCd" );
    }
  };
  ...
  public NameInfo_LegalEntityCd() {
    super( 1821621775, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public NameInfo_LegalEntityCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1821621775, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private NameInfo_LegalEntityCd( gw.internal.xml.XmlElementState state ) {
    super( 1821621775, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.NameInfo_LegalEntityCd> get$Class() {
    return getClass();
  }
