...
public final class PCCREDITSURCHARGE_SecondaryCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCCREDITSURCHARGE_SecondaryCd" );
    }
  };
  ...
  public PCCREDITSURCHARGE_SecondaryCd() {
    super( -1320809642, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCCREDITSURCHARGE_SecondaryCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1320809642, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCCREDITSURCHARGE_SecondaryCd( gw.internal.xml.XmlElementState state ) {
    super( -1320809642, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCCREDITSURCHARGE_SecondaryCd> get$Class() {
    return getClass();
  }
