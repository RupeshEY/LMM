...
public final class CommlVehSupplement_PresentValueAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.CommlVehSupplement_PresentValueAmt" );
    }
  };
  ...
  public CommlVehSupplement_PresentValueAmt() {
    super( 1358788829, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.CURRENCY() );
  }

  public CommlVehSupplement_PresentValueAmt( xsd.iso.req.types.complex.CURRENCY typeInstance ) {
    super( 1358788829, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CommlVehSupplement_PresentValueAmt( gw.internal.xml.XmlElementState state ) {
    super( 1358788829, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.CommlVehSupplement_PresentValueAmt> get$Class() {
    return getClass();
  }
