...
public final class EmployeeInfo_RatingClassificationCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.EmployeeInfo_RatingClassificationCd" );
    }
  };
  ...
  public EmployeeInfo_RatingClassificationCd() {
    super( -510862257, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public EmployeeInfo_RatingClassificationCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -510862257, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private EmployeeInfo_RatingClassificationCd( gw.internal.xml.XmlElementState state ) {
    super( -510862257, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.EmployeeInfo_RatingClassificationCd> get$Class() {
    return getClass();
  }
