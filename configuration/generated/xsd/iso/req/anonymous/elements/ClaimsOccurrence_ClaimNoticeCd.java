...
public final class ClaimsOccurrence_ClaimNoticeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsOccurrence_ClaimNoticeCd" );
    }
  };
  ...
  public ClaimsOccurrence_ClaimNoticeCd() {
    super( 597594902, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsOccurrence_ClaimNoticeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 597594902, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsOccurrence_ClaimNoticeCd( gw.internal.xml.XmlElementState state ) {
    super( 597594902, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsOccurrence_ClaimNoticeCd> get$Class() {
    return getClass();
  }
