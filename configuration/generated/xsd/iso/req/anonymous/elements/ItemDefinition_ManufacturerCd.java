...
public final class ItemDefinition_ManufacturerCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ItemDefinition_ManufacturerCd" );
    }
  };
  ...
  public ItemDefinition_ManufacturerCd() {
    super( 787418419, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ItemDefinition_ManufacturerCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 787418419, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ItemDefinition_ManufacturerCd( gw.internal.xml.XmlElementState state ) {
    super( 787418419, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ItemDefinition_ManufacturerCd> get$Class() {
    return getClass();
  }
