...
public final class ClaimsPartyInfo_ClaimsPartyLocCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsPartyInfo_ClaimsPartyLocCd" );
    }
  };
  ...
  public ClaimsPartyInfo_ClaimsPartyLocCd() {
    super( 1478408076, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsPartyInfo_ClaimsPartyLocCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1478408076, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsPartyInfo_ClaimsPartyLocCd( gw.internal.xml.XmlElementState state ) {
    super( 1478408076, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsPartyInfo_ClaimsPartyLocCd> get$Class() {
    return getClass();
  }
