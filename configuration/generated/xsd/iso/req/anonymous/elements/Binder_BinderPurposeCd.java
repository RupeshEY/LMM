...
public final class Binder_BinderPurposeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.Binder_BinderPurposeCd" );
    }
  };
  ...
  public Binder_BinderPurposeCd() {
    super( 6776696, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public Binder_BinderPurposeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 6776696, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.Binder_BinderPurposeCd> get$Class() {
    return getClass();
  }
