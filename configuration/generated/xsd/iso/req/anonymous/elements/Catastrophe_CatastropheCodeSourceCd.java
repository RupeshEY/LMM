...
public final class Catastrophe_CatastropheCodeSourceCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.Catastrophe_CatastropheCodeSourceCd" );
    }
  };
  ...
  public Catastrophe_CatastropheCodeSourceCd() {
    super( -1195338406, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public Catastrophe_CatastropheCodeSourceCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1195338406, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private Catastrophe_CatastropheCodeSourceCd( gw.internal.xml.XmlElementState state ) {
    super( -1195338406, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.Catastrophe_CatastropheCodeSourceCd> get$Class() {
    return getClass();
  }
