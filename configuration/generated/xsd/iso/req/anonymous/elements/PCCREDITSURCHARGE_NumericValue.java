...
public final class PCCREDITSURCHARGE_NumericValue extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCCREDITSURCHARGE_NumericValue" );
    }
  };
  ...
  public PCCREDITSURCHARGE_NumericValue() {
    super( 156832803, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.anonymous.types.complex.PCCREDITSURCHARGE_NumericValue() );
  }

  public PCCREDITSURCHARGE_NumericValue( xsd.iso.req.anonymous.types.complex.PCCREDITSURCHARGE_NumericValue typeInstance ) {
    super( 156832803, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCCREDITSURCHARGE_NumericValue( gw.internal.xml.XmlElementState state ) {
    super( 156832803, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCCREDITSURCHARGE_NumericValue> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.req.anonymous.types.complex.PCCREDITSURCHARGE_NumericValue get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.req.anonymous.types.complex.PCCREDITSURCHARGE_NumericValue.class );
  }

  public final void set$TypeInstance( xsd.iso.req.anonymous.types.complex.PCCREDITSURCHARGE_NumericValue typeInstance ) {
