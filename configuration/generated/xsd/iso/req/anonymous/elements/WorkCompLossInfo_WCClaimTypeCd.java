...
public final class WorkCompLossInfo_WCClaimTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.WorkCompLossInfo_WCClaimTypeCd" );
    }
  };
  ...
  public WorkCompLossInfo_WCClaimTypeCd() {
    super( 969044821, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public WorkCompLossInfo_WCClaimTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 969044821, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private WorkCompLossInfo_WCClaimTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 969044821, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.WorkCompLossInfo_WCClaimTypeCd> get$Class() {
    return getClass();
  }
