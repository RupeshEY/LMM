...
public final class Registration_RegistrationTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.Registration_RegistrationTypeCd" );
    }
  };
  ...
  public Registration_RegistrationTypeCd() {
    super( -72437982, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public Registration_RegistrationTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -72437982, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private Registration_RegistrationTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -72437982, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.Registration_RegistrationTypeCd> get$Class() {
    return getClass();
  }
