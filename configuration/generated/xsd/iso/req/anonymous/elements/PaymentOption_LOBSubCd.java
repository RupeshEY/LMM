...
public final class PaymentOption_LOBSubCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PaymentOption_LOBSubCd" );
    }
  };
  ...
  public PaymentOption_LOBSubCd() {
    super( 1613326622, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PaymentOption_LOBSubCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1613326622, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PaymentOption_LOBSubCd( gw.internal.xml.XmlElementState state ) {
    super( 1613326622, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PaymentOption_LOBSubCd> get$Class() {
    return getClass();
  }
