...
public final class Watercraft_HullDesignTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.Watercraft_HullDesignTypeCd" );
    }
  };
  ...
  public Watercraft_HullDesignTypeCd() {
    super( -1643264732, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public Watercraft_HullDesignTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1643264732, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private Watercraft_HullDesignTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -1643264732, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.Watercraft_HullDesignTypeCd> get$Class() {
    return getClass();
  }
