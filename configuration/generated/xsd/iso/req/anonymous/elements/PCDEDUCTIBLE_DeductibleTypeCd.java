...
public final class PCDEDUCTIBLE_DeductibleTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCDEDUCTIBLE_DeductibleTypeCd" );
    }
  };
  ...
  public PCDEDUCTIBLE_DeductibleTypeCd() {
    super( -1831550097, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCDEDUCTIBLE_DeductibleTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1831550097, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCDEDUCTIBLE_DeductibleTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -1831550097, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCDEDUCTIBLE_DeductibleTypeCd> get$Class() {
    return getClass();
  }
