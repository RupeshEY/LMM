...
public final class DriversLicense_CountryCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.DriversLicense_CountryCd" );
    }
  };
  ...
  public DriversLicense_CountryCd() {
    super( 429824134, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public DriversLicense_CountryCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 429824134, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private DriversLicense_CountryCd( gw.internal.xml.XmlElementState state ) {
    super( 429824134, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.DriversLicense_CountryCd> get$Class() {
    return getClass();
  }
