...
public final class WorkCompLossInfo_JurisdictionCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.WorkCompLossInfo_JurisdictionCd" );
    }
  };
  ...
  public WorkCompLossInfo_JurisdictionCd() {
    super( 2142641144, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public WorkCompLossInfo_JurisdictionCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 2142641144, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private WorkCompLossInfo_JurisdictionCd( gw.internal.xml.XmlElementState state ) {
    super( 2142641144, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.WorkCompLossInfo_JurisdictionCd> get$Class() {
    return getClass();
  }
