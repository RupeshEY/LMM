...
public final class SelfInsuredRetentionInfo_SelfInsuredRetentionAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.SelfInsuredRetentionInfo_SelfInsuredRetentionAmt" );
    }
  };
  ...
  public SelfInsuredRetentionInfo_SelfInsuredRetentionAmt() {
    super( -1229447249, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.CURRENCY() );
  }

  public SelfInsuredRetentionInfo_SelfInsuredRetentionAmt( xsd.iso.req.types.complex.CURRENCY typeInstance ) {
    super( -1229447249, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private SelfInsuredRetentionInfo_SelfInsuredRetentionAmt( gw.internal.xml.XmlElementState state ) {
    super( -1229447249, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.SelfInsuredRetentionInfo_SelfInsuredRetentionAmt> get$Class() {
    return getClass();
  }
