...
public final class TaxCodeInfo_TaxTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.TaxCodeInfo_TaxTypeCd" );
    }
  };
  ...
  public TaxCodeInfo_TaxTypeCd() {
    super( -2118418155, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public TaxCodeInfo_TaxTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -2118418155, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private TaxCodeInfo_TaxTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -2118418155, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.TaxCodeInfo_TaxTypeCd> get$Class() {
    return getClass();
  }
