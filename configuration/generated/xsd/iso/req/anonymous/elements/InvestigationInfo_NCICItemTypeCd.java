...
public final class InvestigationInfo_NCICItemTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.InvestigationInfo_NCICItemTypeCd" );
    }
  };
  ...
  public InvestigationInfo_NCICItemTypeCd() {
    super( -2023132924, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public InvestigationInfo_NCICItemTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -2023132924, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private InvestigationInfo_NCICItemTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -2023132924, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.InvestigationInfo_NCICItemTypeCd> get$Class() {
    return getClass();
  }
