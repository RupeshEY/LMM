...
public final class ItemIdInfo_OtherIdentifier_OtherIdTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ItemIdInfo_OtherIdentifier_OtherIdTypeCd" );
    }
  };
  ...
  public ItemIdInfo_OtherIdentifier_OtherIdTypeCd() {
    super( -1626740171, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ItemIdInfo_OtherIdentifier_OtherIdTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1626740171, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ItemIdInfo_OtherIdentifier_OtherIdTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -1626740171, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ItemIdInfo_OtherIdentifier_OtherIdTypeCd> get$Class() {
    return getClass();
  }
