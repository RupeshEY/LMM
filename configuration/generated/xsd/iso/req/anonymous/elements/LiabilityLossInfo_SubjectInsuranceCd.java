...
public final class LiabilityLossInfo_SubjectInsuranceCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.LiabilityLossInfo_SubjectInsuranceCd" );
    }
  };
  ...
  public LiabilityLossInfo_SubjectInsuranceCd() {
    super( 2029335048, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public LiabilityLossInfo_SubjectInsuranceCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 2029335048, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private LiabilityLossInfo_SubjectInsuranceCd( gw.internal.xml.XmlElementState state ) {
    super( 2029335048, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.LiabilityLossInfo_SubjectInsuranceCd> get$Class() {
    return getClass();
  }
