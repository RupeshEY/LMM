...
public final class ComIso_ScoredMatch_CoverageCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ComIso_ScoredMatch_CoverageCd" );
    }
  };
  ...
  public ComIso_ScoredMatch_CoverageCd() {
    super( -2028053672, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ComIso_ScoredMatch_CoverageCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -2028053672, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ComIso_ScoredMatch_CoverageCd( gw.internal.xml.XmlElementState state ) {
    super( -2028053672, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ComIso_ScoredMatch_CoverageCd> get$Class() {
    return getClass();
  }
