...
public final class PCPOLICY_TotalPaidLossAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCPOLICY_TotalPaidLossAmt" );
    }
  };
  ...
  public PCPOLICY_TotalPaidLossAmt() {
    super( -1151139305, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.anonymous.types.complex.PCPOLICY_TotalPaidLossAmt() );
  }

  public PCPOLICY_TotalPaidLossAmt( xsd.iso.req.anonymous.types.complex.PCPOLICY_TotalPaidLossAmt typeInstance ) {
    super( -1151139305, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCPOLICY_TotalPaidLossAmt( gw.internal.xml.XmlElementState state ) {
    super( -1151139305, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCPOLICY_TotalPaidLossAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.req.anonymous.types.complex.PCPOLICY_TotalPaidLossAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.req.anonymous.types.complex.PCPOLICY_TotalPaidLossAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.req.anonymous.types.complex.PCPOLICY_TotalPaidLossAmt typeInstance ) {
