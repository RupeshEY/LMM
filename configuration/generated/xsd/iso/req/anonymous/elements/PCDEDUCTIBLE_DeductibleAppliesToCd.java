...
public final class PCDEDUCTIBLE_DeductibleAppliesToCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCDEDUCTIBLE_DeductibleAppliesToCd" );
    }
  };
  ...
  public PCDEDUCTIBLE_DeductibleAppliesToCd() {
    super( -1508961996, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCDEDUCTIBLE_DeductibleAppliesToCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1508961996, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCDEDUCTIBLE_DeductibleAppliesToCd( gw.internal.xml.XmlElementState state ) {
    super( -1508961996, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCDEDUCTIBLE_DeductibleAppliesToCd> get$Class() {
    return getClass();
  }
