...
public final class QuestionAnswer_YesNoCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.QuestionAnswer_YesNoCd" );
    }
  };
  ...
  public QuestionAnswer_YesNoCd() {
    super( 1524243462, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public QuestionAnswer_YesNoCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1524243462, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private QuestionAnswer_YesNoCd( gw.internal.xml.XmlElementState state ) {
    super( 1524243462, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.QuestionAnswer_YesNoCd> get$Class() {
    return getClass();
  }
