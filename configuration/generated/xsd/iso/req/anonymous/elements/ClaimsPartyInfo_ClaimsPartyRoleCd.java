...
public final class ClaimsPartyInfo_ClaimsPartyRoleCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsPartyInfo_ClaimsPartyRoleCd" );
    }
  };
  ...
  public ClaimsPartyInfo_ClaimsPartyRoleCd() {
    super( -1241915124, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsPartyInfo_ClaimsPartyRoleCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1241915124, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsPartyInfo_ClaimsPartyRoleCd( gw.internal.xml.XmlElementState state ) {
    super( -1241915124, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsPartyInfo_ClaimsPartyRoleCd> get$Class() {
    return getClass();
  }
