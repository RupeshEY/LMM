...
public final class ItemDefinition_ItemTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ItemDefinition_ItemTypeCd" );
    }
  };
  ...
  public ItemDefinition_ItemTypeCd() {
    super( 737052623, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ItemDefinition_ItemTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 737052623, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ItemDefinition_ItemTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 737052623, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ItemDefinition_ItemTypeCd> get$Class() {
    return getClass();
  }
