...
public final class Catastrophe_CatastropheCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.Catastrophe_CatastropheCd" );
    }
  };
  ...
  public Catastrophe_CatastropheCd() {
    super( -1482743790, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public Catastrophe_CatastropheCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1482743790, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private Catastrophe_CatastropheCd( gw.internal.xml.XmlElementState state ) {
    super( -1482743790, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.Catastrophe_CatastropheCd> get$Class() {
    return getClass();
  }
