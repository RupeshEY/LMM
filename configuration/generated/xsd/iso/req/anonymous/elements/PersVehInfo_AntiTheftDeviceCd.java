...
public final class PersVehInfo_AntiTheftDeviceCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PersVehInfo_AntiTheftDeviceCd" );
    }
  };
  ...
  public PersVehInfo_AntiTheftDeviceCd() {
    super( 509637326, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PersVehInfo_AntiTheftDeviceCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 509637326, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PersVehInfo_AntiTheftDeviceCd( gw.internal.xml.XmlElementState state ) {
    super( 509637326, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PersVehInfo_AntiTheftDeviceCd> get$Class() {
    return getClass();
  }
