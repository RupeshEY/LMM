...
public final class PCCOVERAGE_PremiumBasisCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCCOVERAGE_PremiumBasisCd" );
    }
  };
  ...
  public PCCOVERAGE_PremiumBasisCd() {
    super( -544953484, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCCOVERAGE_PremiumBasisCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -544953484, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCCOVERAGE_PremiumBasisCd( gw.internal.xml.XmlElementState state ) {
    super( -544953484, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCCOVERAGE_PremiumBasisCd> get$Class() {
    return getClass();
  }
