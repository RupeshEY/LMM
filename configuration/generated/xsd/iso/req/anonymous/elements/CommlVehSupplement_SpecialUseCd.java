...
public final class CommlVehSupplement_SpecialUseCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.CommlVehSupplement_SpecialUseCd" );
    }
  };
  ...
  public CommlVehSupplement_SpecialUseCd() {
    super( 1755077252, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public CommlVehSupplement_SpecialUseCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1755077252, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CommlVehSupplement_SpecialUseCd( gw.internal.xml.XmlElementState state ) {
    super( 1755077252, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.CommlVehSupplement_SpecialUseCd> get$Class() {
    return getClass();
  }
