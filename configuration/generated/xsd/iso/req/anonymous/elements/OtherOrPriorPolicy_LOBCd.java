...
public final class OtherOrPriorPolicy_LOBCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.OtherOrPriorPolicy_LOBCd" );
    }
  };
  ...
  public OtherOrPriorPolicy_LOBCd() {
    super( -451371966, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public OtherOrPriorPolicy_LOBCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -451371966, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private OtherOrPriorPolicy_LOBCd( gw.internal.xml.XmlElementState state ) {
    super( -451371966, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.OtherOrPriorPolicy_LOBCd> get$Class() {
    return getClass();
  }
