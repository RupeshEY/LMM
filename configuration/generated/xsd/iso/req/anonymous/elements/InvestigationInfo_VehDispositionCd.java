...
public final class InvestigationInfo_VehDispositionCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.InvestigationInfo_VehDispositionCd" );
    }
  };
  ...
  public InvestigationInfo_VehDispositionCd() {
    super( -320595546, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public InvestigationInfo_VehDispositionCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -320595546, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private InvestigationInfo_VehDispositionCd( gw.internal.xml.XmlElementState state ) {
    super( -320595546, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.InvestigationInfo_VehDispositionCd> get$Class() {
    return getClass();
  }
