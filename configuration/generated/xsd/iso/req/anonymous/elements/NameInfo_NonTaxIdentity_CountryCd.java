...
public final class NameInfo_NonTaxIdentity_CountryCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.NameInfo_NonTaxIdentity_CountryCd" );
    }
  };
  ...
  public NameInfo_NonTaxIdentity_CountryCd() {
    super( 1980397218, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public NameInfo_NonTaxIdentity_CountryCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1980397218, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private NameInfo_NonTaxIdentity_CountryCd( gw.internal.xml.XmlElementState state ) {
    super( 1980397218, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.NameInfo_NonTaxIdentity_CountryCd> get$Class() {
    return getClass();
  }
