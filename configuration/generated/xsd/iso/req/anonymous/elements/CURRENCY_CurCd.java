...
@gw.xml.annotation.SuperTypeData({ xsd.iso.req.CurCd.class })
public final class CURRENCY_CurCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.CURRENCY_CurCd" );
    }
  };
  ...
  public CURRENCY_CurCd() {
    super( 1358848363, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public CURRENCY_CurCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1358848363, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CURRENCY_CurCd( gw.internal.xml.XmlElementState state ) {
    super( 1358848363, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.CURRENCY_CurCd> get$Class() {
    return getClass();
  }
