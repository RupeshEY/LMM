...
public final class FileAttachmentInfo_AttachmentTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.FileAttachmentInfo_AttachmentTypeCd" );
    }
  };
  ...
  public FileAttachmentInfo_AttachmentTypeCd() {
    super( 143790008, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public FileAttachmentInfo_AttachmentTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 143790008, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private FileAttachmentInfo_AttachmentTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 143790008, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.FileAttachmentInfo_AttachmentTypeCd> get$Class() {
    return getClass();
  }
