...
public final class LiabilityLossInfo_InsuredInterestCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.LiabilityLossInfo_InsuredInterestCd" );
    }
  };
  ...
  public LiabilityLossInfo_InsuredInterestCd() {
    super( -360853348, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public LiabilityLossInfo_InsuredInterestCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -360853348, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private LiabilityLossInfo_InsuredInterestCd( gw.internal.xml.XmlElementState state ) {
    super( -360853348, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.LiabilityLossInfo_InsuredInterestCd> get$Class() {
    return getClass();
  }
