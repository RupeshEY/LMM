...
public final class ClaimsInjury_BodyPartCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsInjury_BodyPartCd" );
    }
  };
  ...
  public ClaimsInjury_BodyPartCd() {
    super( 374638927, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsInjury_BodyPartCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 374638927, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsInjury_BodyPartCd( gw.internal.xml.XmlElementState state ) {
    super( 374638927, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsInjury_BodyPartCd> get$Class() {
    return getClass();
  }
