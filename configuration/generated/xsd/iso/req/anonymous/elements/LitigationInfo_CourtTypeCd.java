...
public final class LitigationInfo_CourtTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.LitigationInfo_CourtTypeCd" );
    }
  };
  ...
  public LitigationInfo_CourtTypeCd() {
    super( -1143519411, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public LitigationInfo_CourtTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1143519411, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private LitigationInfo_CourtTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -1143519411, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.LitigationInfo_CourtTypeCd> get$Class() {
    return getClass();
  }
