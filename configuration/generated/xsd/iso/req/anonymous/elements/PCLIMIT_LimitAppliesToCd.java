...
public final class PCLIMIT_LimitAppliesToCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCLIMIT_LimitAppliesToCd" );
    }
  };
  ...
  public PCLIMIT_LimitAppliesToCd() {
    super( -258967396, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCLIMIT_LimitAppliesToCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -258967396, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCLIMIT_LimitAppliesToCd( gw.internal.xml.XmlElementState state ) {
    super( -258967396, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCLIMIT_LimitAppliesToCd> get$Class() {
    return getClass();
  }
