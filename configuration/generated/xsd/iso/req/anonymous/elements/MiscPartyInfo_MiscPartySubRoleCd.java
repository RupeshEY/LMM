...
public final class MiscPartyInfo_MiscPartySubRoleCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.MiscPartyInfo_MiscPartySubRoleCd" );
    }
  };
  ...
  public MiscPartyInfo_MiscPartySubRoleCd() {
    super( 1378390220, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public MiscPartyInfo_MiscPartySubRoleCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1378390220, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private MiscPartyInfo_MiscPartySubRoleCd( gw.internal.xml.XmlElementState state ) {
    super( 1378390220, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.MiscPartyInfo_MiscPartySubRoleCd> get$Class() {
    return getClass();
  }
