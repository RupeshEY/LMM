...
public final class LitigationInfo_ThresholdTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.LitigationInfo_ThresholdTypeCd" );
    }
  };
  ...
  public LitigationInfo_ThresholdTypeCd() {
    super( -2144631123, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public LitigationInfo_ThresholdTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -2144631123, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private LitigationInfo_ThresholdTypeCd( gw.internal.xml.XmlElementState state ) {
    super( -2144631123, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.LitigationInfo_ThresholdTypeCd> get$Class() {
    return getClass();
  }
