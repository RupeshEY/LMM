...
public final class PCBASICWATERCRAFT_WaterUnitTypeCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.PCBASICWATERCRAFT_WaterUnitTypeCd" );
    }
  };
  ...
  public PCBASICWATERCRAFT_WaterUnitTypeCd() {
    super( 1793656355, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public PCBASICWATERCRAFT_WaterUnitTypeCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 1793656355, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCBASICWATERCRAFT_WaterUnitTypeCd( gw.internal.xml.XmlElementState state ) {
    super( 1793656355, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.PCBASICWATERCRAFT_WaterUnitTypeCd> get$Class() {
    return getClass();
  }
