...
public final class Form_CopyrightOwnerNameCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.Form_CopyrightOwnerNameCd" );
    }
  };
  ...
  public Form_CopyrightOwnerNameCd() {
    super( 730636219, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public Form_CopyrightOwnerNameCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 730636219, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private Form_CopyrightOwnerNameCd( gw.internal.xml.XmlElementState state ) {
    super( 730636219, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.Form_CopyrightOwnerNameCd> get$Class() {
    return getClass();
  }
