...
public final class ElectronicFundsTransfer_EFTFrequencyCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ElectronicFundsTransfer_EFTFrequencyCd" );
    }
  };
  ...
  public ElectronicFundsTransfer_EFTFrequencyCd() {
    super( -1376462108, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ElectronicFundsTransfer_EFTFrequencyCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( -1376462108, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ElectronicFundsTransfer_EFTFrequencyCd( gw.internal.xml.XmlElementState state ) {
    super( -1376462108, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ElectronicFundsTransfer_EFTFrequencyCd> get$Class() {
    return getClass();
  }
