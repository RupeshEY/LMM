...
public final class ClaimsOccurrence_LitigationStatusCd extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.req.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.req.anonymous.elements.ClaimsOccurrence_LitigationStatusCd" );
    }
  };
  ...
  public ClaimsOccurrence_LitigationStatusCd() {
    super( 932358514, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.req.types.complex.StringCd() );
  }

  public ClaimsOccurrence_LitigationStatusCd( xsd.iso.req.types.complex.StringCd typeInstance ) {
    super( 932358514, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsOccurrence_LitigationStatusCd( gw.internal.xml.XmlElementState state ) {
    super( 932358514, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.req.anonymous.elements.ClaimsOccurrence_LitigationStatusCd> get$Class() {
    return getClass();
  }
