...
public class NonResLicense extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.req.anonymous.types.complex.NonResLicense> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.req.anonymous.types.complex.NonResLicense get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.req.anonymous.elements.NonResLicense_NonResProducerLicenseNumber getNonResProducerLicenseNumber_elem() {
    return (xsd.iso.req.anonymous.elements.NonResLicense_NonResProducerLicenseNumber) TYPE.get().getPropertyValue( this, "_NonResProducerLicenseNumber_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.NonResLicense_NonResProducerLicenseExpirationDt getNonResProducerLicenseExpirationDt_elem() {
    return (xsd.iso.req.anonymous.elements.NonResLicense_NonResProducerLicenseExpirationDt) TYPE.get().getPropertyValue( this, "_NonResProducerLicenseExpirationDt_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.NonResLicense_StateProvCd getStateProvCd_elem() {
    return (xsd.iso.req.anonymous.elements.NonResLicense_StateProvCd) TYPE.get().getPropertyValue( this, "_StateProvCd_elem" );
  }
