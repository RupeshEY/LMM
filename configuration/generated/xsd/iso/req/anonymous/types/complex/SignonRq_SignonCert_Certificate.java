...
public class SignonRq_SignonCert_Certificate extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.req.anonymous.types.complex.SignonRq_SignonCert_Certificate> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.req.anonymous.types.complex.SignonRq_SignonCert_Certificate get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.req.anonymous.elements.SignonRq_SignonCert_Certificate_ContentTypeCd getContentTypeCd_elem() {
    return (xsd.iso.req.anonymous.elements.SignonRq_SignonCert_Certificate_ContentTypeCd) TYPE.get().getPropertyValue( this, "_ContentTypeCd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.SignonRq_SignonCert_Certificate_BinLength getBinLength_elem() {
    return (xsd.iso.req.anonymous.elements.SignonRq_SignonCert_Certificate_BinLength) TYPE.get().getPropertyValue( this, "_BinLength_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.SignonRq_SignonCert_Certificate_BinData getBinData_elem() {
    return (xsd.iso.req.anonymous.elements.SignonRq_SignonCert_Certificate_BinData) TYPE.get().getPropertyValue( this, "_BinData_elem" );
  }
