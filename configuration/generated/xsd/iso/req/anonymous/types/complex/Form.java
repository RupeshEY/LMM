...
public class Form extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.req.anonymous.types.complex.Form> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.req.anonymous.types.complex.Form get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.req.anonymous.elements.Form_FormNumber getFormNumber_elem() {
    return (xsd.iso.req.anonymous.elements.Form_FormNumber) TYPE.get().getPropertyValue( this, "_FormNumber_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.Form_FormName getFormName_elem() {
    return (xsd.iso.req.anonymous.elements.Form_FormName) TYPE.get().getPropertyValue( this, "_FormName_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.Form_CopyrightOwnerCd getCopyrightOwnerCd_elem() {
    return (xsd.iso.req.anonymous.elements.Form_CopyrightOwnerCd) TYPE.get().getPropertyValue( this, "_CopyrightOwnerCd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.Form_CopyrightOwnerNameCd getCopyrightOwnerNameCd_elem() {
    return (xsd.iso.req.anonymous.elements.Form_CopyrightOwnerNameCd) TYPE.get().getPropertyValue( this, "_CopyrightOwnerNameCd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.Form_FormDesc getFormDesc_elem() {
    return (xsd.iso.req.anonymous.elements.Form_FormDesc) TYPE.get().getPropertyValue( this, "_FormDesc_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.Form_EditionDt getEditionDt_elem() {
    return (xsd.iso.req.anonymous.elements.Form_EditionDt) TYPE.get().getPropertyValue( this, "_EditionDt_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.Form_FormDataArea getFormDataArea_elem() {
    return (xsd.iso.req.anonymous.elements.Form_FormDataArea) TYPE.get().getPropertyValue( this, "_FormDataArea_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.Form_IterationNumber getIterationNumber_elem() {
    return (xsd.iso.req.anonymous.elements.Form_IterationNumber) TYPE.get().getPropertyValue( this, "_IterationNumber_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.Form_FormSequencingNumber getFormSequencingNumber_elem() {
    return (xsd.iso.req.anonymous.elements.Form_FormSequencingNumber) TYPE.get().getPropertyValue( this, "_FormSequencingNumber_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.Form_BondFormOwner getBondFormOwner_elem() {
    return (xsd.iso.req.anonymous.elements.Form_BondFormOwner) TYPE.get().getPropertyValue( this, "_BondFormOwner_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.Form_BondFormNumberOwner getBondFormNumberOwner_elem() {
    return (xsd.iso.req.anonymous.elements.Form_BondFormNumberOwner) TYPE.get().getPropertyValue( this, "_BondFormNumberOwner_elem" );
  }
