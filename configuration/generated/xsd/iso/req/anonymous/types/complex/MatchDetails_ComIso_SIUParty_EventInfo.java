...
public class MatchDetails_ComIso_SIUParty_EventInfo extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public MatchDetails_ComIso_SIUParty_EventInfo() {
    super( -846319781, TYPE.get() );
  }

  private MatchDetails_ComIso_SIUParty_EventInfo( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -846319781, state );
  }

  protected MatchDetails_ComIso_SIUParty_EventInfo( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected MatchDetails_ComIso_SIUParty_EventInfo( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.req.anonymous.types.complex.MatchDetails_ComIso_SIUParty_EventInfo> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.req.anonymous.types.complex.MatchDetails_ComIso_SIUParty_EventInfo get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.req.anonymous.elements.MatchDetails_ComIso_SIUParty_EventInfo_EventCd getEventCd_elem() {
    return (xsd.iso.req.anonymous.elements.MatchDetails_ComIso_SIUParty_EventInfo_EventCd) TYPE.get().getPropertyValue( this, "_EventCd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.MatchDetails_ComIso_SIUParty_EventInfo_EventDt getEventDt_elem() {
    return (xsd.iso.req.anonymous.elements.MatchDetails_ComIso_SIUParty_EventInfo_EventDt) TYPE.get().getPropertyValue( this, "_EventDt_elem" );
  }
