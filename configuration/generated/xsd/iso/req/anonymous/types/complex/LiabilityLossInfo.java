...
public class LiabilityLossInfo extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.req.anonymous.types.complex.LiabilityLossInfo> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.req.anonymous.types.complex.LiabilityLossInfo get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.iso.req.anonymous.elements.LiabilityLossInfo_SubjectInsuranceCd> getSubjectInsuranceCd_elem() {
    return (java.util.List<xsd.iso.req.anonymous.elements.LiabilityLossInfo_SubjectInsuranceCd>) TYPE.get().getPropertyValue( this, "_SubjectInsuranceCd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.LiabilityLossInfo_InsuredInterestCd getInsuredInterestCd_elem() {
    return (xsd.iso.req.anonymous.elements.LiabilityLossInfo_InsuredInterestCd) TYPE.get().getPropertyValue( this, "_InsuredInterestCd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.LiabilityLossInfo_ItemDesc getItemDesc_elem() {
    return (xsd.iso.req.anonymous.elements.LiabilityLossInfo_ItemDesc) TYPE.get().getPropertyValue( this, "_ItemDesc_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.LiabilityLossInfo_ObjectLossDesc getObjectLossDesc_elem() {
    return (xsd.iso.req.anonymous.elements.LiabilityLossInfo_ObjectLossDesc) TYPE.get().getPropertyValue( this, "_ObjectLossDesc_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.LiabilityLossInfo_WhereSeenDesc getWhereSeenDesc_elem() {
    return (xsd.iso.req.anonymous.elements.LiabilityLossInfo_WhereSeenDesc) TYPE.get().getPropertyValue( this, "_WhereSeenDesc_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.LiabilityLossInfo_OtherInsuranceInd getOtherInsuranceInd_elem() {
    return (xsd.iso.req.anonymous.elements.LiabilityLossInfo_OtherInsuranceInd) TYPE.get().getPropertyValue( this, "_OtherInsuranceInd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.LiabilityLossInfo_OperationsDesc getOperationsDesc_elem() {
    return (xsd.iso.req.anonymous.elements.LiabilityLossInfo_OperationsDesc) TYPE.get().getPropertyValue( this, "_OperationsDesc_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.LiabilityLossInfo_OtherExposureDesc getOtherExposureDesc_elem() {
    return (xsd.iso.req.anonymous.elements.LiabilityLossInfo_OtherExposureDesc) TYPE.get().getPropertyValue( this, "_OtherExposureDesc_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.LiabilityLossInfo_ProbableIncurredAmt getProbableIncurredAmt() {
    return (xsd.iso.req.anonymous.elements.LiabilityLossInfo_ProbableIncurredAmt) TYPE.get().getPropertyValue( this, "_ProbableIncurredAmt" );
  }
