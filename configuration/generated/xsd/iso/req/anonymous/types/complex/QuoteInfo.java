...
public class QuoteInfo extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.req.anonymous.types.complex.QuoteInfo> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.req.anonymous.types.complex.QuoteInfo get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_CompanysQuoteNumber getCompanysQuoteNumber_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_CompanysQuoteNumber) TYPE.get().getPropertyValue( this, "_CompanysQuoteNumber_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_IterationNumber getIterationNumber_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_IterationNumber) TYPE.get().getPropertyValue( this, "_IterationNumber_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_InsuredFullToBePaidAmt getInsuredFullToBePaidAmt() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_InsuredFullToBePaidAmt) TYPE.get().getPropertyValue( this, "_InsuredFullToBePaidAmt" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_QuoteDeclinedInd getQuoteDeclinedInd_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_QuoteDeclinedInd) TYPE.get().getPropertyValue( this, "_QuoteDeclinedInd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_QuoteDeclinationReason getQuoteDeclinationReason_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_QuoteDeclinationReason) TYPE.get().getPropertyValue( this, "_QuoteDeclinationReason_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_QuoteConditionsInd getQuoteConditionsInd_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_QuoteConditionsInd) TYPE.get().getPropertyValue( this, "_QuoteConditionsInd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_QuoteConditionsReason getQuoteConditionsReason_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_QuoteConditionsReason) TYPE.get().getPropertyValue( this, "_QuoteConditionsReason_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_CoverageDeclinedInd getCoverageDeclinedInd_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_CoverageDeclinedInd) TYPE.get().getPropertyValue( this, "_CoverageDeclinedInd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_CoverageDeclinationReason getCoverageDeclinationReason_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_CoverageDeclinationReason) TYPE.get().getPropertyValue( this, "_CoverageDeclinationReason_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_CoverageConditionsInd getCoverageConditionsInd_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_CoverageConditionsInd) TYPE.get().getPropertyValue( this, "_CoverageConditionsInd_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_CoverageConditionsReason getCoverageConditionsReason_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_CoverageConditionsReason) TYPE.get().getPropertyValue( this, "_CoverageConditionsReason_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_InitialQuoteRequestDt getInitialQuoteRequestDt_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_InitialQuoteRequestDt) TYPE.get().getPropertyValue( this, "_InitialQuoteRequestDt_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_QuotePreparedDt getQuotePreparedDt_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_QuotePreparedDt) TYPE.get().getPropertyValue( this, "_QuotePreparedDt_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_QuoteValidUntilDt getQuoteValidUntilDt_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_QuoteValidUntilDt) TYPE.get().getPropertyValue( this, "_QuoteValidUntilDt_elem" );
  }
  ...
  public final xsd.iso.req.anonymous.elements.QuoteInfo_Description getDescription_elem() {
    return (xsd.iso.req.anonymous.elements.QuoteInfo_Description) TYPE.get().getPropertyValue( this, "_Description_elem" );
  }
