...
public class PCCREDITSURCHARGE extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.types.complex.PCCREDITSURCHARGE" );
    }
  };

  public PCCREDITSURCHARGE() {
    super( -699926027, TYPE.get() );
  }

  private PCCREDITSURCHARGE( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -699926027, state );
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.types.complex.PCCREDITSURCHARGE> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.types.complex.PCCREDITSURCHARGE get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.resp.anonymous.elements.PCCREDITSURCHARGE_CreditSurchargeDt getCreditSurchargeDt_elem() {
    return (xsd.iso.resp.anonymous.elements.PCCREDITSURCHARGE_CreditSurchargeDt) TYPE.get().getPropertyValue( this, "_CreditSurchargeDt_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.PCCREDITSURCHARGE_CreditSurchargeCd getCreditSurchargeCd_elem() {
    return (xsd.iso.resp.anonymous.elements.PCCREDITSURCHARGE_CreditSurchargeCd) TYPE.get().getPropertyValue( this, "_CreditSurchargeCd_elem" );
  }
  ...
  public final java.util.List<xsd.iso.resp.anonymous.elements.PCCREDITSURCHARGE_NumericValue> getNumericValue() {
    return (java.util.List<xsd.iso.resp.anonymous.elements.PCCREDITSURCHARGE_NumericValue>) TYPE.get().getPropertyValue( this, "_NumericValue" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.PCCREDITSURCHARGE_SecondaryCd getSecondaryCd_elem() {
    return (xsd.iso.resp.anonymous.elements.PCCREDITSURCHARGE_SecondaryCd) TYPE.get().getPropertyValue( this, "_SecondaryCd_elem" );
  }
