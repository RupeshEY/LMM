...
public class CURRENCY extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.types.complex.CURRENCY> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.types.complex.CURRENCY get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.resp.anonymous.elements.CURRENCY_Amt getAmt_elem() {
    return (xsd.iso.resp.anonymous.elements.CURRENCY_Amt) TYPE.get().getPropertyValue( this, "_Amt_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.CURRENCY_CurCd getCurCd_elem() {
    return (xsd.iso.resp.anonymous.elements.CURRENCY_CurCd) TYPE.get().getPropertyValue( this, "_CurCd_elem" );
  }
