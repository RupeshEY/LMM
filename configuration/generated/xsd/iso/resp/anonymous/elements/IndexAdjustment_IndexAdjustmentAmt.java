...
public final class IndexAdjustment_IndexAdjustmentAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.IndexAdjustment_IndexAdjustmentAmt" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.types.complex.IndexAdjustment_IndexAdjustmentAmt" );
    }
  };

  public IndexAdjustment_IndexAdjustmentAmt() {
    super( -284558449, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.IndexAdjustment_IndexAdjustmentAmt() );
  }

  public IndexAdjustment_IndexAdjustmentAmt( xsd.iso.resp.anonymous.types.complex.IndexAdjustment_IndexAdjustmentAmt typeInstance ) {
    super( -284558449, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private IndexAdjustment_IndexAdjustmentAmt( gw.internal.xml.XmlElementState state ) {
    super( -284558449, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.IndexAdjustment_IndexAdjustmentAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.IndexAdjustment_IndexAdjustmentAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.IndexAdjustment_IndexAdjustmentAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.IndexAdjustment_IndexAdjustmentAmt typeInstance ) {
