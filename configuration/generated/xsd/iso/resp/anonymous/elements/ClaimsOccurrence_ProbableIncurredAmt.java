...
public final class ClaimsOccurrence_ProbableIncurredAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.ClaimsOccurrence_ProbableIncurredAmt" );
    }
  };
  ...
  public ClaimsOccurrence_ProbableIncurredAmt() {
    super( 355114674, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.ClaimsOccurrence_ProbableIncurredAmt() );
  }

  public ClaimsOccurrence_ProbableIncurredAmt( xsd.iso.resp.anonymous.types.complex.ClaimsOccurrence_ProbableIncurredAmt typeInstance ) {
    super( 355114674, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsOccurrence_ProbableIncurredAmt( gw.internal.xml.XmlElementState state ) {
    super( 355114674, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.ClaimsOccurrence_ProbableIncurredAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.ClaimsOccurrence_ProbableIncurredAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.ClaimsOccurrence_ProbableIncurredAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.ClaimsOccurrence_ProbableIncurredAmt typeInstance ) {
