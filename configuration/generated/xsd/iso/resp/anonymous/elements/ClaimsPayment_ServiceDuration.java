...
public final class ClaimsPayment_ServiceDuration extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.ClaimsPayment_ServiceDuration" );
    }
  };
  ...
  public ClaimsPayment_ServiceDuration() {
    super( -2085195789, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.ClaimsPayment_ServiceDuration() );
  }

  public ClaimsPayment_ServiceDuration( xsd.iso.resp.anonymous.types.complex.ClaimsPayment_ServiceDuration typeInstance ) {
    super( -2085195789, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsPayment_ServiceDuration( gw.internal.xml.XmlElementState state ) {
    super( -2085195789, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.ClaimsPayment_ServiceDuration> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.ClaimsPayment_ServiceDuration get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.ClaimsPayment_ServiceDuration.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.ClaimsPayment_ServiceDuration typeInstance ) {
