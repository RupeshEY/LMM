...
public final class AppraiserActivityInfo_AppraisedValueAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.AppraiserActivityInfo_AppraisedValueAmt" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.types.complex.AppraiserActivityInfo_AppraisedValueAmt" );
    }
  };

  public AppraiserActivityInfo_AppraisedValueAmt() {
    super( -713450257, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.AppraiserActivityInfo_AppraisedValueAmt() );
  }

  public AppraiserActivityInfo_AppraisedValueAmt( xsd.iso.resp.anonymous.types.complex.AppraiserActivityInfo_AppraisedValueAmt typeInstance ) {
    super( -713450257, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private AppraiserActivityInfo_AppraisedValueAmt( gw.internal.xml.XmlElementState state ) {
    super( -713450257, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.AppraiserActivityInfo_AppraisedValueAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.AppraiserActivityInfo_AppraisedValueAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.AppraiserActivityInfo_AppraisedValueAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.AppraiserActivityInfo_AppraisedValueAmt typeInstance ) {
