...
public final class LiabilityLossInfo_ProbableIncurredAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.LiabilityLossInfo_ProbableIncurredAmt" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.types.complex.LiabilityLossInfo_ProbableIncurredAmt" );
    }
  };

  public LiabilityLossInfo_ProbableIncurredAmt() {
    super( -398201380, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.LiabilityLossInfo_ProbableIncurredAmt() );
  }

  public LiabilityLossInfo_ProbableIncurredAmt( xsd.iso.resp.anonymous.types.complex.LiabilityLossInfo_ProbableIncurredAmt typeInstance ) {
    super( -398201380, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private LiabilityLossInfo_ProbableIncurredAmt( gw.internal.xml.XmlElementState state ) {
    super( -398201380, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.LiabilityLossInfo_ProbableIncurredAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.LiabilityLossInfo_ProbableIncurredAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.LiabilityLossInfo_ProbableIncurredAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.LiabilityLossInfo_ProbableIncurredAmt typeInstance ) {
