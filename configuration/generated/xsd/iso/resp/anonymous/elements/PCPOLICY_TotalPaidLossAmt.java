...
public final class PCPOLICY_TotalPaidLossAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.PCPOLICY_TotalPaidLossAmt" );
    }
  };
  ...
  public PCPOLICY_TotalPaidLossAmt() {
    super( -164598455, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.PCPOLICY_TotalPaidLossAmt() );
  }

  public PCPOLICY_TotalPaidLossAmt( xsd.iso.resp.anonymous.types.complex.PCPOLICY_TotalPaidLossAmt typeInstance ) {
    super( -164598455, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCPOLICY_TotalPaidLossAmt( gw.internal.xml.XmlElementState state ) {
    super( -164598455, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.PCPOLICY_TotalPaidLossAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.PCPOLICY_TotalPaidLossAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.PCPOLICY_TotalPaidLossAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.PCPOLICY_TotalPaidLossAmt typeInstance ) {
