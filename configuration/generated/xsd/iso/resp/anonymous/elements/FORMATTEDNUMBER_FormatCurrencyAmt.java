...
public final class FORMATTEDNUMBER_FormatCurrencyAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.FORMATTEDNUMBER_FormatCurrencyAmt" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.types.complex.FORMATTEDNUMBER_FormatCurrencyAmt" );
    }
  };

  public FORMATTEDNUMBER_FormatCurrencyAmt() {
    super( 1947624000, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.FORMATTEDNUMBER_FormatCurrencyAmt() );
  }

  public FORMATTEDNUMBER_FormatCurrencyAmt( xsd.iso.resp.anonymous.types.complex.FORMATTEDNUMBER_FormatCurrencyAmt typeInstance ) {
    super( 1947624000, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private FORMATTEDNUMBER_FormatCurrencyAmt( gw.internal.xml.XmlElementState state ) {
    super( 1947624000, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.FORMATTEDNUMBER_FormatCurrencyAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.FORMATTEDNUMBER_FormatCurrencyAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.FORMATTEDNUMBER_FormatCurrencyAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.FORMATTEDNUMBER_FormatCurrencyAmt typeInstance ) {
