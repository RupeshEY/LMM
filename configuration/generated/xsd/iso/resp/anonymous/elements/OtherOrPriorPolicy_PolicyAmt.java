...
public final class OtherOrPriorPolicy_PolicyAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyAmt" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.types.complex.OtherOrPriorPolicy_PolicyAmt" );
    }
  };

  public OtherOrPriorPolicy_PolicyAmt() {
    super( 1440300550, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.OtherOrPriorPolicy_PolicyAmt() );
  }

  public OtherOrPriorPolicy_PolicyAmt( xsd.iso.resp.anonymous.types.complex.OtherOrPriorPolicy_PolicyAmt typeInstance ) {
    super( 1440300550, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private OtherOrPriorPolicy_PolicyAmt( gw.internal.xml.XmlElementState state ) {
    super( 1440300550, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.OtherOrPriorPolicy_PolicyAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.OtherOrPriorPolicy_PolicyAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.OtherOrPriorPolicy_PolicyAmt typeInstance ) {
