...
public final class ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields" );
    }
  };
  ...
  public ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields() {
    super( 1837638648, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields() );
  }

  public ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields( xsd.iso.resp.anonymous.types.complex.ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields typeInstance ) {
    super( 1837638648, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields( gw.internal.xml.XmlElementState state ) {
    super( 1837638648, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields typeInstance ) {
  ...
  public final xsd.iso.resp.anonymous.elements.ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields_PolicyNumber getPolicyNumber_elem() {
    return (xsd.iso.resp.anonymous.elements.ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields_PolicyNumber) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_PolicyNumber_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields_LossDt getLossDt_elem() {
    return (xsd.iso.resp.anonymous.elements.ComIso_Update_ComIso_OriginalFields_ComIso_KeyFields_LossDt) TYPEINSTANCETYPE.get().getPropertyValue( get$TypeInstance(), "_LossDt_elem" );
  }
