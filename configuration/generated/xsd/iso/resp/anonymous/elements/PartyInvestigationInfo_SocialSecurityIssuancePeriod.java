...
public final class PartyInvestigationInfo_SocialSecurityIssuancePeriod extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.PartyInvestigationInfo_SocialSecurityIssuancePeriod" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.types.complex.PartyInvestigationInfo_SocialSecurityIssuancePeriod" );
    }
  };

  public PartyInvestigationInfo_SocialSecurityIssuancePeriod() {
    super( 273041400, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.PartyInvestigationInfo_SocialSecurityIssuancePeriod() );
  }

  public PartyInvestigationInfo_SocialSecurityIssuancePeriod( xsd.iso.resp.anonymous.types.complex.PartyInvestigationInfo_SocialSecurityIssuancePeriod typeInstance ) {
    super( 273041400, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PartyInvestigationInfo_SocialSecurityIssuancePeriod( gw.internal.xml.XmlElementState state ) {
    super( 273041400, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.PartyInvestigationInfo_SocialSecurityIssuancePeriod> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.PartyInvestigationInfo_SocialSecurityIssuancePeriod get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.PartyInvestigationInfo_SocialSecurityIssuancePeriod.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.PartyInvestigationInfo_SocialSecurityIssuancePeriod typeInstance ) {
