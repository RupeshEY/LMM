...
public final class PCVEH_CostNewAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.PCVEH_CostNewAmt" );
    }
  };
  ...
  public PCVEH_CostNewAmt() {
    super( -678014316, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.PCVEH_CostNewAmt() );
  }

  public PCVEH_CostNewAmt( xsd.iso.resp.anonymous.types.complex.PCVEH_CostNewAmt typeInstance ) {
    super( -678014316, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCVEH_CostNewAmt( gw.internal.xml.XmlElementState state ) {
    super( -678014316, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.PCVEH_CostNewAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.PCVEH_CostNewAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.PCVEH_CostNewAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.PCVEH_CostNewAmt typeInstance ) {
