...
public final class ConversionRate_TargetCurrency extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.ConversionRate_TargetCurrency" );
    }
  };
  ...
  public ConversionRate_TargetCurrency() {
    super( 1336955845, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.ConversionRate_TargetCurrency() );
  }

  public ConversionRate_TargetCurrency( xsd.iso.resp.anonymous.types.complex.ConversionRate_TargetCurrency typeInstance ) {
    super( 1336955845, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ConversionRate_TargetCurrency( gw.internal.xml.XmlElementState state ) {
    super( 1336955845, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.ConversionRate_TargetCurrency> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.ConversionRate_TargetCurrency get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.ConversionRate_TargetCurrency.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.ConversionRate_TargetCurrency typeInstance ) {
