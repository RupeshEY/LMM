...
public final class PaymentOption_CollectedByAgentAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.PaymentOption_CollectedByAgentAmt" );
    }
  };
  ...
  public PaymentOption_CollectedByAgentAmt() {
    super( -1363254407, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.PaymentOption_CollectedByAgentAmt() );
  }

  public PaymentOption_CollectedByAgentAmt( xsd.iso.resp.anonymous.types.complex.PaymentOption_CollectedByAgentAmt typeInstance ) {
    super( -1363254407, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PaymentOption_CollectedByAgentAmt( gw.internal.xml.XmlElementState state ) {
    super( -1363254407, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.PaymentOption_CollectedByAgentAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.PaymentOption_CollectedByAgentAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.PaymentOption_CollectedByAgentAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.PaymentOption_CollectedByAgentAmt typeInstance ) {
