...
public final class PCBASICWATERCRAFT_PurchasePriceAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.PCBASICWATERCRAFT_PurchasePriceAmt" );
    }
  };
  ...
  public PCBASICWATERCRAFT_PurchasePriceAmt() {
    super( -847139647, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.PCBASICWATERCRAFT_PurchasePriceAmt() );
  }

  public PCBASICWATERCRAFT_PurchasePriceAmt( xsd.iso.resp.anonymous.types.complex.PCBASICWATERCRAFT_PurchasePriceAmt typeInstance ) {
    super( -847139647, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCBASICWATERCRAFT_PurchasePriceAmt( gw.internal.xml.XmlElementState state ) {
    super( -847139647, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.PCBASICWATERCRAFT_PurchasePriceAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.PCBASICWATERCRAFT_PurchasePriceAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.PCBASICWATERCRAFT_PurchasePriceAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.PCBASICWATERCRAFT_PurchasePriceAmt typeInstance ) {
