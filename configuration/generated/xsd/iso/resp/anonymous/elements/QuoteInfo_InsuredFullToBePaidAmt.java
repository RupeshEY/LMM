...
public final class QuoteInfo_InsuredFullToBePaidAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.QuoteInfo_InsuredFullToBePaidAmt" );
    }
  };
  ...
  public QuoteInfo_InsuredFullToBePaidAmt() {
    super( 1184667360, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.QuoteInfo_InsuredFullToBePaidAmt() );
  }

  public QuoteInfo_InsuredFullToBePaidAmt( xsd.iso.resp.anonymous.types.complex.QuoteInfo_InsuredFullToBePaidAmt typeInstance ) {
    super( 1184667360, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private QuoteInfo_InsuredFullToBePaidAmt( gw.internal.xml.XmlElementState state ) {
    super( 1184667360, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.QuoteInfo_InsuredFullToBePaidAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.QuoteInfo_InsuredFullToBePaidAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.QuoteInfo_InsuredFullToBePaidAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.QuoteInfo_InsuredFullToBePaidAmt typeInstance ) {
