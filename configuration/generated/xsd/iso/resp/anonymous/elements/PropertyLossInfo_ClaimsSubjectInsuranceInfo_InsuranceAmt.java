...
public final class PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt" );
    }
  };
  ...
  public PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt() {
    super( 714356583, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.types.complex.CURRENCY() );
  }

  public PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt( xsd.iso.resp.types.complex.CURRENCY typeInstance ) {
    super( 714356583, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt( gw.internal.xml.XmlElementState state ) {
    super( 714356583, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.PropertyLossInfo_ClaimsSubjectInsuranceInfo_InsuranceAmt> get$Class() {
    return getClass();
  }
