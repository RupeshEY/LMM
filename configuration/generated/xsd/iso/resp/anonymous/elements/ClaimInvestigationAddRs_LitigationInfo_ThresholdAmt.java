...
public final class ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.types.complex.ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt" );
    }
  };

  public ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt() {
    super( -1207140699, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt() );
  }

  public ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt( xsd.iso.resp.anonymous.types.complex.ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt typeInstance ) {
    super( -1207140699, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt( gw.internal.xml.XmlElementState state ) {
    super( -1207140699, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.ClaimInvestigationAddRs_LitigationInfo_ThresholdAmt typeInstance ) {
