...
public final class CommlVehSupplement_FinancedAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.CommlVehSupplement_FinancedAmt" );
    }
  };
  ...
  public CommlVehSupplement_FinancedAmt() {
    super( -1591585897, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.types.complex.CURRENCY() );
  }

  public CommlVehSupplement_FinancedAmt( xsd.iso.resp.types.complex.CURRENCY typeInstance ) {
    super( -1591585897, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CommlVehSupplement_FinancedAmt( gw.internal.xml.XmlElementState state ) {
    super( -1591585897, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.CommlVehSupplement_FinancedAmt> get$Class() {
    return getClass();
  }
