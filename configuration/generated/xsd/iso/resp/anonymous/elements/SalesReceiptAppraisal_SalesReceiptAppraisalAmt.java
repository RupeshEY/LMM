...
public final class SalesReceiptAppraisal_SalesReceiptAppraisalAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.SalesReceiptAppraisal_SalesReceiptAppraisalAmt" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.types.complex.SalesReceiptAppraisal_SalesReceiptAppraisalAmt" );
    }
  };

  public SalesReceiptAppraisal_SalesReceiptAppraisalAmt() {
    super( 865743835, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.SalesReceiptAppraisal_SalesReceiptAppraisalAmt() );
  }

  public SalesReceiptAppraisal_SalesReceiptAppraisalAmt( xsd.iso.resp.anonymous.types.complex.SalesReceiptAppraisal_SalesReceiptAppraisalAmt typeInstance ) {
    super( 865743835, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private SalesReceiptAppraisal_SalesReceiptAppraisalAmt( gw.internal.xml.XmlElementState state ) {
    super( 865743835, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.SalesReceiptAppraisal_SalesReceiptAppraisalAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.SalesReceiptAppraisal_SalesReceiptAppraisalAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.SalesReceiptAppraisal_SalesReceiptAppraisalAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.SalesReceiptAppraisal_SalesReceiptAppraisalAmt typeInstance ) {
