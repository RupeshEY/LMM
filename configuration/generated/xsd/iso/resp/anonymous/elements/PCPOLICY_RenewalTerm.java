...
public final class PCPOLICY_RenewalTerm extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.PCPOLICY_RenewalTerm" );
    }
  };
  ...
  public PCPOLICY_RenewalTerm() {
    super( 274506640, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.PCPOLICY_RenewalTerm() );
  }

  public PCPOLICY_RenewalTerm( xsd.iso.resp.anonymous.types.complex.PCPOLICY_RenewalTerm typeInstance ) {
    super( 274506640, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCPOLICY_RenewalTerm( gw.internal.xml.XmlElementState state ) {
    super( 274506640, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.PCPOLICY_RenewalTerm> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.PCPOLICY_RenewalTerm get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.PCPOLICY_RenewalTerm.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.PCPOLICY_RenewalTerm typeInstance ) {
