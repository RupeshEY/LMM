...
public final class ClaimsInjuredInfo_TimeLostPeriod extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.ClaimsInjuredInfo_TimeLostPeriod" );
    }
  };
  ...
  public ClaimsInjuredInfo_TimeLostPeriod() {
    super( 413743519, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.ClaimsInjuredInfo_TimeLostPeriod() );
  }

  public ClaimsInjuredInfo_TimeLostPeriod( xsd.iso.resp.anonymous.types.complex.ClaimsInjuredInfo_TimeLostPeriod typeInstance ) {
    super( 413743519, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsInjuredInfo_TimeLostPeriod( gw.internal.xml.XmlElementState state ) {
    super( 413743519, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.ClaimsInjuredInfo_TimeLostPeriod> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.ClaimsInjuredInfo_TimeLostPeriod get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.ClaimsInjuredInfo_TimeLostPeriod.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.ClaimsInjuredInfo_TimeLostPeriod typeInstance ) {
