...
public final class CommlVehSupplement_LeasedAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.CommlVehSupplement_LeasedAmt" );
    }
  };
  ...
  public CommlVehSupplement_LeasedAmt() {
    super( 1954036823, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.types.complex.CURRENCY() );
  }

  public CommlVehSupplement_LeasedAmt( xsd.iso.resp.types.complex.CURRENCY typeInstance ) {
    super( 1954036823, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CommlVehSupplement_LeasedAmt( gw.internal.xml.XmlElementState state ) {
    super( 1954036823, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.CommlVehSupplement_LeasedAmt> get$Class() {
    return getClass();
  }
