...
public final class SalvageInfo_ItemAppraisedValueAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.SalvageInfo_ItemAppraisedValueAmt" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.types.complex.SalvageInfo_ItemAppraisedValueAmt" );
    }
  };

  public SalvageInfo_ItemAppraisedValueAmt() {
    super( -1104929299, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.SalvageInfo_ItemAppraisedValueAmt() );
  }

  public SalvageInfo_ItemAppraisedValueAmt( xsd.iso.resp.anonymous.types.complex.SalvageInfo_ItemAppraisedValueAmt typeInstance ) {
    super( -1104929299, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private SalvageInfo_ItemAppraisedValueAmt( gw.internal.xml.XmlElementState state ) {
    super( -1104929299, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.SalvageInfo_ItemAppraisedValueAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.SalvageInfo_ItemAppraisedValueAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.SalvageInfo_ItemAppraisedValueAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.SalvageInfo_ItemAppraisedValueAmt typeInstance ) {
