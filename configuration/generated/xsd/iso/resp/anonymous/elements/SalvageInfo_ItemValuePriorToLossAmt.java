...
public final class SalvageInfo_ItemValuePriorToLossAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.SalvageInfo_ItemValuePriorToLossAmt" );
    }
  };
  ...
  public SalvageInfo_ItemValuePriorToLossAmt() {
    super( 1947356782, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.SalvageInfo_ItemValuePriorToLossAmt() );
  }

  public SalvageInfo_ItemValuePriorToLossAmt( xsd.iso.resp.anonymous.types.complex.SalvageInfo_ItemValuePriorToLossAmt typeInstance ) {
    super( 1947356782, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private SalvageInfo_ItemValuePriorToLossAmt( gw.internal.xml.XmlElementState state ) {
    super( 1947356782, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.SalvageInfo_ItemValuePriorToLossAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.SalvageInfo_ItemValuePriorToLossAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.SalvageInfo_ItemValuePriorToLossAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.SalvageInfo_ItemValuePriorToLossAmt typeInstance ) {
