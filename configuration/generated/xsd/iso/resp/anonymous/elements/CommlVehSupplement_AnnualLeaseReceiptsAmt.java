...
public final class CommlVehSupplement_AnnualLeaseReceiptsAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.CommlVehSupplement_AnnualLeaseReceiptsAmt" );
    }
  };
  ...
  public CommlVehSupplement_AnnualLeaseReceiptsAmt() {
    super( -252615623, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.types.complex.CURRENCY() );
  }

  public CommlVehSupplement_AnnualLeaseReceiptsAmt( xsd.iso.resp.types.complex.CURRENCY typeInstance ) {
    super( -252615623, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CommlVehSupplement_AnnualLeaseReceiptsAmt( gw.internal.xml.XmlElementState state ) {
    super( -252615623, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.CommlVehSupplement_AnnualLeaseReceiptsAmt> get$Class() {
    return getClass();
  }
