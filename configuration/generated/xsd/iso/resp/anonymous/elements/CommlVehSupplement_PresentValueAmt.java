...
public final class CommlVehSupplement_PresentValueAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.CommlVehSupplement_PresentValueAmt" );
    }
  };
  ...
  public CommlVehSupplement_PresentValueAmt() {
    super( 1433437675, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.types.complex.CURRENCY() );
  }

  public CommlVehSupplement_PresentValueAmt( xsd.iso.resp.types.complex.CURRENCY typeInstance ) {
    super( 1433437675, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private CommlVehSupplement_PresentValueAmt( gw.internal.xml.XmlElementState state ) {
    super( 1433437675, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.CommlVehSupplement_PresentValueAmt> get$Class() {
    return getClass();
  }
