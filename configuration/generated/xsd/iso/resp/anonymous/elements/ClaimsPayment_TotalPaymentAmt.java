...
public final class ClaimsPayment_TotalPaymentAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.ClaimsPayment_TotalPaymentAmt" );
    }
  };
  ...
  public ClaimsPayment_TotalPaymentAmt() {
    super( -53724976, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.ClaimsPayment_TotalPaymentAmt() );
  }

  public ClaimsPayment_TotalPaymentAmt( xsd.iso.resp.anonymous.types.complex.ClaimsPayment_TotalPaymentAmt typeInstance ) {
    super( -53724976, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsPayment_TotalPaymentAmt( gw.internal.xml.XmlElementState state ) {
    super( -53724976, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.ClaimsPayment_TotalPaymentAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.ClaimsPayment_TotalPaymentAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.ClaimsPayment_TotalPaymentAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.ClaimsPayment_TotalPaymentAmt typeInstance ) {
