...
public final class PCBASICWATERCRAFT_CostNewAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.PCBASICWATERCRAFT_CostNewAmt" );
    }
  };
  ...
  public PCBASICWATERCRAFT_CostNewAmt() {
    super( -550456362, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.PCBASICWATERCRAFT_CostNewAmt() );
  }

  public PCBASICWATERCRAFT_CostNewAmt( xsd.iso.resp.anonymous.types.complex.PCBASICWATERCRAFT_CostNewAmt typeInstance ) {
    super( -550456362, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCBASICWATERCRAFT_CostNewAmt( gw.internal.xml.XmlElementState state ) {
    super( -550456362, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.PCBASICWATERCRAFT_CostNewAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.PCBASICWATERCRAFT_CostNewAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.PCBASICWATERCRAFT_CostNewAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.PCBASICWATERCRAFT_CostNewAmt typeInstance ) {
