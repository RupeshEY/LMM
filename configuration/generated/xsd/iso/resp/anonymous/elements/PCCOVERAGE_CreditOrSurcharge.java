...
public final class PCCOVERAGE_CreditOrSurcharge extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.PCCOVERAGE_CreditOrSurcharge" );
    }
  };
  ...
  public PCCOVERAGE_CreditOrSurcharge() {
    super( -1217628886, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.PCCOVERAGE_CreditOrSurcharge() );
  }

  public PCCOVERAGE_CreditOrSurcharge( xsd.iso.resp.anonymous.types.complex.PCCOVERAGE_CreditOrSurcharge typeInstance ) {
    super( -1217628886, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private PCCOVERAGE_CreditOrSurcharge( gw.internal.xml.XmlElementState state ) {
    super( -1217628886, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.PCCOVERAGE_CreditOrSurcharge> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.PCCOVERAGE_CreditOrSurcharge get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.PCCOVERAGE_CreditOrSurcharge.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.PCCOVERAGE_CreditOrSurcharge typeInstance ) {
