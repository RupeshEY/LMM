...
public final class ElectronicFundsTransfer_TransferAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.ElectronicFundsTransfer_TransferAmt" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.types.complex.ElectronicFundsTransfer_TransferAmt" );
    }
  };

  public ElectronicFundsTransfer_TransferAmt() {
    super( -31478059, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.ElectronicFundsTransfer_TransferAmt() );
  }

  public ElectronicFundsTransfer_TransferAmt( xsd.iso.resp.anonymous.types.complex.ElectronicFundsTransfer_TransferAmt typeInstance ) {
    super( -31478059, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ElectronicFundsTransfer_TransferAmt( gw.internal.xml.XmlElementState state ) {
    super( -31478059, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.ElectronicFundsTransfer_TransferAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.ElectronicFundsTransfer_TransferAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.ElectronicFundsTransfer_TransferAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.ElectronicFundsTransfer_TransferAmt typeInstance ) {
