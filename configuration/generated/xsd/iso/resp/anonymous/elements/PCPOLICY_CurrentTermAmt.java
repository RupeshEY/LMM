...
public final class PCPOLICY_CurrentTermAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.PCPOLICY_CurrentTermAmt" );
    }
  };
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl> TYPEINSTANCETYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlTypeInstanceTypeDataImpl>() {
    @java.lang.Override
    public gw.internal.xml.XmlTypeInstanceTypeDataImpl init() {
      return (gw.internal.xml.XmlTypeInstanceTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.types.complex.PCPOLICY_CurrentTermAmt" );
    }
  };

  public PCPOLICY_CurrentTermAmt() {
    super( 7162615, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.PCPOLICY_CurrentTermAmt() );
  }

  public PCPOLICY_CurrentTermAmt( xsd.iso.resp.anonymous.types.complex.PCPOLICY_CurrentTermAmt typeInstance ) {
    super( 7162615, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.PCPOLICY_CurrentTermAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.PCPOLICY_CurrentTermAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.PCPOLICY_CurrentTermAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.PCPOLICY_CurrentTermAmt typeInstance ) {
