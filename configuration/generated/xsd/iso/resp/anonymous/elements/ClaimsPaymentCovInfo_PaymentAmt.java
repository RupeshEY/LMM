...
public final class ClaimsPaymentCovInfo_PaymentAmt extends gw.xml.XmlElement {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlElementTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlElementTypeDataImpl init() {
      return (gw.internal.xml.XmlElementTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.elements.ClaimsPaymentCovInfo_PaymentAmt" );
    }
  };
  ...
  public ClaimsPaymentCovInfo_PaymentAmt() {
    super( 1950401554, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), new xsd.iso.resp.anonymous.types.complex.ClaimsPaymentCovInfo_PaymentAmt() );
  }

  public ClaimsPaymentCovInfo_PaymentAmt( xsd.iso.resp.anonymous.types.complex.ClaimsPaymentCovInfo_PaymentAmt typeInstance ) {
    super( 1950401554, $QNAME, TYPE.get(), TYPEINSTANCETYPE.get(), typeInstance );
  }

  private ClaimsPaymentCovInfo_PaymentAmt( gw.internal.xml.XmlElementState state ) {
    super( 1950401554, state );
  }
  ...
  @java.lang.Override
  public final java.lang.Class<? extends xsd.iso.resp.anonymous.elements.ClaimsPaymentCovInfo_PaymentAmt> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public final xsd.iso.resp.anonymous.types.complex.ClaimsPaymentCovInfo_PaymentAmt get$TypeInstance() {
    return super.get$TypeInstance().cast( xsd.iso.resp.anonymous.types.complex.ClaimsPaymentCovInfo_PaymentAmt.class );
  }

  public final void set$TypeInstance( xsd.iso.resp.anonymous.types.complex.ClaimsPaymentCovInfo_PaymentAmt typeInstance ) {
