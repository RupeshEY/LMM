...
public final class ClaimInvestigationAddRq_ComIso_AddCovInfo_ComIso_CovInfo1_ItemRef {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.attributes.ClaimInvestigationAddRq_ComIso_AddCovInfo_ComIso_CovInfo1_ItemRef" );
    }
  };

  // disable public constructor
  private ClaimInvestigationAddRq_ComIso_AddCovInfo_ComIso_CovInfo1_ItemRef() {
  }
