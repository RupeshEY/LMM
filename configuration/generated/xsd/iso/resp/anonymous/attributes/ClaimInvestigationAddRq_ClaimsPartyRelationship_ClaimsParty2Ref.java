...
public final class ClaimInvestigationAddRq_ClaimsPartyRelationship_ClaimsParty2Ref {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.attributes.ClaimInvestigationAddRq_ClaimsPartyRelationship_ClaimsParty2Ref" );
    }
  };

  // disable public constructor
  private ClaimInvestigationAddRq_ClaimsPartyRelationship_ClaimsParty2Ref() {
  }
