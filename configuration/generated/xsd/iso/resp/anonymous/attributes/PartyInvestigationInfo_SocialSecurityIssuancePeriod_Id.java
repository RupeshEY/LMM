...
public final class PartyInvestigationInfo_SocialSecurityIssuancePeriod_Id {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.attributes.PartyInvestigationInfo_SocialSecurityIssuancePeriod_Id" );
    }
  };

  // disable public constructor
  private PartyInvestigationInfo_SocialSecurityIssuancePeriod_Id() {
  }
