...
public final class AppraiserActivityInfo_AppraiserRef {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "AppraiserRef", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.attributes.AppraiserActivityInfo_AppraiserRef" );
    }
  };

  // disable public constructor
  private AppraiserActivityInfo_AppraiserRef() {
  }
