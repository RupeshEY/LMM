...
public final class AutoInvestigationInfo_ImpoundFacilityRef {

  public static final javax.xml.namespace.QName $QNAME = new javax.xml.namespace.QName( "", "ImpoundFacilityRef", "" );
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.attributes.AutoInvestigationInfo_ImpoundFacilityRef" );
    }
  };

  // disable public constructor
  private AutoInvestigationInfo_ImpoundFacilityRef() {
  }
