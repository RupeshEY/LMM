...
public final class ComIso_AppendDS_GeneralPartyInfo_PreferredContact_BlackoutDuration_Id {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.attributes.ComIso_AppendDS_GeneralPartyInfo_PreferredContact_BlackoutDuration_Id" );
    }
  };

  // disable public constructor
  private ComIso_AppendDS_GeneralPartyInfo_PreferredContact_BlackoutDuration_Id() {
  }
