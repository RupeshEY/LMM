...
public final class ClaimInvestigationAddRs_ComIso_AddCovInfo_ComIso_CovInfo1_ComIso_TPOCAmt_Id {
  ...
  private static final gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl> TYPE = new gw.internal.xml.util.LockingLazyVar<gw.internal.xml.XmlAttributeTypeDataImpl>() {
    ...
    public gw.internal.xml.XmlAttributeTypeDataImpl init() {
      return (gw.internal.xml.XmlAttributeTypeDataImpl) ( (gw.internal.xml.XmlSchemaAccessImpl) xsd.iso.resp.util.SchemaAccess ).getSchemaIndex().getTypeData( "xsd.iso.resp.anonymous.attributes.ClaimInvestigationAddRs_ComIso_AddCovInfo_ComIso_CovInfo1_ComIso_TPOCAmt_Id" );
    }
  };

  // disable public constructor
  private ClaimInvestigationAddRs_ComIso_AddCovInfo_ComIso_CovInfo1_ComIso_TPOCAmt_Id() {
  }
