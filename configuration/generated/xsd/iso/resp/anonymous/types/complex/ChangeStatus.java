...
public class ChangeStatus extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.ChangeStatus> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.ChangeStatus get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ChangeStatus_ActionCd getActionCd() {
    return (xsd.iso.resp.anonymous.elements.ChangeStatus_ActionCd) TYPE.get().getPropertyValue( this, "_ActionCd" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ChangeStatus_PreviousValue getPreviousValue() {
    return (xsd.iso.resp.anonymous.elements.ChangeStatus_PreviousValue) TYPE.get().getPropertyValue( this, "_PreviousValue" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ChangeStatus_RefNameCd getRefNameCd() {
    return (xsd.iso.resp.anonymous.elements.ChangeStatus_RefNameCd) TYPE.get().getPropertyValue( this, "_RefNameCd" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ChangeStatus_ChangeDesc getChangeDesc() {
    return (xsd.iso.resp.anonymous.elements.ChangeStatus_ChangeDesc) TYPE.get().getPropertyValue( this, "_ChangeDesc" );
  }
