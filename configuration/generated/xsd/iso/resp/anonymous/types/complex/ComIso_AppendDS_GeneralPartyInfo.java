...
public class ComIso_AppendDS_GeneralPartyInfo extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  public ComIso_AppendDS_GeneralPartyInfo() {
    super( 796986283, TYPE.get() );
  }

  private ComIso_AppendDS_GeneralPartyInfo( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 796986283, state );
  }

  protected ComIso_AppendDS_GeneralPartyInfo( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ComIso_AppendDS_GeneralPartyInfo( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.ComIso_AppendDS_GeneralPartyInfo> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.ComIso_AppendDS_GeneralPartyInfo get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.iso.resp.anonymous.elements.ComIso_AppendDS_GeneralPartyInfo_PreferredContact> getPreferredContact() {
    return (java.util.List<xsd.iso.resp.anonymous.elements.ComIso_AppendDS_GeneralPartyInfo_PreferredContact>) TYPE.get().getPropertyValue( this, "_PreferredContact" );
  }
