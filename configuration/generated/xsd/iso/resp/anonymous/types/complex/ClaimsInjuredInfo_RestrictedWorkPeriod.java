...
public class ClaimsInjuredInfo_RestrictedWorkPeriod extends xsd.iso.resp.types.complex.DURATION {
  ...
  public ClaimsInjuredInfo_RestrictedWorkPeriod() {
    super( -1709007784, TYPE.get() );
  }

  private ClaimsInjuredInfo_RestrictedWorkPeriod( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -1709007784, state );
  }

  protected ClaimsInjuredInfo_RestrictedWorkPeriod( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected ClaimsInjuredInfo_RestrictedWorkPeriod( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.ClaimsInjuredInfo_RestrictedWorkPeriod> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.ClaimsInjuredInfo_RestrictedWorkPeriod get$TypeInstance() {
    return this;
  }
