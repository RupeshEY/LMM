...
public class Binder_ContractTerm extends xsd.iso.resp.types.complex.DURATION {
  ...
  public Binder_ContractTerm() {
    super( 324128463, TYPE.get() );
  }

  private Binder_ContractTerm( gw.internal.xml.XmlTypeInstanceState state ) {
    super( 324128463, state );
  }

  protected Binder_ContractTerm( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected Binder_ContractTerm( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.Binder_ContractTerm> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.Binder_ContractTerm get$TypeInstance() {
    return this;
  }
