...
public class PartyInvestigationInfo_SocialSecurityIssuancePeriod extends xsd.iso.resp.types.complex.DURATION {
  ...
  public PartyInvestigationInfo_SocialSecurityIssuancePeriod() {
    super( -2090726790, TYPE.get() );
  }

  private PartyInvestigationInfo_SocialSecurityIssuancePeriod( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -2090726790, state );
  }

  protected PartyInvestigationInfo_SocialSecurityIssuancePeriod( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected PartyInvestigationInfo_SocialSecurityIssuancePeriod( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.PartyInvestigationInfo_SocialSecurityIssuancePeriod> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.PartyInvestigationInfo_SocialSecurityIssuancePeriod get$TypeInstance() {
    return this;
  }
