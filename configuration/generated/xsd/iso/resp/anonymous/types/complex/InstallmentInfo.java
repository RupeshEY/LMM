...
public class InstallmentInfo extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.InstallmentInfo> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.InstallmentInfo get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.resp.anonymous.elements.InstallmentInfo_InstallmentAmt getInstallmentAmt() {
    return (xsd.iso.resp.anonymous.elements.InstallmentInfo_InstallmentAmt) TYPE.get().getPropertyValue( this, "_InstallmentAmt" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.InstallmentInfo_InstallmentDueDt getInstallmentDueDt_elem() {
    return (xsd.iso.resp.anonymous.elements.InstallmentInfo_InstallmentDueDt) TYPE.get().getPropertyValue( this, "_InstallmentDueDt_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.InstallmentInfo_InstallmentNumber getInstallmentNumber_elem() {
    return (xsd.iso.resp.anonymous.elements.InstallmentInfo_InstallmentNumber) TYPE.get().getPropertyValue( this, "_InstallmentNumber_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.InstallmentInfo_FirstInstallmentPct getFirstInstallmentPct_elem() {
    return (xsd.iso.resp.anonymous.elements.InstallmentInfo_FirstInstallmentPct) TYPE.get().getPropertyValue( this, "_FirstInstallmentPct_elem" );
  }
