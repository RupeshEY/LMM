...
public class ClaimsPayment extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.ClaimsPayment> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.ClaimsPayment get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ClaimsPayment_PaymentTypeCd getPaymentTypeCd_elem() {
    return (xsd.iso.resp.anonymous.elements.ClaimsPayment_PaymentTypeCd) TYPE.get().getPropertyValue( this, "_PaymentTypeCd_elem" );
  }
  ...
  public final java.util.List<xsd.iso.resp.ClaimsPaymentCovInfo> getClaimsPaymentCovInfo() {
    return (java.util.List<xsd.iso.resp.ClaimsPaymentCovInfo>) TYPE.get().getPropertyValue( this, "_ClaimsPaymentCovInfo" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ClaimsPayment_TotalPaymentAmt getTotalPaymentAmt() {
    return (xsd.iso.resp.anonymous.elements.ClaimsPayment_TotalPaymentAmt) TYPE.get().getPropertyValue( this, "_TotalPaymentAmt" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ClaimsPayment_LossCauseCd getLossCauseCd_elem() {
    return (xsd.iso.resp.anonymous.elements.ClaimsPayment_LossCauseCd) TYPE.get().getPropertyValue( this, "_LossCauseCd_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ClaimsPayment_MethodPaymentCd getMethodPaymentCd_elem() {
    return (xsd.iso.resp.anonymous.elements.ClaimsPayment_MethodPaymentCd) TYPE.get().getPropertyValue( this, "_MethodPaymentCd_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ClaimsPayment_CheckNumber getCheckNumber_elem() {
    return (xsd.iso.resp.anonymous.elements.ClaimsPayment_CheckNumber) TYPE.get().getPropertyValue( this, "_CheckNumber_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ClaimsPayment_PaymentDt getPaymentDt_elem() {
    return (xsd.iso.resp.anonymous.elements.ClaimsPayment_PaymentDt) TYPE.get().getPropertyValue( this, "_PaymentDt_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ClaimsPayment_ServiceDuration getServiceDuration() {
    return (xsd.iso.resp.anonymous.elements.ClaimsPayment_ServiceDuration) TYPE.get().getPropertyValue( this, "_ServiceDuration" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ClaimsPayment_PaymentDesc getPaymentDesc_elem() {
    return (xsd.iso.resp.anonymous.elements.ClaimsPayment_PaymentDesc) TYPE.get().getPropertyValue( this, "_PaymentDesc_elem" );
  }
