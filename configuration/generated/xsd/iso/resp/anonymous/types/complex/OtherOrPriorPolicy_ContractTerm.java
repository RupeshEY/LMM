...
public class OtherOrPriorPolicy_ContractTerm extends xsd.iso.resp.types.complex.DURATION {
  ...
  public OtherOrPriorPolicy_ContractTerm() {
    super( -288485552, TYPE.get() );
  }

  private OtherOrPriorPolicy_ContractTerm( gw.internal.xml.XmlTypeInstanceState state ) {
    super( -288485552, state );
  }

  protected OtherOrPriorPolicy_ContractTerm( int magic, gw.internal.xml.XmlTypeInstanceTypeDataImpl typeData ) {
    super(magic, typeData);
  }

  protected OtherOrPriorPolicy_ContractTerm( int magic, gw.internal.xml.XmlTypeInstanceState state ) {
    super(magic, state);
  }
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.OtherOrPriorPolicy_ContractTerm> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.OtherOrPriorPolicy_ContractTerm get$TypeInstance() {
    return this;
  }
