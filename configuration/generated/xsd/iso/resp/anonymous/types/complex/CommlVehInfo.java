...
public class CommlVehInfo extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.CommlVehInfo> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.CommlVehInfo get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.resp.CommlVehSupplement getCommlVehSupplement() {
    return (xsd.iso.resp.CommlVehSupplement) TYPE.get().getPropertyValue( this, "_CommlVehSupplement" );
  }
  ...
  public final java.util.List<xsd.iso.resp.anonymous.elements.CommlVehInfo_CommlCoverage> getCommlCoverage() {
    return (java.util.List<xsd.iso.resp.anonymous.elements.CommlVehInfo_CommlCoverage>) TYPE.get().getPropertyValue( this, "_CommlCoverage" );
  }
  ...
  public final java.util.List<xsd.iso.resp.CreditOrSurcharge> getCreditOrSurcharge() {
    return (java.util.List<xsd.iso.resp.CreditOrSurcharge>) TYPE.get().getPropertyValue( this, "_CreditOrSurcharge" );
  }
