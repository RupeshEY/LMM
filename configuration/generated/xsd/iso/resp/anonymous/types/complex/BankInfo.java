...
public class BankInfo extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.BankInfo> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.BankInfo get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.resp.anonymous.elements.BankInfo_BankId getBankId_elem() {
    return (xsd.iso.resp.anonymous.elements.BankInfo_BankId) TYPE.get().getPropertyValue( this, "_BankId_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.BankInfo_BranchId getBranchId_elem() {
    return (xsd.iso.resp.anonymous.elements.BankInfo_BranchId) TYPE.get().getPropertyValue( this, "_BranchId_elem" );
  }
