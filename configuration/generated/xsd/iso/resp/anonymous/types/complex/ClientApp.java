...
public class ClientApp extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.ClientApp> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.ClientApp get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.resp.Org getOrg_elem() {
    return (xsd.iso.resp.Org) TYPE.get().getPropertyValue( this, "_Org_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.ClientApp_Name getName_elem() {
    return (xsd.iso.resp.anonymous.elements.ClientApp_Name) TYPE.get().getPropertyValue( this, "_Name_elem" );
  }
  ...
  public final xsd.iso.resp.Version getVersion_elem() {
    return (xsd.iso.resp.Version) TYPE.get().getPropertyValue( this, "_Version_elem" );
  }
