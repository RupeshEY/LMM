...
public class Communications_PhoneInfo extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.Communications_PhoneInfo> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.Communications_PhoneInfo get$TypeInstance() {
    return this;
  }
  ...
  public final java.util.List<xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_PhoneTypeCd> getPhoneTypeCd_elem() {
    return (java.util.List<xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_PhoneTypeCd>) TYPE.get().getPropertyValue( this, "_PhoneTypeCd_elem" );
  }
  ...
  public final java.util.List<xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_CommunicationUseCd> getCommunicationUseCd_elem() {
    return (java.util.List<xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_CommunicationUseCd>) TYPE.get().getPropertyValue( this, "_CommunicationUseCd_elem" );
  }
  ...
  public final java.util.List<xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_PhoneNumber> getPhoneNumber_elem() {
    return (java.util.List<xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_PhoneNumber>) TYPE.get().getPropertyValue( this, "_PhoneNumber_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_EmailAddr getEmailAddr_elem() {
    return (xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_EmailAddr) TYPE.get().getPropertyValue( this, "_EmailAddr_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_ComIso_PhoneName getComIso_PhoneName_elem() {
    return (xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_ComIso_PhoneName) TYPE.get().getPropertyValue( this, "_ComIso_PhoneName_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_ComIso_PublishedInd getComIso_PublishedInd_elem() {
    return (xsd.iso.resp.anonymous.elements.Communications_PhoneInfo_ComIso_PublishedInd) TYPE.get().getPropertyValue( this, "_ComIso_PublishedInd_elem" );
  }
