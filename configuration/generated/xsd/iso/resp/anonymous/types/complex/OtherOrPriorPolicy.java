...
public class OtherOrPriorPolicy extends gw.xsd.w3c.xmlschema.types.complex.AnyType {
  ...
  @java.lang.Override
  public java.lang.Class<? extends xsd.iso.resp.anonymous.types.complex.OtherOrPriorPolicy> get$Class() {
    return getClass();
  }

  @java.lang.Override
  public xsd.iso.resp.anonymous.types.complex.OtherOrPriorPolicy get$TypeInstance() {
    return this;
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyCd getPolicyCd_elem() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyCd) TYPE.get().getPropertyValue( this, "_PolicyCd_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyNumber getPolicyNumber_elem() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyNumber) TYPE.get().getPropertyValue( this, "_PolicyNumber_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_LOBCd getLOBCd_elem() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_LOBCd) TYPE.get().getPropertyValue( this, "_LOBCd_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_LOBSubCd getLOBSubCd_elem() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_LOBSubCd) TYPE.get().getPropertyValue( this, "_LOBSubCd_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_NAICCd getNAICCd_elem() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_NAICCd) TYPE.get().getPropertyValue( this, "_NAICCd_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_InsurerName getInsurerName_elem() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_InsurerName) TYPE.get().getPropertyValue( this, "_InsurerName_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_ContractTerm getContractTerm() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_ContractTerm) TYPE.get().getPropertyValue( this, "_ContractTerm" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_OriginalInceptionDt getOriginalInceptionDt_elem() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_OriginalInceptionDt) TYPE.get().getPropertyValue( this, "_OriginalInceptionDt_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyTerminatedCd getPolicyTerminatedCd_elem() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyTerminatedCd) TYPE.get().getPropertyValue( this, "_PolicyTerminatedCd_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyTransferInd getPolicyTransferInd_elem() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyTransferInd) TYPE.get().getPropertyValue( this, "_PolicyTransferInd_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_LengthTimeWithPreviousInsurer getLengthTimeWithPreviousInsurer() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_LengthTimeWithPreviousInsurer) TYPE.get().getPropertyValue( this, "_LengthTimeWithPreviousInsurer" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyAmt getPolicyAmt() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_PolicyAmt) TYPE.get().getPropertyValue( this, "_PolicyAmt" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_RatingFactor getRatingFactor_elem() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_RatingFactor) TYPE.get().getPropertyValue( this, "_RatingFactor_elem" );
  }
  ...
  public final xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_CompanyProductCd getCompanyProductCd_elem() {
    return (xsd.iso.resp.anonymous.elements.OtherOrPriorPolicy_CompanyProductCd) TYPE.get().getPropertyValue( this, "_CompanyProductCd_elem" );
  }
