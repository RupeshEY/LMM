 ...
 * @private
 * @UpgradedSencha Mostly 5.1.2 code use to support IE Edge
 */
...
// @require Ext.Version
    ...
    if (/Edge\//.test(userAgent)) {
        ...
        Ext.isChrome = null;    // @UpgradedSencha reset the previous incorrect Chrome detection
        Ext.chromeVersion = null;
    }
...
Ext.env.Browser.prototype = {
    ...
    browserNames: {
        ...
        opera: 'Opera',
        dolfin: 'Dolfin',
        edge : 'IE',    // @UpgradedSencha make Edge like IE otherwise the isIE checks will fail and our app will break
