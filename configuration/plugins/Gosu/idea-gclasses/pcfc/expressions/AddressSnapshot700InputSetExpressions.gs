...
class AddressSnapshot700InputSetExpressions {
  ...
  public static class AddressSnapshot700InputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=LossLocationCode) at AddressSnapshot700InputSet.pcf: line 33, column 117
    function valueRoot_13 () : java.lang.Object {
      return Claim
    }
    
    // 'value' attribute on TextInput (id=Address_Name) at AddressSnapshot700InputSet.pcf: line 17, column 36
    ...
    // 'value' attribute on TextInput (id=JurisdictionState) at AddressSnapshot700InputSet.pcf: line 39, column 30
    function value_15 () : dynamic.Dynamic {
      return Claim.JurisdictionState
    }
    
    // 'value' attribute on TextInput (id=AddressType) at AddressSnapshot700InputSet.pcf: line 22, column 36
    function value_3 () : dynamic.Dynamic {
      return Address.AddressType
    }
    
    // 'value' attribute on TextInput (id=ValidUntil) at AddressSnapshot700InputSet.pcf: line 27, column 36
    function value_6 () : dynamic.Dynamic {
      return Address.ValidUntil
    }
    
    // 'visible' attribute on TextInput (id=JurisdictionState) at AddressSnapshot700InputSet.pcf: line 39, column 30
    function visible_14 () : java.lang.Boolean {
      return Claim!=null
    }
    
    // 'visible' attribute on TextInput (id=LossLocationCode) at AddressSnapshot700InputSet.pcf: line 33, column 117
