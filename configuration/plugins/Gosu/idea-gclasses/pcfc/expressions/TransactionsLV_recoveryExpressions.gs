...
class TransactionsLV_recoveryExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends TransactionsLVExpressionsImpl {
    ...
    // 'action' attribute on CurrencyCell (id=Amount) at TransactionsLV.recovery.pcf: line 39, column 24
    function action_16 () : void {
      TransactionViewDetailForward.drilldown(Claim, TransactionView)
    }
    
    // 'action' attribute on TextCell (id=Exposure) at TransactionsLV.recovery.pcf: line 47, column 23
    ...
    // 'outputConversion' attribute on TextCell (id=Exposure) at TransactionsLV.recovery.pcf: line 47, column 23
    ...
    // 'value' attribute on DateCell (id=CreateDate) at TransactionsLV.recovery.pcf: line 30, column 47
    ...
    // 'value' attribute on CurrencyCell (id=Amount) at TransactionsLV.recovery.pcf: line 39, column 24
    function value_15 () : gw.api.financials.CurrencyAmountPair {
      return TransactionView.CurrencyAmount
    }
    
    // 'value' attribute on TextCell (id=Exposure) at TransactionsLV.recovery.pcf: line 47, column 23
    function value_20 () : java.lang.Integer {
      return TransactionView.ExposureName
    }
    
    // 'value' attribute on TypeKeyCell (id=CoverageType) at TransactionsLV.recovery.pcf: line 52, column 45
    function value_26 () : typekey.CoverageType {
      return TransactionView.CoverageType
    }
    
    // 'value' attribute on TypeKeyCell (id=CostType) at TransactionsLV.recovery.pcf: line 57, column 41
    function value_29 () : typekey.CostType {
      return TransactionView.CostType
    }
    
    // 'value' attribute on TypeKeyCell (id=CostCategory) at TransactionsLV.recovery.pcf: line 62, column 45
    function value_32 () : typekey.CostCategory {
      return TransactionView.CostCategory
    }
    
    // 'value' attribute on TypeKeyCell (id=RecoveryCategory) at TransactionsLV.recovery.pcf: line 67, column 49
    function value_35 () : typekey.RecoveryCategory {
      return TransactionView.RecoveryCategory
    }
    
    // 'value' attribute on TypeKeyCell (id=ReservingCurrency) at TransactionsLV.recovery.pcf: line 73, column 74
    function value_39 () : typekey.Currency {
      return TransactionView.ReservingCurrency
    }
    
    // 'value' attribute on TypeKeyCell (id=Status) at TransactionsLV.recovery.pcf: line 78, column 50
    function value_42 () : typekey.TransactionStatus {
      return TransactionView.Status
    }
    
    // 'value' attribute on TextCell (id=User) at TransactionsLV.recovery.pcf: line 82, column 41
    function value_45 () : java.lang.String {
      return TransactionView.User
    }
    
    // 'visible' attribute on TypeKeyCell (id=ReservingCurrency) at TransactionsLV.recovery.pcf: line 73, column 74
  ...
  public static class TransactionsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RowIterator at TransactionsLV.recovery.pcf: line 30, column 47
    function sortValue_1 (TransactionView :  RecoveryView) : java.lang.Object {
      return TransactionView.CreateTime
    }
    
    // 'value' attribute on RowIterator at TransactionsLV.recovery.pcf: line 78, column 50
    function sortValue_10 (TransactionView :  RecoveryView) : java.lang.Object {
      return TransactionView.Status
    }
    
    // 'value' attribute on RowIterator at TransactionsLV.recovery.pcf: line 82, column 41
    function sortValue_11 (TransactionView :  RecoveryView) : java.lang.Object {
      return TransactionView.User
    }
    
    // 'sortBy' attribute on RowIterator at TransactionsLV.recovery.pcf: line 39, column 24
    function sortValue_2 (TransactionView :  RecoveryView) : java.lang.Object {
      return TransactionView.ClaimAmount
    }
    
    // 'value' attribute on RowIterator at TransactionsLV.recovery.pcf: line 47, column 23
    function sortValue_3 (TransactionView :  RecoveryView) : java.lang.Object {
      return TransactionView.ExposureName
    }
    
    // 'value' attribute on RowIterator at TransactionsLV.recovery.pcf: line 52, column 45
    function sortValue_4 (TransactionView :  RecoveryView) : java.lang.Object {
      return TransactionView.CoverageType
    }
    
    // 'value' attribute on RowIterator at TransactionsLV.recovery.pcf: line 57, column 41
    function sortValue_5 (TransactionView :  RecoveryView) : java.lang.Object {
      return TransactionView.CostType
    }
    
    // 'value' attribute on RowIterator at TransactionsLV.recovery.pcf: line 62, column 45
    function sortValue_6 (TransactionView :  RecoveryView) : java.lang.Object {
      return TransactionView.CostCategory
    }
    
    // 'value' attribute on RowIterator at TransactionsLV.recovery.pcf: line 67, column 49
    function sortValue_7 (TransactionView :  RecoveryView) : java.lang.Object {
      return TransactionView.RecoveryCategory
    }
    
    // 'value' attribute on RowIterator at TransactionsLV.recovery.pcf: line 73, column 74
    function sortValue_9 (TransactionView :  RecoveryView) : java.lang.Object {
      return TransactionView.ReservingCurrency
    }
    ...
    // 'visible' attribute on RowIterator at TransactionsLV.recovery.pcf: line 73, column 74
