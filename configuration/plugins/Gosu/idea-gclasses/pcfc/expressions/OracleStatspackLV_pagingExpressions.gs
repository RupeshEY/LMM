...
class OracleStatspackLV_pagingExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends OracleStatspackLVExpressionsImpl {
    ...
    // 'value' attribute on CheckBoxCell (id=selector) at OracleStatspackLV.paging.pcf: line 23, column 38
    ...
    // 'value' attribute on DateCell (id=startuptime) at OracleStatspackLV.paging.pcf: line 46, column 36
    function value_10 () : java.util.Date {
      return Row.StartupTime
    }
    
    // 'value' attribute on TextCell (id=Description) at OracleStatspackLV.paging.pcf: line 51, column 36
    function value_13 () : java.lang.String {
      return Row.Description
    }
    
    // 'value' attribute on TextCell (id=SnapshotID) at OracleStatspackLV.paging.pcf: line 32, column 42
    function value_4 () : java.lang.Integer {
      return Row.Id
    }
    
    // 'value' attribute on DateCell (id=time) at OracleStatspackLV.paging.pcf: line 39, column 33
  ...
  public static class OracleStatspackLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RowIterator at OracleStatspackLV.paging.pcf: line 17, column 58
