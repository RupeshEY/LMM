...
class NewClaimExposureDV_GeneraldamageExpressions {
  ...
  public static class NewClaimExposureDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on PolicyStatCodePickerInput (id=Exposure_StatLine) at NewClaimExposureDV.Generaldamage.pcf: line 50, column 63
    ...
    // 'condition' attribute on ReflectCondition at NewClaimExposureDV.Generaldamage.pcf: line 75, column 45
    function condition_36 (TRIGGER_INDEX :  int, VALUE :  typekey.LossPartyType) : java.lang.Boolean {
      return VALUE == TC_INSURED
    }
    
    // 'condition' attribute on ReflectCondition at NewClaimExposureDV.Generaldamage.pcf: line 92, column 42
    function condition_58 (TRIGGER_INDEX :  int, VALUE :  entity.Contact) : java.lang.Boolean {
      return Exposure.Claim.Insured==VALUE
    }
    
    // 'def' attribute on InputSetRef at NewClaimExposureDV.Generaldamage.pcf: line 186, column 128
    ...
    // 'def' attribute on ListViewInput at NewClaimExposureDV.Generaldamage.pcf: line 166, column 118
    ...
    // 'value' attribute on RangeInput (id=Exposure_Coverage) at NewClaimExposureDV.Generaldamage.pcf: line 41, column 38
    ...
    // 'value' attribute on TypeKeyInput (id=Claimant_Type) at NewClaimExposureDV.Generaldamage.pcf: line 87, column 42
    ...
    // 'value' attribute on BooleanRadioInput (id=Claimant_ContactProhibited) at NewClaimExposureDV.Generaldamage.pcf: line 102, column 36
    function defaultSetter_66 (__VALUE_TO_SET :  java.lang.Object) : void {
      ContactProhibited = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on TypeKeyInput (id=Severity) at NewClaimExposureDV.Generaldamage.pcf: line 130, column 43
    ...
    // 'value' attribute on TextAreaInput (id=Description) at NewClaimExposureDV.Generaldamage.pcf: line 137, column 48
    ...
    // 'value' attribute on CurrencyInput (id=LossEstimate) at NewClaimExposureDV.Generaldamage.pcf: line 143, column 49
    ...
    // 'value' attribute on TypeKeyInput (id=Exposure_JurisdictionState) at NewClaimExposureDV.Generaldamage.pcf: line 153, column 43
    ...
    // 'value' attribute on BooleanRadioInput (id=Claimant_OtherCoverage) at NewClaimExposureDV.Generaldamage.pcf: line 162, column 41
    function defaultSetter_97 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.OtherCoverage = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'filter' attribute on TypeKeyInput (id=Severity) at NewClaimExposureDV.Generaldamage.pcf: line 130, column 43
    ...
    // 'filter' attribute on TypeKeyInput (id=Exposure_JurisdictionState) at NewClaimExposureDV.Generaldamage.pcf: line 153, column 43
    ...
    // Reflect at NewClaimExposureDV.Generaldamage.pcf: line 72, column 43
    ...
    // 'valueRange' attribute on RangeInput (id=Exposure_Coverage) at NewClaimExposureDV.Generaldamage.pcf: line 41, column 38
    ...
    // 'value' attribute on TypeKeyInput (id=Exposure_LossParty) at NewClaimExposureDV.Generaldamage.pcf: line 23, column 44
    function valueRoot_2 () : java.lang.Object {
      return Exposure
    }
    
    // 'value' attribute on TextInput (id=Claimant_PrimaryPhone) at NewClaimExposureDV.Generaldamage.pcf: line 106, column 53
    ...
    // 'value' attribute on PolicyStatCodePickerInput (id=Exposure_StatLine) at NewClaimExposureDV.Generaldamage.pcf: line 50, column 63
    function value_16 () : entity.StatCode {
      return Exposure.StatLine
    }
    
    // 'value' attribute on TypeKeyInput (id=Exposure_PrimaryCoverage) at NewClaimExposureDV.Generaldamage.pcf: line 28, column 43
    function value_3 () : typekey.CoverageType {
      return Exposure.PrimaryCoverage
    }
    
    // 'value' attribute on TextInput (id=StatLine_Warning) at NewClaimExposureDV.Generaldamage.pcf: line 57, column 65
    ...
    // 'value' attribute on ReflectCondition at NewClaimExposureDV.Generaldamage.pcf: line 75, column 45
    function value_37 (TRIGGER_INDEX :  int, VALUE :  typekey.LossPartyType) : java.lang.Object {
      return Exposure.Claim.Insured
    }
    
    // 'value' attribute on ClaimContactInput (id=Claimant_Picker) at NewClaimExposureDV.Generaldamage.pcf: line 70, column 94
    function value_39 () : entity.Contact {
      return Exposure.Claimant
    }
    
    // 'value' attribute on TypeKeyInput (id=Exposure_CoverageSubType) at NewClaimExposureDV.Generaldamage.pcf: line 33, column 46
    ...
    // 'value' attribute on TextInput (id=Claimant_Address) at NewClaimExposureDV.Generaldamage.pcf: line 114, column 62
    ...
    // 'visible' attribute on TextInput (id=ServiceRequestSubmitMessageFNOL) at NewClaimExposureDV.Generaldamage.pcf: line 179, column 55
    function visible_101 () : java.lang.Boolean {
      return Exposure.Incident.Claim.DraftClaim
    }
    
    // 'visible' attribute on TextInput (id=ServiceRequestSubmitMessage) at NewClaimExposureDV.Generaldamage.pcf: line 184, column 90
    function visible_103 () : java.lang.Boolean {
      return not Exposure.Incident.Claim.DraftClaim and CurrentLocation.InEditMode
    }
    
    // 'visible' attribute on TextInput (id=StatLine_Warning) at NewClaimExposureDV.Generaldamage.pcf: line 57, column 65
