...
class FNOLWizard_ServicesScreen_PrExpressions {
  ...
  public static class FNOLWizard_ServicesScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef (id=PolicyPanelSet) at FNOLWizard_ServicesScreen.Pr.pcf: line 28, column 39
    function def_onEnter_0 (def :  pcf.FNOLWizard_ServicesPolicyPanelSet_Homeowners) : void {
      def.onEnter(claim, wizard)
    }
    
    // 'def' attribute on PanelRef (id=PolicyPanelSet) at FNOLWizard_ServicesScreen.Pr.pcf: line 28, column 39
    function def_refreshVariables_1 (def :  pcf.FNOLWizard_ServicesPolicyPanelSet_Homeowners) : void {
      def.refreshVariables(claim, wizard)
    }
    
    // 'mode' attribute on PanelRef (id=PolicyPanelSet) at FNOLWizard_ServicesScreen.Pr.pcf: line 28, column 39
