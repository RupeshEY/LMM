...
class ClaimSnapshotExposureDV_ContentExpressions {
  ...
  public static class ClaimSnapshotExposureDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextInput (id=Contents_Incident) at ClaimSnapshotExposureDV.Content.pcf: line 27, column 38
    ...
    // 'value' attribute on TextInput (id=Contents_Incident) at ClaimSnapshotExposureDV.Content.pcf: line 27, column 38
