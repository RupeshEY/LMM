...
class DashboardPeriodFinancialsExpressions {
  ...
  public static class DashboardPeriodFinancialsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at DashboardPeriodFinancials.pcf: line 46, column 101
    function def_onEnter_11 (def :  pcf.PeriodFinancialsByLossTypeLV) : void {
      def.onEnter(Stats.LossTypeStats?.toTypedArray())
    }
    
    // 'def' attribute on PanelRef at DashboardPeriodFinancials.pcf: line 51, column 99
    function def_onEnter_14 (def :  pcf.PeriodFinancialsByCoverageTypeLV) : void {
      def.onEnter(Stats.CoverageTypeStats?.toTypedArray())
    }
    
    // 'def' attribute on PanelRef at DashboardPeriodFinancials.pcf: line 38, column 108
    ...
    // 'def' attribute on PanelRef at DashboardPeriodFinancials.pcf: line 41, column 101
    ...
    // 'value' attribute on ToolbarInput (id=label) at DashboardPeriodFinancials.pcf: line 31, column 41
    function value_2 () : java.lang.String {
      return Stats.WhenLastCalculatedString
    }
    
    // 'visible' attribute on PanelRef at DashboardPeriodFinancials.pcf: line 51, column 99
    function visible_13 () : java.lang.Boolean {
      return GroupInfo.isRoot() && gw.api.dashboard.DashboardUtil.isShowByCoverage()
    }
    
    // 'visible' attribute on PanelRef at DashboardPeriodFinancials.pcf: line 41, column 101
