...
class ReplacementServicesDVExpressions {
  ...
  public static class ReplacementServicesDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateInput (id=LostWagesBenefits_BenefitsBeginDate) at ReplacementServicesDV.pcf: line 17, column 56
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.RSBenefits.BenefitsBeginDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=LostWagesBenefits_BenefitsEndDate) at ReplacementServicesDV.pcf: line 23, column 54
    function defaultSetter_8 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.RSBenefits.BenefitsEndDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'validationExpression' attribute on DateInput (id=LostWagesBenefits_BenefitsEndDate) at ReplacementServicesDV.pcf: line 23, column 54
