...
class CommandParameterInputSet_formulaExpressions {
  ...
  public static class CommandParameterInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'autoComplete' attribute on TextInput (id=Expression) at CommandParameterInputSet.formula.pcf: line 26, column 45
    function autoComplete_12 () : gw.api.contact.AutocompleteHandler {
      return fragHolder.AutocompleteHandler
    }
    
    // 'def' attribute on MenuItemSetRef at CommandParameterInputSet.formula.pcf: line 29, column 61
    ...
    // 'value' attribute on TextInput (id=Expression) at CommandParameterInputSet.formula.pcf: line 26, column 45
    ...
    // 'inputConversion' attribute on TextInput (id=Expression) at CommandParameterInputSet.formula.pcf: line 26, column 45
    function inputConversion_6 (VALUE :  java.lang.String) : java.lang.Object {
      return fragHolder.inputConversion(VALUE)
    }
    
    // 'label' attribute on TextInput (id=Expression) at CommandParameterInputSet.formula.pcf: line 26, column 45
    function label_1 () : java.lang.Object {
      return parameterHolder.ParameterLabel
    }
    
    // 'numCols' attribute on TextInput (id=Expression) at CommandParameterInputSet.formula.pcf: line 26, column 45
    function numCols_7 () : java.lang.Integer {
      return parameterHolder.UIConfig.NumCols
    }
    
    // 'outputConversion' attribute on TextInput (id=Expression) at CommandParameterInputSet.formula.pcf: line 26, column 45
