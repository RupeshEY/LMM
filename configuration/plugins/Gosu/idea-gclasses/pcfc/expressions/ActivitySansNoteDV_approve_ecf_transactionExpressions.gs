...
class ActivitySansNoteDV_approve_ecf_transactionExpressions {
  @javax.annotation.Generated("config/web/pcf/workspace/activity/ActivitySansNoteDV.approve_ecf_transaction.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ActivitySansNoteDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at ActivitySansNoteDV.approve_ecf_transaction.pcf: line 15, column 94
    ...
    // 'def' attribute on ListViewInput at ActivitySansNoteDV.approve_ecf_transaction.pcf: line 22, column 41
    ...
    // 'value' attribute on DateInput (id=Details_CreateTime) at ActivitySansNoteDV.approve_ecf_transaction.pcf: line 38, column 52
    ...
    // 'value' attribute on ClaimContactInput (id=Details_CreateUser) at ActivitySansNoteDV.approve_ecf_transaction.pcf: line 34, column 41
    ...
    // 'valueType' attribute on ClaimContactInput (id=Details_CreateUser) at ActivitySansNoteDV.approve_ecf_transaction.pcf: line 34, column 41
