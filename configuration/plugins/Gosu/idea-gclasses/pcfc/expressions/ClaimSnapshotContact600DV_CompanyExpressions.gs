...
@javax.annotation.Generated("config/web/pcf/claim/snapshot/600/ClaimSnapshotContact600DV.company.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotContact600DV_CompanyExpressions {
  ...
  public static class ClaimSnapshotContact600DVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at ClaimSnapshotContact600DV.company.pcf: line 156, column 27
    ...
    // 'encryptionExpression' attribute on PrivacyInput (id=TaxID) at ClaimSnapshotContact600DV.company.pcf: line 119, column 38
    ...
    // 'value' attribute on RowIterator at ClaimSnapshotContact600DV.company.pcf: line 29, column 46
    function sortValue_0 (Role :  dynamic.Dynamic) : java.lang.Object {
      return Role.Role
    }
    
    // 'value' attribute on RowIterator at ClaimSnapshotContact600DV.company.pcf: line 33, column 59
    function sortValue_1 (Role :  dynamic.Dynamic) : java.lang.Object {
      return util.Snapshot.getRoleOwner(Role)
    }
    
    // 'value' attribute on RowIterator at ClaimSnapshotContact600DV.company.pcf: line 37, column 65
    function sortValue_2 (Role :  dynamic.Dynamic) : java.lang.Object {
      return util.Snapshot.renderValue(Role.Active)
    }
    
    // 'value' attribute on RowIterator at ClaimSnapshotContact600DV.company.pcf: line 42, column 46
    function sortValue_3 (Role :  dynamic.Dynamic) : java.lang.Object {
      return Role.Comments
    }
    
    // 'value' attribute on TextInput (id=Contact) at ClaimSnapshotContact600DV.company.pcf: line 56, column 38
    function valueRoot_17 () : java.lang.Object {
      return asClaimContact().Contact
    }
    
    // 'value' attribute on TextInput (id=AddressType) at ClaimSnapshotContact600DV.company.pcf: line 100, column 38
    ...
    // 'value' attribute on TextInput (id=PrimaryPhone) at ClaimSnapshotContact600DV.company.pcf: line 64, column 38
    function value_18 () : dynamic.Dynamic {
      return asClaimContact().Contact.PrimaryPhone
    }
    
    // 'value' attribute on TextInput (id=WorkPhone) at ClaimSnapshotContact600DV.company.pcf: line 69, column 38
    function value_21 () : dynamic.Dynamic {
      return asClaimContact().Contact.WorkPhone
    }
    
    // 'value' attribute on TextInput (id=FaxPhone) at ClaimSnapshotContact600DV.company.pcf: line 74, column 38
    function value_24 () : dynamic.Dynamic {
      return asClaimContact().Contact.FaxPhone
    }
    
    // 'value' attribute on TextInput (id=EmailAddress1) at ClaimSnapshotContact600DV.company.pcf: line 82, column 38
    function value_27 () : dynamic.Dynamic {
      return asClaimContact().Contact.EmailAddress1
    }
    
    // 'value' attribute on TextInput (id=EmailAddress2) at ClaimSnapshotContact600DV.company.pcf: line 87, column 38
    ...
    // 'value' attribute on TextInput (id=Description) at ClaimSnapshotContact600DV.company.pcf: line 105, column 38
    function value_38 () : dynamic.Dynamic {
      return asClaimContact().Contact.PrimaryAddress.Description
    }
    
    // 'value' attribute on TextInput (id=ValidUntil) at ClaimSnapshotContact600DV.company.pcf: line 110, column 38
    function value_41 () : dynamic.Dynamic {
      return asClaimContact().Contact.PrimaryAddress.ValidUntil
    }
    
    // 'value' attribute on PrivacyInput (id=TaxID) at ClaimSnapshotContact600DV.company.pcf: line 119, column 38
    function value_44 () : dynamic.Dynamic {
      return asClaimContact().Contact.TaxID
    }
    
    // 'value' attribute on TextInput (id=WithholdingRate) at ClaimSnapshotContact600DV.company.pcf: line 124, column 38
    function value_48 () : dynamic.Dynamic {
      return asClaimContact().Contact.WithholdingRate
    }
    
    // 'value' attribute on TextInput (id=TaxStatus) at ClaimSnapshotContact600DV.company.pcf: line 129, column 38
    function value_51 () : dynamic.Dynamic {
      return asClaimContact().Contact.TaxStatus
    }
    
    // 'value' attribute on TextInput (id=PrimaryContact) at ClaimSnapshotContact600DV.company.pcf: line 133, column 85
    function value_54 () : java.lang.String {
      return util.Snapshot.renderValue(asClaimContact().Contact.PrimaryContact)
    }
    
    // 'value' attribute on TextInput (id=PreferredCurrency) at ClaimSnapshotContact600DV.company.pcf: line 138, column 38
    function value_56 () : dynamic.Dynamic {
      return asClaimContact().Contact.PreferredCurrency
    }
    
    // 'value' attribute on TextAreaInput (id=Notes) at ClaimSnapshotContact600DV.company.pcf: line 147, column 38
  ...
  public static class IteratorEntryExpressionsImpl extends ClaimSnapshotContact600DVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=Role) at ClaimSnapshotContact600DV.company.pcf: line 29, column 46
    function valueRoot_6 () : java.lang.Object {
      return Role
    }
    
    // 'value' attribute on TextCell (id=Comments) at ClaimSnapshotContact600DV.company.pcf: line 42, column 46
    ...
    // 'value' attribute on TextCell (id=Owner) at ClaimSnapshotContact600DV.company.pcf: line 33, column 59
    function value_7 () : java.lang.String {
      return util.Snapshot.getRoleOwner(Role)
    }
    
    // 'value' attribute on TextCell (id=Active) at ClaimSnapshotContact600DV.company.pcf: line 37, column 65
