...
@javax.annotation.Generated("config/web/pcf/claim/quickjump/contextualforward/ClaimHistoryForward.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimHistoryForward extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ClaimHistoryForward, LOCATION_CONFIG_CLASS)
  }
