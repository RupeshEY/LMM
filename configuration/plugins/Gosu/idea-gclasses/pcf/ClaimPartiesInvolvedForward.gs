...
@javax.annotation.Generated("config/web/pcf/claim/quickjump/contextualforward/ClaimPartiesInvolvedForward.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimPartiesInvolvedForward extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ClaimPartiesInvolvedForward, LOCATION_CONFIG_CLASS)
  }
