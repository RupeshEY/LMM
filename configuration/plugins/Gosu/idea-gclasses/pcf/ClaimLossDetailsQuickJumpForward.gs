...
@javax.annotation.Generated("config/web/pcf/claim/quickjump/contextualforward/ClaimLossDetailsQuickJumpForward.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimLossDetailsQuickJumpForward extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ClaimLossDetailsQuickJumpForward, LOCATION_CONFIG_CLASS)
  }
