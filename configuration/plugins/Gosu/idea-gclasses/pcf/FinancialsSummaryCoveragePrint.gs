...
@javax.annotation.Generated("config/web/pcf/claim/financials/summary/print/FinancialsSummaryCoveragePrint.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
public class FinancialsSummaryCoveragePrint extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.FinancialsSummaryCoveragePrint, LOCATION_CONFIG_CLASS)
  }
