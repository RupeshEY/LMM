...
public class ActivityRuleExportImportStatus extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ActivityRuleExportImportStatus, LOCATION_CONFIG_CLASS)
  }
