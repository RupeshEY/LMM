...
public class ECFMessageSuspenseQueue extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ECFMessageSuspenseQueue, LOCATION_CONFIG_CLASS)
  }
