...
public class ECFAdminClaimRetrievePage extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ECFAdminClaimRetrievePage, LOCATION_CONFIG_CLASS)
  }
