...
@javax.annotation.Generated("config/web/pcf/claim/quickjump/contextualforward/ClaimExposuresForward.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimExposuresForward extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.ClaimExposuresForward, LOCATION_CONFIG_CLASS)
  }
