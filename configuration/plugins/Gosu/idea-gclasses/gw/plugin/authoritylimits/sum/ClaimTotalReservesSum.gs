...
@Export
class ClaimTotalReservesSum extends AbstractAuthoritySum {
  ...
  override function exceedsLimit(bean: Approvable, limit: AuthorityLimit): boolean {
    ...
    var sum = sumExisting(FinancialsCalculations.TotalReserves, claim, limit, exposures)
  ...
  override property get AuthorityLimitType(): AuthorityLimitType {
    return typekey.AuthorityLimitType.TC_CTR
  }
}