...
uses wsi.remote.gw.webservice.ab.ab800.abvendorevaluationapi.ABVendorEvaluationAPI
uses wsi.remote.gw.webservice.ab.ab800.abvendorevaluationapi.types.complex.ABVendorEvaluationAPIReviewSummary
...
class ContactReviewPlugin implements IContactReviewPlugin, InitializablePlugin {
   ...
   * @throws java.rmi.RemoteException if there is a problem connecting to the ContactManager server.
   */
  override function submitReview(review: Review) : String {
    ...
    if (linkstatus.Linked and not linkstatus.Broken) {
      ...
      var categoryScore = new wsi.remote.gw.webservice.ab.ab800.abvendorevaluationapi.anonymous.elements.ABVendorEvaluationAPIReviewSummary_CategoryScores()
      var category = new wsi.remote.gw.webservice.ab.ab800.abvendorevaluationapi.anonymous.elements.ABVendorEvaluationAPIReviewSummary_ReviewCategories()
