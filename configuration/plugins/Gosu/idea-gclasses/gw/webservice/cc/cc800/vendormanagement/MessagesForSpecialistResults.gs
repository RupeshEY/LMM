...
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc800/vendormanagement/MessagesForSpecialistResults")
final class MessagesForSpecialistResults {
   ...
   */
  var _results : List<gw.webservice.cc.cc800.vendormanagement.Message> as Results
}