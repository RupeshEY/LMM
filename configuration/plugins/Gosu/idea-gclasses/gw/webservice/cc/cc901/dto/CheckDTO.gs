 ...
 * A(n) {@link gw.webservice.cc.cc901.dto.CheckDTO} is a DTO that represents an instance of {@link Check} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link Check}.
 ...
 * <p>The specific mappings for {@link gw.webservice.cc.cc901.dto.CheckDTO} are as follows:
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc901/dto/CheckDTO")
final class CheckDTO {
  ...
  var _newAdditionalPayees            : gw.webservice.cc.cc901.dto.CheckPayeeDTO[]                  as NewAdditionalPayees = {}
  var _newJointPayees                 : gw.webservice.cc.cc901.dto.CheckPayeeDTO[]                  as NewJointPayees = {}
  var _newPayees                      : gw.webservice.cc.cc901.dto.CheckPayeeDTO[]                  as NewPayees = {}
  var _newPayments                    : gw.webservice.cc.cc901.dto.TransactionDTO[]                 as NewPayments = {}
  var _newPrimaryPayee                : gw.webservice.cc.cc901.dto.CheckPayeeDTO as NewPrimaryPayee
   ...
   * @param that The Check to copy from.
   */
  final function readFrom(that : Check) : gw.webservice.cc.cc901.dto.CheckDTO {
   ...
   */
  static function valueOf(that : Check) : gw.webservice.cc.cc901.dto.CheckDTO {
    return new gw.webservice.cc.cc901.dto.CheckDTO().readFrom(that)
  }
