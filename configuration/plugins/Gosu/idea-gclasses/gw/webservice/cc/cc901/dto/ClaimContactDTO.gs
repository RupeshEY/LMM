 ...
 * A(n) {@link ClaimContactDTO} is a DTO that represents an instance of {@link ClaimContact} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link ClaimContact}.
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc901/dto/ClaimContactDTO")
