 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc900/dto/ExposureDTO")
final class ExposureDTO {
  ...
  /** Convenience property that returns the {@link Coverage} whose PublicID is {@code CoveragePublicID}, or {@code null} if PublicID is {@code null}. This property is only available on the server--it is not exposed through the WS-I layer. */
