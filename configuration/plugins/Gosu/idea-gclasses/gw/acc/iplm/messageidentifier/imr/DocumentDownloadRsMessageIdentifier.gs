...
class DocumentDownloadRsMessageIdentifier extends BaseMessageIdentifier {

  override function messageType(): LMMessageTypeString_Ext {
    return LMMessageTypeString_Ext.TC_ECFMESSAGEDOCUMENTDOWNLOADRS_EXT
  }
  ...
  override function canHandle(element: XmlElement): Boolean {
    ...
    return messageType == ECFMessageConstants.DocumentDownloadType
  }
}