...
enhancement ECFRetrieveClaimRsEnhancement: RetrieveClaimRs {
   ...
   *
   * @return SimultaneousReinstatementRequired indicator
   */
  ...
  /**
   * Sets the ClaimMovement.Extension.Claim.LossPeriod.EndDate.
   *
   * @param newLossEndDate
   */
  property set ClaimLossEndDate(newLossEndDate: String) {
    this.ClaimMovement.Extension?.Claim?.LossPeriod?.EndDate = newLossEndDate
  }

  /**
   * Gets the ClaimMovement.ClaimLossLocation.LossLocation.Location.Description.
   *
   * @return String
   */
  property get ClaimLossLocationDescription(): String {
    return this.ClaimMovement.Claim.LossLocation?.Location?.Description
  }

  /**
   * Sets the ClaimMovement.Claim.LossLocation.Location.Description.
   *
   * @param newLossLocationDescription
   */
  property set ClaimLossLocationDescription(newLossLocationDescription: String) {
    this.ClaimMovement.Claim.LossLocation?.Location?.Description = newLossLocationDescription
  }

  /**
   * Gets the first transaction status which is not null
   * from the options of Lloyd's, LIRMA or ILU.
   *
   * @return String A transaction status or null if none found.
   */
  ...
  /**
   * Sets the ClaimMovement.Extension.ClaimEntry.LloydsStatus.
   *
   * @param newStatus
   */
  property set LloydsStatus(newStatus: String) {
    this.ClaimMovement.Extension?.ClaimEntry?.LloydsStatus = newStatus
  }
  ...
  /**
   * Sets the ClaimMovement.Extension.ClaimEntry.LirmaStatus.
   *
   * @param newStatus
   */
  property set LirmaStatus(newStatus: String) {
    this.ClaimMovement.Extension?.ClaimEntry?.LirmaStatus = newStatus
  }
  ...
  /**
   * Sets the ClaimMovement.Extension.ClaimEntry.IluStatus.
   *
   * @param newStatus
   */
  property set IluStatus(newStatus: String) {
    this.ClaimMovement.Extension?.ClaimEntry?.IluStatus = newStatus
  }
  ...
  property get MessageType(): ECFMessageType_Ext {
    return ECFMessageType_Ext.TC_RETRIEVECLAIM
  }
  ...
  /**
   * Sets the ClaimMovement.ClaimMovement.ServiceProvider.Party.FirstId.
   */
  ...
  /**
   * Sets the ClaimMovement.ServiceProvider.Party.Name.
   */
  ...
  /**
   * Sets the ClaimMovement.ServiceProvider.Party.FirstAgency.
   */
  ...
  /**
   * Using the value at the XML tag wb:RetrieveClaimRs/wb:ClaimMovement/wb:Extension/wb:Claim/wb:ClaimsScheme
  ...
  /**
   * Gets ContactName of the Bureau Lead Insurer Or Reinsurer Name
   *
   * @return String
   */
  ...
  /**
   * Gets ContactPhone of the Bureau Lead Insurer Or Reinsurer Name
   *
   * @return String
   */
  ...
  /**
   * Gets ContactEmail of the Bureau Lead Insurer Or Reinsurer Name
   *
   * @return String
   */
  ...
  /**
   * @return a list of Soft Warning descriptions from the message or empty list if no Soft Warnings exist
   */
  ...
  /**
   * Gets the ClaimMovement.Extension.Claim.Indicators.MultipleResponseIndicator element
   *
   ...
   *
   * @return {@link java.lang.String} ChaseUpIndicatorInterval
   */
