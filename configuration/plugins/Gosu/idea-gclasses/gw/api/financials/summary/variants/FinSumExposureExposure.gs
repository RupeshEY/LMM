...
@Export
class FinSumExposureExposure extends RootNode implements Node {
  ...
  override function compareTo(o: Node): int {
    var node = o as FinSumExposureExposure
  ...
  override function equals(obj: Object): boolean {
    ...
    if (!(obj typeis FinSumExposureExposure )) {
      return false
    }
    var rhs = obj as FinSumExposureExposure
