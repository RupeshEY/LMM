...
@Export
class FinSumCoverageLeaf extends FinSumCoverageExposure implements Leaf {
  ...
  override function buildSummaryInstance(): Node {
    return new FinSumCoverageExposure (_exposure, _claim)
  }

  override function compareTo(o: Node): int {
    var node = o as FinSumCoverageLeaf
  ...
  override function equals(obj: Object): boolean {
    ...
    if (!(obj typeis FinSumCoverageLeaf )) {
      return false
    }
    var rhs = obj as FinSumCoverageLeaf
