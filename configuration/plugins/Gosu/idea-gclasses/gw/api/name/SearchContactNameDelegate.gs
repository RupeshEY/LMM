...
@Export
class SearchContactNameDelegate implements PersonNameFields {
  construct (nameCriteria : CCNameCriteria) {
    _nameCriteria = nameCriteria
  }

  var _nameCriteria : CCNameCriteria

  // for Contacts
  override property get Name() : String {
    return _nameCriteria.CompanyName  // note: CCNameCriteria.Name fields appears not to be used
  }
